...
Debug.ShouldStop(524288);
parent.__c.runVoidMethod ("LogImpl","052101198",RemoteObject.concat(RemoteObject.createImmutable("ERROR al obtener el nombre del cliente: "),_j2.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(4);
parent.__c.runVoidMethod ("LogImpl","052101213",RemoteObject.concat(RemoteObject.createImmutable("ERROR al obtener el nombre de la hacienda: "),_j3.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
parent.__c.runVoidMethod ("LogImpl","052101228",RemoteObject.concat(RemoteObject.createImmutable("ERROR al obtener el nombre de la hacienda: "),_j3.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
;
...
Debug.ShouldStop(2048);
parent.__c.runVoidMethod ("LogImpl","052101254",RemoteObject.createImmutable("Error: Formato de fecha inválido o no se pudo parsear la fecha."),0);
 if (true) break;
if (true) break;
...
Debug.ShouldStop(1048576);
parent.__c.runVoidMethod ("LogImpl","052101263",RemoteObject.concat(RemoteObject.createImmutable("ERROR: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
