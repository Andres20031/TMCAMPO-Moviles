...
try {
		Debug.PushSubsStack("B4XPage_Created (formprogramacampocancelar) ","formprogramacampocancelar",6,__ref.getField(false, "ba"),__ref,25);
...
try {
		Debug.PushSubsStack("Button1_Click (formprogramacampocancelar) ","formprogramacampocancelar",6,__ref.getField(false, "ba"),__ref,54);
...
parent.__c.runVoidMethod ("LogImpl","053805065",RemoteObject.concat(RemoteObject.createImmutable("Fecha actual: "),_fechaactual),0);
 BA.debugLineNum = 64;BA.debugLine="Log(\"Hora actual: \" & horaSistema)  ' Muestra la";
Debug.ShouldStop(-2147483648);
parent.__c.runVoidMethod ("LogImpl","053805066",RemoteObject.concat(RemoteObject.createImmutable("Hora actual: "),_horasistema),0);
 BA.debugLineNum = 65;BA.debugLine="Log(\"Observacion: \" & observacion)";
Debug.ShouldStop(1);
parent.__c.runVoidMethod ("LogImpl","053805067",RemoteObject.concat(RemoteObject.createImmutable("Observacion: "),__ref.getField(true,"_observacion" /*RemoteObject*/ )),0);
 BA.debugLineNum = 66;BA.debugLine="Log(\"Cancelada\")";
Debug.ShouldStop(2);
parent.__c.runVoidMethod ("LogImpl","053805068",RemoteObject.createImmutable("Cancelada"),0);
 BA.debugLineNum = 67;BA.debugLine="Log(\"ID\" & consecutivoInt)";
Debug.ShouldStop(4);
parent.__c.runVoidMethod ("LogImpl","053805069",RemoteObject.concat(RemoteObject.createImmutable("ID"),_consecutivoint),0);
...
Debug.ShouldStop(134217728);
parent.__c.runVoidMethod ("LogImpl","053805094",RemoteObject.concat(RemoteObject.createImmutable("Error al ejecutar la consulta: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(1073741824);
parent.__c.runVoidMethod ("LogImpl","053805097",RemoteObject.concat(RemoteObject.createImmutable("Error al agregar datos: "),parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba")).runMethod(true,"getMessage")),0);
 if (true) break;
if (true) break;
...
try {
		Debug.PushSubsStack("CreateCommand (formprogramacampocancelar) ","formprogramacampocancelar",6,__ref.getField(false, "ba"),__ref,46);
...
try {
		Debug.PushSubsStack("EditText3_TextChanged (formprogramacampocancelar) ","formprogramacampocancelar",6,__ref.getField(false, "ba"),__ref,39);
...
formprogramacampocancelar.__c.runVoidMethod ("LogImpl","053673988",__ref.getField(true,"_observacion" /*RemoteObject*/ ),0);
...
try {
		Debug.PushSubsStack("Initialize (formprogramacampocancelar) ","formprogramacampocancelar",6,__ref.getField(false, "ba"),__ref,12);
...
try {
		Debug.PushSubsStack("Label1_Click (formprogramacampocancelar) ","formprogramacampocancelar",6,__ref.getField(false, "ba"),__ref,33);
...
try {
		Debug.PushSubsStack("SetConsecutivo (formprogramacampocancelar) ","formprogramacampocancelar",6,__ref.getField(false, "ba"),__ref,16);
