...
try {
		Debug.PushSubsStack("B4XPage_Created (menu) ","menu",6,__ref.getField(false, "ba"),__ref,25);
...
try {
		Debug.PushSubsStack("Initialize (menu) ","menu",6,__ref.getField(false, "ba"),__ref,18);
...
public static RemoteObject  _panel1precipitacion2_click(RemoteObject __ref) throws Exception{
try {
		Debug.PushSubsStack("Panel1Precipitacion2_Click (menu) ","menu",6,__ref.getField(false, "ba"),__ref,93);
if (RapidSub.canDelegate("panel1precipitacion2_click")) { return __ref.runUserSub(false, "menu","panel1precipitacion2_click", __ref);}
...
try {
		Debug.PushSubsStack("pnlCosecha_Click (menu) ","menu",6,__ref.getField(false, "ba"),__ref,80);
...
try {
		Debug.PushSubsStack("PnlMaquinaria_Click (menu) ","menu",6,__ref.getField(false, "ba"),__ref,63);
...
try {
		Debug.PushSubsStack("pnlPersonal_Click (menu) ","menu",6,__ref.getField(false, "ba"),__ref,68);
...
try {
		Debug.PushSubsStack("pnlPrecipitacion_Click (menu) ","menu",6,__ref.getField(false, "ba"),__ref,84);
...
try {
		Debug.PushSubsStack("pnlPrograma_de_labores_Click (menu) ","menu",6,__ref.getField(false, "ba"),__ref,88);
...
try {
		Debug.PushSubsStack("pnlTaller_Click (menu) ","menu",6,__ref.getField(false, "ba"),__ref,76);
