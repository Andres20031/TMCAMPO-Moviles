...
parent.__c.runVoidMethod ("LogImpl","76881309",RemoteObject.concat(RemoteObject.createImmutable("NIT: "),__ref.getField(true,"_nitupdate" /*RemoteObject*/ )),0);
 if (true) break;
if (true) break;
...
parent.__c.runVoidMethod ("LogImpl","76881312",RemoteObject.concat(RemoteObject.createImmutable("NIT: "),__ref.getField(true,"_nit" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(64);
parent.__c.runVoidMethod ("LogImpl","76881326",BA.ObjectToString(parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 if (true) break;
if (true) break;
...
form.__c.runVoidMethod ("LogImpl","79306120",BA.ObjectToString(form.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
Debug.ShouldStop(65536);
form.__c.runVoidMethod ("LogImpl","79437193",BA.ObjectToString(form.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
Debug.ShouldStop(16777216);
parent.__c.runVoidMethod ("LogImpl","77143434",_cursor.runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("name"))),0);
...
Debug.ShouldStop(512);
parent.__c.runVoidMethod ("LogImpl","77143451",BA.ObjectToString(parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 if (true) break;
if (true) break;
...
Debug.ShouldStop(16384);
parent.__c.runVoidMethod ("LogImpl","78912924",RemoteObject.concat(RemoteObject.createImmutable("ERROR: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(-2147483648);
parent.__c.runVoidMethod ("LogImpl","78519706",RemoteObject.concat(RemoteObject.createImmutable("cadena: "),_cadena),0);
 BA.debugLineNum = 705;BA.debugLine="Log(\"hacienda: \"&haciendaUpdate)";
Debug.ShouldStop(1);
parent.__c.runVoidMethod ("LogImpl","78519707",RemoteObject.concat(RemoteObject.createImmutable("hacienda: "),__ref.getField(true,"_haciendaupdate" /*RemoteObject*/ )),0);
...
Debug.ShouldStop(32768);
parent.__c.runVoidMethod ("LogImpl","78519722",RemoteObject.concat(RemoteObject.createImmutable("ERROR: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(8192);
parent.__c.runVoidMethod ("LogImpl","78847389",RemoteObject.concat(RemoteObject.createImmutable("ERROR: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(134217728);
parent.__c.runVoidMethod ("LogImpl","78650775",RemoteObject.concat(RemoteObject.createImmutable("ERROR: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(1024);
parent.__c.runVoidMethod ("LogImpl","78781851",RemoteObject.concat(RemoteObject.createImmutable("ERROR: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(524288);
parent.__c.runVoidMethod ("LogImpl","78454174",RemoteObject.concat(RemoteObject.createImmutable("NIT: "),__ref.getField(true,"_nitupdate" /*RemoteObject*/ )),0);
...
Debug.ShouldStop(-2147483648);
parent.__c.runVoidMethod ("LogImpl","78454186",RemoteObject.concat(RemoteObject.createImmutable("ERROR: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(4096);
parent.__c.runVoidMethod ("LogImpl","77798792",RemoteObject.concat(RemoteObject.createImmutable("=====ITEM #"),RemoteObject.createImmutable(_i),RemoteObject.createImmutable("=====")),0);
 BA.debugLineNum = 430;BA.debugLine="Log(Cursor.GetString(\"idmaquina\"))";
Debug.ShouldStop(8192);
parent.__c.runVoidMethod ("LogImpl","77798793",_cursor.runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("idmaquina"))),0);
 BA.debugLineNum = 431;BA.debugLine="Log(Cursor.GetString(\"name\")&\"--\"&Cursor.GetStri";
Debug.ShouldStop(16384);
parent.__c.runVoidMethod ("LogImpl","77798794",RemoteObject.concat(_cursor.runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("name"))),RemoteObject.createImmutable("--"),_cursor.runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("qnt")))),0);
...
Debug.ShouldStop(262144);
parent.__c.runVoidMethod ("LogImpl","77798798",_sb.runMethod(true,"ToString"),0);
...
Debug.ShouldStop(16777216);
parent.__c.runVoidMethod ("LogImpl","77798804",RemoteObject.concat(RemoteObject.createImmutable("=====Maquinas #"),RemoteObject.createImmutable(_i),RemoteObject.createImmutable("=====")),0);
 BA.debugLineNum = 442;BA.debugLine="Log(Cursor.GetString(\"id\"))'&\"--\"&Cursor.GetStr";
Debug.ShouldStop(33554432);
parent.__c.runVoidMethod ("LogImpl","77798805",_cursor.runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("id"))),0);
 if (true) break;
if (true) break;
...
Debug.ShouldStop(1);
parent.__c.runVoidMethod ("LogImpl","77798812",BA.ObjectToString(parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 if (true) break;
if (true) break;
...
Debug.ShouldStop(1048576);
parent.__c.runVoidMethod ("LogImpl","77995399",RemoteObject.createImmutable("Inserted successfully!"),0);
 if (true) break;
...
Debug.ShouldStop(262144);
form.__c.runVoidMethod ("LogImpl","79371650",BA.ObjectToString(__ref.getField(false,"_label1removeinsumo" /*RemoteObject*/ ).runMethod(false,"getTag")),0);
...
Debug.ShouldStop(67108864);
form.__c.runVoidMethod ("LogImpl","77929864",RemoteObject.concat(__ref.getField(false,"_label10" /*RemoteObject*/ ).runMethod(true,"getText"),RemoteObject.createImmutable("----"),__ref.getField(false,"_label13time" /*RemoteObject*/ ).runMethod(true,"getText")),0);
 BA.debugLineNum = 476;BA.debugLine="Log(\"HACIENDA: \"&haciendaUpdate)";
Debug.ShouldStop(134217728);
form.__c.runVoidMethod ("LogImpl","77929865",RemoteObject.concat(RemoteObject.createImmutable("HACIENDA: "),__ref.getField(true,"_haciendaupdate" /*RemoteObject*/ )),0);
...
Debug.ShouldStop(8);
form.__c.runVoidMethod ("LogImpl","77929873",RemoteObject.createImmutable("update"),0);
 };
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e12) {
...
Debug.ShouldStop(128);
form.__c.runVoidMethod ("LogImpl","77929877",BA.ObjectToString(form.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
Debug.ShouldStop(134217728);
form.__c.runVoidMethod ("LogImpl","76946829",_cursor.runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("id"))),0);
 BA.debugLineNum = 157;BA.debugLine="Log(Cursor.GetString(\"name\"))";
Debug.ShouldStop(268435456);
form.__c.runVoidMethod ("LogImpl","76946830",_cursor.runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("name"))),0);
 BA.debugLineNum = 158;BA.debugLine="Log(Cursor.GetString(\"qnt\"))";
Debug.ShouldStop(536870912);
form.__c.runVoidMethod ("LogImpl","76946831",_cursor.runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("qnt"))),0);
...
Debug.ShouldStop(-2147483648);
form.__c.runVoidMethod ("LogImpl","77012358",RemoteObject.concat(RemoteObject.createImmutable("REMOVE: "),RemoteObject.createImmutable(_iw)),form.__c.getField(false,"Colors").getField(true,"Red"));
...
Debug.ShouldStop(8);
form.__c.runVoidMethod ("LogImpl","77012362",BA.ObjectToString(form.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
 };
 }
}Debug.locals.put("iw", _iw);
...
Debug.ShouldStop(8388608);
form.__c.runVoidMethod ("LogImpl","78585219",BA.ObjectToString(_value),0);
...
Debug.ShouldStop(1);
form.__c.runVoidMethod ("LogImpl","78585228",__ref.getField(true,"_hacienda" /*RemoteObject*/ ),0);
...
Debug.ShouldStop(128);
form.__c.runVoidMethod ("LogImpl","78716294",RemoteObject.concat(_position,RemoteObject.createImmutable(" - "),_value),0);
...
Debug.ShouldStop(2048);
form.__c.runVoidMethod ("LogImpl","78716298",__ref.getField(true,"_hacienda" /*RemoteObject*/ ),0);
...
Debug.ShouldStop(4);
parent.__c.runVoidMethod ("LogImpl","79502733",BA.ObjectToString(parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 if (true) break;
if (true) break;
...
Debug.ShouldStop(1024);
form.__c.runVoidMethod ("LogImpl","79568258",BA.ObjectToString(__ref.getField(false,"_spinner1nameinsumo" /*RemoteObject*/ ).runMethod(false,"getTag")),0);
 BA.debugLineNum = 1004;BA.debugLine="Log(Spinner1NameInsumo.SelectedItem)";
Debug.ShouldStop(2048);
form.__c.runVoidMethod ("LogImpl","79568259",__ref.getField(false,"_spinner1nameinsumo" /*RemoteObject*/ ).runMethod(true,"getSelectedItem"),0);
...
Debug.ShouldStop(16777216);
form.__c.runVoidMethod ("LogImpl","78978433",BA.ObjectToString(_value),0);
