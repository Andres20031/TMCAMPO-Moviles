...
try {
		Debug.PushSubsStack("Initialize (util) ","util",17,__ref.getField(false, "ba"),__ref,6);
...
try {
		Debug.PushSubsStack("SetStatusBarColor (util) ","util",17,__ref.getField(false, "ba"),__ref,10);
...
util.__c.runVoidMethod ("LogImpl","734603022",BA.ObjectToString(util.__c.runMethod(false,"LastException",__ref.runMethod(false,"getActivityBA"))),0);
 };
