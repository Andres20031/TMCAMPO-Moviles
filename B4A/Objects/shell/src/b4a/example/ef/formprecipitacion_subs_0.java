...
formprecipitacion.__c.runVoidMethod ("LogImpl","866387988",__ref.getField(true,"_fecha" /*RemoteObject*/ ),0);
...
Debug.ShouldStop(256);
parent.__c.runVoidMethod ("LogImpl","865929253",RemoteObject.concat(RemoteObject.createImmutable("Error en la consulta de Maquina: "),_j2.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(33554432);
parent.__c.runVoidMethod ("LogImpl","866519056",RemoteObject.concat(RemoteObject.createImmutable("Error al ejecutar la consulta: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(268435456);
parent.__c.runVoidMethod ("LogImpl","866519059",RemoteObject.concat(RemoteObject.createImmutable("Error al agregar datos: "),parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba")).runMethod(true,"getMessage")),0);
 if (true) break;
if (true) break;
...
Debug.ShouldStop(536870912);
formprecipitacion.__c.runVoidMethod ("LogImpl","866453505",RemoteObject.concat(RemoteObject.createImmutable("Texto anterior: "),_old),0);
 BA.debugLineNum = 159;BA.debugLine="Log(\"Texto nuevo: \" & New)";
Debug.ShouldStop(1073741824);
formprecipitacion.__c.runVoidMethod ("LogImpl","866453506",RemoteObject.concat(RemoteObject.createImmutable("Texto nuevo: "),_new),0);
...
Debug.ShouldStop(32);
formprecipitacion.__c.runVoidMethod ("LogImpl","866453513",RemoteObject.concat(RemoteObject.createImmutable("El texto es mayor de 5 caracteres: "),__ref.getField(true,"_textocapturado" /*RemoteObject*/ )),0);
...
Debug.ShouldStop(65536);
formprecipitacion.__c.runVoidMethod ("LogImpl","866322433",RemoteObject.concat(RemoteObject.createImmutable("VALOR COMBOBOX: "),_value),0);
...
Debug.ShouldStop(134217728);
formprecipitacion.__c.runVoidMethod ("LogImpl","866322444",RemoteObject.concat(RemoteObject.createImmutable("Código: "),__ref.getField(true,"_selectedcdgo_plvmtro" /*RemoteObject*/ )),0);
 BA.debugLineNum = 125;BA.debugLine="Log(\"Nombre: \" & selectedNombre_Plvmtro)";
Debug.ShouldStop(268435456);
formprecipitacion.__c.runVoidMethod ("LogImpl","866322445",RemoteObject.concat(RemoteObject.createImmutable("Nombre: "),__ref.getField(true,"_selectednombre_plvmtro" /*RemoteObject*/ )),0);
 BA.debugLineNum = 126;BA.debugLine="Log(\"NIT: \" & selectedNit_Plvmtro)";
Debug.ShouldStop(536870912);
formprecipitacion.__c.runVoidMethod ("LogImpl","866322446",RemoteObject.concat(RemoteObject.createImmutable("NIT: "),__ref.getField(true,"_selectednit_plvmtro" /*RemoteObject*/ )),0);
 BA.debugLineNum = 127;BA.debugLine="Log(\"Hacienda: \" & selectedHda_Pvlmtro)";
Debug.ShouldStop(1073741824);
formprecipitacion.__c.runVoidMethod ("LogImpl","866322447",RemoteObject.concat(RemoteObject.createImmutable("Hacienda: "),__ref.getField(true,"_selectedhda_pvlmtro" /*RemoteObject*/ )),0);
 }else {
 BA.debugLineNum = 129;BA.debugLine="Log(\"Error: No se encontraron detalles para el c";
Debug.ShouldStop(1);
formprecipitacion.__c.runVoidMethod ("LogImpl","866322449",RemoteObject.createImmutable("Error: No se encontraron detalles para el código seleccionado."),0);
 };
