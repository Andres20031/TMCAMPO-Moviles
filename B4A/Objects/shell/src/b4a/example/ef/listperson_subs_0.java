...
try {
		Debug.PushSubsStack("B4XPage_Appear (listperson) ","listperson",14,__ref.getField(false, "ba"),__ref,35);
...
Debug.ShouldStop(8);
parent.__c.runVoidMethod ("LogImpl","820119585",RemoteObject.concat(RemoteObject.createImmutable("ERROR: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
try {
		Debug.PushSubsStack("B4XPage_Created (listperson) ","listperson",14,__ref.getField(false, "ba"),__ref,25);
...
try {
		Debug.PushSubsStack("CLV_Persons_ItemClick (listperson) ","listperson",14,__ref.getField(false, "ba"),__ref,111);
...
try {
		Debug.PushSubsStack("CreateCommand (listperson) ","listperson",14,__ref.getField(false, "ba"),__ref,121);
...
try {
		Debug.PushSubsStack("CreateItem (listperson) ","listperson",14,__ref.getField(false, "ba"),__ref,74);
...
try {
		Debug.PushSubsStack("Initialize (listperson) ","listperson",14,__ref.getField(false, "ba"),__ref,18);
...
try {
		Debug.PushSubsStack("Label1_Click (listperson) ","listperson",14,__ref.getField(false, "ba"),__ref,117);
