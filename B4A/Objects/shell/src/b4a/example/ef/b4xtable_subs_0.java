...
try {
		Debug.PushSubsStack("AddColumn (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,595);
if (RapidSub.canDelegate("addcolumn")) { return __ref.runUserSub(false, "b4xtable","addcolumn", __ref, _title, _columntype);}
RemoteObject _c = RemoteObject.declareNull("b4a.example.ef.b4xtable._b4xtablecolumn");
...
Debug.JustUpdateDeviceLine();
_c = RemoteObject.createNew ("b4a.example.ef.b4xtable._b4xtablecolumn");Debug.locals.put("c", _c);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_createcolumnlayouts" /*RemoteObject*/ ,(Object)(_c),(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mrowsperpage" /*RemoteObject*/ ),RemoteObject.createImmutable(1)}, "+",1, 1)));
...
_header = __ref.runClassMethod (b4a.example.ef.b4xtable.class, "_getlabelfromcolumn" /*RemoteObject*/ ,(Object)(_c),(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("header", _header);Debug.locals.put("header", _header);
 BA.debugLineNum = 611;BA.debugLine="SetTextOrCSBuilderToLabel (header, Title)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_settextorcsbuildertolabel" /*RemoteObject*/ ,(Object)(_header),(Object)((_title)));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_addcolumntoclv" /*RemoteObject*/ ,(Object)(_c));
 };
...
try {
		Debug.PushSubsStack("AddColumnToCLV (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,587);
...
try {
		Debug.PushSubsStack("Base_Resize (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,141);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_refresh2" /*RemoteObject*/ ,(Object)(b4xtable.__c.getField(true,"False")),(Object)(b4xtable.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("BuildLayoutsCache (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,619);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_createcolumnlayouts" /*RemoteObject*/ ,(Object)(_c),(Object)(RemoteObject.solve(new RemoteObject[] {_size,RemoteObject.createImmutable(1)}, "+",1, 1)));
 }
}Debug.locals.put("c", _c);
;
...
try {
		Debug.PushSubsStack("BuildQuery (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,337);
...
try {
		Debug.PushSubsStack("CalculateWidths (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,565);
...
try {
		Debug.PushSubsStack("Cell_Click (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,738);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_cellclicked" /*void*/ ,RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), b4xtable.__c.runMethod(false,"Sender",__ref.getField(false, "ba"))),(Object)(b4xtable.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("Cell_LongClick (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,742);
...
try {
		Debug.PushSubsStack("CellClicked (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,776);
...
public ResumableSub_CellClicked(b4a.example.ef.b4xtable parent,RemoteObject __ref,RemoteObject _pnl,RemoteObject _longclicked) {
this.parent = parent;
this.__ref = __ref;
this._pnl = _pnl;
...
RemoteObject _column = RemoteObject.declareNull("b4a.example.ef.b4xtable._b4xtablecolumn");
...
{ BA.debugLineNum = 795;BA.debugLine="Else If VisibleRowIds.Size > 0 Then";
Debug.JustUpdateDeviceLine();
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_headerclicked" /*RemoteObject*/ ,(Object)(_column));
 if (true) break;
;
...
try {
		Debug.PushSubsStack("CheckAndRemoveColumnThatWasAddedToIncorrectParent (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,279);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_removecolumnfromclv" /*RemoteObject*/ ,(Object)(_c));
 }else {
...
b4xtable._defaultformatter = RemoteObject.createNew ("b4a.example.ef.b4xformatter");__ref.setField("_defaultformatter",b4xtable._defaultformatter);
b4xtable._defaultdataformatter = RemoteObject.createNew ("b4a.example.ef.b4xformatter");__ref.setField("_defaultdataformatter",b4xtable._defaultdataformatter);
...
b4xtable._searchfield = RemoteObject.createNew ("b4a.example.ef.b4xfloattextfield");__ref.setField("_searchfield",b4xtable._searchfield);
...
try {
		Debug.PushSubsStack("Clear (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,146);
...
public ResumableSub_Clear(b4a.example.ef.b4xtable parent,RemoteObject __ref) {
this.parent = parent;
this.__ref = __ref;
}
java.util.LinkedHashMap<String, Object> rsLocals = new java.util.LinkedHashMap<String, Object>();
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_clearnavigationstate" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("ClearDataView (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,400);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_updatedata" /*RemoteObject*/ ,(Object)(b4xtable.__c.getField(true,"True")));
...
try {
		Debug.PushSubsStack("ClearNavigationState (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,171);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_setpagelabelstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lblnext" /*RemoteObject*/ )),(Object)(b4xtable.__c.getField(true,"False")));
 BA.debugLineNum = 174;BA.debugLine="SetPageLabelState(lblLast, False)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_setpagelabelstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lbllast" /*RemoteObject*/ )),(Object)(b4xtable.__c.getField(true,"False")));
 BA.debugLineNum = 175;BA.debugLine="SetPageLabelState(lblBack, False)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_setpagelabelstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lblback" /*RemoteObject*/ )),(Object)(b4xtable.__c.getField(true,"False")));
 BA.debugLineNum = 176;BA.debugLine="SetPageLabelState(lblFirst, False)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_setpagelabelstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lblfirst" /*RemoteObject*/ )),(Object)(b4xtable.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("ColumnToSQLType (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,711);
...
try {
		Debug.PushSubsStack("CreateCellViews (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,716);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_setmousetransparent" /*RemoteObject*/ ,RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), _lbl.getObject()));
...
try {
		Debug.PushSubsStack("CreateColumnLayouts (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,625);
...
Debug.JustUpdateDeviceLine();
_p = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
_p = __ref.runClassMethod (b4a.example.ef.b4xtable.class, "_createcellviews" /*RemoteObject*/ );Debug.locals.put("p", _p);Debug.locals.put("p", _p);
...
try {
		Debug.PushSubsStack("CreateDataView (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,391);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_updatedata" /*RemoteObject*/ ,(Object)(b4xtable.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("CreateTable (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,695);
...
Debug.JustUpdateDeviceLine();
_sb.runVoidMethod ("Append",(Object)(RemoteObject.concat(_column.getField(true,"SQLID" /*RemoteObject*/ ),RemoteObject.createImmutable(" "),__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_columntosqltype" /*RemoteObject*/ ,(Object)(_column)),RemoteObject.createImmutable(","))));
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,104);
...
public ResumableSub_DesignerCreateView(b4a.example.ef.b4xtable parent,RemoteObject __ref,RemoteObject _base,RemoteObject _lbl,RemoteObject _props) {
this.parent = parent;
this.__ref = __ref;
this._base = _base;
this._lbl = _lbl;
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_searchfield" /*RemoteObject*/ ).runClassMethod (b4a.example.ef.b4xfloattextfield.class, "_update" /*RemoteObject*/ );
 BA.debugLineNum = 126;BA.debugLine="Dim jo As JavaObject = SearchField.TextField";
Debug.JustUpdateDeviceLine();
_jo = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), __ref.getField(false,"_searchfield" /*RemoteObject*/ ).runClassMethod (b4a.example.ef.b4xfloattextfield.class, "_gettextfield" /*RemoteObject*/ ).getObject());Debug.locals.put("jo", _jo);Debug.locals.put("jo", _jo);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_setmousetransparent" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lblsort" /*RemoteObject*/ )));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_refresh2" /*RemoteObject*/ ,(Object)(parent.__c.getField(true,"True")),(Object)(parent.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("GetColumn (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,543);
...
try {
		Debug.PushSubsStack("getCurrentPage (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,895);
...
try {
		Debug.PushSubsStack("getFirstRowIndex (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,885);
...
try {
		Debug.PushSubsStack("GetLabelFromColumn (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,560);
...
try {
		Debug.PushSubsStack("GetRow (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,858);
...
try {
		Debug.PushSubsStack("getRowsPerPage (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,890);
...
try {
		Debug.PushSubsStack("getSize (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,958);
...
try {
		Debug.PushSubsStack("HeaderClicked (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,824);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_updatesorticon" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("ImplUpdateDataFromQuery (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,413);
...
public ResumableSub_ImplUpdateDataFromQuery(b4a.example.ef.b4xtable parent,RemoteObject __ref,RemoteObject _query,RemoteObject _args,RemoteObject _totalcount,RemoteObject _dontsleep) {
this.parent = parent;
this.__ref = __ref;
this._query = _query;
this._args = _args;
...
Debug.JustUpdateDeviceLine();
_lbl = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
_lbl = __ref.runClassMethod (b4a.example.ef.b4xtable.class, "_getlabelfromcolumn" /*RemoteObject*/ ,(Object)(_c),(Object)(_rownumber));Debug.locals.put("lbl", _lbl);Debug.locals.put("lbl", _lbl);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_settexttocell" /*RemoteObject*/ ,(Object)(_rs.runMethod(true,"GetString",(Object)(_c.getField(true,"SQLID" /*RemoteObject*/ )))),(Object)(_lbl),(Object)(_c.getField(true,"Searchable" /*RemoteObject*/ )));
 if (true) break;
...
Debug.JustUpdateDeviceLine();
_c.getField(false,"Formatter" /*RemoteObject*/ ).runClassMethod (b4a.example.ef.b4xformatter.class, "_formatlabel" /*RemoteObject*/ ,(Object)(_rs.runMethod(true,"GetDouble",(Object)(_c.getField(true,"SQLID" /*RemoteObject*/ )))),(Object)(_lbl));
 if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_getlabelfromcolumn" /*RemoteObject*/ ,(Object)(_c),(Object)(BA.numberCast(int.class, _i))).runMethod(true,"setText",BA.ObjectToCharSequence(""));
 if (true) break;
if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_setpagelabelstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lbllast" /*RemoteObject*/ )),(Object)(BA.ObjectToBoolean(RemoteObject.solveBoolean("g",_totalcount,BA.numberCast(double.class, 0)))));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_setpagelabelstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lblnext" /*RemoteObject*/ )),(Object)(_aretheremoreresults));
 BA.debugLineNum = 478;BA.debugLine="SetPageLabelState(lblLast, False)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_setpagelabelstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lbllast" /*RemoteObject*/ )),(Object)(parent.__c.getField(true,"False")));
 if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_setpagelabelstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lblback" /*RemoteObject*/ )),(Object)(BA.ObjectToBoolean(RemoteObject.solveBoolean(">",__ref.getField(true,"_mfirstrowindex" /*RemoteObject*/ ),BA.numberCast(double.class, 0)))));
 BA.debugLineNum = 481;BA.debugLine="SetPageLabelState(lblFirst, lblBack.Tag)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_setpagelabelstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lblfirst" /*RemoteObject*/ )),(Object)(BA.ObjectToBoolean(__ref.getField(false,"_lblback" /*RemoteObject*/ ).runMethod(false,"getTag"))));
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","957868362",BA.ObjectToString(parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 if (true) break;
;
...
try {
		Debug.PushSubsStack("Initialize (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,81);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_defaultformatter" /*RemoteObject*/ ).runClassMethod (b4a.example.ef.b4xformatter.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
 BA.debugLineNum = 86;BA.debugLine="DefaultDataFormatter.Initialize";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_defaultdataformatter" /*RemoteObject*/ ).runClassMethod (b4a.example.ef.b4xformatter.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
...
try {
		Debug.PushSubsStack("lbl_Click (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,728);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_cellclicked" /*void*/ ,(Object)(_lbl.runMethod(false,"getParent")),(Object)(b4xtable.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("lbl_LongClick (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,733);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_cellclicked" /*void*/ ,(Object)(_lbl.runMethod(false,"getParent")),(Object)(b4xtable.__c.getField(true,"True")));
...
try {
		Debug.PushSubsStack("lblBack_Click (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,908);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_setfirstrowindex" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mfirstrowindex" /*RemoteObject*/ ),__ref.getField(true,"_mrowsperpage" /*RemoteObject*/ )}, "-",1, 1)));
...
try {
		Debug.PushSubsStack("lblFirst_Click (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,903);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_setfirstrowindex" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, 0)));
...
try {
		Debug.PushSubsStack("lblLast_Click (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,913);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_setfirstrowindex" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_numberofpages,RemoteObject.createImmutable(1)}, "-",1, 1)),__ref.getField(true,"_mrowsperpage" /*RemoteObject*/ )}, "*",0, 1)));
...
try {
		Debug.PushSubsStack("lblNext_Click (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,919);
...
try {
		Debug.PushSubsStack("Refresh (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,182);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_refresh2" /*RemoteObject*/ ,(Object)(b4xtable.__c.getField(true,"True")),(Object)(b4xtable.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("Refresh2 (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,191);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_calculatewidths" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_checkandremovecolumnthatwasaddedtoincorrectparent" /*RemoteObject*/ ,(Object)(_c),(Object)(_isfrozen));
 };
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_resizecolumnimpl" /*RemoteObject*/ ,(Object)(_c),(Object)(_totalheight));
...
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_updatedata" /*RemoteObject*/ ,(Object)(_dontsleep));};
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_resizeandreorderclvitems" /*RemoteObject*/ );
 BA.debugLineNum = 253;BA.debugLine="UpdateSearchFieldVisibility";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_updatesearchfieldvisibility" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("RefreshNow (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,187);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_refresh2" /*RemoteObject*/ ,(Object)(b4xtable.__c.getField(true,"True")),(Object)(b4xtable.__c.getField(true,"True")));
...
try {
		Debug.PushSubsStack("RemoveColumnFromCLV (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,289);
...
try {
		Debug.PushSubsStack("ResizeAndReorderCLVItems (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,257);
...
try {
		Debug.PushSubsStack("ResizeColumnImpl (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,299);
...
try {
		Debug.PushSubsStack("SearchField_TextChanged (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,943);
...
public ResumableSub_SearchField_TextChanged(b4a.example.ef.b4xtable parent,RemoteObject __ref,RemoteObject _old,RemoteObject _new) {
this.parent = parent;
this.__ref = __ref;
this._old = _old;
this._new = _new;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_updatedata" /*RemoteObject*/ ,(Object)(parent.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("setCurrentPage (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,899);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_setfirstrowindex" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_p,RemoteObject.createImmutable(1)}, "-",1, 1)),__ref.getField(true,"_mrowsperpage" /*RemoteObject*/ )}, "*",0, 1)));
...
try {
		Debug.PushSubsStack("SetData (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,657);
...
public ResumableSub_SetData(b4a.example.ef.b4xtable parent,RemoteObject __ref,RemoteObject _data) {
this.parent = parent;
this.__ref = __ref;
this._data = _data;
}
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_createtable" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_refreshnow" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("setFirstRowIndex (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,879);
...
try {
		Debug.PushSubsStack("SetMouseTransparent (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,753);
...
try {
		Debug.PushSubsStack("SetPageLabelState (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,550);
...
try {
		Debug.PushSubsStack("SetTextOrCSBuilderToLabel (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,760);
...
try {
		Debug.PushSubsStack("SetTextToCell (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,494);
...
try {
		Debug.PushSubsStack("UpdateData (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,328);
...
Debug.JustUpdateDeviceLine();
_o = __ref.runClassMethod (b4a.example.ef.b4xtable.class, "_buildquery" /*RemoteObject*/ ,(Object)(b4xtable.__c.getField(true,"True")));Debug.locals.put("o", _o);Debug.locals.put("o", _o);
 BA.debugLineNum = 332;BA.debugLine="ImplUpdateDataFromQuery (o(0), o(1), o(2), DontSl";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.ef.b4xtable.class, "_implupdatedatafromquery" /*void*/ ,(Object)(BA.ObjectToString(_o.getArrayElement(false,BA.numberCast(int.class, 0)))),(Object)(_o.getArrayElement(false,BA.numberCast(int.class, 1))),(Object)(BA.numberCast(int.class, _o.getArrayElement(false,BA.numberCast(int.class, 2)))),(Object)(_dontsleep));
...
try {
		Debug.PushSubsStack("UpdateSearchFieldVisibility (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,272);
...
try {
		Debug.PushSubsStack("UpdateSortIcon (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,839);
if (RapidSub.canDelegate("updatesorticon")) { return __ref.runUserSub(false, "b4xtable","updatesorticon", __ref);}
RemoteObject _col = RemoteObject.declareNull("b4a.example.ef.b4xtable._b4xtablecolumn");
...
try {
		Debug.PushSubsStack("UpdateTableCounters (b4xtable) ","b4xtable",34,__ref.getField(false, "ba"),__ref,408);
