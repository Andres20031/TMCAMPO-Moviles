...
parent.__c.runVoidMethod ("LogImpl","813500477",RemoteObject.concat(RemoteObject.createImmutable("ERROR al obtener el nombre del cliente: "),_j2.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(2048);
parent.__c.runVoidMethod ("LogImpl","813500493",RemoteObject.concat(RemoteObject.createImmutable("ERROR al obtener el nombre de la hacienda: "),_j3.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(4194304);
parent.__c.runVoidMethod ("LogImpl","813500504",RemoteObject.concat(RemoteObject.createImmutable("ERROR: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(128);
detailsperson.__c.runVoidMethod ("LogImpl","813697033",BA.ObjectToString(detailsperson.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
Debug.ShouldStop(64);
parent.__c.runVoidMethod ("LogImpl","813631493",BA.NumberToString(_index),0);
...
Debug.ShouldStop(1048576);
parent.__c.runVoidMethod ("LogImpl","813631507",RemoteObject.createImmutable("Error: el índice está fuera de los límites de la lista."),0);
 if (true) break;
...
Debug.ShouldStop(33554432);
parent.__c.runVoidMethod ("LogImpl","813631512",BA.ObjectToString(parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 if (true) break;
if (true) break;
