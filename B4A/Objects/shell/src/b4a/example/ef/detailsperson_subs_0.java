...
try {
		Debug.PushSubsStack("B4XPage_Appear (detailsperson) ","detailsperson",7,__ref.getField(false, "ba"),__ref,32);
...
parent.__c.runVoidMethod ("LogImpl","25636158",RemoteObject.concat(RemoteObject.createImmutable("ERROR al obtener el nombre del cliente: "),_j2.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(8192);
parent.__c.runVoidMethod ("LogImpl","25636174",RemoteObject.concat(RemoteObject.createImmutable("ERROR al obtener el nombre de la hacienda: "),_j3.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(16777216);
parent.__c.runVoidMethod ("LogImpl","25636185",RemoteObject.concat(RemoteObject.createImmutable("ERROR: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
try {
		Debug.PushSubsStack("B4XPage_Created (detailsperson) ","detailsperson",7,__ref.getField(false, "ba"),__ref,24);
...
try {
		Debug.PushSubsStack("Button1Check_Click (detailsperson) ","detailsperson",7,__ref.getField(false, "ba"),__ref,193);
...
Debug.ShouldStop(512);
detailsperson.__c.runVoidMethod ("LogImpl","25832713",BA.ObjectToString(detailsperson.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("Button2Del_Click (detailsperson) ","detailsperson",7,__ref.getField(false, "ba"),__ref,164);
...
Debug.ShouldStop(256);
parent.__c.runVoidMethod ("LogImpl","25767173",BA.NumberToString(_index),0);
...
Debug.ShouldStop(4194304);
parent.__c.runVoidMethod ("LogImpl","25767187",RemoteObject.createImmutable("Error: el índice está fuera de los límites de la lista."),0);
 if (true) break;
...
Debug.ShouldStop(134217728);
parent.__c.runVoidMethod ("LogImpl","25767192",BA.ObjectToString(parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 if (true) break;
if (true) break;
...
try {
		Debug.PushSubsStack("CreateCommand (detailsperson) ","detailsperson",7,__ref.getField(false, "ba"),__ref,212);
...
try {
		Debug.PushSubsStack("CreateItem (detailsperson) ","detailsperson",7,__ref.getField(false, "ba"),__ref,130);
...
try {
		Debug.PushSubsStack("Initialize (detailsperson) ","detailsperson",7,__ref.getField(false, "ba"),__ref,19);
...
try {
		Debug.PushSubsStack("Label1_Click (detailsperson) ","detailsperson",7,__ref.getField(false, "ba"),__ref,208);
...
try {
		Debug.PushSubsStack("Label2_Click (detailsperson) ","detailsperson",7,__ref.getField(false, "ba"),__ref,221);
...
try {
		Debug.PushSubsStack("LimitarPalabras (detailsperson) ","detailsperson",7,__ref.getField(false, "ba"),__ref,226);
