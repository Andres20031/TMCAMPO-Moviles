...
try {
		Debug.PushSubsStack("B4XPage_Appear (detailsperson) ","detailsperson",8,__ref.getField(false, "ba"),__ref,31);
...
parent.__c.runVoidMethod ("LogImpl","511337789",RemoteObject.concat(RemoteObject.createImmutable("ERROR al obtener el nombre del cliente: "),_j2.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(2048);
parent.__c.runVoidMethod ("LogImpl","511337805",RemoteObject.concat(RemoteObject.createImmutable("ERROR al obtener el nombre de la hacienda: "),_j3.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(4194304);
parent.__c.runVoidMethod ("LogImpl","511337816",RemoteObject.concat(RemoteObject.createImmutable("ERROR: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
try {
		Debug.PushSubsStack("B4XPage_Created (detailsperson) ","detailsperson",8,__ref.getField(false, "ba"),__ref,24);
...
try {
		Debug.PushSubsStack("Button1Check_Click (detailsperson) ","detailsperson",8,__ref.getField(false, "ba"),__ref,191);
...
Debug.ShouldStop(128);
detailsperson.__c.runVoidMethod ("LogImpl","511534345",BA.ObjectToString(detailsperson.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
try {
		Debug.PushSubsStack("Button2Del_Click (detailsperson) ","detailsperson",8,__ref.getField(false, "ba"),__ref,162);
...
Debug.ShouldStop(64);
parent.__c.runVoidMethod ("LogImpl","511468805",BA.NumberToString(_index),0);
...
Debug.ShouldStop(1048576);
parent.__c.runVoidMethod ("LogImpl","511468819",RemoteObject.createImmutable("Error: el índice está fuera de los límites de la lista."),0);
 if (true) break;
...
Debug.ShouldStop(33554432);
parent.__c.runVoidMethod ("LogImpl","511468824",BA.ObjectToString(parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 if (true) break;
if (true) break;
...
try {
		Debug.PushSubsStack("CreateCommand (detailsperson) ","detailsperson",8,__ref.getField(false, "ba"),__ref,210);
...
try {
		Debug.PushSubsStack("CreateItem (detailsperson) ","detailsperson",8,__ref.getField(false, "ba"),__ref,128);
...
try {
		Debug.PushSubsStack("Initialize (detailsperson) ","detailsperson",8,__ref.getField(false, "ba"),__ref,19);
...
try {
		Debug.PushSubsStack("Label1_Click (detailsperson) ","detailsperson",8,__ref.getField(false, "ba"),__ref,206);
...
try {
		Debug.PushSubsStack("Label2_Click (detailsperson) ","detailsperson",8,__ref.getField(false, "ba"),__ref,219);
...
try {
		Debug.PushSubsStack("LimitarPalabras (detailsperson) ","detailsperson",8,__ref.getField(false, "ba"),__ref,224);
