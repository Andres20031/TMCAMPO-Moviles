...
try {
		Debug.PushSubsStack("B4XPage_Appear (detailsperson) ","detailsperson",3,__ref.getField(false, "ba"),__ref,32);
...
try {
		Debug.PushSubsStack("B4XPage_Created (detailsperson) ","detailsperson",3,__ref.getField(false, "ba"),__ref,24);
...
try {
		Debug.PushSubsStack("Button1Check_Click (detailsperson) ","detailsperson",3,__ref.getField(false, "ba"),__ref,193);
...
try {
		Debug.PushSubsStack("Button2Del_Click (detailsperson) ","detailsperson",3,__ref.getField(false, "ba"),__ref,164);
...
try {
		Debug.PushSubsStack("CreateCommand (detailsperson) ","detailsperson",3,__ref.getField(false, "ba"),__ref,212);
...
try {
		Debug.PushSubsStack("CreateItem (detailsperson) ","detailsperson",3,__ref.getField(false, "ba"),__ref,130);
...
try {
		Debug.PushSubsStack("Initialize (detailsperson) ","detailsperson",3,__ref.getField(false, "ba"),__ref,19);
...
try {
		Debug.PushSubsStack("Label1_Click (detailsperson) ","detailsperson",3,__ref.getField(false, "ba"),__ref,208);
...
try {
		Debug.PushSubsStack("Label2_Click (detailsperson) ","detailsperson",3,__ref.getField(false, "ba"),__ref,221);
...
try {
		Debug.PushSubsStack("LimitarPalabras (detailsperson) ","detailsperson",3,__ref.getField(false, "ba"),__ref,226);
