...
try {
		Debug.PushSubsStack("CallFromResume (gifviewer) ","gifviewer",12,__ref.getField(false, "ba"),__ref,68);
...
Debug.ShouldStop(16);
if (__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getVisible").<Boolean>get().booleanValue()) { 
__ref.runClassMethod (b4a.example.ef.gifviewer.class, "_start" /*RemoteObject*/ );};
...
try {
		Debug.PushSubsStack("DesignerCreateView (gifviewer) ","gifviewer",12,__ref.getField(false, "ba"),__ref,19);
...
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"setVisible",gifviewer.__c.getField(true,"False"));
...
try {
		Debug.PushSubsStack("GetBase (gifviewer) ","gifviewer",12,__ref.getField(false, "ba"),__ref,85);
...
try {
		Debug.PushSubsStack("Initialize (gifviewer) ","gifviewer",12,__ref.getField(false, "ba"),__ref,14);
...
try {
		Debug.PushSubsStack("SetGif (gifviewer) ","gifviewer",12,__ref.getField(false, "ba"),__ref,24);
...
int _i = 0;
RemoteObject _bd = RemoteObject.declareNull("b4a.example.ef.gifviewer._bitmapanddelay");
RemoteObject _firstframe = RemoteObject.declareNull("b4a.example.ef.gifviewer._bitmapanddelay");
...
if (RemoteObject.solveBoolean("=",gifviewer._main._gifscache /*RemoteObject*/ .runMethod(true,"IsInitialized"),gifviewer.__c.getField(true,"False"))) { 
gifviewer._main._gifscache /*RemoteObject*/ .runVoidMethod ("Initialize");};
 BA.debugLineNum = 31;BA.debugLine="If Main.GifsCache.ContainsKey(path) Then";
Debug.ShouldStop(1073741824);
if (gifviewer._main._gifscache /*RemoteObject*/ .runMethod(true,"ContainsKey",(Object)((_path))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 32;BA.debugLine="bitmaps = Main.GifsCache.Get(path)";
Debug.ShouldStop(-2147483648);
__ref.getField(false,"_bitmaps" /*RemoteObject*/ ).setObject (gifviewer._main._gifscache /*RemoteObject*/ .runMethod(false,"Get",(Object)((_path))));
 }else {
...
Debug.ShouldStop(8);
__ref.getField(false,"_bitmaps" /*RemoteObject*/ ).runVoidMethod ("Initialize");
...
Debug.ShouldStop(32);
_bd = RemoteObject.createNew ("b4a.example.ef.gifviewer._bitmapanddelay");Debug.locals.put("bd", _bd);
...
_bd.getField(false,"bmp" /*RemoteObject*/ ).setObject (_gd.runMethod(false,"Frame",(Object)(BA.numberCast(int.class, _i))));
 BA.debugLineNum = 41;BA.debugLine="bd.Delay = gd.Delay(i)";
Debug.ShouldStop(256);
_bd.setField ("Delay" /*RemoteObject*/ ,_gd.runMethod(true,"Delay",(Object)(BA.numberCast(int.class, _i))));
 BA.debugLineNum = 42;BA.debugLine="bitmaps.Add(bd)";
Debug.ShouldStop(512);
__ref.getField(false,"_bitmaps" /*RemoteObject*/ ).runVoidMethod ("Add",(Object)((_bd)));
 }
}Debug.locals.put("i", _i);
;
 BA.debugLineNum = 44;BA.debugLine="Main.GifsCache.Put(path, bitmaps)";
Debug.ShouldStop(2048);
gifviewer._main._gifscache /*RemoteObject*/ .runVoidMethod ("Put",(Object)((_path)),(Object)((__ref.getField(false,"_bitmaps" /*RemoteObject*/ ).getObject())));
 };
 BA.debugLineNum = 47;BA.debugLine="Dim FirstFrame As BitmapAndDelay = bitmaps.Get(0)";
Debug.ShouldStop(16384);
_firstframe = (__ref.getField(false,"_bitmaps" /*RemoteObject*/ ).runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0))));Debug.locals.put("FirstFrame", _firstframe);Debug.locals.put("FirstFrame", _firstframe);
...
_firstbmp = _firstframe.getField(false,"bmp" /*RemoteObject*/ );Debug.locals.put("FirstBmp", _firstbmp);Debug.locals.put("FirstBmp", _firstbmp);
 BA.debugLineNum = 49;BA.debugLine="If FirstBmp.Width < mBase.Width Or FirstBmp.Heigh";
Debug.ShouldStop(65536);
if (RemoteObject.solveBoolean("<",_firstbmp.runMethod(true,"getWidth"),BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"))) || RemoteObject.solveBoolean("<",_firstbmp.runMethod(true,"getHeight"),BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight")))) { 
 BA.debugLineNum = 50;BA.debugLine="BDGravity = Gravity.CENTER";
Debug.ShouldStop(131072);
__ref.setField ("_bdgravity" /*RemoteObject*/ ,gifviewer.__c.getField(false,"Gravity").getField(true,"CENTER"));
 }else {
 BA.debugLineNum = 52;BA.debugLine="BDGravity = Gravity.FILL";
Debug.ShouldStop(524288);
__ref.setField ("_bdgravity" /*RemoteObject*/ ,gifviewer.__c.getField(false,"Gravity").getField(true,"FILL"));
 };
...
try {
		Debug.PushSubsStack("ShowImpl (gifviewer) ","gifviewer",12,__ref.getField(false, "ba"),__ref,72);
...
public ResumableSub_ShowImpl(b4a.example.ef.gifviewer parent,RemoteObject __ref,RemoteObject _myworkindex) {
this.parent = parent;
this.__ref = __ref;
...
//do while
this.state = 4;
while (RemoteObject.solveBoolean("=",_myworkindex,BA.numberCast(double.class, __ref.getField(true,"_workindex" /*RemoteObject*/ )))) {
this.state = 3;
if (true) break;
}
if (true) break;
...
_frameindex = RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_frameindex,RemoteObject.createImmutable(1)}, "+",1, 1)),__ref.getField(false,"_bitmaps" /*RemoteObject*/ ).runMethod(true,"getSize")}, "%",0, 1);Debug.locals.put("FrameIndex", _frameindex);
...
_bd = (__ref.getField(false,"_bitmaps" /*RemoteObject*/ ).runMethod(false,"Get",(Object)(_frameindex)));Debug.locals.put("bd", _bd);Debug.locals.put("bd", _bd);
 BA.debugLineNum = 78;BA.debugLine="bdrawable.Initialize(bd.bmp)";
Debug.ShouldStop(8192);
_bdrawable.runVoidMethod ("Initialize",(Object)((_bd.getField(false,"bmp" /*RemoteObject*/ ).getObject())));
 BA.debugLineNum = 79;BA.debugLine="bdrawable.Gravity = BDGravity";
Debug.ShouldStop(16384);
_bdrawable.runMethod(true,"setGravity",__ref.getField(true,"_bdgravity" /*RemoteObject*/ ));
 BA.debugLineNum = 80;BA.debugLine="mBase.Background = bdrawable";
Debug.ShouldStop(32768);
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(false,"setBackground",(_bdrawable.getObject()));
 BA.debugLineNum = 81;BA.debugLine="Sleep(bd.Delay)";
Debug.ShouldStop(65536);
parent.__c.runVoidMethod ("Sleep",__ref.getField(false, "ba"),anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "gifviewer", "showimpl"),_bd.getField(true,"Delay" /*RemoteObject*/ ));
this.state = 5;
return;
case 5:
//C
...
try {
		Debug.PushSubsStack("Start (gifviewer) ","gifviewer",12,__ref.getField(false, "ba"),__ref,57);
...
Debug.ShouldStop(33554432);
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"setVisible",gifviewer.__c.getField(true,"True"));
 BA.debugLineNum = 59;BA.debugLine="WorkIndex = WorkIndex + 1";
Debug.ShouldStop(67108864);
__ref.setField ("_workindex" /*RemoteObject*/ ,RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_workindex" /*RemoteObject*/ ),RemoteObject.createImmutable(1)}, "+",1, 1));
 BA.debugLineNum = 60;BA.debugLine="ShowImpl(WorkIndex)";
Debug.ShouldStop(134217728);
__ref.runClassMethod (b4a.example.ef.gifviewer.class, "_showimpl" /*void*/ ,(Object)(__ref.getField(true,"_workindex" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("Stop (gifviewer) ","gifviewer",12,__ref.getField(false, "ba"),__ref,63);
