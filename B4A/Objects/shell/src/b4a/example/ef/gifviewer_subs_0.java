...
try {
		Debug.PushSubsStack("CallFromResume (gifviewer) ","gifviewer",15,__ref.getField(false, "ba"),__ref,68);
...
try {
		Debug.PushSubsStack("DesignerCreateView (gifviewer) ","gifviewer",15,__ref.getField(false, "ba"),__ref,19);
...
try {
		Debug.PushSubsStack("GetBase (gifviewer) ","gifviewer",15,__ref.getField(false, "ba"),__ref,85);
...
try {
		Debug.PushSubsStack("Initialize (gifviewer) ","gifviewer",15,__ref.getField(false, "ba"),__ref,14);
...
try {
		Debug.PushSubsStack("SetGif (gifviewer) ","gifviewer",15,__ref.getField(false, "ba"),__ref,24);
...
try {
		Debug.PushSubsStack("ShowImpl (gifviewer) ","gifviewer",15,__ref.getField(false, "ba"),__ref,72);
...
try {
		Debug.PushSubsStack("Start (gifviewer) ","gifviewer",15,__ref.getField(false, "ba"),__ref,57);
...
try {
		Debug.PushSubsStack("Stop (gifviewer) ","gifviewer",15,__ref.getField(false, "ba"),__ref,63);
