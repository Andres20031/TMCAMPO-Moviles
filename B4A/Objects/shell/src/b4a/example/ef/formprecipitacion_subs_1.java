...
public class formprecipitacion_subs_1 {


public static RemoteObject  _as_datepicker1_selecteddatechanged(RemoteObject __ref,RemoteObject _date) throws Exception{
try {
		Debug.PushSubsStack("AS_DatePicker1_SelectedDateChanged (formprecipitacion) ","formprecipitacion",11,__ref.getField(false, "ba"),__ref,151);
...
formprecipitacion.__c.runVoidMethod ("LogImpl","817629204",__ref.getField(true,"_fecha" /*RemoteObject*/ ),0);
...
try {
		Debug.PushSubsStack("B4XPage_Appear (formprecipitacion) ","formprecipitacion",11,__ref.getField(false, "ba"),__ref,45);
...
Debug.ShouldStop(16777216);
parent.__c.runVoidMethod ("LogImpl","817170476",RemoteObject.concat(RemoteObject.createImmutable("Error en la consulta de Maquina: "),_j2.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
try {
		Debug.PushSubsStack("B4XPage_Created (formprecipitacion) ","formprecipitacion",11,__ref.getField(false, "ba"),__ref,36);
...
try {
		Debug.PushSubsStack("Button1_Click (formprecipitacion) ","formprecipitacion",11,__ref.getField(false, "ba"),__ref,187);
...
Debug.ShouldStop(1024);
parent.__c.runVoidMethod ("LogImpl","817760272",RemoteObject.concat(RemoteObject.createImmutable("Error al ejecutar la consulta: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(8192);
parent.__c.runVoidMethod ("LogImpl","817760275",RemoteObject.concat(RemoteObject.createImmutable("Error al agregar datos: "),parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba")).runMethod(true,"getMessage")),0);
 if (true) break;
if (true) break;
...
try {
		Debug.PushSubsStack("CreateCommand (formprecipitacion) ","formprecipitacion",11,__ref.getField(false, "ba"),__ref,108);
...
try {
		Debug.PushSubsStack("CreateItem (formprecipitacion) ","formprecipitacion",11,__ref.getField(false, "ba"),__ref,97);
...
try {
		Debug.PushSubsStack("EditTextHoraFin_TextChanged (formprecipitacion) ","formprecipitacion",11,__ref.getField(false, "ba"),__ref,174);
...
Debug.ShouldStop(16384);
formprecipitacion.__c.runVoidMethod ("LogImpl","817694721",RemoteObject.concat(RemoteObject.createImmutable("Texto anterior: "),_old),0);
 BA.debugLineNum = 176;BA.debugLine="Log(\"Texto nuevo: \" & New)";
Debug.ShouldStop(32768);
formprecipitacion.__c.runVoidMethod ("LogImpl","817694722",RemoteObject.concat(RemoteObject.createImmutable("Texto nuevo: "),_new),0);
...
Debug.ShouldStop(4194304);
formprecipitacion.__c.runVoidMethod ("LogImpl","817694729",RemoteObject.concat(RemoteObject.createImmutable("El texto es mayor de 5 caracteres: "),__ref.getField(true,"_textocapturado" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("Initialize (formprecipitacion) ","formprecipitacion",11,__ref.getField(false, "ba"),__ref,31);
...
try {
		Debug.PushSubsStack("Label13Time_Click (formprecipitacion) ","formprecipitacion",11,__ref.getField(false, "ba"),__ref,125);
...
try {
		Debug.PushSubsStack("Label1Back_Click (formprecipitacion) ","formprecipitacion",11,__ref.getField(false, "ba"),__ref,117);
...
try {
		Debug.PushSubsStack("Label2Save_Click (formprecipitacion) ","formprecipitacion",11,__ref.getField(false, "ba"),__ref,121);
...
try {
		Debug.PushSubsStack("SD_xComboBoxPluviometro_ItemClick (formprecipitacion) ","formprecipitacion",11,__ref.getField(false, "ba"),__ref,129);
...
Debug.ShouldStop(2);
formprecipitacion.__c.runVoidMethod ("LogImpl","817563649",RemoteObject.concat(RemoteObject.createImmutable("VALOR COMBOBOX: "),_value),0);
...
Debug.ShouldStop(4096);
formprecipitacion.__c.runVoidMethod ("LogImpl","817563660",RemoteObject.concat(RemoteObject.createImmutable("Código: "),__ref.getField(true,"_selectedcdgo_plvmtro" /*RemoteObject*/ )),0);
 BA.debugLineNum = 142;BA.debugLine="Log(\"Nombre: \" & selectedNombre_Plvmtro)";
Debug.ShouldStop(8192);
formprecipitacion.__c.runVoidMethod ("LogImpl","817563661",RemoteObject.concat(RemoteObject.createImmutable("Nombre: "),__ref.getField(true,"_selectednombre_plvmtro" /*RemoteObject*/ )),0);
 BA.debugLineNum = 143;BA.debugLine="Log(\"NIT: \" & selectedNit_Plvmtro)";
Debug.ShouldStop(16384);
formprecipitacion.__c.runVoidMethod ("LogImpl","817563662",RemoteObject.concat(RemoteObject.createImmutable("NIT: "),__ref.getField(true,"_selectednit_plvmtro" /*RemoteObject*/ )),0);
 BA.debugLineNum = 144;BA.debugLine="Log(\"Hacienda: \" & selectedHda_Pvlmtro)";
Debug.ShouldStop(32768);
formprecipitacion.__c.runVoidMethod ("LogImpl","817563663",RemoteObject.concat(RemoteObject.createImmutable("Hacienda: "),__ref.getField(true,"_selectedhda_pvlmtro" /*RemoteObject*/ )),0);
 }else {
 BA.debugLineNum = 146;BA.debugLine="Log(\"Error: No se encontraron detalles para el c";
Debug.ShouldStop(131072);
formprecipitacion.__c.runVoidMethod ("LogImpl","817563665",RemoteObject.createImmutable("Error: No se encontraron detalles para el código seleccionado."),0);
 };
...
try {
		Debug.PushSubsStack("SwiftButtonPluvimetro_Click (formprecipitacion) ","formprecipitacion",11,__ref.getField(false, "ba"),__ref,210);
...
;
 BA.debugLineNum = 212;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
Debug.ShouldStop(524288);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 213;BA.debugLine="SwiftButtonPluvimetro.xLBL.Text = SearchTemplate";
Debug.ShouldStop(1048576);
__ref.getField(false,"_swiftbuttonpluvimetro" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(__ref.getField(false,"_searchtemplatepluvimetro" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));
 BA.debugLineNum = 214;BA.debugLine="Dim Partes() As String = Regex.Split(\":\", Search";
Debug.ShouldStop(2097152);
