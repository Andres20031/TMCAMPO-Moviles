...
Debug.ShouldStop(64);
table.__c.runVoidMethod ("LogImpl","019529730",RemoteObject.concat(RemoteObject.createImmutable("Wrong number of values ="),_values.getField(true,"length"),RemoteObject.createImmutable(" col="),__ref.getField(true,"_mnumberofcolumns" /*RemoteObject*/ )),0);
...
table.__c.runVoidMethod ("LogImpl","019595268",RemoteObject.concat(RemoteObject.createImmutable("Wrong number of values ="),_values.getField(true,"length"),RemoteObject.createImmutable(" col="),__ref.getField(true,"_mnumberofcolumns" /*RemoteObject*/ )),0);
...
Debug.ShouldStop(512);
parent.__c.runVoidMethod ("LogImpl","020578305",RemoteObject.createImmutable("You may get this warning:"),0);
 BA.debugLineNum = 1707;BA.debugLine="Log(\"Unexpected event (missing RaiseSynchronousEv";
Debug.ShouldStop(1024);
parent.__c.runVoidMethod ("LogImpl","020578306",RemoteObject.createImmutable("Unexpected event (missing RaiseSynchronousEvents): sv_scrollchanged"),0);
 BA.debugLineNum = 1708;BA.debugLine="Log(\"Ignore it, it is NOT harmful !\")";
Debug.ShouldStop(2048);
parent.__c.runVoidMethod ("LogImpl","020578307",RemoteObject.createImmutable("Ignore it, it is NOT harmful !"),0);
...
Debug.ShouldStop(8192);
table.__c.runVoidMethod ("LogImpl","027983875",RemoteObject.createImmutable("Table.ScaleTable must be called before filling the Table"),0);
...
Debug.ShouldStop(65536);
table.__c.runVoidMethod ("LogImpl","027459613",RemoteObject.createImmutable("SetHeaderTypeFaces: Invalid number of columns"),0);
...
Debug.ShouldStop(2);
table.__c.runVoidMethod ("LogImpl","030670881",RemoteObject.concat(RemoteObject.createImmutable("SortTable2, cColumnDataType("),_col,RemoteObject.createImmutable("): "),__ref.getField(false,"_ccolumndatatype" /*RemoteObject*/ ).getArrayElement(true,_col)),0);
...
Debug.ShouldStop(32768);
table.__c.runVoidMethod ("LogImpl","030670927",RemoteObject.concat(RemoteObject.createImmutable("SortTable2, cColumnDataType("),_col,RemoteObject.createImmutable("): "),__ref.getField(false,"_ccolumndatatype" /*RemoteObject*/ ).getArrayElement(true,_col)),0);
