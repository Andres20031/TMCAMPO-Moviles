...
try {
		Debug.PushSubsStack("AnimateValueTo (b4xprogressbar) ","b4xprogressbar",6,__ref.getField(false, "ba"),__ref,50);
...
try {
		Debug.PushSubsStack("Base_Resize (b4xprogressbar) ","b4xprogressbar",6,__ref.getField(false, "ba"),__ref,37);
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4xprogressbar) ","b4xprogressbar",6,__ref.getField(false, "ba"),__ref,26);
...
try {
		Debug.PushSubsStack("DrawValue (b4xprogressbar) ","b4xprogressbar",6,__ref.getField(false, "ba"),__ref,76);
...
try {
		Debug.PushSubsStack("getProgress (b4xprogressbar) ","b4xprogressbar",6,__ref.getField(false, "ba"),__ref,42);
...
try {
		Debug.PushSubsStack("Initialize (b4xprogressbar) ","b4xprogressbar",6,__ref.getField(false, "ba"),__ref,20);
...
try {
		Debug.PushSubsStack("setProgress (b4xprogressbar) ","b4xprogressbar",6,__ref.getField(false, "ba"),__ref,46);
...
try {
		Debug.PushSubsStack("ValueFromTimeEaseInOut (b4xprogressbar) ","b4xprogressbar",6,__ref.getField(false, "ba"),__ref,66);
