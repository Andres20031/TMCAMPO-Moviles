...
try {
		Debug.PushSubsStack("AS_DatePicker1_SelectedDateChanged (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,354);
...
Debug.ShouldStop(2);
 BA.debugLineNum = 356;BA.debugLine="Dim formattedDate As String = DateTime.Date(Date)";
Debug.ShouldStop(8);
_formatteddate = formlabores.__c.getField(false,"DateTime").runMethod(true,"Date",(Object)(_date));Debug.locals.put("formattedDate", _formatteddate);Debug.locals.put("formattedDate", _formatteddate);
 BA.debugLineNum = 359;BA.debugLine="formattedDate = formattedDate.Replace(\"/\", \"-\")";
Debug.ShouldStop(64);
_formatteddate = _formatteddate.runMethod(true,"replace",(Object)(BA.ObjectToString("/")),(Object)(RemoteObject.createImmutable("-")));Debug.locals.put("formattedDate", _formatteddate);
 BA.debugLineNum = 362;BA.debugLine="Dim dateParts() As String = Regex.Split(\"-\", form";
...
_dateparts = formlabores.__c.getField(false,"Regex").runMethod(false,"Split",(Object)(BA.ObjectToString("-")),(Object)(_formatteddate));Debug.locals.put("dateParts", _dateparts);Debug.locals.put("dateParts", _dateparts);
 BA.debugLineNum = 365;BA.debugLine="If dateParts.Length = 3 Then";
Debug.ShouldStop(4096);
if (RemoteObject.solveBoolean("=",_dateparts.getField(true,"length"),BA.numberCast(double.class, 3))) { 
 BA.debugLineNum = 367;BA.debugLine="formattedDate = dateParts(2) & \"-\" & dateParts(1";
...
_formatteddate = RemoteObject.concat(_dateparts.getArrayElement(true,BA.numberCast(int.class, 2)),RemoteObject.createImmutable("-"),_dateparts.getArrayElement(true,BA.numberCast(int.class, 1)),RemoteObject.createImmutable("-"),_dateparts.getArrayElement(true,BA.numberCast(int.class, 0)));Debug.locals.put("formattedDate", _formatteddate);
 ...
 BA.debugLineNum = 371;BA.debugLine="formattedDate = formattedDate & \" 00:00:00\"";
...
_formatteddate = RemoteObject.concat(_formatteddate,RemoteObject.createImmutable(" 00:00:00"));Debug.locals.put("formattedDate", _formatteddate);
 BA.debugLineNum = 374;BA.debugLine="Label13Time.Text = formattedDate";
Debug.ShouldStop(2097152);
__ref.getField(false,"_label13time" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(_formatteddate));
 BA.debugLineNum = 377;BA.debugLine="Panel12.Visible = False";
Debug.ShouldStop(16777216);
__ref.getField(false,"_panel12" /*RemoteObject*/ ).runMethod(true,"setVisible",formlabores.__c.getField(true,"False"));
 BA.debugLineNum = 380;BA.debugLine="fechaInicio = formattedDate";
Debug.ShouldStop(134217728);
__ref.setField ("_fechainicio" /*RemoteObject*/ ,_formatteddate);
 BA.debugLineNum = 383;BA.debugLine="Log(\"Fecha inicio: \" & fechaInicio)";
Debug.ShouldStop(1073741824);
formlabores.__c.runVoidMethod ("LogImpl","861866013",RemoteObject.concat(RemoteObject.createImmutable("Fecha inicio: "),__ref.getField(true,"_fechainicio" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("AS_DatePicker2_SelectedDateChanged (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,387);
...
Debug.ShouldStop(4);
 BA.debugLineNum = 389;BA.debugLine="Dim formattedDate As String = DateTime.Date(Date)";
Debug.ShouldStop(16);
_formatteddate = formlabores.__c.getField(false,"DateTime").runMethod(true,"Date",(Object)(_date));Debug.locals.put("formattedDate", _formatteddate);Debug.locals.put("formattedDate", _formatteddate);
 BA.debugLineNum = 392;BA.debugLine="formattedDate = formattedDate.Replace(\"/\", \"-\")";
Debug.ShouldStop(128);
_formatteddate = _formatteddate.runMethod(true,"replace",(Object)(BA.ObjectToString("/")),(Object)(RemoteObject.createImmutable("-")));Debug.locals.put("formattedDate", _formatteddate);
 BA.debugLineNum = 395;BA.debugLine="Dim dateParts() As String = Regex.Split(\"-\", form";
Debug.ShouldStop(1024);
_dateparts = formlabores.__c.getField(false,"Regex").runMethod(false,"Split",(Object)(BA.ObjectToString("-")),(Object)(_formatteddate));Debug.locals.put("dateParts", _dateparts);Debug.locals.put("dateParts", _dateparts);
 BA.debugLineNum = 398;BA.debugLine="If dateParts.Length = 3 Then";
Debug.ShouldStop(8192);
if (RemoteObject.solveBoolean("=",_dateparts.getField(true,"length"),BA.numberCast(double.class, 3))) { 
 BA.debugLineNum = 400;BA.debugLine="formattedDate = dateParts(2) & \"-\" & dateParts(1";
Debug.ShouldStop(32768);
_formatteddate = RemoteObject.concat(_dateparts.getArrayElement(true,BA.numberCast(int.class, 2)),RemoteObject.createImmutable("-"),_dateparts.getArrayElement(true,BA.numberCast(int.class, 1)),RemoteObject.createImmutable("-"),_dateparts.getArrayElement(true,BA.numberCast(int.class, 0)));Debug.locals.put("formattedDate", _formatteddate);
 };
 BA.debugLineNum = 404;BA.debugLine="formattedDate = formattedDate & \" 00:00:00\"";
Debug.ShouldStop(524288);
_formatteddate = RemoteObject.concat(_formatteddate,RemoteObject.createImmutable(" 00:00:00"));Debug.locals.put("formattedDate", _formatteddate);
 BA.debugLineNum = 407;BA.debugLine="Label14Time.Text = formattedDate";
Debug.ShouldStop(4194304);
__ref.getField(false,"_label14time" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(_formatteddate));
 BA.debugLineNum = 410;BA.debugLine="Panel3.Visible = False";
Debug.ShouldStop(33554432);
__ref.getField(false,"_panel3" /*RemoteObject*/ ).runMethod(true,"setVisible",formlabores.__c.getField(true,"False"));
 BA.debugLineNum = 413;BA.debugLine="fechaFin = formattedDate";
Debug.ShouldStop(268435456);
__ref.setField ("_fechafin" /*RemoteObject*/ ,_formatteddate);
 BA.debugLineNum = 416;BA.debugLine="Log(\"Fecha fin: \" & fechaFin)";
Debug.ShouldStop(-2147483648);
formlabores.__c.runVoidMethod ("LogImpl","861931549",RemoteObject.concat(RemoteObject.createImmutable("Fecha fin: "),__ref.getField(true,"_fechafin" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("B4XPage_Appear (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,125);
...
Debug.ShouldStop(1073741824);
parent.__c.runVoidMethod ("LogImpl","861407266",RemoteObject.concat(RemoteObject.createImmutable("Error en la consulta de NITs: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(536870912);
parent.__c.runVoidMethod ("LogImpl","861407297",RemoteObject.concat(RemoteObject.createImmutable("Error en la consulta de Maquina: "),_j3.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(16777216);
parent.__c.runVoidMethod ("LogImpl","861407324",RemoteObject.concat(RemoteObject.createImmutable("Error en la consulta de Maquina: "),_j4.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(16777216);
parent.__c.runVoidMethod ("LogImpl","861407356",RemoteObject.concat(RemoteObject.createImmutable("Último Registro obtenido: "),_ultimoregistro),0);
 if (true) break;
if (true) break;
...
Debug.ShouldStop(268435456);
parent.__c.runVoidMethod ("LogImpl","861407360",RemoteObject.concat(RemoteObject.createImmutable("Error en la consulta select_maxIdLabor: "),_j5.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(2);
parent.__c.runVoidMethod ("LogImpl","861407365",BA.NumberToString(__ref.getField(true,"_consecutivo" /*RemoteObject*/ )),0);
...
Debug.ShouldStop(4096);
parent.__c.runVoidMethod ("LogImpl","861407376",RemoteObject.concat(RemoteObject.createImmutable("Último Registro Siembra  obtenido: "),_ultimoregistrosiembra),0);
 if (true) break;
if (true) break;
...
Debug.ShouldStop(65536);
parent.__c.runVoidMethod ("LogImpl","861407380",RemoteObject.concat(RemoteObject.createImmutable("Error en la consulta select_maxIdLabor: "),_j5.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(2097152);
parent.__c.runVoidMethod ("LogImpl","861407385",BA.NumberToString(__ref.getField(true,"_consecutivosiembra" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("B4XPage_Created (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,109);
...
try {
		Debug.PushSubsStack("B4XTable1_CellClicked (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,848);
...
Debug.ShouldStop(65536);
formlabores.__c.runVoidMethod ("LogImpl","864028673",RemoteObject.concat(RemoteObject.createImmutable("COLUM ID"),_columnid),0);
 BA.debugLineNum = 850;BA.debugLine="Log(\"ROW ID\"&RowId)";
Debug.ShouldStop(131072);
formlabores.__c.runVoidMethod ("LogImpl","864028674",RemoteObject.concat(RemoteObject.createImmutable("ROW ID"),_rowid),0);
...
Debug.ShouldStop(268435456);
formlabores.__c.runVoidMethod ("LogImpl","864028685",BA.NumberToString(__ref.getField(true,"_ideliminartabla" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("ButtonAddInsumo_Click (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,821);
...
try {
		Debug.PushSubsStack("ButtonDeleteInsumo_Click (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,835);
...
try {
		Debug.PushSubsStack("ButtonInsumo_Click (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,886);
...
Debug.ShouldStop(4194304);
parent.__c.runVoidMethod ("LogImpl","864225313",RemoteObject.concat(RemoteObject.createImmutable("Fila "),(RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(_i),RemoteObject.createImmutable(1)}, "+",1, 1)),RemoteObject.createImmutable(":")),0);
 BA.debugLineNum = 920;BA.debugLine="Log(\" - ID: \" & ID)";
Debug.ShouldStop(8388608);
parent.__c.runVoidMethod ("LogImpl","864225314",RemoteObject.concat(RemoteObject.createImmutable(" - ID: "),_id),0);
 BA.debugLineNum = 921;BA.debugLine="Log(\" - NOMBRE: \" & nombreInsu)";
Debug.ShouldStop(16777216);
parent.__c.runVoidMethod ("LogImpl","864225315",RemoteObject.concat(RemoteObject.createImmutable(" - NOMBRE: "),_nombreinsu),0);
 BA.debugLineNum = 922;BA.debugLine="Log(\" - CANTIDAD: \" & cantidadInsu)";
Debug.ShouldStop(33554432);
parent.__c.runVoidMethod ("LogImpl","864225316",RemoteObject.concat(RemoteObject.createImmutable(" - CANTIDAD: "),_cantidadinsu),0);
...
_cmd = __ref.runClassMethod (b4a.example.ef.formlabores.class, "_createcommand" /*RemoteObject*/ ,(Object)(BA.ObjectToString("insert_laborInsumo")),(Object)(RemoteObject.createNewArray("Object",new int[] {3},new Object[] {(__ref.getField(true,"_consecutivo" /*RemoteObject*/ )),(_id),(_cantidadinsu)})));Debug.locals.put("cmd", _cmd);Debug.locals.put("cmd", _cmd);
 BA.debugLineNum = 932;BA.debugLine="Dim j As HttpJob = Req.ExecuteCommand(cmd, Nul";
Debug.ShouldStop(8);
_j = _req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_executecommand" /*RemoteObject*/ ,(Object)(_cmd),(Object)(parent.__c.getField(false,"Null")));Debug.locals.put("j", _j);Debug.locals.put("j", _j);
 BA.debugLineNum = 933;BA.debugLine="Wait For(j) JobDone(j As HttpJob)";
Debug.ShouldStop(16);
...
_j = (RemoteObject) result.getArrayElement(false,RemoteObject.createImmutable(1));Debug.locals.put("j", _j);
;
 BA.debugLineNum = 935;BA.debugLine="consecutivo  = consecutivo + 1";
Debug.ShouldStop(64);
...
this.state = 24;
this.catchState = 0;
 BA.debugLineNum = 938;BA.debugLine="cantidadInsu = 0 ' Valor predeterminado si no";
Debug.ShouldStop(512);
...
//C
this.state = 27;
 BA.debugLineNum = 941;BA.debugLine="cantidadInsu = 0";
Debug.ShouldStop(4096);
_cantidadinsu = BA.numberCast(int.class, 0);Debug.locals.put("cantidadInsu", _cantidadinsu);
 if (true) break;
...
Debug.locals.put("i", _i);
;
 BA.debugLineNum = 946;BA.debugLine="Dim horaSistema As String = DateTime.Time(DateTim";
Debug.ShouldStop(131072);
parent._horasistema = parent.__c.getField(false,"DateTime").runMethod(true,"Time",(Object)(parent.__c.getField(false,"DateTime").runMethod(true,"getNow")));__ref.setField("_horasistema",parent._horasistema);
 BA.debugLineNum = 947;BA.debugLine="user = Main.pUser";
Debug.ShouldStop(262144);
__ref.setField ("_user" /*RemoteObject*/ ,parent._main._puser /*RemoteObject*/ );
 BA.debugLineNum = 948;BA.debugLine="DeviceName = GetDeviceName";
Debug.ShouldStop(524288);
__ref.setField ("_devicename" /*RemoteObject*/ ,__ref.runClassMethod (b4a.example.ef.formlabores.class, "_getdevicename" /*RemoteObject*/ ));
 BA.debugLineNum = 949;BA.debugLine="Dim fecha As Long = DateTime.Now ' Obtiene el tie";
Debug.ShouldStop(1048576);
_fecha = parent.__c.getField(false,"DateTime").runMethod(true,"getNow");Debug.locals.put("fecha", _fecha);Debug.locals.put("fecha", _fecha);
 BA.debugLineNum = 950;BA.debugLine="DateTime.DateFormat = \"yyyy-MM-dd HH:mm:ss\" ' Con";
Debug.ShouldStop(2097152);
parent.__c.getField(false,"DateTime").runMethod(true,"setDateFormat",BA.ObjectToString("yyyy-MM-dd HH:mm:ss"));
 BA.debugLineNum = 951;BA.debugLine="fechaActual = DateTime.Date(fecha) ' Almacena la";
Debug.ShouldStop(4194304);
__ref.setField ("_fechaactual" /*RemoteObject*/ ,parent.__c.getField(false,"DateTime").runMethod(true,"Date",(Object)(_fecha)));
 BA.debugLineNum = 953;BA.debugLine="fechafmrto = DateTime.Date(fecha)";
Debug.ShouldStop(16777216);
__ref.setField ("_fechafmrto" /*RemoteObject*/ ,parent.__c.getField(false,"DateTime").runMethod(true,"Date",(Object)(_fecha)));
 BA.debugLineNum = 955;BA.debugLine="Dim Req As DBRequestManager";
Debug.ShouldStop(67108864);
_req = RemoteObject.createNew ("b4a.example.ef.dbrequestmanager");Debug.locals.put("Req", _req);
 BA.debugLineNum = 956;BA.debugLine="Req.Initialize(Me, rdcLink & \"?DBName=\" & Main.pD";
Debug.ShouldStop(134217728);
_req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(__ref),(Object)(RemoteObject.concat(__ref.getField(true,"_rdclink" /*RemoteObject*/ ),RemoteObject.createImmutable("?DBName="),parent._main._pdbname /*RemoteObject*/ )));
 BA.debugLineNum = 959;BA.debugLine="Dim cmd As DBCommand = CreateCommand(\"insert_labo";
Debug.ShouldStop(1073741824);
_cmd = __ref.runClassMethod (b4a.example.ef.formlabores.class, "_createcommand" /*RemoteObject*/ ,(Object)(BA.ObjectToString("insert_labor")),(Object)(RemoteObject.createNewArray("Object",new int[] {18},new Object[] {(__ref.getField(true,"_nitempresacbx" /*RemoteObject*/ )),(__ref.getField(true,"_haciendacbx" /*RemoteObject*/ )),(__ref.getField(true,"_lotecbx" /*RemoteObject*/ )),(__ref.getField(true,"_fechafmrto" /*RemoteObject*/ )),RemoteObject.createImmutable(("CA")),(__ref.getField(true,"_tipolabor" /*RemoteObject*/ )),(__ref.getField(true,"_fechainicio" /*RemoteObject*/ )),(__ref.getField(true,"_fechafin" /*RemoteObject*/ )),(__ref.getField(true,"_elementogasto" /*RemoteObject*/ )),(__ref.getField(true,"_arealabor" /*RemoteObject*/ )),(__ref.getField(true,"_consecutivo" /*RemoteObject*/ )),parent.__c.getField(false,"Null"),(__ref.getField(true,"_arealote" /*RemoteObject*/ )),parent.__c.getField(false,"Null"),(__ref.getField(true,"_fechaactual" /*RemoteObject*/ )),(__ref.getField(true,"_horasistema" /*RemoteObject*/ )),(__ref.getField(true,"_user" /*RemoteObject*/ )),(__ref.getField(true,"_devicename" /*RemoteObject*/ ))})));Debug.locals.put("cmd", _cmd);Debug.locals.put("cmd", _cmd);
 BA.debugLineNum = 962;BA.debugLine="Dim j As HttpJob = Req.ExecuteCommand(cmd, Null)";
Debug.ShouldStop(2);
_j = _req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_executecommand" /*RemoteObject*/ ,(Object)(_cmd),(Object)(parent.__c.getField(false,"Null")));Debug.locals.put("j", _j);Debug.locals.put("j", _j);
 BA.debugLineNum = 963;BA.debugLine="Wait For(j) JobDone(j As HttpJob)";
Debug.ShouldStop(4);
parent.__c.runVoidMethod ("WaitFor","jobdone", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "formlabores", "buttoninsumo_click"), (_j));
this.state = 44;
return;
...
this.state = 32;
this.catchState = 39;
 BA.debugLineNum = 967;BA.debugLine="If j.Success Then";
Debug.ShouldStop(64);
if (true) break;
...
//C
this.state = 37;
 BA.debugLineNum = 969;BA.debugLine="MsgboxAsync(\"Se ha insertado correctamente.\", \"";
Debug.ShouldStop(256);
...
//C
this.state = 37;
 BA.debugLineNum = 972;BA.debugLine="Log(\"Error al ejecutar la consulta: \" & j.Error";
Debug.ShouldStop(2048);
parent.__c.runVoidMethod ("LogImpl","864225366",RemoteObject.concat(RemoteObject.createImmutable("Error al ejecutar la consulta: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
this.state = 40;
this.catchState = 0;
 BA.debugLineNum = 976;BA.debugLine="Log(\"Error al agregar datos: \" & LastException.M";
Debug.ShouldStop(32768);
parent.__c.runVoidMethod ("LogImpl","864225370",RemoteObject.concat(RemoteObject.createImmutable("Error al agregar datos: "),parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba")).runMethod(true,"getMessage")),0);
 if (true) break;
if (true) break;
...
try {
		Debug.PushSubsStack("ButtonRiego_Click (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,985);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 989;BA.debugLine="Dim Req As DBRequestManager";
Debug.ShouldStop(268435456);
_req = RemoteObject.createNew ("b4a.example.ef.dbrequestmanager");Debug.locals.put("Req", _req);
 BA.debugLineNum = 990;BA.debugLine="Req.Initialize(Me, rdcLink & \"?DBName=\" & Main.pD";
Debug.ShouldStop(536870912);
_req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(__ref),(Object)(RemoteObject.concat(__ref.getField(true,"_rdclink" /*RemoteObject*/ ),RemoteObject.createImmutable("?DBName="),parent._main._pdbname /*RemoteObject*/ )));
 BA.debugLineNum = 993;BA.debugLine="Dim cmd As DBCommand = CreateCommand(\"insert_labo";
Debug.ShouldStop(1);
_cmd = __ref.runClassMethod (b4a.example.ef.formlabores.class, "_createcommand" /*RemoteObject*/ ,(Object)(BA.ObjectToString("insert_laborRiego")),(Object)(RemoteObject.createNewArray("Object",new int[] {5},new Object[] {(__ref.getField(true,"_consecutivo" /*RemoteObject*/ )),(__ref.getField(true,"_tiporiego" /*RemoteObject*/ )),(__ref.getField(true,"_procedenciariego" /*RemoteObject*/ )),(__ref.getField(true,"_caudalriego" /*RemoteObject*/ )),(__ref.getField(true,"_cantidadriego" /*RemoteObject*/ ))})));Debug.locals.put("cmd", _cmd);Debug.locals.put("cmd", _cmd);
 BA.debugLineNum = 996;BA.debugLine="Dim j As HttpJob = Req.ExecuteCommand(cmd, Null)";
Debug.ShouldStop(8);
_j = _req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_executecommand" /*RemoteObject*/ ,(Object)(_cmd),(Object)(parent.__c.getField(false,"Null")));Debug.locals.put("j", _j);Debug.locals.put("j", _j);
 BA.debugLineNum = 997;BA.debugLine="Wait For(j) JobDone(j As HttpJob)";
Debug.ShouldStop(16);
...
_j = (RemoteObject) result.getArrayElement(false,RemoteObject.createImmutable(1));Debug.locals.put("j", _j);
;
 BA.debugLineNum = 1000;BA.debugLine="Try";
Debug.ShouldStop(128);
if (true) break;
...
this.state = 4;
this.catchState = 11;
 BA.debugLineNum = 1001;BA.debugLine="If j.Success Then";
Debug.ShouldStop(256);
if (true) break;
...
//C
this.state = 9;
 BA.debugLineNum = 1002;BA.debugLine="MsgboxAsync(\"Se ha insertado correctamente.\", \"";
Debug.ShouldStop(512);
parent.__c.runVoidMethod ("MsgboxAsync",(Object)(BA.ObjectToCharSequence("Se ha insertado correctamente.")),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Éxito"))),__ref.getField(false, "ba"));
 if (true) break;
...
//C
this.state = 9;
 BA.debugLineNum = 1004;BA.debugLine="Log(\"Error al ejecutar la consulta: \" & j.Error";
Debug.ShouldStop(2048);
parent.__c.runVoidMethod ("LogImpl","864290835",RemoteObject.concat(RemoteObject.createImmutable("Error al ejecutar la consulta: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
this.state = 12;
this.catchState = 0;
 BA.debugLineNum = 1007;BA.debugLine="Log(\"Error al agregar datos: \" & LastException.M";
Debug.ShouldStop(16384);
parent.__c.runVoidMethod ("LogImpl","864290838",RemoteObject.concat(RemoteObject.createImmutable("Error al agregar datos: "),parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba")).runMethod(true,"getMessage")),0);
 if (true) break;
if (true) break;
...
this.catchState = 0;
;
 BA.debugLineNum = 1011;BA.debugLine="Dim horaSistema As String = DateTime.Time(DateTim";
Debug.ShouldStop(262144);
parent._horasistema = parent.__c.getField(false,"DateTime").runMethod(true,"Time",(Object)(parent.__c.getField(false,"DateTime").runMethod(true,"getNow")));__ref.setField("_horasistema",parent._horasistema);
 BA.debugLineNum = 1012;BA.debugLine="user = Main.pUser";
Debug.ShouldStop(524288);
__ref.setField ("_user" /*RemoteObject*/ ,parent._main._puser /*RemoteObject*/ );
 BA.debugLineNum = 1013;BA.debugLine="DeviceName = GetDeviceName";
Debug.ShouldStop(1048576);
__ref.setField ("_devicename" /*RemoteObject*/ ,__ref.runClassMethod (b4a.example.ef.formlabores.class, "_getdevicename" /*RemoteObject*/ ));
 BA.debugLineNum = 1014;BA.debugLine="Dim fecha As Long = DateTime.Now ' Obtiene el tie";
Debug.ShouldStop(2097152);
_fecha = parent.__c.getField(false,"DateTime").runMethod(true,"getNow");Debug.locals.put("fecha", _fecha);Debug.locals.put("fecha", _fecha);
 BA.debugLineNum = 1015;BA.debugLine="DateTime.DateFormat = \"yyyy-MM-dd HH:mm:ss\" ' Con";
Debug.ShouldStop(4194304);
parent.__c.getField(false,"DateTime").runMethod(true,"setDateFormat",BA.ObjectToString("yyyy-MM-dd HH:mm:ss"));
 BA.debugLineNum = 1016;BA.debugLine="fechaActual = DateTime.Date(fecha) ' Almacena la";
Debug.ShouldStop(8388608);
__ref.setField ("_fechaactual" /*RemoteObject*/ ,parent.__c.getField(false,"DateTime").runMethod(true,"Date",(Object)(_fecha)));
 BA.debugLineNum = 1018;BA.debugLine="fechafmrto = DateTime.Date(fecha)";
Debug.ShouldStop(33554432);
__ref.setField ("_fechafmrto" /*RemoteObject*/ ,parent.__c.getField(false,"DateTime").runMethod(true,"Date",(Object)(_fecha)));
 BA.debugLineNum = 1020;BA.debugLine="Dim Req As DBRequestManager";
Debug.ShouldStop(134217728);
_req = RemoteObject.createNew ("b4a.example.ef.dbrequestmanager");Debug.locals.put("Req", _req);
 BA.debugLineNum = 1021;BA.debugLine="Req.Initialize(Me, rdcLink & \"?DBName=\" & Main.pD";
Debug.ShouldStop(268435456);
_req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(__ref),(Object)(RemoteObject.concat(__ref.getField(true,"_rdclink" /*RemoteObject*/ ),RemoteObject.createImmutable("?DBName="),parent._main._pdbname /*RemoteObject*/ )));
 BA.debugLineNum = 1024;BA.debugLine="Dim cmd As DBCommand = CreateCommand(\"insert_labo";
Debug.ShouldStop(-2147483648);
_cmd = __ref.runClassMethod (b4a.example.ef.formlabores.class, "_createcommand" /*RemoteObject*/ ,(Object)(BA.ObjectToString("insert_labor")),(Object)(RemoteObject.createNewArray("Object",new int[] {18},new Object[] {(__ref.getField(true,"_nitempresacbx" /*RemoteObject*/ )),(__ref.getField(true,"_haciendacbx" /*RemoteObject*/ )),(__ref.getField(true,"_lotecbx" /*RemoteObject*/ )),(__ref.getField(true,"_fechafmrto" /*RemoteObject*/ )),RemoteObject.createImmutable(("CA")),(__ref.getField(true,"_tipolabor" /*RemoteObject*/ )),(__ref.getField(true,"_fechainicio" /*RemoteObject*/ )),(__ref.getField(true,"_fechafin" /*RemoteObject*/ )),(__ref.getField(true,"_elementogasto" /*RemoteObject*/ )),(__ref.getField(true,"_arealabor" /*RemoteObject*/ )),(__ref.getField(true,"_consecutivo" /*RemoteObject*/ )),parent.__c.getField(false,"Null"),(__ref.getField(true,"_arealote" /*RemoteObject*/ )),parent.__c.getField(false,"Null"),(__ref.getField(true,"_fechaactual" /*RemoteObject*/ )),(__ref.getField(true,"_horasistema" /*RemoteObject*/ )),(__ref.getField(true,"_user" /*RemoteObject*/ )),(__ref.getField(true,"_devicename" /*RemoteObject*/ ))})));Debug.locals.put("cmd", _cmd);Debug.locals.put("cmd", _cmd);
 BA.debugLineNum = 1027;BA.debugLine="Dim j As HttpJob = Req.ExecuteCommand(cmd, Null)";
Debug.ShouldStop(4);
_j = _req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_executecommand" /*RemoteObject*/ ,(Object)(_cmd),(Object)(parent.__c.getField(false,"Null")));Debug.locals.put("j", _j);Debug.locals.put("j", _j);
 BA.debugLineNum = 1028;BA.debugLine="Wait For(j) JobDone(j As HttpJob)";
Debug.ShouldStop(8);
parent.__c.runVoidMethod ("WaitFor","jobdone", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "formlabores", "buttonriego_click"), (_j));
this.state = 26;
return;
...
//C
this.state = 21;
 BA.debugLineNum = 1034;BA.debugLine="MsgboxAsync(\"Se ha insertado correctamente.\", \"";
Debug.ShouldStop(512);
parent.__c.runVoidMethod ("MsgboxAsync",(Object)(BA.ObjectToCharSequence("Se ha insertado correctamente.")),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Éxito"))),__ref.getField(false, "ba"));
 if (true) break;
...
//C
this.state = 21;
 BA.debugLineNum = 1037;BA.debugLine="Log(\"Error al ejecutar la consulta: \" & j.Error";
Debug.ShouldStop(4096);
parent.__c.runVoidMethod ("LogImpl","864290868",RemoteObject.concat(RemoteObject.createImmutable("Error al ejecutar la consulta: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
this.state = 24;
this.catchState = 0;
 BA.debugLineNum = 1041;BA.debugLine="Log(\"Error al agregar datos: \" & LastException.M";
Debug.ShouldStop(65536);
parent.__c.runVoidMethod ("LogImpl","864290872",RemoteObject.concat(RemoteObject.createImmutable("Error al agregar datos: "),parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba")).runMethod(true,"getMessage")),0);
 if (true) break;
if (true) break;
...
try {
		Debug.PushSubsStack("ButtonSimbra_Click (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,1046);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 1048;BA.debugLine="Dim Req As DBRequestManager";
Debug.ShouldStop(8388608);
_req = RemoteObject.createNew ("b4a.example.ef.dbrequestmanager");Debug.locals.put("Req", _req);
 BA.debugLineNum = 1049;BA.debugLine="Req.Initialize(Me, rdcLink & \"?DBName=\" & Main.pD";
Debug.ShouldStop(16777216);
_req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(__ref),(Object)(RemoteObject.concat(__ref.getField(true,"_rdclink" /*RemoteObject*/ ),RemoteObject.createImmutable("?DBName="),parent._main._pdbname /*RemoteObject*/ )));
 BA.debugLineNum = 1051;BA.debugLine="Dim cmdUltimoRegistro As DBCommand = CreateComman";
Debug.ShouldStop(67108864);
_cmdultimoregistro = __ref.runClassMethod (b4a.example.ef.formlabores.class, "_createcommand" /*RemoteObject*/ ,(Object)(BA.ObjectToString("select_maxIdSiembra")),(Object)((parent.__c.getField(false,"Null"))));Debug.locals.put("cmdUltimoRegistro", _cmdultimoregistro);Debug.locals.put("cmdUltimoRegistro", _cmdultimoregistro);
 BA.debugLineNum = 1052;BA.debugLine="Wait For (Req.ExecuteQuery(cmdUltimoRegistro, 0,";
Debug.ShouldStop(134217728);
...
_j5 = (RemoteObject) result.getArrayElement(false,RemoteObject.createImmutable(1));Debug.locals.put("j5", _j5);
;
 BA.debugLineNum = 1054;BA.debugLine="If j5.Success Then";
Debug.ShouldStop(536870912);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 1055;BA.debugLine="Req.HandleJobAsync(j5, \"req_ultimoRegistro\")";
Debug.ShouldStop(1073741824);
_req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_handlejobasync" /*void*/ ,(Object)(_j5),(Object)(RemoteObject.createImmutable("req_ultimoRegistro")));
 BA.debugLineNum = 1056;BA.debugLine="Wait For (Req) req_ultimoRegistro_Result(resUlti";
Debug.ShouldStop(-2147483648);
...
_resultimoregistro = (RemoteObject) result.getArrayElement(false,RemoteObject.createImmutable(1));Debug.locals.put("resUltimoRegistro", _resultimoregistro);
;
 BA.debugLineNum = 1058;BA.debugLine="For Each rowRegistro() As Object In resUltimoReg";
Debug.ShouldStop(2);
if (true) break;
...
//C
this.state = 38;
 BA.debugLineNum = 1059;BA.debugLine="Dim ultimoRegistroSiembra As Int = rowRegistro(";
Debug.ShouldStop(4);
_ultimoregistrosiembra = BA.numberCast(int.class, _rowregistro.getArrayElement(false,BA.numberCast(int.class, 0)));Debug.locals.put("ultimoRegistroSiembra", _ultimoregistrosiembra);Debug.locals.put("ultimoRegistroSiembra", _ultimoregistrosiembra);
 BA.debugLineNum = 1060;BA.debugLine="Log(\"Último Registro Siembra  obtenido: \" & ult";
Debug.ShouldStop(8);
parent.__c.runVoidMethod ("LogImpl","864356366",RemoteObject.concat(RemoteObject.createImmutable("Último Registro Siembra  obtenido: "),_ultimoregistrosiembra),0);
 if (true) break;
if (true) break;
...
//C
this.state = 10;
 BA.debugLineNum = 1064;BA.debugLine="Log(\"Error en la consulta select_maxIdLabor: \" &";
Debug.ShouldStop(128);
parent.__c.runVoidMethod ("LogImpl","864356370",RemoteObject.concat(RemoteObject.createImmutable("Error en la consulta select_maxIdLabor: "),_j5.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
this.state = 11;
;
 BA.debugLineNum = 1067;BA.debugLine="consecutivoSiembra = ultimoRegistroSiembra + 1";
Debug.ShouldStop(1024);
__ref.setField ("_consecutivosiembra" /*RemoteObject*/ ,RemoteObject.solve(new RemoteObject[] {_ultimoregistrosiembra,RemoteObject.createImmutable(1)}, "+",1, 1));
 BA.debugLineNum = 1069;BA.debugLine="Log(consecutivoSiembra)";
Debug.ShouldStop(4096);
parent.__c.runVoidMethod ("LogImpl","864356375",BA.NumberToString(__ref.getField(true,"_consecutivosiembra" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1074;BA.debugLine="Dim cmd As DBCommand = CreateCommand(\"insert_labo";
Debug.ShouldStop(131072);
_cmd = __ref.runClassMethod (b4a.example.ef.formlabores.class, "_createcommand" /*RemoteObject*/ ,(Object)(BA.ObjectToString("insert_laborSiembra")),(Object)(RemoteObject.createNewArray("Object",new int[] {9},new Object[] {(__ref.getField(true,"_consecutivosiembra" /*RemoteObject*/ )),(__ref.getField(true,"_codigosiembra" /*RemoteObject*/ )),(__ref.getField(true,"_distanciasiembra" /*RemoteObject*/ )),(__ref.getField(true,"_toneladasemillasiembra" /*RemoteObject*/ )),(__ref.getField(true,"_numeropaquetessiembra" /*RemoteObject*/ )),(__ref.getField(true,"_procedenciasiembra" /*RemoteObject*/ )),(__ref.getField(true,"_tipolabranzasiembra" /*RemoteObject*/ )),(__ref.getField(true,"_bandereosiembra" /*RemoteObject*/ )),(__ref.getField(true,"_numeromacollosiembra" /*RemoteObject*/ ))})));Debug.locals.put("cmd", _cmd);Debug.locals.put("cmd", _cmd);
 BA.debugLineNum = 1077;BA.debugLine="Dim j As HttpJob = Req.ExecuteCommand(cmd, Null)";
Debug.ShouldStop(1048576);
_j = _req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_executecommand" /*RemoteObject*/ ,(Object)(_cmd),(Object)(parent.__c.getField(false,"Null")));Debug.locals.put("j", _j);Debug.locals.put("j", _j);
 BA.debugLineNum = 1078;BA.debugLine="Wait For(j) JobDone(j As HttpJob)";
Debug.ShouldStop(2097152);
...
this.state = 14;
this.catchState = 21;
 BA.debugLineNum = 1082;BA.debugLine="If j.Success Then";
Debug.ShouldStop(33554432);
if (true) break;
...
//C
this.state = 19;
 BA.debugLineNum = 1086;BA.debugLine="Log(\"Error al agregar datos: \" & LastException)";
Debug.ShouldStop(536870912);
parent.__c.runVoidMethod ("LogImpl","864356392",RemoteObject.concat(RemoteObject.createImmutable("Error al agregar datos: "),parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 BA.debugLineNum = 1087;BA.debugLine="Log(\"Error al ejecutar la consulta: \" & j.Error";
Debug.ShouldStop(1073741824);
parent.__c.runVoidMethod ("LogImpl","864356393",RemoteObject.concat(RemoteObject.createImmutable("Error al ejecutar la consulta: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1088;BA.debugLine="Log(\"Valores enviados: consecutivo=\" & consecut";
Debug.ShouldStop(-2147483648);
parent.__c.runVoidMethod ("LogImpl","864356394",RemoteObject.concat(RemoteObject.createImmutable("Valores enviados: consecutivo="),__ref.getField(true,"_consecutivo" /*RemoteObject*/ ),RemoteObject.createImmutable(", codigoSiembra="),__ref.getField(true,"_codigosiembra" /*RemoteObject*/ ),RemoteObject.createImmutable(", distanciaSiembra="),__ref.getField(true,"_distanciasiembra" /*RemoteObject*/ ),RemoteObject.createImmutable(", toneladaSemillaSiembra="),__ref.getField(true,"_toneladasemillasiembra" /*RemoteObject*/ ),RemoteObject.createImmutable(", numeroPaquetesSiembra="),__ref.getField(true,"_numeropaquetessiembra" /*RemoteObject*/ ),RemoteObject.createImmutable(", procedenciaSiembra="),__ref.getField(true,"_procedenciasiembra" /*RemoteObject*/ ),RemoteObject.createImmutable(", tipoLabranzaSiembra="),__ref.getField(true,"_tipolabranzasiembra" /*RemoteObject*/ ),RemoteObject.createImmutable(", bandereoSiembra="),__ref.getField(true,"_bandereosiembra" /*RemoteObject*/ ),RemoteObject.createImmutable(", numeroMacolloSiembra="),__ref.getField(true,"_numeromacollosiembra" /*RemoteObject*/ )),0);
 if (true) break;
...
this.state = 22;
this.catchState = 0;
 BA.debugLineNum = 1096;BA.debugLine="Log(\"Excepción capturada: \" & LastException)";
Debug.ShouldStop(128);
parent.__c.runVoidMethod ("LogImpl","864356402",RemoteObject.concat(RemoteObject.createImmutable("Excepción capturada: "),parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 if (true) break;
if (true) break;
...
this.catchState = 0;
;
 BA.debugLineNum = 1101;BA.debugLine="Dim horaSistema As String = DateTime.Time(DateTim";
Debug.ShouldStop(4096);
parent._horasistema = parent.__c.getField(false,"DateTime").runMethod(true,"Time",(Object)(parent.__c.getField(false,"DateTime").runMethod(true,"getNow")));__ref.setField("_horasistema",parent._horasistema);
 BA.debugLineNum = 1102;BA.debugLine="user = Main.pUser";
Debug.ShouldStop(8192);
__ref.setField ("_user" /*RemoteObject*/ ,parent._main._puser /*RemoteObject*/ );
 BA.debugLineNum = 1103;BA.debugLine="DeviceName = GetDeviceName";
Debug.ShouldStop(16384);
__ref.setField ("_devicename" /*RemoteObject*/ ,__ref.runClassMethod (b4a.example.ef.formlabores.class, "_getdevicename" /*RemoteObject*/ ));
 BA.debugLineNum = 1104;BA.debugLine="Dim fecha As Long = DateTime.Now ' Obtiene el tie";
Debug.ShouldStop(32768);
_fecha = parent.__c.getField(false,"DateTime").runMethod(true,"getNow");Debug.locals.put("fecha", _fecha);Debug.locals.put("fecha", _fecha);
 BA.debugLineNum = 1105;BA.debugLine="DateTime.DateFormat = \"yyyy-MM-dd HH:mm:ss\" ' Con";
Debug.ShouldStop(65536);
parent.__c.getField(false,"DateTime").runMethod(true,"setDateFormat",BA.ObjectToString("yyyy-MM-dd HH:mm:ss"));
 BA.debugLineNum = 1106;BA.debugLine="fechaActual = DateTime.Date(fecha) ' Almacena la";
Debug.ShouldStop(131072);
__ref.setField ("_fechaactual" /*RemoteObject*/ ,parent.__c.getField(false,"DateTime").runMethod(true,"Date",(Object)(_fecha)));
 BA.debugLineNum = 1108;BA.debugLine="fechafmrto = DateTime.Date(fecha)";
Debug.ShouldStop(524288);
__ref.setField ("_fechafmrto" /*RemoteObject*/ ,parent.__c.getField(false,"DateTime").runMethod(true,"Date",(Object)(_fecha)));
 BA.debugLineNum = 1110;BA.debugLine="Dim Req As DBRequestManager";
Debug.ShouldStop(2097152);
_req = RemoteObject.createNew ("b4a.example.ef.dbrequestmanager");Debug.locals.put("Req", _req);
 BA.debugLineNum = 1111;BA.debugLine="Req.Initialize(Me, rdcLink & \"?DBName=\" & Main.pD";
Debug.ShouldStop(4194304);
_req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(__ref),(Object)(RemoteObject.concat(__ref.getField(true,"_rdclink" /*RemoteObject*/ ),RemoteObject.createImmutable("?DBName="),parent._main._pdbname /*RemoteObject*/ )));
 BA.debugLineNum = 1114;BA.debugLine="Dim cmd As DBCommand = CreateCommand(\"insert_labo";
Debug.ShouldStop(33554432);
_cmd = __ref.runClassMethod (b4a.example.ef.formlabores.class, "_createcommand" /*RemoteObject*/ ,(Object)(BA.ObjectToString("insert_labor")),(Object)(RemoteObject.createNewArray("Object",new int[] {18},new Object[] {(__ref.getField(true,"_nitempresacbx" /*RemoteObject*/ )),(__ref.getField(true,"_haciendacbx" /*RemoteObject*/ )),(__ref.getField(true,"_lotecbx" /*RemoteObject*/ )),(__ref.getField(true,"_fechafmrto" /*RemoteObject*/ )),RemoteObject.createImmutable(("CA")),(__ref.getField(true,"_tipolabor" /*RemoteObject*/ )),(__ref.getField(true,"_fechainicio" /*RemoteObject*/ )),(__ref.getField(true,"_fechafin" /*RemoteObject*/ )),(__ref.getField(true,"_elementogasto" /*RemoteObject*/ )),(__ref.getField(true,"_arealabor" /*RemoteObject*/ )),(__ref.getField(true,"_consecutivo" /*RemoteObject*/ )),parent.__c.getField(false,"Null"),(__ref.getField(true,"_arealote" /*RemoteObject*/ )),parent.__c.getField(false,"Null"),(__ref.getField(true,"_fechaactual" /*RemoteObject*/ )),(__ref.getField(true,"_horasistema" /*RemoteObject*/ )),(__ref.getField(true,"_user" /*RemoteObject*/ )),(__ref.getField(true,"_devicename" /*RemoteObject*/ ))})));Debug.locals.put("cmd", _cmd);Debug.locals.put("cmd", _cmd);
 BA.debugLineNum = 1117;BA.debugLine="Dim j As HttpJob = Req.ExecuteCommand(cmd, Null)";
Debug.ShouldStop(268435456);
_j = _req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_executecommand" /*RemoteObject*/ ,(Object)(_cmd),(Object)(parent.__c.getField(false,"Null")));Debug.locals.put("j", _j);Debug.locals.put("j", _j);
...
this.state = 26;
this.catchState = 33;
 BA.debugLineNum = 1122;BA.debugLine="If j.Success Then";
Debug.ShouldStop(2);
if (true) break;
...
//C
this.state = 31;
 BA.debugLineNum = 1124;BA.debugLine="MsgboxAsync(\"Se ha insertado correctamente.\", \"";
Debug.ShouldStop(8);
parent.__c.runVoidMethod ("MsgboxAsync",(Object)(BA.ObjectToCharSequence("Se ha insertado correctamente.")),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Éxito"))),__ref.getField(false, "ba"));
 if (true) break;
...
//C
this.state = 31;
 BA.debugLineNum = 1127;BA.debugLine="Log(\"Error al ejecutar la consulta: \" & j.Error";
Debug.ShouldStop(64);
parent.__c.runVoidMethod ("LogImpl","864356433",RemoteObject.concat(RemoteObject.createImmutable("Error al ejecutar la consulta: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
this.state = 34;
this.catchState = 0;
 BA.debugLineNum = 1131;BA.debugLine="Log(\"Error al agregar datos: \" & LastException.M";
Debug.ShouldStop(1024);
parent.__c.runVoidMethod ("LogImpl","864356437",RemoteObject.concat(RemoteObject.createImmutable("Error al agregar datos: "),parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba")).runMethod(true,"getMessage")),0);
 if (true) break;
if (true) break;
...
try {
		Debug.PushSubsStack("CreateCommand (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,421);
...
try {
		Debug.PushSubsStack("CreateItem (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,291);
...
try {
		Debug.PushSubsStack("CreateItemInsumo (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,331);
...
try {
		Debug.PushSubsStack("CreateItemRiego (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,305);
...
try {
		Debug.PushSubsStack("CreateItemSiembra (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,318);
...
try {
		Debug.PushSubsStack("EditTextAreaLabor_TextChanged (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,533);
...
Debug.ShouldStop(16777216);
formlabores.__c.runVoidMethod ("LogImpl","862390276",RemoteObject.concat(RemoteObject.createImmutable("Area Labor "),__ref.getField(true,"_arealabor" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("EditTextAreaLote_TextChanged (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,541);
...
Debug.ShouldStop(1);
formlabores.__c.runVoidMethod ("LogImpl","862455812",RemoteObject.concat(RemoteObject.createImmutable("Area lote "),__ref.getField(true,"_arealote" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("EditTextBandereo_TextChanged (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,661);
...
Debug.ShouldStop(16777216);
formlabores.__c.runVoidMethod ("LogImpl","863176708",RemoteObject.concat(RemoteObject.createImmutable("bandereo "),__ref.getField(true,"_bandereosiembra" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("EditTextCantidadAgua_TextChanged (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,602);
...
Debug.ShouldStop(268435456);
formlabores.__c.runVoidMethod ("LogImpl","862717955",RemoteObject.concat(RemoteObject.createImmutable("cantidad"),__ref.getField(true,"_cantidadriego" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("EditTextCantidadInsumo_TextChanged (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,816);
...
try {
		Debug.PushSubsStack("EditTextCaudalAplicado_TextChanged (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,596);
...
Debug.ShouldStop(4194304);
formlabores.__c.runVoidMethod ("LogImpl","862652419",RemoteObject.concat(RemoteObject.createImmutable("caudal"),__ref.getField(true,"_caudalriego" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("EditTextDistanciaSiembra_TextChanged (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,655);
...
Debug.ShouldStop(131072);
formlabores.__c.runVoidMethod ("LogImpl","863111171",RemoteObject.concat(RemoteObject.createImmutable("Distancia de siembra "),__ref.getField(true,"_distanciasiembra" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("EditTextNumeroMacollos_TextChanged (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,695);
...
Debug.ShouldStop(33554432);
formlabores.__c.runVoidMethod ("LogImpl","863504387",RemoteObject.concat(RemoteObject.createImmutable("numero de macollos "),__ref.getField(true,"_numeromacollosiembra" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("EditTextNumeroPaquetes_TextChanged (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,688);
...
Debug.ShouldStop(524288);
formlabores.__c.runVoidMethod ("LogImpl","863438852",RemoteObject.concat(RemoteObject.createImmutable("numero de paquetes "),__ref.getField(true,"_numeropaquetessiembra" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("EditTextProcedencia_TextChanged (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,589);
...
Debug.ShouldStop(65536);
formlabores.__c.runVoidMethod ("LogImpl","862586884",RemoteObject.concat(RemoteObject.createImmutable("procedencia"),__ref.getField(true,"_procedenciariego" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("EditTextProcedenciaDestino_TextChanged (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,675);
...
Debug.ShouldStop(32);
formlabores.__c.runVoidMethod ("LogImpl","863307779",RemoteObject.concat(RemoteObject.createImmutable("procedencia "),__ref.getField(true,"_procedenciasiembra" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("EditTextToneladaSemilla_TextChanged (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,668);
...
Debug.ShouldStop(-2147483648);
formlabores.__c.runVoidMethod ("LogImpl","863242244",RemoteObject.concat(RemoteObject.createImmutable("tonelada Semilla "),__ref.getField(true,"_toneladasemillasiembra" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("GetDeviceName (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,118);
...
try {
		Debug.PushSubsStack("Initialize (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,103);
...
try {
		Debug.PushSubsStack("Label13Time_Click (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,346);
...
try {
		Debug.PushSubsStack("Label14Time_Click (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,350);
...
try {
		Debug.PushSubsStack("Label1Back_Click (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,881);
...
try {
		Debug.PushSubsStack("LlenarComboBoxInsumo (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,782);
...
Debug.ShouldStop(4);
parent.__c.runVoidMethod ("LogImpl","863701013",RemoteObject.concat(RemoteObject.createImmutable("Error en la consulta de NITs: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
try {
		Debug.PushSubsStack("LlenarComboBoxRiego (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,703);
...
Debug.ShouldStop(524288);
parent.__c.runVoidMethod ("LogImpl","863569941",RemoteObject.concat(RemoteObject.createImmutable("Error en la consulta de NITs: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
try {
		Debug.PushSubsStack("LlenarComboBoxSiembra (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,731);
...
Debug.ShouldStop(524288);
parent.__c.runVoidMethod ("LogImpl","863635481",RemoteObject.concat(RemoteObject.createImmutable("Error en la consulta de NITs: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(64);
parent.__c.runVoidMethod ("LogImpl","863635500",RemoteObject.concat(RemoteObject.createImmutable("Error en la consulta de Tipo_Labranza: "),_j4.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
try {
		Debug.PushSubsStack("RemoveForm0IfExists (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,617);
...
try {
		Debug.PushSubsStack("RemoveForm2IfExists (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,628);
...
try {
		Debug.PushSubsStack("RemoveForm3IfExists (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,638);
...
try {
		Debug.PushSubsStack("RemoveInsumoFromData (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,865);
...
try {
		Debug.PushSubsStack("SD_xComboBoxCodigoVariedad_ItemClick (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,649);
...
Debug.ShouldStop(2048);
formlabores.__c.runVoidMethod ("LogImpl","863045635",RemoteObject.concat(RemoteObject.createImmutable("codigo "),__ref.getField(true,"_codigosiembra" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("SD_xComboBoxElemento_ItemClick (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,516);
...
Debug.ShouldStop(65536);
formlabores.__c.runVoidMethod ("LogImpl","862324749",RemoteObject.concat(RemoteObject.createImmutable("Las dos primeras letras (o menos si no hay suficientes): "),__ref.getField(true,"_elementogasto" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("SD_xComboBoxHacienda_ItemClick (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,466);
...
Debug.ShouldStop(4096);
parent.__c.runVoidMethod ("LogImpl","862128155",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(524288);
parent.__c.runVoidMethod ("LogImpl","862128162",RemoteObject.concat(RemoteObject.createImmutable("Hacienda"),__ref.getField(true,"_haciendacbx" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("SD_xComboBoxInsumo_ItemClick (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,810);
...
try {
		Debug.PushSubsStack("SD_xComboBoxLabor_ItemClick (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,509);
...
Debug.ShouldStop(1);
formlabores.__c.runVoidMethod ("LogImpl","862259204",RemoteObject.concat(RemoteObject.createImmutable("Elemento labor"),__ref.getField(true,"_elementolabor" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("SD_xComboBoxLote_ItemClick (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,503);
...
Debug.ShouldStop(33554432);
formlabores.__c.runVoidMethod ("LogImpl","862193667",RemoteObject.concat(RemoteObject.createImmutable("Lotecbx"),__ref.getField(true,"_lotecbx" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("SD_xComboBoxNit_ItemClick (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,429);
...
Debug.ShouldStop(256);
parent.__c.runVoidMethod ("LogImpl","862062620",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(16384);
parent.__c.runVoidMethod ("LogImpl","862062626",RemoteObject.concat(RemoteObject.createImmutable("Nit seleccionado"),__ref.getField(true,"_nitempresacbx" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("SD_xComboBoxTipoLabranza_ItemClick (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,681);
...
Debug.ShouldStop(4096);
formlabores.__c.runVoidMethod ("LogImpl","863373316",RemoteObject.concat(RemoteObject.createImmutable("tipo labranza "),__ref.getField(true,"_tipolabranzasiembra" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("SD_xComboBoxTipoRiego_ItemClick (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,609);
...
Debug.ShouldStop(8);
formlabores.__c.runVoidMethod ("LogImpl","862783491",RemoteObject.concat(RemoteObject.createImmutable("tipo riego"),__ref.getField(true,"_tiporiego" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("SD_xComboBoxTypeForm_ItemClick (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,548);
...
Debug.ShouldStop(8);
formlabores.__c.runVoidMethod ("LogImpl","862521376",RemoteObject.concat(RemoteObject.createImmutable("Valor no reconocido: "),_value),0);
 break; }
}
;
 }else {
...
Debug.ShouldStop(64);
formlabores.__c.runVoidMethod ("LogImpl","862521379",RemoteObject.createImmutable("Error: Value no es un número válido."),0);
 };
 BA.debugLineNum = 586;BA.debugLine="Log(\"Tipo labor \" & tipoLabor)";
Debug.ShouldStop(512);
formlabores.__c.runVoidMethod ("LogImpl","862521382",RemoteObject.concat(RemoteObject.createImmutable("Tipo labor "),__ref.getField(true,"_tipolabor" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("SwiftButtonElemento_Click (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,1255);
...
RemoteObject _elementocompleto = RemoteObject.createImmutable("");
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 1256;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateEleme";
Debug.ShouldStop(128);
...
;
 BA.debugLineNum = 1257;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
Debug.ShouldStop(256);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 1258;BA.debugLine="SwiftButtonElemento.xLBL.Text = SearchTemplateEl";
Debug.ShouldStop(512);
__ref.getField(false,"_swiftbuttonelemento" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(__ref.getField(false,"_searchtemplateelemento" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));
 BA.debugLineNum = 1259;BA.debugLine="Dim ELEMENTOCOMPLETO As String = SearchTemplateE";
Debug.ShouldStop(1024);
_elementocompleto = __ref.getField(false,"_searchtemplateelemento" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ );Debug.locals.put("ELEMENTOCOMPLETO", _elementocompleto);Debug.locals.put("ELEMENTOCOMPLETO", _elementocompleto);
 if (true) break;
...
try {
		Debug.PushSubsStack("SwiftButtonHacienda_Click (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,1190);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 1191;BA.debugLine="Dim ItemsLote As List";
Debug.ShouldStop(64);
_itemslote = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("ItemsLote", _itemslote);
 BA.debugLineNum = 1192;BA.debugLine="ItemsLote.Initialize";
Debug.ShouldStop(128);
_itemslote.runVoidMethod ("Initialize");
 BA.debugLineNum = 1194;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateHacie";
Debug.ShouldStop(512);
...
_result = (RemoteObject) result.getArrayElement(true,RemoteObject.createImmutable(1));Debug.locals.put("Result", _result);
;
 BA.debugLineNum = 1195;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
Debug.ShouldStop(1024);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 1196;BA.debugLine="SwiftButtonHacienda.xLBL.Text = SearchTemplateHa";
Debug.ShouldStop(2048);
__ref.getField(false,"_swiftbuttonhacienda" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(__ref.getField(false,"_searchtemplatehacienda" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));
 BA.debugLineNum = 1197;BA.debugLine="Dim HACIENDACOMPLETO As String = SearchTemplateH";
Debug.ShouldStop(4096);
_haciendacompleto = __ref.getField(false,"_searchtemplatehacienda" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ );Debug.locals.put("HACIENDACOMPLETO", _haciendacompleto);Debug.locals.put("HACIENDACOMPLETO", _haciendacompleto);
 BA.debugLineNum = 1198;BA.debugLine="Dim Partes() As String = Regex.Split(\":\", HACIEN";
Debug.ShouldStop(8192);
_partes = parent.__c.getField(false,"Regex").runMethod(false,"Split",(Object)(BA.ObjectToString(":")),(Object)(_haciendacompleto));Debug.locals.put("Partes", _partes);Debug.locals.put("Partes", _partes);
 BA.debugLineNum = 1199;BA.debugLine="haciendaCBX = Partes(0)";
Debug.ShouldStop(16384);
__ref.setField ("_haciendacbx" /*RemoteObject*/ ,_partes.getArrayElement(true,BA.numberCast(int.class, 0)));
 BA.debugLineNum = 1200;BA.debugLine="ItemsLote.Clear";
Debug.ShouldStop(32768);
_itemslote.runVoidMethod ("Clear");
 BA.debugLineNum = 1201;BA.debugLine="ItemsLote.Add(\"Seleccionar:\")";
Debug.ShouldStop(65536);
_itemslote.runVoidMethod ("Add",(Object)((RemoteObject.createImmutable("Seleccionar:"))));
 BA.debugLineNum = 1202;BA.debugLine="SwiftButtonLote.xLBL.Text = \"\"";
Debug.ShouldStop(131072);
__ref.getField(false,"_swiftbuttonlote" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(""));
 BA.debugLineNum = 1204;BA.debugLine="Dim Req As DBRequestManager";
Debug.ShouldStop(524288);
_req = RemoteObject.createNew ("b4a.example.ef.dbrequestmanager");Debug.locals.put("Req", _req);
 BA.debugLineNum = 1205;BA.debugLine="Req.Initialize(Me, rdcLink & \"?DBName=\" & Main.p";
Debug.ShouldStop(1048576);
_req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(__ref),(Object)(RemoteObject.concat(__ref.getField(true,"_rdclink" /*RemoteObject*/ ),RemoteObject.createImmutable("?DBName="),parent._main._pdbname /*RemoteObject*/ )));
 BA.debugLineNum = 1206;BA.debugLine="Dim cmd As DBCommand = CreateCommand(\"select_lot";
Debug.ShouldStop(2097152);
_cmd = __ref.runClassMethod (b4a.example.ef.formlabores.class, "_createcommand" /*RemoteObject*/ ,(Object)(BA.ObjectToString("select_lotes")),(Object)(RemoteObject.createNewArray("Object",new int[] {2},new Object[] {(__ref.getField(true,"_nitempresacbx" /*RemoteObject*/ )),(__ref.getField(true,"_haciendacbx" /*RemoteObject*/ ))})));Debug.locals.put("cmd", _cmd);Debug.locals.put("cmd", _cmd);
 BA.debugLineNum = 1209;BA.debugLine="Wait For (Req.ExecuteQuery(cmd, 0, Null)) JobDon";
Debug.ShouldStop(16777216);
...
_j = (RemoteObject) result.getArrayElement(false,RemoteObject.createImmutable(1));Debug.locals.put("j", _j);
;
 BA.debugLineNum = 1212;BA.debugLine="If j.Success Then";
Debug.ShouldStop(134217728);
if (true) break;
...
//C
this.state = 7;
 BA.debugLineNum = 1214;BA.debugLine="Req.HandleJobAsync(j, \"req\")";
Debug.ShouldStop(536870912);
_req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_handlejobasync" /*void*/ ,(Object)(_j),(Object)(RemoteObject.createImmutable("req")));
 BA.debugLineNum = 1215;BA.debugLine="Wait For (Req) req_Result(res As DBResult)";
Debug.ShouldStop(1073741824);
...
_res = (RemoteObject) result.getArrayElement(false,RemoteObject.createImmutable(1));Debug.locals.put("res", _res);
;
 BA.debugLineNum = 1219;BA.debugLine="For Each row() As Object In res.Rows";
Debug.ShouldStop(4);
if (true) break;
...
//C
this.state = 19;
 BA.debugLineNum = 1220;BA.debugLine="Dim Codg_Hacienda As String = row(0)";
Debug.ShouldStop(8);
_codg_hacienda = BA.ObjectToString(_row.getArrayElement(false,BA.numberCast(int.class, 0)));Debug.locals.put("Codg_Hacienda", _codg_hacienda);Debug.locals.put("Codg_Hacienda", _codg_hacienda);
 BA.debugLineNum = 1224;BA.debugLine="ItemsLote.Add(Codg_Hacienda)";
Debug.ShouldStop(128);
...
//C
this.state = 13;
 BA.debugLineNum = 1229;BA.debugLine="Log(\"Error: \" & j.ErrorMessage)";
Debug.ShouldStop(4096);
parent.__c.runVoidMethod ("LogImpl","882378791",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
this.state = 14;
;
 BA.debugLineNum = 1231;BA.debugLine="SearchTemplateLote.SetItems(ItemsLote)";
Debug.ShouldStop(16384);
__ref.getField(false,"_searchtemplatelote" /*RemoteObject*/ ).runClassMethod (b4a.example.ef.b4xsearchtemplate.class, "_setitems" /*RemoteObject*/ ,(Object)(_itemslote));
 BA.debugLineNum = 1232;BA.debugLine="SwiftButtonLote.Enabled = True";
Debug.ShouldStop(32768);
...
try {
		Debug.PushSubsStack("SwiftButtonInsumo_Click (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,1304);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 1305;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateInsum";
Debug.ShouldStop(16777216);
...
_result = (RemoteObject) result.getArrayElement(true,RemoteObject.createImmutable(1));Debug.locals.put("Result", _result);
;
 BA.debugLineNum = 1306;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
Debug.ShouldStop(33554432);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 1307;BA.debugLine="SwiftButtonInsumo.xLBL.Text = SearchTemplateInsu";
Debug.ShouldStop(67108864);
__ref.getField(false,"_swiftbuttoninsumo" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(__ref.getField(false,"_searchtemplateinsumo" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));
 BA.debugLineNum = 1308;BA.debugLine="Dim INSUMOCOMPLETO As String = SearchTemplateIns";
Debug.ShouldStop(134217728);
_insumocompleto = __ref.getField(false,"_searchtemplateinsumo" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ );Debug.locals.put("INSUMOCOMPLETO", _insumocompleto);Debug.locals.put("INSUMOCOMPLETO", _insumocompleto);
 BA.debugLineNum = 1309;BA.debugLine="Dim partes() As String = Regex.Split(\":\", INSUMO";
Debug.ShouldStop(268435456);
_partes = parent.__c.getField(false,"Regex").runMethod(false,"Split",(Object)(BA.ObjectToString(":")),(Object)(_insumocompleto));Debug.locals.put("partes", _partes);Debug.locals.put("partes", _partes);
 BA.debugLineNum = 1310;BA.debugLine="NAMEINSUMO = partes(1)";
Debug.ShouldStop(536870912);
__ref.setField ("_nameinsumo" /*RemoteObject*/ ,_partes.getArrayElement(true,BA.numberCast(int.class, 1)));
 BA.debugLineNum = 1311;BA.debugLine="IDINSUMO = partes(0)";
Debug.ShouldStop(1073741824);
...
try {
		Debug.PushSubsStack("SwiftButtonLabor_Click (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,1247);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 1248;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateLabor";
Debug.ShouldStop(-2147483648);
...
//C
this.state = 4;
 BA.debugLineNum = 1250;BA.debugLine="SwiftButtonLabor.xLBL.Text = SearchTemplateLabor";
Debug.ShouldStop(2);
__ref.getField(false,"_swiftbuttonlabor" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(__ref.getField(false,"_searchtemplatelabor" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));
 BA.debugLineNum = 1251;BA.debugLine="Dim LABORCOMPLETO As String = SearchTemplateLabo";
Debug.ShouldStop(4);
...
try {
		Debug.PushSubsStack("SwiftButtonLote_Click (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,1239);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 1240;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateLote,";
Debug.ShouldStop(8388608);
...
_result = (RemoteObject) result.getArrayElement(true,RemoteObject.createImmutable(1));Debug.locals.put("Result", _result);
;
 BA.debugLineNum = 1241;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
Debug.ShouldStop(16777216);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 1242;BA.debugLine="SwiftButtonLote.xLBL.Text = SearchTemplateLote.S";
Debug.ShouldStop(33554432);
__ref.getField(false,"_swiftbuttonlote" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(__ref.getField(false,"_searchtemplatelote" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));
 BA.debugLineNum = 1243;BA.debugLine="loteCBX = SearchTemplateNit.SelectedItem";
Debug.ShouldStop(67108864);
...
try {
		Debug.PushSubsStack("SwiftButtonNit_Click (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,1139);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 1140;BA.debugLine="Dim ItemsHacienda As List";
Debug.ShouldStop(524288);
_itemshacienda = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("ItemsHacienda", _itemshacienda);
 BA.debugLineNum = 1141;BA.debugLine="ItemsHacienda.Initialize";
Debug.ShouldStop(1048576);
_itemshacienda.runVoidMethod ("Initialize");
 BA.debugLineNum = 1142;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateNit,";
Debug.ShouldStop(2097152);
...
_result = (RemoteObject) result.getArrayElement(true,RemoteObject.createImmutable(1));Debug.locals.put("Result", _result);
;
 BA.debugLineNum = 1143;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
Debug.ShouldStop(4194304);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 1144;BA.debugLine="SwiftButtonNit.xLBL.Text = SearchTemplateNit.Sel";
Debug.ShouldStop(8388608);
__ref.getField(false,"_swiftbuttonnit" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(__ref.getField(false,"_searchtemplatenit" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));
 BA.debugLineNum = 1145;BA.debugLine="Dim NITCOMPLETO As String = SearchTemplateNit.Se";
Debug.ShouldStop(16777216);
_nitcompleto = __ref.getField(false,"_searchtemplatenit" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ );Debug.locals.put("NITCOMPLETO", _nitcompleto);Debug.locals.put("NITCOMPLETO", _nitcompleto);
 BA.debugLineNum = 1146;BA.debugLine="Dim Partes() As String = Regex.Split(\":\", NITCOM";
Debug.ShouldStop(33554432);
_partes = parent.__c.getField(false,"Regex").runMethod(false,"Split",(Object)(BA.ObjectToString(":")),(Object)(_nitcompleto));Debug.locals.put("Partes", _partes);Debug.locals.put("Partes", _partes);
 BA.debugLineNum = 1147;BA.debugLine="nitEmpresaCBX = Partes(0)";
Debug.ShouldStop(67108864);
__ref.setField ("_nitempresacbx" /*RemoteObject*/ ,_partes.getArrayElement(true,BA.numberCast(int.class, 0)));
 BA.debugLineNum = 1148;BA.debugLine="ItemsHacienda.Clear";
Debug.ShouldStop(134217728);
_itemshacienda.runVoidMethod ("Clear");
 BA.debugLineNum = 1149;BA.debugLine="ItemsHacienda.Add(\"Seleccionar:\")";
Debug.ShouldStop(268435456);
_itemshacienda.runVoidMethod ("Add",(Object)((RemoteObject.createImmutable("Seleccionar:"))));
 BA.debugLineNum = 1150;BA.debugLine="SwiftButtonHacienda.xLBL.Text = \"\"";
Debug.ShouldStop(536870912);
__ref.getField(false,"_swiftbuttonhacienda" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(""));
 BA.debugLineNum = 1152;BA.debugLine="Dim Req As DBRequestManager";
Debug.ShouldStop(-2147483648);
_req = RemoteObject.createNew ("b4a.example.ef.dbrequestmanager");Debug.locals.put("Req", _req);
 BA.debugLineNum = 1153;BA.debugLine="Req.Initialize(Me, rdcLink & \"?DBName=\" & Main.p";
Debug.ShouldStop(1);
_req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(__ref),(Object)(RemoteObject.concat(__ref.getField(true,"_rdclink" /*RemoteObject*/ ),RemoteObject.createImmutable("?DBName="),parent._main._pdbname /*RemoteObject*/ )));
 BA.debugLineNum = 1154;BA.debugLine="Dim cmd As DBCommand = CreateCommand(\"select_hac";
Debug.ShouldStop(2);
_cmd = __ref.runClassMethod (b4a.example.ef.formlabores.class, "_createcommand" /*RemoteObject*/ ,(Object)(BA.ObjectToString("select_haciendas")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {(__ref.getField(true,"_nitempresacbx" /*RemoteObject*/ ))})));Debug.locals.put("cmd", _cmd);Debug.locals.put("cmd", _cmd);
 BA.debugLineNum = 1157;BA.debugLine="Wait For (Req.ExecuteQuery(cmd, 0, Null)) JobDon";
Debug.ShouldStop(16);
...
//C
this.state = 7;
 BA.debugLineNum = 1162;BA.debugLine="Req.HandleJobAsync(j, \"req\")";
Debug.ShouldStop(512);
_req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_handlejobasync" /*void*/ ,(Object)(_j),(Object)(RemoteObject.createImmutable("req")));
 BA.debugLineNum = 1163;BA.debugLine="Wait For (Req) req_Result(res As DBResult)";
Debug.ShouldStop(1024);
...
_res = (RemoteObject) result.getArrayElement(false,RemoteObject.createImmutable(1));Debug.locals.put("res", _res);
;
 BA.debugLineNum = 1167;BA.debugLine="For Each row() As Object In res.Rows";
Debug.ShouldStop(16384);
if (true) break;
...
//C
this.state = 19;
 BA.debugLineNum = 1168;BA.debugLine="Dim Codg_Hacienda As String = row(0)";
Debug.ShouldStop(32768);
_codg_hacienda = BA.ObjectToString(_row.getArrayElement(false,BA.numberCast(int.class, 0)));Debug.locals.put("Codg_Hacienda", _codg_hacienda);Debug.locals.put("Codg_Hacienda", _codg_hacienda);
 BA.debugLineNum = 1169;BA.debugLine="Dim NombreHacienda As String = row(1)";
Debug.ShouldStop(65536);
_nombrehacienda = BA.ObjectToString(_row.getArrayElement(false,BA.numberCast(int.class, 1)));Debug.locals.put("NombreHacienda", _nombrehacienda);Debug.locals.put("NombreHacienda", _nombrehacienda);
 BA.debugLineNum = 1174;BA.debugLine="ItemsHacienda.Add(Codg_Hacienda&\":\"&NombreHaci";
Debug.ShouldStop(2097152);
...
//C
this.state = 13;
 BA.debugLineNum = 1179;BA.debugLine="Log(\"Error: \" & j.ErrorMessage)";
Debug.ShouldStop(67108864);
parent.__c.runVoidMethod ("LogImpl","882313256",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
this.state = 14;
;
 BA.debugLineNum = 1181;BA.debugLine="SearchTemplateHacienda.SetItems(ItemsHacienda)";
Debug.ShouldStop(268435456);
__ref.getField(false,"_searchtemplatehacienda" /*RemoteObject*/ ).runClassMethod (b4a.example.ef.b4xsearchtemplate.class, "_setitems" /*RemoteObject*/ ,(Object)(_itemshacienda));
 BA.debugLineNum = 1182;BA.debugLine="SwiftButtonHacienda.Enabled = True";
Debug.ShouldStop(536870912);
__ref.getField(false,"_swiftbuttonhacienda" /*RemoteObject*/ ).runClassMethod (b4a.example.ef.swiftbutton.class, "_setenabled" /*RemoteObject*/ ,parent.__c.getField(true,"True"));
 BA.debugLineNum = 1183;BA.debugLine="Log(nitEmpresaCBX)";
Debug.ShouldStop(1073741824);
parent.__c.runVoidMethod ("LogImpl","882313260",__ref.getField(true,"_nitempresacbx" /*RemoteObject*/ ),0);
 BA.debugLineNum = 1185;BA.debugLine="j.Release";
Debug.ShouldStop(1);
_j.runClassMethod (b4a.example.ef.httpjob.class, "_release" /*RemoteObject*/ );
 if (true) break;
...
try {
		Debug.PushSubsStack("SwiftButtonRiego_Click (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,1315);
...
b4a.example.ef.formlabores parent;
RemoteObject _result = RemoteObject.createImmutable(0);
RemoteObject _riegocompleto = RemoteObject.createImmutable("");
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 1316;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateRiego";
Debug.ShouldStop(8);
...
_result = (RemoteObject) result.getArrayElement(true,RemoteObject.createImmutable(1));Debug.locals.put("Result", _result);
;
 BA.debugLineNum = 1317;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
Debug.ShouldStop(16);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 1318;BA.debugLine="SwiftButtonRiego.xLBL.Text = SearchTemplateRiego";
Debug.ShouldStop(32);
__ref.getField(false,"_swiftbuttonriego" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(__ref.getField(false,"_searchtemplateriego" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));
 BA.debugLineNum = 1319;BA.debugLine="Dim RIEGOCOMPLETO As String = SearchTemplateRieg";
Debug.ShouldStop(64);
_riegocompleto = __ref.getField(false,"_searchtemplateriego" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ );Debug.locals.put("RIEGOCOMPLETO", _riegocompleto);Debug.locals.put("RIEGOCOMPLETO", _riegocompleto);
 if (true) break;
...
try {
		Debug.PushSubsStack("SwiftButtonTipoLabranza_Click (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,1323);
...
b4a.example.ef.formlabores parent;
RemoteObject _result = RemoteObject.createImmutable(0);
RemoteObject _codigolabranza = RemoteObject.createImmutable("");
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 1324;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateTipoL";
Debug.ShouldStop(2048);
...
//C
this.state = 4;
 BA.debugLineNum = 1326;BA.debugLine="SwiftButtonTipoLabranza.xLBL.Text = SearchTempla";
Debug.ShouldStop(8192);
__ref.getField(false,"_swiftbuttontipolabranza" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(__ref.getField(false,"_searchtemplatetipolabranza" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));
 BA.debugLineNum = 1327;BA.debugLine="Dim CODIGOLABRANZA As String = SearchTemplateTip";
Debug.ShouldStop(16384);
_codigolabranza = __ref.getField(false,"_searchtemplatetipolabranza" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ );Debug.locals.put("CODIGOLABRANZA", _codigolabranza);Debug.locals.put("CODIGOLABRANZA", _codigolabranza);
 if (true) break;
...
try {
		Debug.PushSubsStack("SwiftButtonTypeForm_Click (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,1263);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 1264;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateTypeF";
Debug.ShouldStop(32768);
...
_result = (RemoteObject) result.getArrayElement(true,RemoteObject.createImmutable(1));Debug.locals.put("Result", _result);
;
 BA.debugLineNum = 1265;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
Debug.ShouldStop(65536);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 1266;BA.debugLine="SwiftButtonTypeForm.xLBL.Text = SearchTemplateTy";
Debug.ShouldStop(131072);
__ref.getField(false,"_swiftbuttontypeform" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(__ref.getField(false,"_searchtemplatetypeform" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));
 BA.debugLineNum = 1267;BA.debugLine="Dim TYPEFORMCOMPLETO As String = SearchTemplateT";
Debug.ShouldStop(262144);
_typeformcompleto = __ref.getField(false,"_searchtemplatetypeform" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ );Debug.locals.put("TYPEFORMCOMPLETO", _typeformcompleto);Debug.locals.put("TYPEFORMCOMPLETO", _typeformcompleto);
 BA.debugLineNum = 1268;BA.debugLine="Dim Partes() As String = Regex.Split(\":\", TYPEFO";
Debug.ShouldStop(524288);
_partes = parent.__c.getField(false,"Regex").runMethod(false,"Split",(Object)(BA.ObjectToString(":")),(Object)(_typeformcompleto));Debug.locals.put("Partes", _partes);Debug.locals.put("Partes", _partes);
 BA.debugLineNum = 1269;BA.debugLine="Dim tipoForm As String = Partes(0)";
Debug.ShouldStop(1048576);
_tipoform = _partes.getArrayElement(true,BA.numberCast(int.class, 0));Debug.locals.put("tipoForm", _tipoform);Debug.locals.put("tipoForm", _tipoform);
 BA.debugLineNum = 1271;BA.debugLine="Select Case tipoForm";
Debug.ShouldStop(4194304);
if (true) break;
...
//C
this.state = 13;
 BA.debugLineNum = 1273;BA.debugLine="RemoveForm2IfExists";
Debug.ShouldStop(16777216);
__ref.runClassMethod (b4a.example.ef.formlabores.class, "_removeform2ifexists" /*RemoteObject*/ );
 BA.debugLineNum = 1274;BA.debugLine="RemoveForm3IfExists";
Debug.ShouldStop(33554432);
__ref.runClassMethod (b4a.example.ef.formlabores.class, "_removeform3ifexists" /*RemoteObject*/ );
 BA.debugLineNum = 1275;BA.debugLine="CustomListView1Geral.Add(CreateItemInsumo,\"form";
Debug.ShouldStop(67108864);
__ref.getField(false,"_customlistview1geral" /*RemoteObject*/ ).runVoidMethod ("_add",RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), __ref.runClassMethod (b4a.example.ef.formlabores.class, "_createiteminsumo" /*RemoteObject*/ ).getObject()),(Object)((RemoteObject.createImmutable("form0"))));
 BA.debugLineNum = 1276;BA.debugLine="LlenarComboBoxInsumo";
Debug.ShouldStop(134217728);
__ref.runClassMethod (b4a.example.ef.formlabores.class, "_llenarcomboboxinsumo" /*void*/ );
 BA.debugLineNum = 1277;BA.debugLine="Dim INSUMOCOLUM As B4XTableColumn = B4XTable1.A";
Debug.ShouldStop(268435456);
_insumocolum = __ref.getField(false,"_b4xtable1" /*RemoteObject*/ ).runClassMethod (b4a.example.ef.b4xtable.class, "_addcolumn" /*RemoteObject*/ ,(Object)(BA.ObjectToString("#")),(Object)(__ref.getField(false,"_b4xtable1" /*RemoteObject*/ ).getField(true,"_column_type_numbers" /*RemoteObject*/ )));Debug.locals.put("INSUMOCOLUM", _insumocolum);Debug.locals.put("INSUMOCOLUM", _insumocolum);
 BA.debugLineNum = 1278;BA.debugLine="INSUMOCOLUM.Width = 50dip";
Debug.ShouldStop(536870912);
_insumocolum.setField ("Width" /*RemoteObject*/ ,parent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 50))));
 BA.debugLineNum = 1279;BA.debugLine="B4XTable1.AddColumn(\"ID\", B4XTable1.COLUMN_TYPE";
Debug.ShouldStop(1073741824);
__ref.getField(false,"_b4xtable1" /*RemoteObject*/ ).runClassMethod (b4a.example.ef.b4xtable.class, "_addcolumn" /*RemoteObject*/ ,(Object)(BA.ObjectToString("ID")),(Object)(__ref.getField(false,"_b4xtable1" /*RemoteObject*/ ).getField(true,"_column_type_text" /*RemoteObject*/ )));
 BA.debugLineNum = 1280;BA.debugLine="B4XTable1.AddColumn(\"NOMBRE\", B4XTable1.COLUMN_";
Debug.ShouldStop(-2147483648);
__ref.getField(false,"_b4xtable1" /*RemoteObject*/ ).runClassMethod (b4a.example.ef.b4xtable.class, "_addcolumn" /*RemoteObject*/ ,(Object)(BA.ObjectToString("NOMBRE")),(Object)(__ref.getField(false,"_b4xtable1" /*RemoteObject*/ ).getField(true,"_column_type_text" /*RemoteObject*/ )));
 BA.debugLineNum = 1281;BA.debugLine="B4XTable1.AddColumn(\"CANTIDAD\", B4XTable1.COLUM";
Debug.ShouldStop(1);
__ref.getField(false,"_b4xtable1" /*RemoteObject*/ ).runClassMethod (b4a.example.ef.b4xtable.class, "_addcolumn" /*RemoteObject*/ ,(Object)(BA.ObjectToString("CANTIDAD")),(Object)(__ref.getField(false,"_b4xtable1" /*RemoteObject*/ ).getField(true,"_column_type_text" /*RemoteObject*/ )));
 BA.debugLineNum = 1283;BA.debugLine="cantidadInsumos = 0";
Debug.ShouldStop(4);
__ref.setField ("_cantidadinsumos" /*RemoteObject*/ ,BA.numberCast(int.class, 0));
 BA.debugLineNum = 1284;BA.debugLine="LabelCantidadInsumos.Text = cantidadInsumos";
Debug.ShouldStop(8);
__ref.getField(false,"_labelcantidadinsumos" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(__ref.getField(true,"_cantidadinsumos" /*RemoteObject*/ )));
 BA.debugLineNum = 1285;BA.debugLine="CANTINSUMO = \"\"";
Debug.ShouldStop(16);
__ref.setField ("_cantinsumo" /*RemoteObject*/ ,BA.ObjectToString(""));
 if (true) break;
...
//C
this.state = 13;
 BA.debugLineNum = 1287;BA.debugLine="RemoveForm0IfExists";
Debug.ShouldStop(64);
__ref.runClassMethod (b4a.example.ef.formlabores.class, "_removeform0ifexists" /*RemoteObject*/ );
 BA.debugLineNum = 1288;BA.debugLine="RemoveForm2IfExists ' Eliminar \"form2\" si exist";
Debug.ShouldStop(128);
__ref.runClassMethod (b4a.example.ef.formlabores.class, "_removeform2ifexists" /*RemoteObject*/ );
 BA.debugLineNum = 1289;BA.debugLine="CustomListView1Geral.Add(CreateItemSiembra,\"for";
Debug.ShouldStop(256);
__ref.getField(false,"_customlistview1geral" /*RemoteObject*/ ).runVoidMethod ("_add",RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), __ref.runClassMethod (b4a.example.ef.formlabores.class, "_createitemsiembra" /*RemoteObject*/ ).getObject()),(Object)((RemoteObject.createImmutable("form3"))));
 BA.debugLineNum = 1290;BA.debugLine="LlenarComboBoxSiembra";
Debug.ShouldStop(512);
__ref.runClassMethod (b4a.example.ef.formlabores.class, "_llenarcomboboxsiembra" /*void*/ );
 if (true) break;
...
//C
this.state = 13;
 BA.debugLineNum = 1292;BA.debugLine="RemoveForm0IfExists";
Debug.ShouldStop(2048);
__ref.runClassMethod (b4a.example.ef.formlabores.class, "_removeform0ifexists" /*RemoteObject*/ );
 BA.debugLineNum = 1293;BA.debugLine="RemoveForm3IfExists";
Debug.ShouldStop(4096);
__ref.runClassMethod (b4a.example.ef.formlabores.class, "_removeform3ifexists" /*RemoteObject*/ );
 BA.debugLineNum = 1294;BA.debugLine="CustomListView1Geral.Add(CreateItemRiego, \"form";
Debug.ShouldStop(8192);
__ref.getField(false,"_customlistview1geral" /*RemoteObject*/ ).runVoidMethod ("_add",RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), __ref.runClassMethod (b4a.example.ef.formlabores.class, "_createitemriego" /*RemoteObject*/ ).getObject()),(Object)((RemoteObject.createImmutable("form2"))));
 BA.debugLineNum = 1295;BA.debugLine="LlenarComboBoxRiego";
Debug.ShouldStop(16384);
__ref.runClassMethod (b4a.example.ef.formlabores.class, "_llenarcomboboxriego" /*void*/ );
 if (true) break;
...
//C
this.state = 13;
 BA.debugLineNum = 1298;BA.debugLine="Log(\"Valor no reconocido: \" & tipoForm)";
Debug.ShouldStop(131072);
parent.__c.runVoidMethod ("LogImpl","882640931",RemoteObject.concat(RemoteObject.createImmutable("Valor no reconocido: "),_tipoform),0);
 if (true) break;
...
try {
		Debug.PushSubsStack("SwiftButtonVariedad_Click (formlabores) ","formlabores",10,__ref.getField(false, "ba"),__ref,1331);
...
b4a.example.ef.formlabores parent;
RemoteObject _result = RemoteObject.createImmutable(0);
RemoteObject _labranzacompleta = RemoteObject.createImmutable("");
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 1332;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateVarie";
Debug.ShouldStop(524288);
...
//C
this.state = 4;
 BA.debugLineNum = 1334;BA.debugLine="SwiftButtonVariedad.xLBL.Text = SearchTemplateVa";
Debug.ShouldStop(2097152);
__ref.getField(false,"_swiftbuttonvariedad" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(__ref.getField(false,"_searchtemplatevariedad" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));
 BA.debugLineNum = 1335;BA.debugLine="Dim LABRANZACOMPLETA As String = SearchTemplateV";
Debug.ShouldStop(4194304);
_labranzacompleta = __ref.getField(false,"_searchtemplatevariedad" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ );Debug.locals.put("LABRANZACOMPLETA", _labranzacompleta);Debug.locals.put("LABRANZACOMPLETA", _labranzacompleta);
 if (true) break;
