...
try {
		Debug.PushSubsStack("AS_DatePicker1_SelectedDateChanged (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,354);
...
formlabores.__c.runVoidMethod ("LogImpl","86684702",RemoteObject.concat(RemoteObject.createImmutable("Fecha inicio: "),__ref.getField(true,"_fechainicio" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("AS_DatePicker2_SelectedDateChanged (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,387);
...
Debug.ShouldStop(1);
formlabores.__c.runVoidMethod ("LogImpl","86750238",RemoteObject.concat(RemoteObject.createImmutable("Fecha fin: "),__ref.getField(true,"_fechafin" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("B4XPage_Appear (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,125);
...
Debug.ShouldStop(1073741824);
parent.__c.runVoidMethod ("LogImpl","86225954",RemoteObject.concat(RemoteObject.createImmutable("Error en la consulta de NITs: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(536870912);
parent.__c.runVoidMethod ("LogImpl","86225985",RemoteObject.concat(RemoteObject.createImmutable("Error en la consulta de Maquina: "),_j3.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(16777216);
parent.__c.runVoidMethod ("LogImpl","86226012",RemoteObject.concat(RemoteObject.createImmutable("Error en la consulta de Maquina: "),_j4.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(16777216);
parent.__c.runVoidMethod ("LogImpl","86226044",RemoteObject.concat(RemoteObject.createImmutable("Último Registro obtenido: "),_ultimoregistro),0);
 if (true) break;
if (true) break;
...
Debug.ShouldStop(268435456);
parent.__c.runVoidMethod ("LogImpl","86226048",RemoteObject.concat(RemoteObject.createImmutable("Error en la consulta select_maxIdLabor: "),_j5.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(2);
parent.__c.runVoidMethod ("LogImpl","86226053",BA.NumberToString(__ref.getField(true,"_consecutivo" /*RemoteObject*/ )),0);
...
Debug.ShouldStop(4096);
parent.__c.runVoidMethod ("LogImpl","86226064",RemoteObject.concat(RemoteObject.createImmutable("Último Registro Siembra  obtenido: "),_ultimoregistrosiembra),0);
 if (true) break;
if (true) break;
...
Debug.ShouldStop(65536);
parent.__c.runVoidMethod ("LogImpl","86226068",RemoteObject.concat(RemoteObject.createImmutable("Error en la consulta select_maxIdLabor: "),_j5.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(2097152);
parent.__c.runVoidMethod ("LogImpl","86226073",BA.NumberToString(__ref.getField(true,"_consecutivosiembra" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("B4XPage_Created (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,109);
...
try {
		Debug.PushSubsStack("B4XTable1_CellClicked (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,848);
...
Debug.ShouldStop(65536);
formlabores.__c.runVoidMethod ("LogImpl","88847361",RemoteObject.concat(RemoteObject.createImmutable("COLUM ID"),_columnid),0);
 BA.debugLineNum = 850;BA.debugLine="Log(\"ROW ID\"&RowId)";
Debug.ShouldStop(131072);
formlabores.__c.runVoidMethod ("LogImpl","88847362",RemoteObject.concat(RemoteObject.createImmutable("ROW ID"),_rowid),0);
...
Debug.ShouldStop(268435456);
formlabores.__c.runVoidMethod ("LogImpl","88847373",BA.NumberToString(__ref.getField(true,"_ideliminartabla" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("ButtonAddInsumo_Click (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,821);
...
try {
		Debug.PushSubsStack("ButtonDeleteInsumo_Click (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,835);
...
try {
		Debug.PushSubsStack("ButtonInsumo_Click (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,886);
...
Debug.ShouldStop(4194304);
parent.__c.runVoidMethod ("LogImpl","89044001",RemoteObject.concat(RemoteObject.createImmutable("Fila "),(RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(_i),RemoteObject.createImmutable(1)}, "+",1, 1)),RemoteObject.createImmutable(":")),0);
 BA.debugLineNum = 920;BA.debugLine="Log(\" - ID: \" & ID)";
Debug.ShouldStop(8388608);
parent.__c.runVoidMethod ("LogImpl","89044002",RemoteObject.concat(RemoteObject.createImmutable(" - ID: "),_id),0);
 BA.debugLineNum = 921;BA.debugLine="Log(\" - NOMBRE: \" & nombreInsu)";
Debug.ShouldStop(16777216);
parent.__c.runVoidMethod ("LogImpl","89044003",RemoteObject.concat(RemoteObject.createImmutable(" - NOMBRE: "),_nombreinsu),0);
 BA.debugLineNum = 922;BA.debugLine="Log(\" - CANTIDAD: \" & cantidadInsu)";
Debug.ShouldStop(33554432);
parent.__c.runVoidMethod ("LogImpl","89044004",RemoteObject.concat(RemoteObject.createImmutable(" - CANTIDAD: "),_cantidadinsu),0);
...
Debug.ShouldStop(4);
parent.__c.runVoidMethod ("LogImpl","89044013",RemoteObject.createImmutable("Comando SQL: insert_laborInsumo"),0);
 BA.debugLineNum = 932;BA.debugLine="Log(\"Parámetro 1 - consecutivo: \" & consecutiv";
Debug.ShouldStop(8);
parent.__c.runVoidMethod ("LogImpl","89044014",RemoteObject.concat(RemoteObject.createImmutable("Parámetro 1 - consecutivo: "),__ref.getField(true,"_consecutivo" /*RemoteObject*/ )),0);
 BA.debugLineNum = 933;BA.debugLine="Log(\"Parámetro 2 - ID: \" & ID)";
Debug.ShouldStop(16);
parent.__c.runVoidMethod ("LogImpl","89044015",RemoteObject.concat(RemoteObject.createImmutable("Parámetro 2 - ID: "),_id),0);
 BA.debugLineNum = 934;BA.debugLine="Log(\"Parámetro 3 - cantidadInsu: \" & cantidadI";
Debug.ShouldStop(32);
parent.__c.runVoidMethod ("LogImpl","89044016",RemoteObject.concat(RemoteObject.createImmutable("Parámetro 3 - cantidadInsu: "),_cantidadinsu),0);
...
Debug.ShouldStop(8192);
parent.__c.runVoidMethod ("LogImpl","89044024",RemoteObject.concat(RemoteObject.createImmutable("Inserción insumo exitosa para ID: "),_id),0);
 BA.debugLineNum = 943;BA.debugLine="ToastMessageShow(\"Inserción exitosa para ID:";
Debug.ShouldStop(16384);
parent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Inserción exitosa para ID: "),_id))),(Object)(parent.__c.getField(true,"True")));
 if (true) break;
...
Debug.ShouldStop(131072);
parent.__c.runVoidMethod ("LogImpl","89044028",RemoteObject.concat(RemoteObject.createImmutable("Error en la inserción insumo para ID: "),_id,RemoteObject.createImmutable(". Error: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
...
Debug.ShouldStop(536870912);
parent.__c.runVoidMethod ("LogImpl","89044040",RemoteObject.concat(RemoteObject.createImmutable("Error al procesar insumo la cantidad para ID: "),_id),0);
...
Debug.ShouldStop(4194304);
parent.__c.runVoidMethod ("LogImpl","89044065",RemoteObject.concat(RemoteObject.createImmutable("nitEmpresaCBX: "),__ref.getField(true,"_nitempresacbx" /*RemoteObject*/ )),0);
 BA.debugLineNum = 984;BA.debugLine="Log(\"haciendaCBX: \" & haciendaCBX)";
Debug.ShouldStop(8388608);
parent.__c.runVoidMethod ("LogImpl","89044066",RemoteObject.concat(RemoteObject.createImmutable("haciendaCBX: "),__ref.getField(true,"_haciendacbx" /*RemoteObject*/ )),0);
 BA.debugLineNum = 985;BA.debugLine="Log(\"loteCBX: \" & loteCBX)";
Debug.ShouldStop(16777216);
parent.__c.runVoidMethod ("LogImpl","89044067",RemoteObject.concat(RemoteObject.createImmutable("loteCBX: "),__ref.getField(true,"_lotecbx" /*RemoteObject*/ )),0);
 BA.debugLineNum = 986;BA.debugLine="Log(\"fechafmrto: \" & fechafmrto)";
Debug.ShouldStop(33554432);
parent.__c.runVoidMethod ("LogImpl","89044068",RemoteObject.concat(RemoteObject.createImmutable("fechafmrto: "),__ref.getField(true,"_fechafmrto" /*RemoteObject*/ )),0);
 BA.debugLineNum = 987;BA.debugLine="Log(\"tipoLabor: \" & tipoLabor)";
Debug.ShouldStop(67108864);
parent.__c.runVoidMethod ("LogImpl","89044069",RemoteObject.concat(RemoteObject.createImmutable("tipoLabor: "),__ref.getField(true,"_tipolabor" /*RemoteObject*/ )),0);
 BA.debugLineNum = 988;BA.debugLine="Log(\"fechaInicio: \" & fechaInicio)";
Debug.ShouldStop(134217728);
parent.__c.runVoidMethod ("LogImpl","89044070",RemoteObject.concat(RemoteObject.createImmutable("fechaInicio: "),__ref.getField(true,"_fechainicio" /*RemoteObject*/ )),0);
 BA.debugLineNum = 989;BA.debugLine="Log(\"fechaFin: \" & fechaFin)";
Debug.ShouldStop(268435456);
parent.__c.runVoidMethod ("LogImpl","89044071",RemoteObject.concat(RemoteObject.createImmutable("fechaFin: "),__ref.getField(true,"_fechafin" /*RemoteObject*/ )),0);
 BA.debugLineNum = 990;BA.debugLine="Log(\"elementoGasto: \" & elementoGasto)";
Debug.ShouldStop(536870912);
parent.__c.runVoidMethod ("LogImpl","89044072",RemoteObject.concat(RemoteObject.createImmutable("elementoGasto: "),__ref.getField(true,"_elementogasto" /*RemoteObject*/ )),0);
 BA.debugLineNum = 991;BA.debugLine="Log(\"areaLabor: \" & areaLabor)";
Debug.ShouldStop(1073741824);
parent.__c.runVoidMethod ("LogImpl","89044073",RemoteObject.concat(RemoteObject.createImmutable("areaLabor: "),__ref.getField(true,"_arealabor" /*RemoteObject*/ )),0);
 BA.debugLineNum = 992;BA.debugLine="Log(\"consecutivo: \" & consecutivo)";
Debug.ShouldStop(-2147483648);
parent.__c.runVoidMethod ("LogImpl","89044074",RemoteObject.concat(RemoteObject.createImmutable("consecutivo: "),__ref.getField(true,"_consecutivo" /*RemoteObject*/ )),0);
 BA.debugLineNum = 993;BA.debugLine="Log(\"areaLote: \" & areaLote)";
Debug.ShouldStop(1);
parent.__c.runVoidMethod ("LogImpl","89044075",RemoteObject.concat(RemoteObject.createImmutable("areaLote: "),__ref.getField(true,"_arealote" /*RemoteObject*/ )),0);
 BA.debugLineNum = 994;BA.debugLine="Log(\"fechaActual: \" & fechaActual)";
Debug.ShouldStop(2);
parent.__c.runVoidMethod ("LogImpl","89044076",RemoteObject.concat(RemoteObject.createImmutable("fechaActual: "),__ref.getField(true,"_fechaactual" /*RemoteObject*/ )),0);
 BA.debugLineNum = 995;BA.debugLine="Log(\"horaSistema: \" & horaSistema)";
Debug.ShouldStop(4);
parent.__c.runVoidMethod ("LogImpl","89044077",RemoteObject.concat(RemoteObject.createImmutable("horaSistema: "),__ref.getField(true,"_horasistema" /*RemoteObject*/ )),0);
 BA.debugLineNum = 996;BA.debugLine="Log(\"user: \" & user)";
Debug.ShouldStop(8);
parent.__c.runVoidMethod ("LogImpl","89044078",RemoteObject.concat(RemoteObject.createImmutable("user: "),__ref.getField(true,"_user" /*RemoteObject*/ )),0);
 BA.debugLineNum = 997;BA.debugLine="Log(\"DeviceName: \" & DeviceName)";
Debug.ShouldStop(16);
parent.__c.runVoidMethod ("LogImpl","89044079",RemoteObject.concat(RemoteObject.createImmutable("DeviceName: "),__ref.getField(true,"_devicename" /*RemoteObject*/ )),0);
...
Debug.ShouldStop(65536);
parent.__c.runVoidMethod ("LogImpl","89044091",RemoteObject.concat(RemoteObject.createImmutable("Error al ejecutar la consulta labor: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(1048576);
parent.__c.runVoidMethod ("LogImpl","89044095",RemoteObject.concat(RemoteObject.createImmutable("Error al agregar datos: "),parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba")).runMethod(true,"getMessage")),0);
 if (true) break;
if (true) break;
...
try {
		Debug.PushSubsStack("ButtonRiego_Click (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,1021);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 1025;BA.debugLine="Dim Req As DBRequestManager";
Debug.ShouldStop(1);
_req = RemoteObject.createNew ("b4a.example.ef.dbrequestmanager");Debug.locals.put("Req", _req);
 BA.debugLineNum = 1026;BA.debugLine="Req.Initialize(Me, rdcLink & \"?DBName=\" & Main.pD";
Debug.ShouldStop(2);
_req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(__ref),(Object)(RemoteObject.concat(__ref.getField(true,"_rdclink" /*RemoteObject*/ ),RemoteObject.createImmutable("?DBName="),parent._main._pdbname /*RemoteObject*/ )));
 BA.debugLineNum = 1029;BA.debugLine="Dim cmd As DBCommand = CreateCommand(\"insert_labo";
Debug.ShouldStop(16);
_cmd = __ref.runClassMethod (b4a.example.ef.formlabores.class, "_createcommand" /*RemoteObject*/ ,(Object)(BA.ObjectToString("insert_laborRiego")),(Object)(RemoteObject.createNewArray("Object",new int[] {5},new Object[] {(__ref.getField(true,"_consecutivo" /*RemoteObject*/ )),(__ref.getField(true,"_tiporiego" /*RemoteObject*/ )),(__ref.getField(true,"_procedenciariego" /*RemoteObject*/ )),(__ref.getField(true,"_caudalriego" /*RemoteObject*/ )),(__ref.getField(true,"_cantidadriego" /*RemoteObject*/ ))})));Debug.locals.put("cmd", _cmd);Debug.locals.put("cmd", _cmd);
 BA.debugLineNum = 1032;BA.debugLine="Log(\"Comando SQL: insert_laborRiego\")";
Debug.ShouldStop(128);
parent.__c.runVoidMethod ("LogImpl","89109515",RemoteObject.createImmutable("Comando SQL: insert_laborRiego"),0);
 BA.debugLineNum = 1033;BA.debugLine="Log(\"Parámetro 1 - consecutivo: \" & consecutivo)";
Debug.ShouldStop(256);
parent.__c.runVoidMethod ("LogImpl","89109516",RemoteObject.concat(RemoteObject.createImmutable("Parámetro 1 - consecutivo: "),__ref.getField(true,"_consecutivo" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1034;BA.debugLine="Log(\"Parámetro 2 - tipoRiego: \" & tipoRiego)";
Debug.ShouldStop(512);
parent.__c.runVoidMethod ("LogImpl","89109517",RemoteObject.concat(RemoteObject.createImmutable("Parámetro 2 - tipoRiego: "),__ref.getField(true,"_tiporiego" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1035;BA.debugLine="Log(\"Parámetro 3 - procedenciaRiego: \" & proceden";
Debug.ShouldStop(1024);
parent.__c.runVoidMethod ("LogImpl","89109518",RemoteObject.concat(RemoteObject.createImmutable("Parámetro 3 - procedenciaRiego: "),__ref.getField(true,"_procedenciariego" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1036;BA.debugLine="Log(\"Parámetro 4 - caudalRiego: \" & caudalRiego)";
Debug.ShouldStop(2048);
parent.__c.runVoidMethod ("LogImpl","89109519",RemoteObject.concat(RemoteObject.createImmutable("Parámetro 4 - caudalRiego: "),__ref.getField(true,"_caudalriego" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1037;BA.debugLine="Log(\"Parámetro 5 - cantidadRiego: \" & cantidadRie";
Debug.ShouldStop(4096);
parent.__c.runVoidMethod ("LogImpl","89109520",RemoteObject.concat(RemoteObject.createImmutable("Parámetro 5 - cantidadRiego: "),__ref.getField(true,"_cantidadriego" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1039;BA.debugLine="Dim j As HttpJob = Req.ExecuteCommand(cmd, Null)";
Debug.ShouldStop(16384);
_j = _req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_executecommand" /*RemoteObject*/ ,(Object)(_cmd),(Object)(parent.__c.getField(false,"Null")));Debug.locals.put("j", _j);Debug.locals.put("j", _j);
 BA.debugLineNum = 1040;BA.debugLine="Wait For(j) JobDone(j As HttpJob)";
Debug.ShouldStop(32768);
...
this.state = 4;
this.catchState = 11;
 BA.debugLineNum = 1044;BA.debugLine="If j.Success Then";
Debug.ShouldStop(524288);
if (true) break;
...
//C
this.state = 9;
 BA.debugLineNum = 1045;BA.debugLine="MsgboxAsync(\"Se ha insertado correctamente. Rie";
Debug.ShouldStop(1048576);
parent.__c.runVoidMethod ("MsgboxAsync",(Object)(BA.ObjectToCharSequence("Se ha insertado correctamente. Riego")),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Éxito"))),__ref.getField(false, "ba"));
 if (true) break;

case 8:
//C
this.state = 9;
 BA.debugLineNum = 1047;BA.debugLine="Log(\"Error al ejecutar la consulta: \" & j.Error";
Debug.ShouldStop(4194304);
parent.__c.runVoidMethod ("LogImpl","89109530",RemoteObject.concat(RemoteObject.createImmutable("Error al ejecutar la consulta: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(33554432);
parent.__c.runVoidMethod ("LogImpl","89109533",RemoteObject.concat(RemoteObject.createImmutable("Error al agregar datos: "),parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba")).runMethod(true,"getMessage")),0);
 if (true) break;
if (true) break;
...
this.catchState = 0;
;
 BA.debugLineNum = 1054;BA.debugLine="Dim horaSistema As String = DateTime.Time(DateTim";
Debug.ShouldStop(536870912);
parent._horasistema = parent.__c.getField(false,"DateTime").runMethod(true,"Time",(Object)(parent.__c.getField(false,"DateTime").runMethod(true,"getNow")));__ref.setField("_horasistema",parent._horasistema);
 BA.debugLineNum = 1055;BA.debugLine="user = Main.pUser";
Debug.ShouldStop(1073741824);
__ref.setField ("_user" /*RemoteObject*/ ,parent._main._puser /*RemoteObject*/ );
 BA.debugLineNum = 1056;BA.debugLine="DeviceName = GetDeviceName";
Debug.ShouldStop(-2147483648);
__ref.setField ("_devicename" /*RemoteObject*/ ,__ref.runClassMethod (b4a.example.ef.formlabores.class, "_getdevicename" /*RemoteObject*/ ));
 BA.debugLineNum = 1057;BA.debugLine="Dim fecha As Long = DateTime.Now ' Obtiene el tie";
Debug.ShouldStop(1);
_fecha = parent.__c.getField(false,"DateTime").runMethod(true,"getNow");Debug.locals.put("fecha", _fecha);Debug.locals.put("fecha", _fecha);
 BA.debugLineNum = 1058;BA.debugLine="DateTime.DateFormat = \"yyyy-MM-dd HH:mm:ss\" ' Con";
Debug.ShouldStop(2);
parent.__c.getField(false,"DateTime").runMethod(true,"setDateFormat",BA.ObjectToString("yyyy-MM-dd HH:mm:ss"));
 BA.debugLineNum = 1059;BA.debugLine="fechaActual = DateTime.Date(fecha) ' Almacena la";
Debug.ShouldStop(4);
__ref.setField ("_fechaactual" /*RemoteObject*/ ,parent.__c.getField(false,"DateTime").runMethod(true,"Date",(Object)(_fecha)));
 BA.debugLineNum = 1061;BA.debugLine="fechafmrto = DateTime.Date(fecha)";
Debug.ShouldStop(16);
__ref.setField ("_fechafmrto" /*RemoteObject*/ ,parent.__c.getField(false,"DateTime").runMethod(true,"Date",(Object)(_fecha)));
 BA.debugLineNum = 1063;BA.debugLine="Dim Req As DBRequestManager";
Debug.ShouldStop(64);
_req = RemoteObject.createNew ("b4a.example.ef.dbrequestmanager");Debug.locals.put("Req", _req);
 BA.debugLineNum = 1064;BA.debugLine="Req.Initialize(Me, rdcLink & \"?DBName=\" & Main.pD";
Debug.ShouldStop(128);
_req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(__ref),(Object)(RemoteObject.concat(__ref.getField(true,"_rdclink" /*RemoteObject*/ ),RemoteObject.createImmutable("?DBName="),parent._main._pdbname /*RemoteObject*/ )));
 BA.debugLineNum = 1067;BA.debugLine="Dim cmd As DBCommand = CreateCommand(\"insert_labo";
Debug.ShouldStop(1024);
_cmd = __ref.runClassMethod (b4a.example.ef.formlabores.class, "_createcommand" /*RemoteObject*/ ,(Object)(BA.ObjectToString("insert_labor")),(Object)(RemoteObject.createNewArray("Object",new int[] {18},new Object[] {(__ref.getField(true,"_nitempresacbx" /*RemoteObject*/ )),(__ref.getField(true,"_haciendacbx" /*RemoteObject*/ )),(__ref.getField(true,"_lotecbx" /*RemoteObject*/ )),RemoteObject.createImmutable(("0000-")),RemoteObject.createImmutable(("CA")),(__ref.getField(true,"_tipolabor" /*RemoteObject*/ )),(__ref.getField(true,"_fechainicio" /*RemoteObject*/ )),(__ref.getField(true,"_fechafin" /*RemoteObject*/ )),(__ref.getField(true,"_elementogasto" /*RemoteObject*/ )),(__ref.getField(true,"_arealabor" /*RemoteObject*/ )),(__ref.getField(true,"_consecutivo" /*RemoteObject*/ )),parent.__c.getField(false,"Null"),(__ref.getField(true,"_arealote" /*RemoteObject*/ )),parent.__c.getField(false,"Null"),(__ref.getField(true,"_fechaactual" /*RemoteObject*/ )),(__ref.getField(true,"_horasistema" /*RemoteObject*/ )),(__ref.getField(true,"_user" /*RemoteObject*/ )),(__ref.getField(true,"_devicename" /*RemoteObject*/ ))})));Debug.locals.put("cmd", _cmd);Debug.locals.put("cmd", _cmd);
 BA.debugLineNum = 1071;BA.debugLine="Log(\"nitEmpresaCBX: \" & nitEmpresaCBX)";
Debug.ShouldStop(16384);
parent.__c.runVoidMethod ("LogImpl","89109554",RemoteObject.concat(RemoteObject.createImmutable("nitEmpresaCBX: "),__ref.getField(true,"_nitempresacbx" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1072;BA.debugLine="Log(\"haciendaCBX: \" & haciendaCBX)";
Debug.ShouldStop(32768);
parent.__c.runVoidMethod ("LogImpl","89109555",RemoteObject.concat(RemoteObject.createImmutable("haciendaCBX: "),__ref.getField(true,"_haciendacbx" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1073;BA.debugLine="Log(\"loteCBX: \" & loteCBX)";
Debug.ShouldStop(65536);
parent.__c.runVoidMethod ("LogImpl","89109556",RemoteObject.concat(RemoteObject.createImmutable("loteCBX: "),__ref.getField(true,"_lotecbx" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1074;BA.debugLine="Log(\"fechafmrto: \" & fechafmrto)";
Debug.ShouldStop(131072);
parent.__c.runVoidMethod ("LogImpl","89109557",RemoteObject.concat(RemoteObject.createImmutable("fechafmrto: "),__ref.getField(true,"_fechafmrto" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1075;BA.debugLine="Log(\"tipoLabor: \" & tipoLabor)";
Debug.ShouldStop(262144);
parent.__c.runVoidMethod ("LogImpl","89109558",RemoteObject.concat(RemoteObject.createImmutable("tipoLabor: "),__ref.getField(true,"_tipolabor" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1076;BA.debugLine="Log(\"fechaInicio: \" & fechaInicio)";
Debug.ShouldStop(524288);
parent.__c.runVoidMethod ("LogImpl","89109559",RemoteObject.concat(RemoteObject.createImmutable("fechaInicio: "),__ref.getField(true,"_fechainicio" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1077;BA.debugLine="Log(\"fechaFin: \" & fechaFin)";
Debug.ShouldStop(1048576);
parent.__c.runVoidMethod ("LogImpl","89109560",RemoteObject.concat(RemoteObject.createImmutable("fechaFin: "),__ref.getField(true,"_fechafin" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1078;BA.debugLine="Log(\"elementoGasto: \" & elementoGasto)";
Debug.ShouldStop(2097152);
parent.__c.runVoidMethod ("LogImpl","89109561",RemoteObject.concat(RemoteObject.createImmutable("elementoGasto: "),__ref.getField(true,"_elementogasto" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1079;BA.debugLine="Log(\"areaLabor: \" & areaLabor)";
Debug.ShouldStop(4194304);
parent.__c.runVoidMethod ("LogImpl","89109562",RemoteObject.concat(RemoteObject.createImmutable("areaLabor: "),__ref.getField(true,"_arealabor" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1080;BA.debugLine="Log(\"consecutivo: \" & consecutivo)";
Debug.ShouldStop(8388608);
parent.__c.runVoidMethod ("LogImpl","89109563",RemoteObject.concat(RemoteObject.createImmutable("consecutivo: "),__ref.getField(true,"_consecutivo" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1081;BA.debugLine="Log(\"areaLote: \" & areaLote)";
Debug.ShouldStop(16777216);
parent.__c.runVoidMethod ("LogImpl","89109564",RemoteObject.concat(RemoteObject.createImmutable("areaLote: "),__ref.getField(true,"_arealote" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1082;BA.debugLine="Log(\"fechaActual: \" & fechaActual)";
Debug.ShouldStop(33554432);
parent.__c.runVoidMethod ("LogImpl","89109565",RemoteObject.concat(RemoteObject.createImmutable("fechaActual: "),__ref.getField(true,"_fechaactual" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1083;BA.debugLine="Log(\"horaSistema: \" & horaSistema)";
Debug.ShouldStop(67108864);
parent.__c.runVoidMethod ("LogImpl","89109566",RemoteObject.concat(RemoteObject.createImmutable("horaSistema: "),__ref.getField(true,"_horasistema" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1084;BA.debugLine="Log(\"user: \" & user)";
Debug.ShouldStop(134217728);
parent.__c.runVoidMethod ("LogImpl","89109567",RemoteObject.concat(RemoteObject.createImmutable("user: "),__ref.getField(true,"_user" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1085;BA.debugLine="Log(\"DeviceName: \" & DeviceName)";
Debug.ShouldStop(268435456);
parent.__c.runVoidMethod ("LogImpl","89109568",RemoteObject.concat(RemoteObject.createImmutable("DeviceName: "),__ref.getField(true,"_devicename" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1087;BA.debugLine="Dim j As HttpJob = Req.ExecuteCommand(cmd, Null)";
Debug.ShouldStop(1073741824);
_j = _req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_executecommand" /*RemoteObject*/ ,(Object)(_cmd),(Object)(parent.__c.getField(false,"Null")));Debug.locals.put("j", _j);Debug.locals.put("j", _j);
 BA.debugLineNum = 1088;BA.debugLine="Wait For(j) JobDone(j As HttpJob)";
Debug.ShouldStop(-2147483648);
parent.__c.runVoidMethod ("WaitFor","jobdone", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "formlabores", "buttonriego_click"), (_j));
this.state = 26;
return;
...
this.state = 16;
this.catchState = 23;
 BA.debugLineNum = 1092;BA.debugLine="If j.Success Then";
Debug.ShouldStop(8);
if (true) break;
...
//C
this.state = 21;
 BA.debugLineNum = 1094;BA.debugLine="MsgboxAsync(\"Se ha insertado correctamente la l";
Debug.ShouldStop(32);
parent.__c.runVoidMethod ("MsgboxAsync",(Object)(BA.ObjectToCharSequence("Se ha insertado correctamente la labor.")),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Éxito"))),__ref.getField(false, "ba"));
 if (true) break;
...
//C
this.state = 21;
 BA.debugLineNum = 1097;BA.debugLine="Log(\"Error al ejecutar la consulta labor: \" & j";
Debug.ShouldStop(256);
parent.__c.runVoidMethod ("LogImpl","89109580",RemoteObject.concat(RemoteObject.createImmutable("Error al ejecutar la consulta labor: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
this.state = 24;
this.catchState = 0;
 BA.debugLineNum = 1101;BA.debugLine="Log(\"Error al agregar datos: \" & LastException.M";
Debug.ShouldStop(4096);
parent.__c.runVoidMethod ("LogImpl","89109584",RemoteObject.concat(RemoteObject.createImmutable("Error al agregar datos: "),parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba")).runMethod(true,"getMessage")),0);
 if (true) break;
if (true) break;
...
try {
		Debug.PushSubsStack("ButtonSimbra_Click (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,1106);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 1108;BA.debugLine="Dim Req As DBRequestManager";
Debug.ShouldStop(524288);
_req = RemoteObject.createNew ("b4a.example.ef.dbrequestmanager");Debug.locals.put("Req", _req);
 BA.debugLineNum = 1109;BA.debugLine="Req.Initialize(Me, rdcLink & \"?DBName=\" & Main.pD";
Debug.ShouldStop(1048576);
_req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(__ref),(Object)(RemoteObject.concat(__ref.getField(true,"_rdclink" /*RemoteObject*/ ),RemoteObject.createImmutable("?DBName="),parent._main._pdbname /*RemoteObject*/ )));
 BA.debugLineNum = 1111;BA.debugLine="Dim cmdUltimoRegistro As DBCommand = CreateComman";
Debug.ShouldStop(4194304);
_cmdultimoregistro = __ref.runClassMethod (b4a.example.ef.formlabores.class, "_createcommand" /*RemoteObject*/ ,(Object)(BA.ObjectToString("select_maxIdSiembra")),(Object)((parent.__c.getField(false,"Null"))));Debug.locals.put("cmdUltimoRegistro", _cmdultimoregistro);Debug.locals.put("cmdUltimoRegistro", _cmdultimoregistro);
 BA.debugLineNum = 1112;BA.debugLine="Wait For (Req.ExecuteQuery(cmdUltimoRegistro, 0,";
Debug.ShouldStop(8388608);
...
_j5 = (RemoteObject) result.getArrayElement(false,RemoteObject.createImmutable(1));Debug.locals.put("j5", _j5);
;
 BA.debugLineNum = 1114;BA.debugLine="If j5.Success Then";
Debug.ShouldStop(33554432);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 1115;BA.debugLine="Req.HandleJobAsync(j5, \"req_ultimoRegistro\")";
Debug.ShouldStop(67108864);
_req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_handlejobasync" /*void*/ ,(Object)(_j5),(Object)(RemoteObject.createImmutable("req_ultimoRegistro")));
 BA.debugLineNum = 1116;BA.debugLine="Wait For (Req) req_ultimoRegistro_Result(resUlti";
Debug.ShouldStop(134217728);
...
_resultimoregistro = (RemoteObject) result.getArrayElement(false,RemoteObject.createImmutable(1));Debug.locals.put("resUltimoRegistro", _resultimoregistro);
;
 BA.debugLineNum = 1118;BA.debugLine="For Each rowRegistro() As Object In resUltimoReg";
Debug.ShouldStop(536870912);
if (true) break;
...
//C
this.state = 38;
 BA.debugLineNum = 1119;BA.debugLine="Dim ultimoRegistroSiembra As Int = rowRegistro(";
Debug.ShouldStop(1073741824);
_ultimoregistrosiembra = BA.numberCast(int.class, _rowregistro.getArrayElement(false,BA.numberCast(int.class, 0)));Debug.locals.put("ultimoRegistroSiembra", _ultimoregistrosiembra);Debug.locals.put("ultimoRegistroSiembra", _ultimoregistrosiembra);
 BA.debugLineNum = 1120;BA.debugLine="Log(\"Último Registro Siembra  obtenido: \" & ult";
Debug.ShouldStop(-2147483648);
parent.__c.runVoidMethod ("LogImpl","89175054",RemoteObject.concat(RemoteObject.createImmutable("Último Registro Siembra  obtenido: "),_ultimoregistrosiembra),0);
 if (true) break;
if (true) break;
...
//C
this.state = 10;
 BA.debugLineNum = 1124;BA.debugLine="Log(\"Error en la consulta select_maxIdLabor: \" &";
Debug.ShouldStop(8);
parent.__c.runVoidMethod ("LogImpl","89175058",RemoteObject.concat(RemoteObject.createImmutable("Error en la consulta select_maxIdLabor: "),_j5.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
this.state = 11;
;
 BA.debugLineNum = 1127;BA.debugLine="consecutivoSiembra = ultimoRegistroSiembra + 1";
Debug.ShouldStop(64);
__ref.setField ("_consecutivosiembra" /*RemoteObject*/ ,RemoteObject.solve(new RemoteObject[] {_ultimoregistrosiembra,RemoteObject.createImmutable(1)}, "+",1, 1));
 BA.debugLineNum = 1129;BA.debugLine="Log(consecutivoSiembra)";
Debug.ShouldStop(256);
parent.__c.runVoidMethod ("LogImpl","89175063",BA.NumberToString(__ref.getField(true,"_consecutivosiembra" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1132;BA.debugLine="Dim cmd As DBCommand = CreateCommand(\"insert_labo";
Debug.ShouldStop(2048);
_cmd = __ref.runClassMethod (b4a.example.ef.formlabores.class, "_createcommand" /*RemoteObject*/ ,(Object)(BA.ObjectToString("insert_laborSiembra")),(Object)(RemoteObject.createNewArray("Object",new int[] {9},new Object[] {(__ref.getField(true,"_consecutivosiembra" /*RemoteObject*/ )),(__ref.getField(true,"_codigosiembra" /*RemoteObject*/ )),(__ref.getField(true,"_distanciasiembra" /*RemoteObject*/ )),(__ref.getField(true,"_toneladasemillasiembra" /*RemoteObject*/ )),(__ref.getField(true,"_numeropaquetessiembra" /*RemoteObject*/ )),(__ref.getField(true,"_procedenciasiembra" /*RemoteObject*/ )),(__ref.getField(true,"_tipolabranzasiembra" /*RemoteObject*/ )),(__ref.getField(true,"_bandereosiembra" /*RemoteObject*/ )),(__ref.getField(true,"_numeromacollosiembra" /*RemoteObject*/ ))})));Debug.locals.put("cmd", _cmd);Debug.locals.put("cmd", _cmd);
 BA.debugLineNum = 1135;BA.debugLine="Log(\"Comando SQL: insert_laborSiembra\")";
Debug.ShouldStop(16384);
parent.__c.runVoidMethod ("LogImpl","89175069",RemoteObject.createImmutable("Comando SQL: insert_laborSiembra"),0);
 BA.debugLineNum = 1136;BA.debugLine="Log(\"Parámetro 1 - consecutivoSiembra: \" & consec";
Debug.ShouldStop(32768);
parent.__c.runVoidMethod ("LogImpl","89175070",RemoteObject.concat(RemoteObject.createImmutable("Parámetro 1 - consecutivoSiembra: "),__ref.getField(true,"_consecutivosiembra" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1137;BA.debugLine="Log(\"Parámetro 2 - codigoSiembra: \" & codigoSiemb";
Debug.ShouldStop(65536);
parent.__c.runVoidMethod ("LogImpl","89175071",RemoteObject.concat(RemoteObject.createImmutable("Parámetro 2 - codigoSiembra: "),__ref.getField(true,"_codigosiembra" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1138;BA.debugLine="Log(\"Parámetro 3 - distanciaSiembra: \" & distanci";
Debug.ShouldStop(131072);
parent.__c.runVoidMethod ("LogImpl","89175072",RemoteObject.concat(RemoteObject.createImmutable("Parámetro 3 - distanciaSiembra: "),__ref.getField(true,"_distanciasiembra" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1139;BA.debugLine="Log(\"Parámetro 4 - toneladaSemillaSiembra: \" & to";
Debug.ShouldStop(262144);
parent.__c.runVoidMethod ("LogImpl","89175073",RemoteObject.concat(RemoteObject.createImmutable("Parámetro 4 - toneladaSemillaSiembra: "),__ref.getField(true,"_toneladasemillasiembra" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1140;BA.debugLine="Log(\"Parámetro 5 - numeroPaquetesSiembra: \" & num";
Debug.ShouldStop(524288);
parent.__c.runVoidMethod ("LogImpl","89175074",RemoteObject.concat(RemoteObject.createImmutable("Parámetro 5 - numeroPaquetesSiembra: "),__ref.getField(true,"_numeropaquetessiembra" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1141;BA.debugLine="Log(\"Parámetro 6 - procedenciaSiembra: \" & proced";
Debug.ShouldStop(1048576);
parent.__c.runVoidMethod ("LogImpl","89175075",RemoteObject.concat(RemoteObject.createImmutable("Parámetro 6 - procedenciaSiembra: "),__ref.getField(true,"_procedenciasiembra" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1142;BA.debugLine="Log(\"Parámetro 7 - tipoLabranzaSiembra: \" & tipoL";
Debug.ShouldStop(2097152);
parent.__c.runVoidMethod ("LogImpl","89175076",RemoteObject.concat(RemoteObject.createImmutable("Parámetro 7 - tipoLabranzaSiembra: "),__ref.getField(true,"_tipolabranzasiembra" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1143;BA.debugLine="Log(\"Parámetro 8 - bandereoSiembra: \" & bandereoS";
Debug.ShouldStop(4194304);
parent.__c.runVoidMethod ("LogImpl","89175077",RemoteObject.concat(RemoteObject.createImmutable("Parámetro 8 - bandereoSiembra: "),__ref.getField(true,"_bandereosiembra" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1144;BA.debugLine="Log(\"Parámetro 9 - numeroMacolloSiembra: \" & nume";
Debug.ShouldStop(8388608);
parent.__c.runVoidMethod ("LogImpl","89175078",RemoteObject.concat(RemoteObject.createImmutable("Parámetro 9 - numeroMacolloSiembra: "),__ref.getField(true,"_numeromacollosiembra" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1147;BA.debugLine="Dim j As HttpJob = Req.ExecuteCommand(cmd, Null)";
Debug.ShouldStop(67108864);
_j = _req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_executecommand" /*RemoteObject*/ ,(Object)(_cmd),(Object)(parent.__c.getField(false,"Null")));Debug.locals.put("j", _j);Debug.locals.put("j", _j);
 BA.debugLineNum = 1148;BA.debugLine="Wait For(j) JobDone(j As HttpJob)";
Debug.ShouldStop(134217728);
...
this.state = 14;
this.catchState = 21;
 BA.debugLineNum = 1152;BA.debugLine="If j.Success Then";
Debug.ShouldStop(-2147483648);
if (true) break;
...
//C
this.state = 19;
 BA.debugLineNum = 1153;BA.debugLine="Log(\"Datos insertados correctamente en insert_l";
Debug.ShouldStop(1);
parent.__c.runVoidMethod ("LogImpl","89175087",RemoteObject.createImmutable("Datos insertados correctamente en insert_laborSiembra"),0);
 BA.debugLineNum = 1154;BA.debugLine="ToastMessageShow(\"Datos de Siembra guardados co";
Debug.ShouldStop(2);
parent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("Datos de Siembra guardados con éxito")),(Object)(parent.__c.getField(true,"False")));
 if (true) break;

case 18:
//C
this.state = 19;
 BA.debugLineNum = 1156;BA.debugLine="ToastMessageShow(\"Error al guardar los datos\",";
Debug.ShouldStop(8);
parent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("Error al guardar los datos")),(Object)(parent.__c.getField(true,"True")));
 if (true) break;
...
this.state = 22;
this.catchState = 0;
 BA.debugLineNum = 1160;BA.debugLine="Log(\"Excepción capturada: \" & LastException)";
Debug.ShouldStop(128);
parent.__c.runVoidMethod ("LogImpl","89175094",RemoteObject.concat(RemoteObject.createImmutable("Excepción capturada: "),parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 BA.debugLineNum = 1161;BA.debugLine="ToastMessageShow(\"Se produjo un error inesperado";
Debug.ShouldStop(256);
...
this.catchState = 0;
;
 BA.debugLineNum = 1165;BA.debugLine="Dim horaSistema As String = DateTime.Time(DateTim";
Debug.ShouldStop(4096);
parent._horasistema = parent.__c.getField(false,"DateTime").runMethod(true,"Time",(Object)(parent.__c.getField(false,"DateTime").runMethod(true,"getNow")));__ref.setField("_horasistema",parent._horasistema);
 BA.debugLineNum = 1166;BA.debugLine="user = Main.pUser";
Debug.ShouldStop(8192);
__ref.setField ("_user" /*RemoteObject*/ ,parent._main._puser /*RemoteObject*/ );
 BA.debugLineNum = 1167;BA.debugLine="DeviceName = GetDeviceName";
Debug.ShouldStop(16384);
__ref.setField ("_devicename" /*RemoteObject*/ ,__ref.runClassMethod (b4a.example.ef.formlabores.class, "_getdevicename" /*RemoteObject*/ ));
 BA.debugLineNum = 1168;BA.debugLine="Dim fecha As Long = DateTime.Now ' Obtiene el tie";
Debug.ShouldStop(32768);
_fecha = parent.__c.getField(false,"DateTime").runMethod(true,"getNow");Debug.locals.put("fecha", _fecha);Debug.locals.put("fecha", _fecha);
 BA.debugLineNum = 1169;BA.debugLine="DateTime.DateFormat = \"yyyy-MM-dd HH:mm:ss\" ' Con";
Debug.ShouldStop(65536);
parent.__c.getField(false,"DateTime").runMethod(true,"setDateFormat",BA.ObjectToString("yyyy-MM-dd HH:mm:ss"));
 BA.debugLineNum = 1170;BA.debugLine="fechaActual = DateTime.Date(fecha) ' Almacena la";
Debug.ShouldStop(131072);
__ref.setField ("_fechaactual" /*RemoteObject*/ ,parent.__c.getField(false,"DateTime").runMethod(true,"Date",(Object)(_fecha)));
 BA.debugLineNum = 1172;BA.debugLine="fechafmrto = DateTime.Date(fecha)";
Debug.ShouldStop(524288);
__ref.setField ("_fechafmrto" /*RemoteObject*/ ,parent.__c.getField(false,"DateTime").runMethod(true,"Date",(Object)(_fecha)));
 BA.debugLineNum = 1174;BA.debugLine="Dim Req As DBRequestManager";
Debug.ShouldStop(2097152);
_req = RemoteObject.createNew ("b4a.example.ef.dbrequestmanager");Debug.locals.put("Req", _req);
 BA.debugLineNum = 1175;BA.debugLine="Req.Initialize(Me, rdcLink & \"?DBName=\" & Main.pD";
Debug.ShouldStop(4194304);
_req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(__ref),(Object)(RemoteObject.concat(__ref.getField(true,"_rdclink" /*RemoteObject*/ ),RemoteObject.createImmutable("?DBName="),parent._main._pdbname /*RemoteObject*/ )));
 BA.debugLineNum = 1178;BA.debugLine="Dim cmd As DBCommand = CreateCommand(\"insert_labo";
Debug.ShouldStop(33554432);
_cmd = __ref.runClassMethod (b4a.example.ef.formlabores.class, "_createcommand" /*RemoteObject*/ ,(Object)(BA.ObjectToString("insert_labor")),(Object)(RemoteObject.createNewArray("Object",new int[] {18},new Object[] {(__ref.getField(true,"_nitempresacbx" /*RemoteObject*/ )),(__ref.getField(true,"_haciendacbx" /*RemoteObject*/ )),(__ref.getField(true,"_lotecbx" /*RemoteObject*/ )),RemoteObject.createImmutable(("0000-")),RemoteObject.createImmutable(("CA")),(__ref.getField(true,"_tipolabor" /*RemoteObject*/ )),(__ref.getField(true,"_fechainicio" /*RemoteObject*/ )),(__ref.getField(true,"_fechafin" /*RemoteObject*/ )),(__ref.getField(true,"_elementogasto" /*RemoteObject*/ )),(__ref.getField(true,"_arealabor" /*RemoteObject*/ )),(__ref.getField(true,"_consecutivo" /*RemoteObject*/ )),parent.__c.getField(false,"Null"),(__ref.getField(true,"_arealote" /*RemoteObject*/ )),parent.__c.getField(false,"Null"),(__ref.getField(true,"_fechaactual" /*RemoteObject*/ )),(__ref.getField(true,"_horasistema" /*RemoteObject*/ )),(__ref.getField(true,"_user" /*RemoteObject*/ )),(__ref.getField(true,"_devicename" /*RemoteObject*/ ))})));Debug.locals.put("cmd", _cmd);Debug.locals.put("cmd", _cmd);
 BA.debugLineNum = 1182;BA.debugLine="Log(\"nitEmpresaCBX: \" & nitEmpresaCBX)";
Debug.ShouldStop(536870912);
parent.__c.runVoidMethod ("LogImpl","89175116",RemoteObject.concat(RemoteObject.createImmutable("nitEmpresaCBX: "),__ref.getField(true,"_nitempresacbx" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1183;BA.debugLine="Log(\"haciendaCBX: \" & haciendaCBX)";
Debug.ShouldStop(1073741824);
parent.__c.runVoidMethod ("LogImpl","89175117",RemoteObject.concat(RemoteObject.createImmutable("haciendaCBX: "),__ref.getField(true,"_haciendacbx" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1184;BA.debugLine="Log(\"loteCBX: \" & loteCBX)";
Debug.ShouldStop(-2147483648);
parent.__c.runVoidMethod ("LogImpl","89175118",RemoteObject.concat(RemoteObject.createImmutable("loteCBX: "),__ref.getField(true,"_lotecbx" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1185;BA.debugLine="Log(\"fechafmrto: \" & fechafmrto)";
Debug.ShouldStop(1);
parent.__c.runVoidMethod ("LogImpl","89175119",RemoteObject.concat(RemoteObject.createImmutable("fechafmrto: "),__ref.getField(true,"_fechafmrto" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1186;BA.debugLine="Log(\"tipoLabor: \" & tipoLabor)";
Debug.ShouldStop(2);
parent.__c.runVoidMethod ("LogImpl","89175120",RemoteObject.concat(RemoteObject.createImmutable("tipoLabor: "),__ref.getField(true,"_tipolabor" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1187;BA.debugLine="Log(\"fechaInicio: \" & fechaInicio)";
Debug.ShouldStop(4);
parent.__c.runVoidMethod ("LogImpl","89175121",RemoteObject.concat(RemoteObject.createImmutable("fechaInicio: "),__ref.getField(true,"_fechainicio" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1188;BA.debugLine="Log(\"fechaFin: \" & fechaFin)";
Debug.ShouldStop(8);
parent.__c.runVoidMethod ("LogImpl","89175122",RemoteObject.concat(RemoteObject.createImmutable("fechaFin: "),__ref.getField(true,"_fechafin" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1189;BA.debugLine="Log(\"elementoGasto: \" & elementoGasto)";
Debug.ShouldStop(16);
parent.__c.runVoidMethod ("LogImpl","89175123",RemoteObject.concat(RemoteObject.createImmutable("elementoGasto: "),__ref.getField(true,"_elementogasto" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1190;BA.debugLine="Log(\"areaLabor: \" & areaLabor)";
Debug.ShouldStop(32);
parent.__c.runVoidMethod ("LogImpl","89175124",RemoteObject.concat(RemoteObject.createImmutable("areaLabor: "),__ref.getField(true,"_arealabor" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1191;BA.debugLine="Log(\"consecutivo: \" & consecutivo)";
Debug.ShouldStop(64);
parent.__c.runVoidMethod ("LogImpl","89175125",RemoteObject.concat(RemoteObject.createImmutable("consecutivo: "),__ref.getField(true,"_consecutivo" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1192;BA.debugLine="Log(\"areaLote: \" & areaLote)";
Debug.ShouldStop(128);
parent.__c.runVoidMethod ("LogImpl","89175126",RemoteObject.concat(RemoteObject.createImmutable("areaLote: "),__ref.getField(true,"_arealote" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1193;BA.debugLine="Log(\"fechaActual: \" & fechaActual)";
Debug.ShouldStop(256);
parent.__c.runVoidMethod ("LogImpl","89175127",RemoteObject.concat(RemoteObject.createImmutable("fechaActual: "),__ref.getField(true,"_fechaactual" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1194;BA.debugLine="Log(\"horaSistema: \" & horaSistema)";
Debug.ShouldStop(512);
parent.__c.runVoidMethod ("LogImpl","89175128",RemoteObject.concat(RemoteObject.createImmutable("horaSistema: "),__ref.getField(true,"_horasistema" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1195;BA.debugLine="Log(\"user: \" & user)";
Debug.ShouldStop(1024);
parent.__c.runVoidMethod ("LogImpl","89175129",RemoteObject.concat(RemoteObject.createImmutable("user: "),__ref.getField(true,"_user" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1196;BA.debugLine="Log(\"DeviceName: \" & DeviceName)";
Debug.ShouldStop(2048);
parent.__c.runVoidMethod ("LogImpl","89175130",RemoteObject.concat(RemoteObject.createImmutable("DeviceName: "),__ref.getField(true,"_devicename" /*RemoteObject*/ )),0);
 BA.debugLineNum = 1198;BA.debugLine="Dim j As HttpJob = Req.ExecuteCommand(cmd, Null)";
Debug.ShouldStop(8192);
_j = _req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_executecommand" /*RemoteObject*/ ,(Object)(_cmd),(Object)(parent.__c.getField(false,"Null")));Debug.locals.put("j", _j);Debug.locals.put("j", _j);
 BA.debugLineNum = 1199;BA.debugLine="Wait For(j) JobDone(j As HttpJob)";
Debug.ShouldStop(16384);
parent.__c.runVoidMethod ("WaitFor","jobdone", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "formlabores", "buttonsimbra_click"), (_j));
this.state = 40;
return;
...
this.state = 26;
this.catchState = 33;
 BA.debugLineNum = 1203;BA.debugLine="If j.Success Then";
Debug.ShouldStop(262144);
if (true) break;
...
//C
this.state = 31;
 BA.debugLineNum = 1205;BA.debugLine="MsgboxAsync(\"Se ha insertado correctamente la l";
Debug.ShouldStop(1048576);
parent.__c.runVoidMethod ("MsgboxAsync",(Object)(BA.ObjectToCharSequence("Se ha insertado correctamente la labor.")),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Éxito"))),__ref.getField(false, "ba"));
 if (true) break;
...
//C
this.state = 31;
 BA.debugLineNum = 1208;BA.debugLine="Log(\"Error al ejecutar la consulta labor: \" & j";
Debug.ShouldStop(8388608);
parent.__c.runVoidMethod ("LogImpl","89175142",RemoteObject.concat(RemoteObject.createImmutable("Error al ejecutar la consulta labor: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
this.state = 34;
this.catchState = 0;
 BA.debugLineNum = 1212;BA.debugLine="Log(\"Error al agregar datos: \" & LastException.M";
Debug.ShouldStop(134217728);
parent.__c.runVoidMethod ("LogImpl","89175146",RemoteObject.concat(RemoteObject.createImmutable("Error al agregar datos: "),parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba")).runMethod(true,"getMessage")),0);
 if (true) break;
if (true) break;
...
try {
		Debug.PushSubsStack("CreateCommand (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,421);
...
try {
		Debug.PushSubsStack("CreateItem (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,291);
...
try {
		Debug.PushSubsStack("CreateItemInsumo (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,331);
...
try {
		Debug.PushSubsStack("CreateItemRiego (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,305);
...
try {
		Debug.PushSubsStack("CreateItemSiembra (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,318);
...
try {
		Debug.PushSubsStack("EditTextAreaLabor_TextChanged (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,533);
...
Debug.ShouldStop(16777216);
formlabores.__c.runVoidMethod ("LogImpl","87208964",RemoteObject.concat(RemoteObject.createImmutable("Area Labor "),__ref.getField(true,"_arealabor" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("EditTextAreaLote_TextChanged (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,541);
...
Debug.ShouldStop(1);
formlabores.__c.runVoidMethod ("LogImpl","87274500",RemoteObject.concat(RemoteObject.createImmutable("Area lote "),__ref.getField(true,"_arealote" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("EditTextBandereo_TextChanged (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,661);
...
Debug.ShouldStop(16777216);
formlabores.__c.runVoidMethod ("LogImpl","87995396",RemoteObject.concat(RemoteObject.createImmutable("bandereo "),__ref.getField(true,"_bandereosiembra" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("EditTextCantidadAgua_TextChanged (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,602);
...
Debug.ShouldStop(268435456);
formlabores.__c.runVoidMethod ("LogImpl","87536643",RemoteObject.concat(RemoteObject.createImmutable("cantidad"),__ref.getField(true,"_cantidadriego" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("EditTextCantidadInsumo_TextChanged (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,816);
...
try {
		Debug.PushSubsStack("EditTextCaudalAplicado_TextChanged (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,596);
...
Debug.ShouldStop(4194304);
formlabores.__c.runVoidMethod ("LogImpl","87471107",RemoteObject.concat(RemoteObject.createImmutable("caudal"),__ref.getField(true,"_caudalriego" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("EditTextDistanciaSiembra_TextChanged (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,655);
...
Debug.ShouldStop(131072);
formlabores.__c.runVoidMethod ("LogImpl","87929859",RemoteObject.concat(RemoteObject.createImmutable("Distancia de siembra "),__ref.getField(true,"_distanciasiembra" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("EditTextNumeroMacollos_TextChanged (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,695);
...
Debug.ShouldStop(33554432);
formlabores.__c.runVoidMethod ("LogImpl","88323075",RemoteObject.concat(RemoteObject.createImmutable("numero de macollos "),__ref.getField(true,"_numeromacollosiembra" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("EditTextNumeroPaquetes_TextChanged (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,688);
...
Debug.ShouldStop(524288);
formlabores.__c.runVoidMethod ("LogImpl","88257540",RemoteObject.concat(RemoteObject.createImmutable("numero de paquetes "),__ref.getField(true,"_numeropaquetessiembra" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("EditTextProcedencia_TextChanged (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,589);
...
Debug.ShouldStop(65536);
formlabores.__c.runVoidMethod ("LogImpl","87405572",RemoteObject.concat(RemoteObject.createImmutable("procedencia"),__ref.getField(true,"_procedenciariego" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("EditTextProcedenciaDestino_TextChanged (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,675);
...
Debug.ShouldStop(32);
formlabores.__c.runVoidMethod ("LogImpl","88126467",RemoteObject.concat(RemoteObject.createImmutable("procedencia "),__ref.getField(true,"_procedenciasiembra" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("EditTextToneladaSemilla_TextChanged (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,668);
...
Debug.ShouldStop(-2147483648);
formlabores.__c.runVoidMethod ("LogImpl","88060932",RemoteObject.concat(RemoteObject.createImmutable("tonelada Semilla "),__ref.getField(true,"_toneladasemillasiembra" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("GetDeviceName (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,118);
...
try {
		Debug.PushSubsStack("Initialize (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,103);
...
try {
		Debug.PushSubsStack("Label13Time_Click (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,346);
...
try {
		Debug.PushSubsStack("Label14Time_Click (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,350);
...
try {
		Debug.PushSubsStack("Label1Back_Click (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,881);
...
try {
		Debug.PushSubsStack("LlenarComboBoxInsumo (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,782);
...
Debug.ShouldStop(4);
parent.__c.runVoidMethod ("LogImpl","88519701",RemoteObject.concat(RemoteObject.createImmutable("Error en la consulta de NITs: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
try {
		Debug.PushSubsStack("LlenarComboBoxRiego (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,703);
...
Debug.ShouldStop(524288);
parent.__c.runVoidMethod ("LogImpl","88388629",RemoteObject.concat(RemoteObject.createImmutable("Error en la consulta de NITs: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
try {
		Debug.PushSubsStack("LlenarComboBoxSiembra (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,731);
...
Debug.ShouldStop(524288);
parent.__c.runVoidMethod ("LogImpl","88454169",RemoteObject.concat(RemoteObject.createImmutable("Error en la consulta de NITs: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(64);
parent.__c.runVoidMethod ("LogImpl","88454188",RemoteObject.concat(RemoteObject.createImmutable("Error en la consulta de Tipo_Labranza: "),_j4.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
try {
		Debug.PushSubsStack("RemoveForm0IfExists (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,617);
...
try {
		Debug.PushSubsStack("RemoveForm2IfExists (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,628);
...
try {
		Debug.PushSubsStack("RemoveForm3IfExists (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,638);
...
try {
		Debug.PushSubsStack("RemoveInsumoFromData (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,865);
...
try {
		Debug.PushSubsStack("SD_xComboBoxCodigoVariedad_ItemClick (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,649);
...
Debug.ShouldStop(2048);
formlabores.__c.runVoidMethod ("LogImpl","87864323",RemoteObject.concat(RemoteObject.createImmutable("codigo "),__ref.getField(true,"_codigosiembra" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("SD_xComboBoxElemento_ItemClick (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,516);
...
Debug.ShouldStop(65536);
formlabores.__c.runVoidMethod ("LogImpl","87143437",RemoteObject.concat(RemoteObject.createImmutable("Las dos primeras letras (o menos si no hay suficientes): "),__ref.getField(true,"_elementogasto" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("SD_xComboBoxHacienda_ItemClick (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,466);
...
Debug.ShouldStop(4096);
parent.__c.runVoidMethod ("LogImpl","86946843",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(524288);
parent.__c.runVoidMethod ("LogImpl","86946850",RemoteObject.concat(RemoteObject.createImmutable("Hacienda"),__ref.getField(true,"_haciendacbx" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("SD_xComboBoxInsumo_ItemClick (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,810);
...
try {
		Debug.PushSubsStack("SD_xComboBoxLabor_ItemClick (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,509);
...
Debug.ShouldStop(1);
formlabores.__c.runVoidMethod ("LogImpl","87077892",RemoteObject.concat(RemoteObject.createImmutable("Elemento labor"),__ref.getField(true,"_elementolabor" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("SD_xComboBoxLote_ItemClick (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,503);
...
Debug.ShouldStop(33554432);
formlabores.__c.runVoidMethod ("LogImpl","87012355",RemoteObject.concat(RemoteObject.createImmutable("Lotecbx"),__ref.getField(true,"_lotecbx" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("SD_xComboBoxNit_ItemClick (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,429);
...
Debug.ShouldStop(256);
parent.__c.runVoidMethod ("LogImpl","86881308",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(16384);
parent.__c.runVoidMethod ("LogImpl","86881314",RemoteObject.concat(RemoteObject.createImmutable("Nit seleccionado"),__ref.getField(true,"_nitempresacbx" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("SD_xComboBoxTipoLabranza_ItemClick (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,681);
...
Debug.ShouldStop(4096);
formlabores.__c.runVoidMethod ("LogImpl","88192004",RemoteObject.concat(RemoteObject.createImmutable("tipo labranza "),__ref.getField(true,"_tipolabranzasiembra" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("SD_xComboBoxTipoRiego_ItemClick (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,609);
...
Debug.ShouldStop(8);
formlabores.__c.runVoidMethod ("LogImpl","87602179",RemoteObject.concat(RemoteObject.createImmutable("tipo riego"),__ref.getField(true,"_tiporiego" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("SD_xComboBoxTypeForm_ItemClick (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,548);
...
Debug.ShouldStop(8);
formlabores.__c.runVoidMethod ("LogImpl","87340064",RemoteObject.concat(RemoteObject.createImmutable("Valor no reconocido: "),_value),0);
 break; }
}
;
 }else {
...
Debug.ShouldStop(64);
formlabores.__c.runVoidMethod ("LogImpl","87340067",RemoteObject.createImmutable("Error: Value no es un número válido."),0);
 };
 BA.debugLineNum = 586;BA.debugLine="Log(\"Tipo labor \" & tipoLabor)";
Debug.ShouldStop(512);
formlabores.__c.runVoidMethod ("LogImpl","87340070",RemoteObject.concat(RemoteObject.createImmutable("Tipo labor "),__ref.getField(true,"_tipolabor" /*RemoteObject*/ )),0);
...
try {
		Debug.PushSubsStack("SwiftButtonElemento_Click (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,1344);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 1345;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateEleme";
Debug.ShouldStop(1);
...
;
 BA.debugLineNum = 1347;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
Debug.ShouldStop(4);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 1348;BA.debugLine="SwiftButtonElemento.xLBL.Text = SearchTemplateEl";
Debug.ShouldStop(8);
__ref.getField(false,"_swiftbuttonelemento" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(__ref.getField(false,"_searchtemplateelemento" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));
 BA.debugLineNum = 1349;BA.debugLine="Dim Partes() As String = Regex.Split(\":\", Search";
Debug.ShouldStop(16);
_partes = parent.__c.getField(false,"Regex").runMethod(false,"Split",(Object)(BA.ObjectToString(":")),(Object)(__ref.getField(false,"_searchtemplateelemento" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));Debug.locals.put("Partes", _partes);Debug.locals.put("Partes", _partes);
 BA.debugLineNum = 1350;BA.debugLine="elementoGasto = Partes(0) ' Asignar solo la prim";
Debug.ShouldStop(32);
__ref.setField ("_elementogasto" /*RemoteObject*/ ,_partes.getArrayElement(true,BA.numberCast(int.class, 0)));
 BA.debugLineNum = 1353;BA.debugLine="If elementoGasto.Length >= 2 Then";
Debug.ShouldStop(256);
if (true) break;
...
//C
this.state = 9;
 BA.debugLineNum = 1354;BA.debugLine="elementoGasto = elementoGasto.SubString2(0, 2)";
Debug.ShouldStop(512);
...
//C
this.state = 9;
 BA.debugLineNum = 1357;BA.debugLine="elementoGasto = elementoGasto";
Debug.ShouldStop(4096);
...
this.state = -1;
;
 BA.debugLineNum = 1360;BA.debugLine="Log(elementoGasto)";
Debug.ShouldStop(32768);
parent.__c.runVoidMethod ("LogImpl","89502736",__ref.getField(true,"_elementogasto" /*RemoteObject*/ ),0);
...
try {
		Debug.PushSubsStack("SwiftButtonHacienda_Click (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,1270);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 1271;BA.debugLine="Dim ItemsLote As List";
Debug.ShouldStop(4194304);
_itemslote = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("ItemsLote", _itemslote);
 BA.debugLineNum = 1272;BA.debugLine="ItemsLote.Initialize";
Debug.ShouldStop(8388608);
_itemslote.runVoidMethod ("Initialize");
 BA.debugLineNum = 1274;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateHacie";
Debug.ShouldStop(33554432);
...
_result = (RemoteObject) result.getArrayElement(true,RemoteObject.createImmutable(1));Debug.locals.put("Result", _result);
;
 BA.debugLineNum = 1275;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
Debug.ShouldStop(67108864);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 1276;BA.debugLine="SwiftButtonHacienda.xLBL.Text = SearchTemplateHa";
Debug.ShouldStop(134217728);
__ref.getField(false,"_swiftbuttonhacienda" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(__ref.getField(false,"_searchtemplatehacienda" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));
 BA.debugLineNum = 1277;BA.debugLine="Dim HACIENDACOMPLETO As String = SearchTemplateH";
Debug.ShouldStop(268435456);
_haciendacompleto = __ref.getField(false,"_searchtemplatehacienda" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ );Debug.locals.put("HACIENDACOMPLETO", _haciendacompleto);Debug.locals.put("HACIENDACOMPLETO", _haciendacompleto);
 BA.debugLineNum = 1278;BA.debugLine="Dim Partes() As String = Regex.Split(\":\", HACIEN";
Debug.ShouldStop(536870912);
_partes = parent.__c.getField(false,"Regex").runMethod(false,"Split",(Object)(BA.ObjectToString(":")),(Object)(_haciendacompleto));Debug.locals.put("Partes", _partes);Debug.locals.put("Partes", _partes);
 BA.debugLineNum = 1279;BA.debugLine="haciendaCBX = Partes(0)";
Debug.ShouldStop(1073741824);
__ref.setField ("_haciendacbx" /*RemoteObject*/ ,_partes.getArrayElement(true,BA.numberCast(int.class, 0)));
 BA.debugLineNum = 1280;BA.debugLine="ItemsLote.Clear";
Debug.ShouldStop(-2147483648);
_itemslote.runVoidMethod ("Clear");
 BA.debugLineNum = 1281;BA.debugLine="ItemsLote.Add(\"Seleccionar:\")";
Debug.ShouldStop(1);
_itemslote.runVoidMethod ("Add",(Object)((RemoteObject.createImmutable("Seleccionar:"))));
 BA.debugLineNum = 1282;BA.debugLine="SwiftButtonLote.xLBL.Text = \"\"";
Debug.ShouldStop(2);
__ref.getField(false,"_swiftbuttonlote" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(""));
 BA.debugLineNum = 1284;BA.debugLine="Dim Req As DBRequestManager";
Debug.ShouldStop(8);
_req = RemoteObject.createNew ("b4a.example.ef.dbrequestmanager");Debug.locals.put("Req", _req);
 BA.debugLineNum = 1285;BA.debugLine="Req.Initialize(Me, rdcLink & \"?DBName=\" & Main.p";
Debug.ShouldStop(16);
_req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(__ref),(Object)(RemoteObject.concat(__ref.getField(true,"_rdclink" /*RemoteObject*/ ),RemoteObject.createImmutable("?DBName="),parent._main._pdbname /*RemoteObject*/ )));
 BA.debugLineNum = 1286;BA.debugLine="Dim cmd As DBCommand = CreateCommand(\"select_lot";
Debug.ShouldStop(32);
_cmd = __ref.runClassMethod (b4a.example.ef.formlabores.class, "_createcommand" /*RemoteObject*/ ,(Object)(BA.ObjectToString("select_lotes")),(Object)(RemoteObject.createNewArray("Object",new int[] {2},new Object[] {(__ref.getField(true,"_nitempresacbx" /*RemoteObject*/ )),(__ref.getField(true,"_haciendacbx" /*RemoteObject*/ ))})));Debug.locals.put("cmd", _cmd);Debug.locals.put("cmd", _cmd);
 BA.debugLineNum = 1289;BA.debugLine="Wait For (Req.ExecuteQuery(cmd, 0, Null)) JobDon";
Debug.ShouldStop(256);
...
_j = (RemoteObject) result.getArrayElement(false,RemoteObject.createImmutable(1));Debug.locals.put("j", _j);
;
 BA.debugLineNum = 1292;BA.debugLine="If j.Success Then";
Debug.ShouldStop(2048);
if (true) break;
...
//C
this.state = 7;
 BA.debugLineNum = 1294;BA.debugLine="Req.HandleJobAsync(j, \"req\")";
Debug.ShouldStop(8192);
_req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_handlejobasync" /*void*/ ,(Object)(_j),(Object)(RemoteObject.createImmutable("req")));
 BA.debugLineNum = 1295;BA.debugLine="Wait For (Req) req_Result(res As DBResult)";
Debug.ShouldStop(16384);
...
_res = (RemoteObject) result.getArrayElement(false,RemoteObject.createImmutable(1));Debug.locals.put("res", _res);
;
 BA.debugLineNum = 1299;BA.debugLine="For Each row() As Object In res.Rows";
Debug.ShouldStop(262144);
if (true) break;
...
//C
this.state = 19;
 BA.debugLineNum = 1300;BA.debugLine="Dim Codg_Hacienda As String = row(0)";
Debug.ShouldStop(524288);
_codg_hacienda = BA.ObjectToString(_row.getArrayElement(false,BA.numberCast(int.class, 0)));Debug.locals.put("Codg_Hacienda", _codg_hacienda);Debug.locals.put("Codg_Hacienda", _codg_hacienda);
 BA.debugLineNum = 1304;BA.debugLine="ItemsLote.Add(Codg_Hacienda)";
Debug.ShouldStop(8388608);
...
//C
this.state = 13;
 BA.debugLineNum = 1309;BA.debugLine="Log(\"Error: \" & j.ErrorMessage)";
Debug.ShouldStop(268435456);
parent.__c.runVoidMethod ("LogImpl","89306151",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
this.state = 14;
;
 BA.debugLineNum = 1311;BA.debugLine="SearchTemplateLote.SetItems(ItemsLote)";
Debug.ShouldStop(1073741824);
__ref.getField(false,"_searchtemplatelote" /*RemoteObject*/ ).runClassMethod (b4a.example.ef.b4xsearchtemplate.class, "_setitems" /*RemoteObject*/ ,(Object)(_itemslote));
 BA.debugLineNum = 1312;BA.debugLine="SwiftButtonLote.Enabled = True";
Debug.ShouldStop(-2147483648);
__ref.getField(false,"_swiftbuttonlote" /*RemoteObject*/ ).runClassMethod (b4a.example.ef.swiftbutton.class, "_setenabled" /*RemoteObject*/ ,parent.__c.getField(true,"True"));
 BA.debugLineNum = 1313;BA.debugLine="Log(haciendaCBX)";
Debug.ShouldStop(1);
parent.__c.runVoidMethod ("LogImpl","89306155",__ref.getField(true,"_haciendacbx" /*RemoteObject*/ ),0);
 BA.debugLineNum = 1315;BA.debugLine="j.Release";
Debug.ShouldStop(4);
_j.runClassMethod (b4a.example.ef.httpjob.class, "_release" /*RemoteObject*/ );
 if (true) break;
...
try {
		Debug.PushSubsStack("SwiftButtonInsumo_Click (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,1407);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 1408;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateInsum";
Debug.ShouldStop(-2147483648);
...
_result = (RemoteObject) result.getArrayElement(true,RemoteObject.createImmutable(1));Debug.locals.put("Result", _result);
;
 BA.debugLineNum = 1409;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
Debug.ShouldStop(1);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 1410;BA.debugLine="SwiftButtonInsumo.xLBL.Text = SearchTemplateInsu";
Debug.ShouldStop(2);
__ref.getField(false,"_swiftbuttoninsumo" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(__ref.getField(false,"_searchtemplateinsumo" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));
 BA.debugLineNum = 1411;BA.debugLine="Dim INSUMOCOMPLETO As String = SearchTemplateIns";
Debug.ShouldStop(4);
_insumocompleto = __ref.getField(false,"_searchtemplateinsumo" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ );Debug.locals.put("INSUMOCOMPLETO", _insumocompleto);Debug.locals.put("INSUMOCOMPLETO", _insumocompleto);
 BA.debugLineNum = 1412;BA.debugLine="Dim partes() As String = Regex.Split(\":\", INSUMO";
Debug.ShouldStop(8);
_partes = parent.__c.getField(false,"Regex").runMethod(false,"Split",(Object)(BA.ObjectToString(":")),(Object)(_insumocompleto));Debug.locals.put("partes", _partes);Debug.locals.put("partes", _partes);
 BA.debugLineNum = 1413;BA.debugLine="NAMEINSUMO = partes(1)";
Debug.ShouldStop(16);
__ref.setField ("_nameinsumo" /*RemoteObject*/ ,_partes.getArrayElement(true,BA.numberCast(int.class, 1)));
 BA.debugLineNum = 1414;BA.debugLine="IDINSUMO = partes(0)";
Debug.ShouldStop(32);
...
this.state = -1;
;
 BA.debugLineNum = 1416;BA.debugLine="Log(IDINSUMO)";
Debug.ShouldStop(128);
parent.__c.runVoidMethod ("LogImpl","89633801",__ref.getField(true,"_idinsumo" /*RemoteObject*/ ),0);
...
try {
		Debug.PushSubsStack("SwiftButtonLabor_Click (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,1332);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 1333;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateLabor";
Debug.ShouldStop(1048576);
...
_result = (RemoteObject) result.getArrayElement(true,RemoteObject.createImmutable(1));Debug.locals.put("Result", _result);
;
 BA.debugLineNum = 1335;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
Debug.ShouldStop(4194304);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 1336;BA.debugLine="SwiftButtonLabor.xLBL.Text = SearchTemplateLabor";
Debug.ShouldStop(8388608);
__ref.getField(false,"_swiftbuttonlabor" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(__ref.getField(false,"_searchtemplatelabor" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));
 BA.debugLineNum = 1337;BA.debugLine="Dim Partes() As String = Regex.Split(\":\", Search";
Debug.ShouldStop(16777216);
_partes = parent.__c.getField(false,"Regex").runMethod(false,"Split",(Object)(BA.ObjectToString(":")),(Object)(__ref.getField(false,"_searchtemplatelabor" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));Debug.locals.put("Partes", _partes);Debug.locals.put("Partes", _partes);
 BA.debugLineNum = 1338;BA.debugLine="elementoLabor = Partes(0) ' Asignar solo la prim";
Debug.ShouldStop(33554432);
...
this.state = -1;
;
 BA.debugLineNum = 1340;BA.debugLine="Log(elementoLabor)";
Debug.ShouldStop(134217728);
parent.__c.runVoidMethod ("LogImpl","89437192",__ref.getField(true,"_elementolabor" /*RemoteObject*/ ),0);
...
try {
		Debug.PushSubsStack("SwiftButtonLote_Click (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,1320);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 1321;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateLote,";
Debug.ShouldStop(256);
...
_result = (RemoteObject) result.getArrayElement(true,RemoteObject.createImmutable(1));Debug.locals.put("Result", _result);
;
 BA.debugLineNum = 1323;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
Debug.ShouldStop(1024);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 1324;BA.debugLine="SwiftButtonLote.xLBL.Text = SearchTemplateLote.S";
Debug.ShouldStop(2048);
__ref.getField(false,"_swiftbuttonlote" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(__ref.getField(false,"_searchtemplatelote" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));
 BA.debugLineNum = 1325;BA.debugLine="Dim Partes() As String = Regex.Split(\":\", Search";
Debug.ShouldStop(4096);
_partes = parent.__c.getField(false,"Regex").runMethod(false,"Split",(Object)(BA.ObjectToString(":")),(Object)(__ref.getField(false,"_searchtemplatelote" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));Debug.locals.put("Partes", _partes);Debug.locals.put("Partes", _partes);
 BA.debugLineNum = 1326;BA.debugLine="loteCBX = Partes(0) ' Asignar solo la primera pa";
Debug.ShouldStop(8192);
...
this.state = -1;
;
 BA.debugLineNum = 1329;BA.debugLine="Log(loteCBX)";
Debug.ShouldStop(65536);
parent.__c.runVoidMethod ("LogImpl","89371657",__ref.getField(true,"_lotecbx" /*RemoteObject*/ ),0);
...
try {
		Debug.PushSubsStack("SwiftButtonNit_Click (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,1219);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 1220;BA.debugLine="Dim ItemsHacienda As List";
Debug.ShouldStop(8);
_itemshacienda = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("ItemsHacienda", _itemshacienda);
 BA.debugLineNum = 1221;BA.debugLine="ItemsHacienda.Initialize";
Debug.ShouldStop(16);
_itemshacienda.runVoidMethod ("Initialize");
 BA.debugLineNum = 1222;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateNit,";
Debug.ShouldStop(32);
...
_result = (RemoteObject) result.getArrayElement(true,RemoteObject.createImmutable(1));Debug.locals.put("Result", _result);
;
 BA.debugLineNum = 1223;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
Debug.ShouldStop(64);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 1224;BA.debugLine="SwiftButtonNit.xLBL.Text = SearchTemplateNit.Sel";
Debug.ShouldStop(128);
__ref.getField(false,"_swiftbuttonnit" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(__ref.getField(false,"_searchtemplatenit" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));
 BA.debugLineNum = 1225;BA.debugLine="Dim NITCOMPLETO As String = SearchTemplateNit.Se";
Debug.ShouldStop(256);
_nitcompleto = __ref.getField(false,"_searchtemplatenit" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ );Debug.locals.put("NITCOMPLETO", _nitcompleto);Debug.locals.put("NITCOMPLETO", _nitcompleto);
 BA.debugLineNum = 1226;BA.debugLine="Dim Partes() As String = Regex.Split(\":\", NITCOM";
Debug.ShouldStop(512);
_partes = parent.__c.getField(false,"Regex").runMethod(false,"Split",(Object)(BA.ObjectToString(":")),(Object)(_nitcompleto));Debug.locals.put("Partes", _partes);Debug.locals.put("Partes", _partes);
 BA.debugLineNum = 1227;BA.debugLine="nitEmpresaCBX = Partes(0)";
Debug.ShouldStop(1024);
__ref.setField ("_nitempresacbx" /*RemoteObject*/ ,_partes.getArrayElement(true,BA.numberCast(int.class, 0)));
 BA.debugLineNum = 1228;BA.debugLine="ItemsHacienda.Clear";
Debug.ShouldStop(2048);
_itemshacienda.runVoidMethod ("Clear");
 BA.debugLineNum = 1229;BA.debugLine="ItemsHacienda.Add(\"Seleccionar:\")";
Debug.ShouldStop(4096);
_itemshacienda.runVoidMethod ("Add",(Object)((RemoteObject.createImmutable("Seleccionar:"))));
 BA.debugLineNum = 1230;BA.debugLine="SwiftButtonHacienda.xLBL.Text = \"\"";
Debug.ShouldStop(8192);
__ref.getField(false,"_swiftbuttonhacienda" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(""));
 BA.debugLineNum = 1232;BA.debugLine="Dim Req As DBRequestManager";
Debug.ShouldStop(32768);
_req = RemoteObject.createNew ("b4a.example.ef.dbrequestmanager");Debug.locals.put("Req", _req);
 BA.debugLineNum = 1233;BA.debugLine="Req.Initialize(Me, rdcLink & \"?DBName=\" & Main.p";
Debug.ShouldStop(65536);
_req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(__ref),(Object)(RemoteObject.concat(__ref.getField(true,"_rdclink" /*RemoteObject*/ ),RemoteObject.createImmutable("?DBName="),parent._main._pdbname /*RemoteObject*/ )));
 BA.debugLineNum = 1234;BA.debugLine="Dim cmd As DBCommand = CreateCommand(\"select_hac";
Debug.ShouldStop(131072);
_cmd = __ref.runClassMethod (b4a.example.ef.formlabores.class, "_createcommand" /*RemoteObject*/ ,(Object)(BA.ObjectToString("select_haciendas")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {(__ref.getField(true,"_nitempresacbx" /*RemoteObject*/ ))})));Debug.locals.put("cmd", _cmd);Debug.locals.put("cmd", _cmd);
 BA.debugLineNum = 1237;BA.debugLine="Wait For (Req.ExecuteQuery(cmd, 0, Null)) JobDon";
Debug.ShouldStop(1048576);
...
_j = (RemoteObject) result.getArrayElement(false,RemoteObject.createImmutable(1));Debug.locals.put("j", _j);
;
 BA.debugLineNum = 1240;BA.debugLine="If j.Success Then";
Debug.ShouldStop(8388608);
if (true) break;
...
//C
this.state = 7;
 BA.debugLineNum = 1242;BA.debugLine="Req.HandleJobAsync(j, \"req\")";
Debug.ShouldStop(33554432);
_req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_handlejobasync" /*void*/ ,(Object)(_j),(Object)(RemoteObject.createImmutable("req")));
 BA.debugLineNum = 1243;BA.debugLine="Wait For (Req) req_Result(res As DBResult)";
Debug.ShouldStop(67108864);
...
_res = (RemoteObject) result.getArrayElement(false,RemoteObject.createImmutable(1));Debug.locals.put("res", _res);
;
 BA.debugLineNum = 1247;BA.debugLine="For Each row() As Object In res.Rows";
Debug.ShouldStop(1073741824);
if (true) break;
...
//C
this.state = 19;
 BA.debugLineNum = 1248;BA.debugLine="Dim Codg_Hacienda As String = row(0)";
Debug.ShouldStop(-2147483648);
_codg_hacienda = BA.ObjectToString(_row.getArrayElement(false,BA.numberCast(int.class, 0)));Debug.locals.put("Codg_Hacienda", _codg_hacienda);Debug.locals.put("Codg_Hacienda", _codg_hacienda);
 BA.debugLineNum = 1249;BA.debugLine="Dim NombreHacienda As String = row(1)";
Debug.ShouldStop(1);
_nombrehacienda = BA.ObjectToString(_row.getArrayElement(false,BA.numberCast(int.class, 1)));Debug.locals.put("NombreHacienda", _nombrehacienda);Debug.locals.put("NombreHacienda", _nombrehacienda);
 BA.debugLineNum = 1254;BA.debugLine="ItemsHacienda.Add(Codg_Hacienda&\":\"&NombreHaci";
Debug.ShouldStop(32);
...
//C
this.state = 13;
 BA.debugLineNum = 1259;BA.debugLine="Log(\"Error: \" & j.ErrorMessage)";
Debug.ShouldStop(1024);
parent.__c.runVoidMethod ("LogImpl","89240616",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
this.state = 14;
;
 BA.debugLineNum = 1261;BA.debugLine="SearchTemplateHacienda.SetItems(ItemsHacienda)";
Debug.ShouldStop(4096);
__ref.getField(false,"_searchtemplatehacienda" /*RemoteObject*/ ).runClassMethod (b4a.example.ef.b4xsearchtemplate.class, "_setitems" /*RemoteObject*/ ,(Object)(_itemshacienda));
 BA.debugLineNum = 1262;BA.debugLine="SwiftButtonHacienda.Enabled = True";
Debug.ShouldStop(8192);
__ref.getField(false,"_swiftbuttonhacienda" /*RemoteObject*/ ).runClassMethod (b4a.example.ef.swiftbutton.class, "_setenabled" /*RemoteObject*/ ,parent.__c.getField(true,"True"));
 BA.debugLineNum = 1263;BA.debugLine="Log(nitEmpresaCBX)";
Debug.ShouldStop(16384);
parent.__c.runVoidMethod ("LogImpl","89240620",__ref.getField(true,"_nitempresacbx" /*RemoteObject*/ ),0);
 BA.debugLineNum = 1265;BA.debugLine="j.Release";
Debug.ShouldStop(65536);
_j.runClassMethod (b4a.example.ef.httpjob.class, "_release" /*RemoteObject*/ );
 if (true) break;
...
try {
		Debug.PushSubsStack("SwiftButtonRiego_Click (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,1419);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 1420;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateRiego";
Debug.ShouldStop(2048);
...
_result = (RemoteObject) result.getArrayElement(true,RemoteObject.createImmutable(1));Debug.locals.put("Result", _result);
;
 BA.debugLineNum = 1422;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
Debug.ShouldStop(8192);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 1423;BA.debugLine="SwiftButtonRiego.xLBL.Text = SearchTemplateRiego";
Debug.ShouldStop(16384);
__ref.getField(false,"_swiftbuttonriego" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(__ref.getField(false,"_searchtemplateriego" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));
 BA.debugLineNum = 1424;BA.debugLine="Dim Partes() As String = Regex.Split(\":\", Search";
Debug.ShouldStop(32768);
_partes = parent.__c.getField(false,"Regex").runMethod(false,"Split",(Object)(BA.ObjectToString(":")),(Object)(__ref.getField(false,"_searchtemplateriego" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));Debug.locals.put("Partes", _partes);Debug.locals.put("Partes", _partes);
 BA.debugLineNum = 1425;BA.debugLine="tipoRiego = Partes(0) ' Asignar solo la primera";
Debug.ShouldStop(65536);
...
this.state = -1;
;
 BA.debugLineNum = 1427;BA.debugLine="Log(tipoRiego)";
Debug.ShouldStop(262144);
parent.__c.runVoidMethod ("LogImpl","89699336",__ref.getField(true,"_tiporiego" /*RemoteObject*/ ),0);
...
try {
		Debug.PushSubsStack("SwiftButtonTipoLabranza_Click (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,1431);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 1432;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateTipoL";
Debug.ShouldStop(8388608);
...
_result = (RemoteObject) result.getArrayElement(true,RemoteObject.createImmutable(1));Debug.locals.put("Result", _result);
;
 BA.debugLineNum = 1434;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
Debug.ShouldStop(33554432);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 1435;BA.debugLine="SwiftButtonTipoLabranza.xLBL.Text = SearchTempla";
Debug.ShouldStop(67108864);
__ref.getField(false,"_swiftbuttontipolabranza" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(__ref.getField(false,"_searchtemplatetipolabranza" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));
 BA.debugLineNum = 1436;BA.debugLine="Dim Partes() As String = Regex.Split(\":\", Search";
Debug.ShouldStop(134217728);
_partes = parent.__c.getField(false,"Regex").runMethod(false,"Split",(Object)(BA.ObjectToString(":")),(Object)(__ref.getField(false,"_searchtemplatetipolabranza" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));Debug.locals.put("Partes", _partes);Debug.locals.put("Partes", _partes);
 BA.debugLineNum = 1439;BA.debugLine="tipoLabranzaSiembra = Partes(0)";
Debug.ShouldStop(1073741824);
__ref.setField ("_tipolabranzasiembra" /*RemoteObject*/ ,_partes.getArrayElement(true,BA.numberCast(int.class, 0)));
 BA.debugLineNum = 1440;BA.debugLine="If tipoLabranzaSiembra.Length >= 2 Then";
Debug.ShouldStop(-2147483648);
if (true) break;
...
//C
this.state = 7;
 BA.debugLineNum = 1441;BA.debugLine="tipoLabranzaSiembra = tipoLabranzaSiembra.SubSt";
Debug.ShouldStop(1);
...
this.state = -1;
;
 BA.debugLineNum = 1445;BA.debugLine="Log(tipoLabranzaSiembra)";
Debug.ShouldStop(16);
parent.__c.runVoidMethod ("LogImpl","89764878",__ref.getField(true,"_tipolabranzasiembra" /*RemoteObject*/ ),0);
...
try {
		Debug.PushSubsStack("SwiftButtonTypeForm_Click (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,1364);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 1365;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateTypeF";
Debug.ShouldStop(1048576);
...
_result = (RemoteObject) result.getArrayElement(true,RemoteObject.createImmutable(1));Debug.locals.put("Result", _result);
;
 BA.debugLineNum = 1366;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
Debug.ShouldStop(2097152);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 1367;BA.debugLine="SwiftButtonTypeForm.xLBL.Text = SearchTemplateTy";
Debug.ShouldStop(4194304);
__ref.getField(false,"_swiftbuttontypeform" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(__ref.getField(false,"_searchtemplatetypeform" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));
 BA.debugLineNum = 1368;BA.debugLine="Dim TYPEFORMCOMPLETO As String = SearchTemplateT";
Debug.ShouldStop(8388608);
_typeformcompleto = __ref.getField(false,"_searchtemplatetypeform" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ );Debug.locals.put("TYPEFORMCOMPLETO", _typeformcompleto);Debug.locals.put("TYPEFORMCOMPLETO", _typeformcompleto);
 BA.debugLineNum = 1369;BA.debugLine="Dim Partes() As String = Regex.Split(\":\", TYPEFO";
Debug.ShouldStop(16777216);
_partes = parent.__c.getField(false,"Regex").runMethod(false,"Split",(Object)(BA.ObjectToString(":")),(Object)(_typeformcompleto));Debug.locals.put("Partes", _partes);Debug.locals.put("Partes", _partes);
 BA.debugLineNum = 1370;BA.debugLine="tipoLabor = Partes(0)";
Debug.ShouldStop(33554432);
__ref.setField ("_tipolabor" /*RemoteObject*/ ,_partes.getArrayElement(true,BA.numberCast(int.class, 0)));
 BA.debugLineNum = 1371;BA.debugLine="Log(tipoLabor)";
Debug.ShouldStop(67108864);
parent.__c.runVoidMethod ("LogImpl","89568263",__ref.getField(true,"_tipolabor" /*RemoteObject*/ ),0);
 BA.debugLineNum = 1372;BA.debugLine="Dim tipoForm As String = Partes(0)";
Debug.ShouldStop(134217728);
_tipoform = _partes.getArrayElement(true,BA.numberCast(int.class, 0));Debug.locals.put("tipoForm", _tipoform);Debug.locals.put("tipoForm", _tipoform);
 BA.debugLineNum = 1374;BA.debugLine="Select Case tipoForm";
Debug.ShouldStop(536870912);
if (true) break;
...
//C
this.state = 13;
 BA.debugLineNum = 1376;BA.debugLine="RemoveForm2IfExists";
Debug.ShouldStop(-2147483648);
__ref.runClassMethod (b4a.example.ef.formlabores.class, "_removeform2ifexists" /*RemoteObject*/ );
 BA.debugLineNum = 1377;BA.debugLine="RemoveForm3IfExists";
Debug.ShouldStop(1);
__ref.runClassMethod (b4a.example.ef.formlabores.class, "_removeform3ifexists" /*RemoteObject*/ );
 BA.debugLineNum = 1378;BA.debugLine="CustomListView1Geral.Add(CreateItemInsumo,\"form";
Debug.ShouldStop(2);
__ref.getField(false,"_customlistview1geral" /*RemoteObject*/ ).runVoidMethod ("_add",RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), __ref.runClassMethod (b4a.example.ef.formlabores.class, "_createiteminsumo" /*RemoteObject*/ ).getObject()),(Object)((RemoteObject.createImmutable("form0"))));
 BA.debugLineNum = 1379;BA.debugLine="LlenarComboBoxInsumo";
Debug.ShouldStop(4);
__ref.runClassMethod (b4a.example.ef.formlabores.class, "_llenarcomboboxinsumo" /*void*/ );
 BA.debugLineNum = 1380;BA.debugLine="Dim INSUMOCOLUM As B4XTableColumn = B4XTable1.A";
Debug.ShouldStop(8);
_insumocolum = __ref.getField(false,"_b4xtable1" /*RemoteObject*/ ).runClassMethod (b4a.example.ef.b4xtable.class, "_addcolumn" /*RemoteObject*/ ,(Object)(BA.ObjectToString("#")),(Object)(__ref.getField(false,"_b4xtable1" /*RemoteObject*/ ).getField(true,"_column_type_numbers" /*RemoteObject*/ )));Debug.locals.put("INSUMOCOLUM", _insumocolum);Debug.locals.put("INSUMOCOLUM", _insumocolum);
 BA.debugLineNum = 1381;BA.debugLine="INSUMOCOLUM.Width = 50dip";
Debug.ShouldStop(16);
_insumocolum.setField ("Width" /*RemoteObject*/ ,parent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 50))));
 BA.debugLineNum = 1382;BA.debugLine="B4XTable1.AddColumn(\"ID\", B4XTable1.COLUMN_TYPE";
Debug.ShouldStop(32);
__ref.getField(false,"_b4xtable1" /*RemoteObject*/ ).runClassMethod (b4a.example.ef.b4xtable.class, "_addcolumn" /*RemoteObject*/ ,(Object)(BA.ObjectToString("ID")),(Object)(__ref.getField(false,"_b4xtable1" /*RemoteObject*/ ).getField(true,"_column_type_text" /*RemoteObject*/ )));
 BA.debugLineNum = 1383;BA.debugLine="B4XTable1.AddColumn(\"NOMBRE\", B4XTable1.COLUMN_";
Debug.ShouldStop(64);
__ref.getField(false,"_b4xtable1" /*RemoteObject*/ ).runClassMethod (b4a.example.ef.b4xtable.class, "_addcolumn" /*RemoteObject*/ ,(Object)(BA.ObjectToString("NOMBRE")),(Object)(__ref.getField(false,"_b4xtable1" /*RemoteObject*/ ).getField(true,"_column_type_text" /*RemoteObject*/ )));
 BA.debugLineNum = 1384;BA.debugLine="B4XTable1.AddColumn(\"CANTIDAD\", B4XTable1.COLUM";
Debug.ShouldStop(128);
__ref.getField(false,"_b4xtable1" /*RemoteObject*/ ).runClassMethod (b4a.example.ef.b4xtable.class, "_addcolumn" /*RemoteObject*/ ,(Object)(BA.ObjectToString("CANTIDAD")),(Object)(__ref.getField(false,"_b4xtable1" /*RemoteObject*/ ).getField(true,"_column_type_text" /*RemoteObject*/ )));
 BA.debugLineNum = 1386;BA.debugLine="cantidadInsumos = 0";
Debug.ShouldStop(512);
__ref.setField ("_cantidadinsumos" /*RemoteObject*/ ,BA.numberCast(int.class, 0));
 BA.debugLineNum = 1387;BA.debugLine="LabelCantidadInsumos.Text = cantidadInsumos";
Debug.ShouldStop(1024);
__ref.getField(false,"_labelcantidadinsumos" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(__ref.getField(true,"_cantidadinsumos" /*RemoteObject*/ )));
 BA.debugLineNum = 1388;BA.debugLine="CANTINSUMO = \"\"";
Debug.ShouldStop(2048);
__ref.setField ("_cantinsumo" /*RemoteObject*/ ,BA.ObjectToString(""));
 if (true) break;
...
//C
this.state = 13;
 BA.debugLineNum = 1390;BA.debugLine="RemoveForm0IfExists";
Debug.ShouldStop(8192);
__ref.runClassMethod (b4a.example.ef.formlabores.class, "_removeform0ifexists" /*RemoteObject*/ );
 BA.debugLineNum = 1391;BA.debugLine="RemoveForm2IfExists ' Eliminar \"form2\" si exist";
Debug.ShouldStop(16384);
__ref.runClassMethod (b4a.example.ef.formlabores.class, "_removeform2ifexists" /*RemoteObject*/ );
 BA.debugLineNum = 1392;BA.debugLine="CustomListView1Geral.Add(CreateItemSiembra,\"for";
Debug.ShouldStop(32768);
__ref.getField(false,"_customlistview1geral" /*RemoteObject*/ ).runVoidMethod ("_add",RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), __ref.runClassMethod (b4a.example.ef.formlabores.class, "_createitemsiembra" /*RemoteObject*/ ).getObject()),(Object)((RemoteObject.createImmutable("form3"))));
 BA.debugLineNum = 1393;BA.debugLine="LlenarComboBoxSiembra";
Debug.ShouldStop(65536);
__ref.runClassMethod (b4a.example.ef.formlabores.class, "_llenarcomboboxsiembra" /*void*/ );
 if (true) break;
...
//C
this.state = 13;
 BA.debugLineNum = 1395;BA.debugLine="RemoveForm0IfExists";
Debug.ShouldStop(262144);
__ref.runClassMethod (b4a.example.ef.formlabores.class, "_removeform0ifexists" /*RemoteObject*/ );
 BA.debugLineNum = 1396;BA.debugLine="RemoveForm3IfExists";
Debug.ShouldStop(524288);
__ref.runClassMethod (b4a.example.ef.formlabores.class, "_removeform3ifexists" /*RemoteObject*/ );
 BA.debugLineNum = 1397;BA.debugLine="CustomListView1Geral.Add(CreateItemRiego, \"form";
Debug.ShouldStop(1048576);
__ref.getField(false,"_customlistview1geral" /*RemoteObject*/ ).runVoidMethod ("_add",RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), __ref.runClassMethod (b4a.example.ef.formlabores.class, "_createitemriego" /*RemoteObject*/ ).getObject()),(Object)((RemoteObject.createImmutable("form2"))));
 BA.debugLineNum = 1398;BA.debugLine="LlenarComboBoxRiego";
Debug.ShouldStop(2097152);
__ref.runClassMethod (b4a.example.ef.formlabores.class, "_llenarcomboboxriego" /*void*/ );
 if (true) break;
...
//C
this.state = 13;
 BA.debugLineNum = 1401;BA.debugLine="Log(\"Valor no reconocido: \" & tipoForm)";
Debug.ShouldStop(16777216);
parent.__c.runVoidMethod ("LogImpl","89568293",RemoteObject.concat(RemoteObject.createImmutable("Valor no reconocido: "),_tipoform),0);
 if (true) break;
...
try {
		Debug.PushSubsStack("SwiftButtonVariedad_Click (formlabores) ","formlabores",5,__ref.getField(false, "ba"),__ref,1449);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 1450;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateVarie";
Debug.ShouldStop(512);
...
_result = (RemoteObject) result.getArrayElement(true,RemoteObject.createImmutable(1));Debug.locals.put("Result", _result);
;
 BA.debugLineNum = 1452;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
Debug.ShouldStop(2048);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 1453;BA.debugLine="SwiftButtonVariedad.xLBL.Text = SearchTemplateVa";
Debug.ShouldStop(4096);
__ref.getField(false,"_swiftbuttonvariedad" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(__ref.getField(false,"_searchtemplatevariedad" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));
 BA.debugLineNum = 1454;BA.debugLine="Dim Partes() As String = Regex.Split(\":\", Search";
Debug.ShouldStop(8192);
_partes = parent.__c.getField(false,"Regex").runMethod(false,"Split",(Object)(BA.ObjectToString(":")),(Object)(__ref.getField(false,"_searchtemplatevariedad" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));Debug.locals.put("Partes", _partes);Debug.locals.put("Partes", _partes);
 BA.debugLineNum = 1455;BA.debugLine="codigoSiembra = Partes(0)";
Debug.ShouldStop(16384);
...
this.state = -1;
;
 BA.debugLineNum = 1457;BA.debugLine="Log(codigoSiembra)";
Debug.ShouldStop(65536);
parent.__c.runVoidMethod ("LogImpl","89830408",__ref.getField(true,"_codigosiembra" /*RemoteObject*/ ),0);
