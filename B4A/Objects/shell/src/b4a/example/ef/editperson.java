...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"AS_DatePicker1",_ref.getField(false, "_as_datepicker1"),"ButtonBuscar",_ref.getField(false, "_buttonbuscar"),"CLV_Editar",_ref.getField(false, "_clv_editar"),"CustomListView1Geral",_ref.getField(false, "_customlistview1geral"),"DateUtils",_ref.getField(false, "_dateutils"),"Fecha",_ref.getField(false, "_fecha"),"Label12Fecha",_ref.getField(false, "_label12fecha"),"Panel12",_ref.getField(false, "_panel12"),"PanelEdit",_ref.getField(false, "_paneledit"),"rdcLink",_ref.getField(false, "_rdclink"),"Root",_ref.getField(false, "_root"),"utilClass",_ref.getField(false, "_utilclass"),"xui",_ref.getField(false, "_xui")};
}
}