...
Debug.ShouldStop(1);
parent.__c.runVoidMethod ("LogImpl","812779525",RemoteObject.concat(RemoteObject.createImmutable("Error building command: "),parent.__c.runMethod(false,"LastException",__ref.runMethod(false,"getActivityBA"))),0);
...
Debug.ShouldStop(1073741824);
parent.__c.runVoidMethod ("LogImpl","812976134",RemoteObject.concat(RemoteObject.createImmutable("Error reading response: "),parent.__c.runMethod(false,"LastException",__ref.runMethod(false,"getActivityBA"))),0);
...
Debug.ShouldStop(8192);
dbrequestmanager.__c.runVoidMethod ("LogImpl","813238279",_sb.runMethod(true,"ToString"),0);
...
Debug.ShouldStop(1048576);
dbrequestmanager.__c.runVoidMethod ("LogImpl","813238286",_sb.runMethod(true,"ToString"),0);
 }
}Debug.locals.put("row", _row);
;
