...
Debug.ShouldStop(1);
parent.__c.runVoidMethod ("LogImpl","76160389",RemoteObject.concat(RemoteObject.createImmutable("Error building command: "),parent.__c.runMethod(false,"LastException",__ref.runMethod(false,"getActivityBA"))),0);
...
Debug.ShouldStop(1073741824);
parent.__c.runVoidMethod ("LogImpl","76356998",RemoteObject.concat(RemoteObject.createImmutable("Error reading response: "),parent.__c.runMethod(false,"LastException",__ref.runMethod(false,"getActivityBA"))),0);
...
dbrequestmanager.__c.runVoidMethod ("LogImpl","76619137",RemoteObject.concat(RemoteObject.createImmutable("Tag: "),_table.getField(false,"Tag" /*RemoteObject*/ ),RemoteObject.createImmutable(", Columns: "),_table.getField(false,"Columns" /*RemoteObject*/ ).runMethod(true,"getSize"),RemoteObject.createImmutable(", Rows: "),_table.getField(false,"Rows" /*RemoteObject*/ ).runMethod(true,"getSize")),0);
...
Debug.ShouldStop(8192);
dbrequestmanager.__c.runVoidMethod ("LogImpl","76619143",_sb.runMethod(true,"ToString"),0);
...
Debug.ShouldStop(1048576);
dbrequestmanager.__c.runVoidMethod ("LogImpl","76619150",_sb.runMethod(true,"ToString"),0);
 }
}Debug.locals.put("row", _row);
;
