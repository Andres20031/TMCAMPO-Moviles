...
try {
		Debug.PushSubsStack("AS_DatePicker1_SelectedDateChanged (formmaquinaria) ","formmaquinaria",10,__ref.getField(false, "ba"),__ref,377);
...
try {
		Debug.PushSubsStack("B4XPage_Appear (formmaquinaria) ","formmaquinaria",10,__ref.getField(false, "ba"),__ref,108);
...
Debug.ShouldStop(512);
parent.__c.runVoidMethod ("LogImpl","515073310",RemoteObject.concat(RemoteObject.createImmutable("Error en la consulta de Maquina: "),_j2.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(16);
parent.__c.runVoidMethod ("LogImpl","515073337",RemoteObject.concat(RemoteObject.createImmutable("Error en la consulta de Maquina: "),_j3.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(536870912);
parent.__c.runVoidMethod ("LogImpl","515073362",RemoteObject.concat(RemoteObject.createImmutable("Error en la consulta de NITs: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(16777216);
parent.__c.runVoidMethod ("LogImpl","515073389",RemoteObject.concat(RemoteObject.createImmutable("Error en la consulta de Maquina: "),_j4.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(1048576);
parent.__c.runVoidMethod ("LogImpl","515073417",RemoteObject.concat(RemoteObject.createImmutable("Error en la consulta de Maquina: "),_j5.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(4096);
parent.__c.runVoidMethod ("LogImpl","515073441",RemoteObject.concat(RemoteObject.createImmutable("Error en la consulta de Maquina: "),_j6.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
try {
		Debug.PushSubsStack("B4XPage_Created (formmaquinaria) ","formmaquinaria",10,__ref.getField(false, "ba"),__ref,93);
...
try {
		Debug.PushSubsStack("Button1_Click (formmaquinaria) ","formmaquinaria",10,__ref.getField(false, "ba"),__ref,449);
...
Debug.ShouldStop(131072);
parent.__c.runVoidMethod ("LogImpl","515990801",RemoteObject.concat(RemoteObject.createImmutable("Ascdo_Maq_Mvto_Maq: "),__ref.getField(true,"_ascdo_maq_mvto_maq" /*RemoteObject*/ )),0);
 BA.debugLineNum = 467;BA.debugLine="Log(\"maquina: \" & maquina)";
Debug.ShouldStop(262144);
parent.__c.runVoidMethod ("LogImpl","515990802",RemoteObject.concat(RemoteObject.createImmutable("maquina: "),__ref.getField(true,"_maquina" /*RemoteObject*/ )),0);
 BA.debugLineNum = 468;BA.debugLine="Log(\"fecha: \" & fecha)";
Debug.ShouldStop(524288);
parent.__c.runVoidMethod ("LogImpl","515990803",RemoteObject.concat(RemoteObject.createImmutable("fecha: "),__ref.getField(true,"_fecha" /*RemoteObject*/ )),0);
 BA.debugLineNum = 469;BA.debugLine="Log(\"labor: \" & labor)";
Debug.ShouldStop(1048576);
parent.__c.runVoidMethod ("LogImpl","515990804",RemoteObject.concat(RemoteObject.createImmutable("labor: "),__ref.getField(true,"_labor" /*RemoteObject*/ )),0);
 BA.debugLineNum = 470;BA.debugLine="Log(\"nitEmpresaCBX: \" & nitEmpresaCBX)";
Debug.ShouldStop(2097152);
parent.__c.runVoidMethod ("LogImpl","515990805",RemoteObject.concat(RemoteObject.createImmutable("nitEmpresaCBX: "),__ref.getField(true,"_nitempresacbx" /*RemoteObject*/ )),0);
 BA.debugLineNum = 471;BA.debugLine="Log(\"haciendaCBX: \" & haciendaCBX)";
Debug.ShouldStop(4194304);
parent.__c.runVoidMethod ("LogImpl","515990806",RemoteObject.concat(RemoteObject.createImmutable("haciendaCBX: "),__ref.getField(true,"_haciendacbx" /*RemoteObject*/ )),0);
 BA.debugLineNum = 472;BA.debugLine="Log(\"Lote: \" & Lote)";
Debug.ShouldStop(8388608);
parent.__c.runVoidMethod ("LogImpl","515990807",RemoteObject.concat(RemoteObject.createImmutable("Lote: "),__ref.getField(true,"_lote" /*RemoteObject*/ )),0);
 BA.debugLineNum = 473;BA.debugLine="Log(\"implemento: \" & implemento)";
Debug.ShouldStop(16777216);
parent.__c.runVoidMethod ("LogImpl","515990808",RemoteObject.concat(RemoteObject.createImmutable("implemento: "),__ref.getField(true,"_implemento" /*RemoteObject*/ )),0);
 BA.debugLineNum = 474;BA.debugLine="Log(\"horainicio: \" & horainicio)";
Debug.ShouldStop(33554432);
parent.__c.runVoidMethod ("LogImpl","515990809",RemoteObject.concat(RemoteObject.createImmutable("horainicio: "),__ref.getField(true,"_horainicio" /*RemoteObject*/ )),0);
 BA.debugLineNum = 475;BA.debugLine="Log(\"horafin: \" & horafin)";
Debug.ShouldStop(67108864);
parent.__c.runVoidMethod ("LogImpl","515990810",RemoteObject.concat(RemoteObject.createImmutable("horafin: "),__ref.getField(true,"_horafin" /*RemoteObject*/ )),0);
 BA.debugLineNum = 476;BA.debugLine="Log(\"combustible: \" & combustible)";
Debug.ShouldStop(134217728);
parent.__c.runVoidMethod ("LogImpl","515990811",RemoteObject.concat(RemoteObject.createImmutable("combustible: "),__ref.getField(true,"_combustible" /*RemoteObject*/ )),0);
 BA.debugLineNum = 477;BA.debugLine="Log(\"observaciones: \" & observaciones)";
Debug.ShouldStop(268435456);
parent.__c.runVoidMethod ("LogImpl","515990812",RemoteObject.concat(RemoteObject.createImmutable("observaciones: "),__ref.getField(true,"_observaciones" /*RemoteObject*/ )),0);
 BA.debugLineNum = 478;BA.debugLine="Log(\"operario: \" & operario)";
Debug.ShouldStop(536870912);
parent.__c.runVoidMethod ("LogImpl","515990813",RemoteObject.concat(RemoteObject.createImmutable("operario: "),__ref.getField(true,"_operario" /*RemoteObject*/ )),0);
 BA.debugLineNum = 479;BA.debugLine="Log(\"implemento2: \" & implemento2)";
Debug.ShouldStop(1073741824);
parent.__c.runVoidMethod ("LogImpl","515990814",RemoteObject.concat(RemoteObject.createImmutable("implemento2: "),__ref.getField(true,"_implemento2" /*RemoteObject*/ )),0);
 BA.debugLineNum = 480;BA.debugLine="Log(\"area: \" & area)";
Debug.ShouldStop(-2147483648);
parent.__c.runVoidMethod ("LogImpl","515990815",RemoteObject.concat(RemoteObject.createImmutable("area: "),__ref.getField(true,"_area" /*RemoteObject*/ )),0);
 BA.debugLineNum = 481;BA.debugLine="Log(\"fechaHoy: \" & fechaHoy)";
Debug.ShouldStop(1);
parent.__c.runVoidMethod ("LogImpl","515990816",RemoteObject.concat(RemoteObject.createImmutable("fechaHoy: "),__ref.getField(true,"_fechahoy" /*RemoteObject*/ )),0);
 BA.debugLineNum = 482;BA.debugLine="Log(\"horaActual: \" & horaActual)";
Debug.ShouldStop(2);
parent.__c.runVoidMethod ("LogImpl","515990817",RemoteObject.concat(RemoteObject.createImmutable("horaActual: "),__ref.getField(true,"_horaactual" /*RemoteObject*/ )),0);
 BA.debugLineNum = 483;BA.debugLine="Log(\"user: \" & user)";
Debug.ShouldStop(4);
parent.__c.runVoidMethod ("LogImpl","515990818",RemoteObject.concat(RemoteObject.createImmutable("user: "),__ref.getField(true,"_user" /*RemoteObject*/ )),0);
 BA.debugLineNum = 484;BA.debugLine="Log(\"DeviceName: \" & DeviceName)";
Debug.ShouldStop(8);
parent.__c.runVoidMethod ("LogImpl","515990819",RemoteObject.concat(RemoteObject.createImmutable("DeviceName: "),__ref.getField(true,"_devicename" /*RemoteObject*/ )),0);
...
Debug.ShouldStop(2097152);
parent.__c.runVoidMethod ("LogImpl","515990837",RemoteObject.concat(RemoteObject.createImmutable("Error al ejecutar la consulta: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(16777216);
parent.__c.runVoidMethod ("LogImpl","515990840",RemoteObject.concat(RemoteObject.createImmutable("Error al agregar datos: "),parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba")).runMethod(true,"getMessage")),0);
 if (true) break;
if (true) break;
...
try {
		Debug.PushSubsStack("CreateCommand (formmaquinaria) ","formmaquinaria",10,__ref.getField(false, "ba"),__ref,403);
...
try {
		Debug.PushSubsStack("CreateItem (formmaquinaria) ","formmaquinaria",10,__ref.getField(false, "ba"),__ref,353);
...
try {
		Debug.PushSubsStack("GetDeviceName (formmaquinaria) ","formmaquinaria",10,__ref.getField(false, "ba"),__ref,101);
...
try {
		Debug.PushSubsStack("Initialize (formmaquinaria) ","formmaquinaria",10,__ref.getField(false, "ba"),__ref,88);
...
try {
		Debug.PushSubsStack("Label13Time_Click (formmaquinaria) ","formmaquinaria",10,__ref.getField(false, "ba"),__ref,371);
...
try {
		Debug.PushSubsStack("Label1Back_Click (formmaquinaria) ","formmaquinaria",10,__ref.getField(false, "ba"),__ref,509);
...
try {
		Debug.PushSubsStack("SD_xComboBoxHacienda_ItemClick (formmaquinaria) ","formmaquinaria",10,__ref.getField(false, "ba"),__ref,317);
...
Debug.ShouldStop(16777216);
parent.__c.runVoidMethod ("LogImpl","515204380",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
try {
		Debug.PushSubsStack("SD_xComboBoxImplemento_ItemClick (formmaquinaria) ","formmaquinaria",10,__ref.getField(false, "ba"),__ref,427);
...
try {
		Debug.PushSubsStack("SD_xComboBoxImplemento2_ItemClick (formmaquinaria) ","formmaquinaria",10,__ref.getField(false, "ba"),__ref,433);
...
try {
		Debug.PushSubsStack("SD_xComboBoxLabor_ItemClick (formmaquinaria) ","formmaquinaria",10,__ref.getField(false, "ba"),__ref,418);
...
try {
		Debug.PushSubsStack("SD_xComboBoxLote_ItemClick (formmaquinaria) ","formmaquinaria",10,__ref.getField(false, "ba"),__ref,422);
...
Debug.ShouldStop(128);
formmaquinaria.__c.runVoidMethod ("LogImpl","515663106",__ref.getField(true,"_lote" /*RemoteObject*/ ),0);
...
try {
		Debug.PushSubsStack("SD_xComboBoxMaquina_ItemClick (formmaquinaria) ","formmaquinaria",10,__ref.getField(false, "ba"),__ref,412);
...
try {
		Debug.PushSubsStack("SD_xComboBoxNit_ItemClick (formmaquinaria) ","formmaquinaria",10,__ref.getField(false, "ba"),__ref,282);
...
Debug.ShouldStop(2097152);
parent.__c.runVoidMethod ("LogImpl","515138844",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
try {
		Debug.PushSubsStack("SD_xComboBoxObservaciones_ItemClick (formmaquinaria) ","formmaquinaria",10,__ref.getField(false, "ba"),__ref,443);
...
try {
		Debug.PushSubsStack("SD_xComboBoxOperario_ItemClick (formmaquinaria) ","formmaquinaria",10,__ref.getField(false, "ba"),__ref,438);
...
try {
		Debug.PushSubsStack("SwiftButtonHacienda_Click (formmaquinaria) ","formmaquinaria",10,__ref.getField(false, "ba"),__ref,580);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 581;BA.debugLine="Dim ItemsLote As List";
Debug.ShouldStop(16);
_itemslote = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("ItemsLote", _itemslote);
 BA.debugLineNum = 582;BA.debugLine="ItemsLote.Initialize";
Debug.ShouldStop(32);
_itemslote.runVoidMethod ("Initialize");
 BA.debugLineNum = 584;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateHacie";
Debug.ShouldStop(128);
...
;
 BA.debugLineNum = 585;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
Debug.ShouldStop(256);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 586;BA.debugLine="SwiftButtonHacienda.xLBL.Text = SearchTemplateHa";
Debug.ShouldStop(512);
__ref.getField(false,"_swiftbuttonhacienda" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(__ref.getField(false,"_searchtemplatehacienda" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));
 BA.debugLineNum = 587;BA.debugLine="Dim HACIENDACOMPLETO As String = SearchTemplateH";
Debug.ShouldStop(1024);
_haciendacompleto = __ref.getField(false,"_searchtemplatehacienda" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ );Debug.locals.put("HACIENDACOMPLETO", _haciendacompleto);Debug.locals.put("HACIENDACOMPLETO", _haciendacompleto);
 BA.debugLineNum = 588;BA.debugLine="Dim Partes() As String = Regex.Split(\":\", HACIEN";
Debug.ShouldStop(2048);
_partes = parent.__c.getField(false,"Regex").runMethod(false,"Split",(Object)(BA.ObjectToString(":")),(Object)(_haciendacompleto));Debug.locals.put("Partes", _partes);Debug.locals.put("Partes", _partes);
 BA.debugLineNum = 589;BA.debugLine="haciendaCBX = Partes(0)";
Debug.ShouldStop(4096);
__ref.setField ("_haciendacbx" /*RemoteObject*/ ,_partes.getArrayElement(true,BA.numberCast(int.class, 0)));
 BA.debugLineNum = 590;BA.debugLine="ItemsLote.Clear";
Debug.ShouldStop(8192);
_itemslote.runVoidMethod ("Clear");
 BA.debugLineNum = 591;BA.debugLine="ItemsLote.Add(\"Seleccionar:\")";
Debug.ShouldStop(16384);
_itemslote.runVoidMethod ("Add",(Object)((RemoteObject.createImmutable("Seleccionar:"))));
 BA.debugLineNum = 592;BA.debugLine="SwiftButtonLote.xLBL.Text = \"\"";
Debug.ShouldStop(32768);
__ref.getField(false,"_swiftbuttonlote" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(""));
 BA.debugLineNum = 594;BA.debugLine="Dim Req As DBRequestManager";
Debug.ShouldStop(131072);
_req = RemoteObject.createNew ("b4a.example.ef.dbrequestmanager");Debug.locals.put("Req", _req);
 BA.debugLineNum = 595;BA.debugLine="Req.Initialize(Me, rdcLink & \"?DBName=\" & Main.p";
Debug.ShouldStop(262144);
_req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(__ref),(Object)(RemoteObject.concat(__ref.getField(true,"_rdclink" /*RemoteObject*/ ),RemoteObject.createImmutable("?DBName="),parent._main._pdbname /*RemoteObject*/ )));
 BA.debugLineNum = 596;BA.debugLine="Dim cmd As DBCommand = CreateCommand(\"select_lot";
Debug.ShouldStop(524288);
_cmd = __ref.runClassMethod (b4a.example.ef.formmaquinaria.class, "_createcommand" /*RemoteObject*/ ,(Object)(BA.ObjectToString("select_lotes")),(Object)(RemoteObject.createNewArray("Object",new int[] {2},new Object[] {(__ref.getField(true,"_nitempresacbx" /*RemoteObject*/ )),(__ref.getField(true,"_haciendacbx" /*RemoteObject*/ ))})));Debug.locals.put("cmd", _cmd);Debug.locals.put("cmd", _cmd);
 BA.debugLineNum = 599;BA.debugLine="Wait For (Req.ExecuteQuery(cmd, 0, Null)) JobDon";
Debug.ShouldStop(4194304);
...
_j = (RemoteObject) result.getArrayElement(false,RemoteObject.createImmutable(1));Debug.locals.put("j", _j);
;
 BA.debugLineNum = 602;BA.debugLine="If j.Success Then";
Debug.ShouldStop(33554432);
if (true) break;
...
//C
this.state = 7;
 BA.debugLineNum = 604;BA.debugLine="Req.HandleJobAsync(j, \"req\")";
Debug.ShouldStop(134217728);
_req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_handlejobasync" /*void*/ ,(Object)(_j),(Object)(RemoteObject.createImmutable("req")));
 BA.debugLineNum = 605;BA.debugLine="Wait For (Req) req_Result(res As DBResult)";
Debug.ShouldStop(268435456);
...
_res = (RemoteObject) result.getArrayElement(false,RemoteObject.createImmutable(1));Debug.locals.put("res", _res);
;
 BA.debugLineNum = 609;BA.debugLine="For Each row() As Object In res.Rows";
Debug.ShouldStop(1);
if (true) break;
...
//C
this.state = 19;
 BA.debugLineNum = 610;BA.debugLine="Dim Codg_Hacienda As String = row(0)";
Debug.ShouldStop(2);
_codg_hacienda = BA.ObjectToString(_row.getArrayElement(false,BA.numberCast(int.class, 0)));Debug.locals.put("Codg_Hacienda", _codg_hacienda);Debug.locals.put("Codg_Hacienda", _codg_hacienda);
 BA.debugLineNum = 614;BA.debugLine="ItemsLote.Add(Codg_Hacienda)";
Debug.ShouldStop(32);
...
//C
this.state = 13;
 BA.debugLineNum = 619;BA.debugLine="Log(\"Error: \" & j.ErrorMessage)";
Debug.ShouldStop(1024);
parent.__c.runVoidMethod ("LogImpl","583165223",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
this.state = 14;
;
 BA.debugLineNum = 621;BA.debugLine="SearchTemplateLote.SetItems(ItemsLote)";
Debug.ShouldStop(4096);
__ref.getField(false,"_searchtemplatelote" /*RemoteObject*/ ).runClassMethod (b4a.example.ef.b4xsearchtemplate.class, "_setitems" /*RemoteObject*/ ,(Object)(_itemslote));
 BA.debugLineNum = 622;BA.debugLine="SwiftButtonLote.Enabled = True";
Debug.ShouldStop(8192);
__ref.getField(false,"_swiftbuttonlote" /*RemoteObject*/ ).runClassMethod (b4a.example.ef.swiftbutton.class, "_setenabled" /*RemoteObject*/ ,parent.__c.getField(true,"True"));
 BA.debugLineNum = 624;BA.debugLine="j.Release";
Debug.ShouldStop(32768);
_j.runClassMethod (b4a.example.ef.httpjob.class, "_release" /*RemoteObject*/ );
 if (true) break;
...
try {
		Debug.PushSubsStack("SwiftButtonImplemento_Click (formmaquinaria) ","formmaquinaria",10,__ref.getField(false, "ba"),__ref,636);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 637;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateImple";
Debug.ShouldStop(268435456);
...
//C
this.state = 4;
 BA.debugLineNum = 639;BA.debugLine="SwiftButtonImplemento.xLBL.Text = SearchTemplate";
Debug.ShouldStop(1073741824);
...
try {
		Debug.PushSubsStack("SwiftButtonImplemento2_Click (formmaquinaria) ","formmaquinaria",10,__ref.getField(false, "ba"),__ref,643);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 644;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateImple";
Debug.ShouldStop(8);
...
_result = (RemoteObject) result.getArrayElement(true,RemoteObject.createImmutable(1));Debug.locals.put("Result", _result);
;
 BA.debugLineNum = 645;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
Debug.ShouldStop(16);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 646;BA.debugLine="SwiftButtonImplemento2.xLBL.Text = SearchTemplat";
Debug.ShouldStop(32);
...
try {
		Debug.PushSubsStack("SwiftButtonLabor_Click (formmaquinaria) ","formmaquinaria",10,__ref.getField(false, "ba"),__ref,521);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 522;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateLabor";
Debug.ShouldStop(512);
...
//C
this.state = 4;
 BA.debugLineNum = 524;BA.debugLine="SwiftButtonLabor.xLBL.Text = SearchTemplateLabor";
Debug.ShouldStop(2048);
__ref.getField(false,"_swiftbuttonlabor" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(__ref.getField(false,"_searchtemplatelabor" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));
 BA.debugLineNum = 525;BA.debugLine="Dim LABORCOMPLETO As String = SearchTemplateLabo";
Debug.ShouldStop(4096);
...
try {
		Debug.PushSubsStack("SwiftButtonLote_Click (formmaquinaria) ","formmaquinaria",10,__ref.getField(false, "ba"),__ref,629);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 630;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateLote,";
Debug.ShouldStop(2097152);
...
_result = (RemoteObject) result.getArrayElement(true,RemoteObject.createImmutable(1));Debug.locals.put("Result", _result);
;
 BA.debugLineNum = 631;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
Debug.ShouldStop(4194304);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 632;BA.debugLine="SwiftButtonLote.xLBL.Text = SearchTemplateLote.S";
Debug.ShouldStop(8388608);
...
try {
		Debug.PushSubsStack("SwiftButtonMaquina_Click (formmaquinaria) ","formmaquinaria",10,__ref.getField(false, "ba"),__ref,513);
...
b4a.example.ef.formmaquinaria parent;
RemoteObject _result = RemoteObject.createImmutable(0);
RemoteObject _maquinacompleto = RemoteObject.createImmutable("");
...
_result = (RemoteObject) result.getArrayElement(true,RemoteObject.createImmutable(1));Debug.locals.put("Result", _result);
;
 BA.debugLineNum = 515;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
Debug.ShouldStop(4);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 516;BA.debugLine="SwiftButtonMaquina.xLBL.Text = SearchTemplateMaq";
Debug.ShouldStop(8);
__ref.getField(false,"_swiftbuttonmaquina" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(__ref.getField(false,"_searchtemplatemaquina" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));
 BA.debugLineNum = 517;BA.debugLine="Dim MAQUINACOMPLETO As String = SearchTemplateMa";
Debug.ShouldStop(16);
_maquinacompleto = __ref.getField(false,"_searchtemplatemaquina" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ );Debug.locals.put("MAQUINACOMPLETO", _maquinacompleto);Debug.locals.put("MAQUINACOMPLETO", _maquinacompleto);
 if (true) break;
...
try {
		Debug.PushSubsStack("SwiftButtonNit_Click (formmaquinaria) ","formmaquinaria",10,__ref.getField(false, "ba"),__ref,529);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 530;BA.debugLine="Dim ItemsHacienda As List";
Debug.ShouldStop(131072);
_itemshacienda = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("ItemsHacienda", _itemshacienda);
 BA.debugLineNum = 531;BA.debugLine="ItemsHacienda.Initialize";
Debug.ShouldStop(262144);
_itemshacienda.runVoidMethod ("Initialize");
 BA.debugLineNum = 532;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateNit,";
Debug.ShouldStop(524288);
...
//C
this.state = 4;
 BA.debugLineNum = 534;BA.debugLine="SwiftButtonNit.xLBL.Text = SearchTemplateNit.Sel";
Debug.ShouldStop(2097152);
__ref.getField(false,"_swiftbuttonnit" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(__ref.getField(false,"_searchtemplatenit" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ )));
 BA.debugLineNum = 535;BA.debugLine="Dim NITCOMPLETO As String = SearchTemplateNit.Se";
Debug.ShouldStop(4194304);
_nitcompleto = __ref.getField(false,"_searchtemplatenit" /*RemoteObject*/ ).getField(true,"_selecteditem" /*RemoteObject*/ );Debug.locals.put("NITCOMPLETO", _nitcompleto);Debug.locals.put("NITCOMPLETO", _nitcompleto);
 BA.debugLineNum = 536;BA.debugLine="Dim Partes() As String = Regex.Split(\":\", NITCOM";
Debug.ShouldStop(8388608);
_partes = parent.__c.getField(false,"Regex").runMethod(false,"Split",(Object)(BA.ObjectToString(":")),(Object)(_nitcompleto));Debug.locals.put("Partes", _partes);Debug.locals.put("Partes", _partes);
 BA.debugLineNum = 537;BA.debugLine="nitEmpresaCBX = Partes(0)";
Debug.ShouldStop(16777216);
__ref.setField ("_nitempresacbx" /*RemoteObject*/ ,_partes.getArrayElement(true,BA.numberCast(int.class, 0)));
 BA.debugLineNum = 538;BA.debugLine="ItemsHacienda.Clear";
Debug.ShouldStop(33554432);
_itemshacienda.runVoidMethod ("Clear");
 BA.debugLineNum = 539;BA.debugLine="ItemsHacienda.Add(\"Seleccionar:\")";
Debug.ShouldStop(67108864);
_itemshacienda.runVoidMethod ("Add",(Object)((RemoteObject.createImmutable("Seleccionar:"))));
 BA.debugLineNum = 540;BA.debugLine="SwiftButtonHacienda.xLBL.Text = \"\"";
Debug.ShouldStop(134217728);
__ref.getField(false,"_swiftbuttonhacienda" /*RemoteObject*/ ).getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(""));
 BA.debugLineNum = 542;BA.debugLine="Dim Req As DBRequestManager";
Debug.ShouldStop(536870912);
_req = RemoteObject.createNew ("b4a.example.ef.dbrequestmanager");Debug.locals.put("Req", _req);
 BA.debugLineNum = 543;BA.debugLine="Req.Initialize(Me, rdcLink & \"?DBName=\" & Main.p";
Debug.ShouldStop(1073741824);
_req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(__ref),(Object)(RemoteObject.concat(__ref.getField(true,"_rdclink" /*RemoteObject*/ ),RemoteObject.createImmutable("?DBName="),parent._main._pdbname /*RemoteObject*/ )));
 BA.debugLineNum = 544;BA.debugLine="Dim cmd As DBCommand = CreateCommand(\"select_hac";
Debug.ShouldStop(-2147483648);
_cmd = __ref.runClassMethod (b4a.example.ef.formmaquinaria.class, "_createcommand" /*RemoteObject*/ ,(Object)(BA.ObjectToString("select_haciendas")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {(__ref.getField(true,"_nitempresacbx" /*RemoteObject*/ ))})));Debug.locals.put("cmd", _cmd);Debug.locals.put("cmd", _cmd);
 BA.debugLineNum = 547;BA.debugLine="Wait For (Req.ExecuteQuery(cmd, 0, Null)) JobDon";
Debug.ShouldStop(4);
parent.__c.runVoidMethod ("WaitFor","jobdone", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "formmaquinaria", "swiftbuttonnit_click"), (_req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_executequery" /*RemoteObject*/ ,(Object)(_cmd),(Object)(BA.numberCast(int.class, 0)),(Object)(parent.__c.getField(false,"Null")))));
this.state = 16;
return;
...
_j = (RemoteObject) result.getArrayElement(false,RemoteObject.createImmutable(1));Debug.locals.put("j", _j);
;
 BA.debugLineNum = 550;BA.debugLine="If j.Success Then";
Debug.ShouldStop(32);
if (true) break;
...
//C
this.state = 7;
 BA.debugLineNum = 552;BA.debugLine="Req.HandleJobAsync(j, \"req\")";
Debug.ShouldStop(128);
_req.runClassMethod (b4a.example.ef.dbrequestmanager.class, "_handlejobasync" /*void*/ ,(Object)(_j),(Object)(RemoteObject.createImmutable("req")));
 BA.debugLineNum = 553;BA.debugLine="Wait For (Req) req_Result(res As DBResult)";
Debug.ShouldStop(256);
...
_res = (RemoteObject) result.getArrayElement(false,RemoteObject.createImmutable(1));Debug.locals.put("res", _res);
;
 BA.debugLineNum = 557;BA.debugLine="For Each row() As Object In res.Rows";
Debug.ShouldStop(4096);
if (true) break;
...
//C
this.state = 19;
 BA.debugLineNum = 558;BA.debugLine="Dim Codg_Hacienda As String = row(0)";
Debug.ShouldStop(8192);
_codg_hacienda = BA.ObjectToString(_row.getArrayElement(false,BA.numberCast(int.class, 0)));Debug.locals.put("Codg_Hacienda", _codg_hacienda);Debug.locals.put("Codg_Hacienda", _codg_hacienda);
 BA.debugLineNum = 559;BA.debugLine="Dim NombreHacienda As String = row(1)";
Debug.ShouldStop(16384);
_nombrehacienda = BA.ObjectToString(_row.getArrayElement(false,BA.numberCast(int.class, 1)));Debug.locals.put("NombreHacienda", _nombrehacienda);Debug.locals.put("NombreHacienda", _nombrehacienda);
 BA.debugLineNum = 564;BA.debugLine="ItemsHacienda.Add(Codg_Hacienda&\":\"&NombreHaci";
Debug.ShouldStop(524288);
...
//C
this.state = 13;
 BA.debugLineNum = 569;BA.debugLine="Log(\"Error: \" & j.ErrorMessage)";
Debug.ShouldStop(16777216);
parent.__c.runVoidMethod ("LogImpl","583099688",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
this.state = 14;
;
 BA.debugLineNum = 571;BA.debugLine="SearchTemplateHacienda.SetItems(ItemsHacienda)";
Debug.ShouldStop(67108864);
__ref.getField(false,"_searchtemplatehacienda" /*RemoteObject*/ ).runClassMethod (b4a.example.ef.b4xsearchtemplate.class, "_setitems" /*RemoteObject*/ ,(Object)(_itemshacienda));
 BA.debugLineNum = 572;BA.debugLine="SwiftButtonHacienda.Enabled = True";
Debug.ShouldStop(134217728);
__ref.getField(false,"_swiftbuttonhacienda" /*RemoteObject*/ ).runClassMethod (b4a.example.ef.swiftbutton.class, "_setenabled" /*RemoteObject*/ ,parent.__c.getField(true,"True"));
 BA.debugLineNum = 573;BA.debugLine="Log(nitEmpresaCBX)";
Debug.ShouldStop(268435456);
parent.__c.runVoidMethod ("LogImpl","583099692",__ref.getField(true,"_nitempresacbx" /*RemoteObject*/ ),0);
...
try {
		Debug.PushSubsStack("SwiftButtonObservaciones_Click (formmaquinaria) ","formmaquinaria",10,__ref.getField(false, "ba"),__ref,657);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 658;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateObser";
Debug.ShouldStop(131072);
...
//C
this.state = 4;
 BA.debugLineNum = 660;BA.debugLine="SwiftButtonObservaciones.xLBL.Text = SearchTempl";
Debug.ShouldStop(524288);
...
try {
		Debug.PushSubsStack("SwiftButtonOperario_Click (formmaquinaria) ","formmaquinaria",10,__ref.getField(false, "ba"),__ref,650);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 651;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateOpera";
Debug.ShouldStop(1024);
...
_result = (RemoteObject) result.getArrayElement(true,RemoteObject.createImmutable(1));Debug.locals.put("Result", _result);
;
 BA.debugLineNum = 652;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
Debug.ShouldStop(2048);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 653;BA.debugLine="SwiftButtonOperario.xLBL.Text = SearchTemplateOp";
Debug.ShouldStop(4096);
