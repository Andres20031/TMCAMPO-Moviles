...
formprogramacampoaplazar.__c.runVoidMethod ("LogImpl","069730324",__ref.getField(true,"_fecha" /*RemoteObject*/ ),0);
...
Debug.ShouldStop(8);
parent.__c.runVoidMethod ("LogImpl","069926913",RemoteObject.concat(RemoteObject.createImmutable("El consecutivo: "),__ref.getField(false,"_label8" /*RemoteObject*/ ).runMethod(true,"getText")),0);
...
parent.__c.runVoidMethod ("LogImpl","069926951",RemoteObject.concat(RemoteObject.createImmutable("Fecha_Programa_LaborAntes: "),__ref.getField(true,"_fecha_programa_laborantes" /*RemoteObject*/ )),0);
 BA.debugLineNum = 139;BA.debugLine="Log(\"Area_Programa_LaborAntes: \" & Area_Programa_";
Debug.ShouldStop(1024);
parent.__c.runVoidMethod ("LogImpl","069926952",RemoteObject.concat(RemoteObject.createImmutable("Area_Programa_LaborAntes: "),__ref.getField(true,"_area_programa_laborantes" /*RemoteObject*/ )),0);
 BA.debugLineNum = 140;BA.debugLine="Log(\"ObservacionAntes: \"& ObservacionAntes)";
Debug.ShouldStop(2048);
parent.__c.runVoidMethod ("LogImpl","069926953",RemoteObject.concat(RemoteObject.createImmutable("ObservacionAntes: "),__ref.getField(true,"_observacionantes" /*RemoteObject*/ )),0);
 BA.debugLineNum = 141;BA.debugLine="Log(\"FECHA: \"&fecha)";
Debug.ShouldStop(4096);
parent.__c.runVoidMethod ("LogImpl","069926954",RemoteObject.concat(RemoteObject.createImmutable("FECHA: "),__ref.getField(true,"_fecha" /*RemoteObject*/ )),0);
 BA.debugLineNum = 142;BA.debugLine="Log(\"AREA: \"&area)";
Debug.ShouldStop(8192);
parent.__c.runVoidMethod ("LogImpl","069926955",RemoteObject.concat(RemoteObject.createImmutable("AREA: "),__ref.getField(true,"_area" /*RemoteObject*/ )),0);
 BA.debugLineNum = 143;BA.debugLine="Log(\"OBSERVACION: \"&Observacion)";
Debug.ShouldStop(16384);
parent.__c.runVoidMethod ("LogImpl","069926956",RemoteObject.concat(RemoteObject.createImmutable("OBSERVACION: "),__ref.getField(true,"_observacion" /*RemoteObject*/ )),0);
...
Debug.ShouldStop(32);
parent.__c.runVoidMethod ("LogImpl","069926979",RemoteObject.concat(RemoteObject.createImmutable("Error al ejecutar la consulta: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(256);
parent.__c.runVoidMethod ("LogImpl","069926982",RemoteObject.concat(RemoteObject.createImmutable("Error al agregar datos: "),parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba")).runMethod(true,"getMessage")),0);
 if (true) break;
if (true) break;
...
Debug.ShouldStop(16777216);
formprogramacampoaplazar.__c.runVoidMethod ("LogImpl","069795843",RemoteObject.concat(RemoteObject.createImmutable("EL area nueva es: "),__ref.getField(true,"_area" /*RemoteObject*/ )),0);
...
Debug.ShouldStop(1073741824);
formprogramacampoaplazar.__c.runVoidMethod ("LogImpl","069861379",RemoteObject.concat(RemoteObject.createImmutable("la observacion es "),__ref.getField(true,"_observacion" /*RemoteObject*/ )),0);
