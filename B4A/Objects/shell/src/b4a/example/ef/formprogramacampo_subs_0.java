...
formprogramacampo.__c.runVoidMethod ("LogImpl","052887572",__ref.getField(true,"_fechainicio" /*RemoteObject*/ ),0);
...
Debug.ShouldStop(32);
formprogramacampo.__c.runVoidMethod ("LogImpl","053018644",__ref.getField(true,"_fechafin" /*RemoteObject*/ ),0);
...
parent.__c.runVoidMethod ("LogImpl","052756487",RemoteObject.concat(RemoteObject.createImmutable("FECHA DE INICIO: "),__ref.getField(true,"_fechainicio" /*RemoteObject*/ )),0);
 BA.debugLineNum = 47;BA.debugLine="Log (\"FECHA DE FIN: \"&fechaFin)";
Debug.ShouldStop(16384);
parent.__c.runVoidMethod ("LogImpl","052756488",RemoteObject.concat(RemoteObject.createImmutable("FECHA DE FIN: "),__ref.getField(true,"_fechafin" /*RemoteObject*/ )),0);
 BA.debugLineNum = 48;BA.debugLine="Log (\"AREA: \"&area)";
Debug.ShouldStop(32768);
parent.__c.runVoidMethod ("LogImpl","052756489",RemoteObject.concat(RemoteObject.createImmutable("AREA: "),__ref.getField(true,"_area" /*RemoteObject*/ )),0);
 BA.debugLineNum = 49;BA.debugLine="Log (\"OBSERVACION: \"&Observacion)";
Debug.ShouldStop(65536);
parent.__c.runVoidMethod ("LogImpl","052756490",RemoteObject.concat(RemoteObject.createImmutable("OBSERVACION: "),__ref.getField(true,"_observacion" /*RemoteObject*/ )),0);
 BA.debugLineNum = 50;BA.debugLine="Log(\"fechaActual: \" & fechaActual)";
Debug.ShouldStop(131072);
parent.__c.runVoidMethod ("LogImpl","052756491",RemoteObject.concat(RemoteObject.createImmutable("fechaActual: "),_fechaactual),0);
 BA.debugLineNum = 51;BA.debugLine="Log(\"horaSistema: \" & horaSistema)";
Debug.ShouldStop(262144);
parent.__c.runVoidMethod ("LogImpl","052756492",RemoteObject.concat(RemoteObject.createImmutable("horaSistema: "),_horasistema),0);
...
Debug.ShouldStop(512);
parent.__c.runVoidMethod ("LogImpl","052756515",RemoteObject.concat(RemoteObject.createImmutable("Error al ejecutar la consulta: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(4096);
parent.__c.runVoidMethod ("LogImpl","052756518",RemoteObject.concat(RemoteObject.createImmutable("Error al agregar datos: "),parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba")).runMethod(true,"getMessage")),0);
 if (true) break;
if (true) break;
...
Debug.ShouldStop(16384);
formprogramacampo.__c.runVoidMethod ("LogImpl","053149698",RemoteObject.concat(RemoteObject.createImmutable("El area es:"),__ref.getField(true,"_area" /*RemoteObject*/ )),0);
...
Debug.ShouldStop(1048576);
formprogramacampo.__c.runVoidMethod ("LogImpl","053215235",RemoteObject.concat(RemoteObject.createImmutable("La observacion es: "),__ref.getField(true,"_observacion" /*RemoteObject*/ )),0);
