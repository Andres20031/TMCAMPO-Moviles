...
Debug.ShouldStop(4096);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","8983045",RemoteObject.createImmutable("JA EXISTEM ITENS"),0);
 if (true) break;
...
Debug.ShouldStop(2048);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","8983076",RemoteObject.concat(RemoteObject.createImmutable("ERROR: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(536870912);
starter.mostCurrent.__c.runVoidMethod ("LogImpl","8917519",BA.ObjectToString(starter.mostCurrent.__c.runMethod(false,"LastException",starter.processBA)),0);
 };
...
Debug.ShouldStop(512);
starter.mostCurrent.__c.runVoidMethod ("LogImpl","81048587",RemoteObject.concat(RemoteObject.createImmutable("Erro 0005: "),starter.mostCurrent.__c.runMethod(false,"LastException",starter.processBA)),0);
 };
