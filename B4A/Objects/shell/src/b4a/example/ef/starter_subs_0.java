...
try {
		Debug.PushSubsStack("Application_Error (starter) ","starter",7,starter.processBA,starter.mostCurrent,151);
...
try {
		Debug.PushSubsStack("CreateCommand (starter) ","starter",7,starter.processBA,starter.mostCurrent,167);
...
try {
		Debug.PushSubsStack("CreateRequest (starter) ","starter",7,starter.processBA,starter.mostCurrent,161);
...
try {
		Debug.PushSubsStack("insertNamesInsumos (starter) ","starter",7,starter.processBA,starter.mostCurrent,72);
...
Debug.ShouldStop(4096);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","36291461",RemoteObject.createImmutable("JA EXISTEM ITENS"),0);
 if (true) break;
...
Debug.ShouldStop(2048);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","36291492",RemoteObject.concat(RemoteObject.createImmutable("ERROR: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
try {
		Debug.PushSubsStack("Service_Create (starter) ","starter",7,starter.processBA,starter.mostCurrent,15);
...
Debug.ShouldStop(536870912);
starter.mostCurrent.__c.runVoidMethod ("LogImpl","36225935",BA.ObjectToString(starter.mostCurrent.__c.runMethod(false,"LastException",starter.processBA)),0);
 };
...
try {
		Debug.PushSubsStack("Service_Destroy (starter) ","starter",7,starter.processBA,starter.mostCurrent,155);
...
try {
		Debug.PushSubsStack("Service_Start (starter) ","starter",7,starter.processBA,starter.mostCurrent,142);
...
try {
		Debug.PushSubsStack("Service_TaskRemoved (starter) ","starter",7,starter.processBA,starter.mostCurrent,146);
...
try {
		Debug.PushSubsStack("updateInsumo (starter) ","starter",7,starter.processBA,starter.mostCurrent,127);
...
Debug.ShouldStop(512);
starter.mostCurrent.__c.runVoidMethod ("LogImpl","36357003",RemoteObject.concat(RemoteObject.createImmutable("Erro 0005: "),starter.mostCurrent.__c.runMethod(false,"LastException",starter.processBA)),0);
 };
