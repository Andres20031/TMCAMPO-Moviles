...
try {
		Debug.PushSubsStack("B4XPage_Appear (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,101);
...
try {
		Debug.PushSubsStack("Button1LOGIN_Click (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,105);
...
try {
		Debug.PushSubsStack("CreateCommand (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,205);
...
try {
		Debug.PushSubsStack("CreateRequest (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,199);
...
try {
		Debug.PushSubsStack("GetRecordUser (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,137);
...
Debug.ShouldStop(67108864);
parent.__c.runVoidMethod ("LogImpl","5655410",RemoteObject.concat(RemoteObject.createImmutable("Usuario: "),__ref.getField(true,"_parametrosusuario" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(2);
parent.__c.runVoidMethod ("LogImpl","5655417",RemoteObject.concat(RemoteObject.createImmutable("ERROR: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
...
try {
		Debug.PushSubsStack("Initialize (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,44);
