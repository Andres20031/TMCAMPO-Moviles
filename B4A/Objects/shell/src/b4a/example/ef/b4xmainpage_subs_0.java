...
Debug.ShouldStop(67108864);
parent.__c.runVoidMethod ("LogImpl","8917554",RemoteObject.concat(RemoteObject.createImmutable("Usuario: "),__ref.getField(true,"_parametrosusuario" /*RemoteObject*/ )),0);
 if (true) break;
...
Debug.ShouldStop(2);
parent.__c.runVoidMethod ("LogImpl","8917561",RemoteObject.concat(RemoteObject.createImmutable("ERROR: "),_j.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 if (true) break;
