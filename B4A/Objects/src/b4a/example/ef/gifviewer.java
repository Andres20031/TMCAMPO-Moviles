...
RDebugUtils.currentLine=70385664;
 //BA.debugLineNum = 70385664;BA.debugLine="Public Sub Start";
RDebugUtils.currentLine=70385665;
 //BA.debugLineNum = 70385665;BA.debugLine="mBase.Visible = True";
__ref._mbase /*anywheresoftware.b4a.objects.PanelWrapper*/ .setVisible(__c.True);
RDebugUtils.currentLine=70385666;
 //BA.debugLineNum = 70385666;BA.debugLine="WorkIndex = WorkIndex + 1";
__ref._workindex /*int*/  = (int) (__ref._workindex /*int*/ +1);
RDebugUtils.currentLine=70385667;
 //BA.debugLineNum = 70385667;BA.debugLine="ShowImpl(WorkIndex)";
...
RDebugUtils.currentLine=70451200;
 //BA.debugLineNum = 70451200;BA.debugLine="Public Sub Stop";
RDebugUtils.currentLine=70451201;
 //BA.debugLineNum = 70451201;BA.debugLine="mBase.Visible = False";
__ref._mbase /*anywheresoftware.b4a.objects.PanelWrapper*/ .setVisible(__c.False);
RDebugUtils.currentLine=70451202;
 //BA.debugLineNum = 70451202;BA.debugLine="WorkIndex = WorkIndex + 1";
__ref._workindex /*int*/  = (int) (__ref._workindex /*int*/ +1);
...
RDebugUtils.currentLine=70320128;
 //BA.debugLineNum = 70320128;BA.debugLine="Public Sub SetGif (Dir As String, FileName As Stri";
RDebugUtils.currentLine=70320129;
 //BA.debugLineNum = 70320129;BA.debugLine="If Dir = File.DirAssets Then";
if ((_dir).equals(__c.File.getDirAssets())) { 
RDebugUtils.currentLine=70320130;
 //BA.debugLineNum = 70320130;BA.debugLine="File.Copy(File.DirAssets, FileName, File.DirInte";
__c.File.Copy(__c.File.getDirAssets(),_filename,__c.File.getDirInternal(),_filename);
RDebugUtils.currentLine=70320131;
 //BA.debugLineNum = 70320131;BA.debugLine="Dir = File.DirInternal";
_dir = __c.File.getDirInternal();
 };
RDebugUtils.currentLine=70320133;
 //BA.debugLineNum = 70320133;BA.debugLine="Dim path As String = File.Combine(Dir, FileName)";
_path = __c.File.Combine(_dir,_filename);
RDebugUtils.currentLine=70320134;
 //BA.debugLineNum = 70320134;BA.debugLine="If Main.GifsCache.IsInitialized = False Then Main";
...
RDebugUtils.currentLine=70320135;
 //BA.debugLineNum = 70320135;BA.debugLine="If Main.GifsCache.ContainsKey(path) Then";
...
RDebugUtils.currentLine=70320136;
 //BA.debugLineNum = 70320136;BA.debugLine="bitmaps = Main.GifsCache.Get(path)";
...
RDebugUtils.currentLine=70320142;
 //BA.debugLineNum = 70320142;BA.debugLine="Dim bd As BitmapAndDelay";
_bd = new b4a.example.ef.gifviewer._bitmapanddelay();
RDebugUtils.currentLine=70320143;
 //BA.debugLineNum = 70320143;BA.debugLine="bd.Initialize";
_bd.Initialize();
RDebugUtils.currentLine=70320144;
 //BA.debugLineNum = 70320144;BA.debugLine="bd.bmp = gd.Frame(i)";
...
RDebugUtils.currentLine=70320145;
 //BA.debugLineNum = 70320145;BA.debugLine="bd.Delay = gd.Delay(i)";
_bd.Delay /*int*/  = _gd.Delay(_i);
RDebugUtils.currentLine=70320146;
 //BA.debugLineNum = 70320146;BA.debugLine="bitmaps.Add(bd)";
__ref._bitmaps /*anywheresoftware.b4a.objects.collections.List*/ .Add((Object)(_bd));
 }
};
RDebugUtils.currentLine=70320148;
 //BA.debugLineNum = 70320148;BA.debugLine="Main.GifsCache.Put(path, bitmaps)";
...
RDebugUtils.currentLine=70320151;
 //BA.debugLineNum = 70320151;BA.debugLine="Dim FirstFrame As BitmapAndDelay = bitmaps.Get(0)";
...
RDebugUtils.currentLine=70320152;
 //BA.debugLineNum = 70320152;BA.debugLine="Dim FirstBmp As Bitmap = FirstFrame.bmp";
...
RDebugUtils.currentLine=70320153;
 //BA.debugLineNum = 70320153;BA.debugLine="If FirstBmp.Width < mBase.Width Or FirstBmp.Heigh";
...
RDebugUtils.currentLine=70320154;
 //BA.debugLineNum = 70320154;BA.debugLine="BDGravity = Gravity.CENTER";
__ref._bdgravity /*int*/  = __c.Gravity.CENTER;
 }else {
RDebugUtils.currentLine=70320156;
 //BA.debugLineNum = 70320156;BA.debugLine="BDGravity = Gravity.FILL";
__ref._bdgravity /*int*/  = __c.Gravity.FILL;
 };
RDebugUtils.currentLine=70320159;
 //BA.debugLineNum = 70320159;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=70516736;
 //BA.debugLineNum = 70516736;BA.debugLine="Public Sub CallFromResume";
RDebugUtils.currentLine=70516737;
 //BA.debugLineNum = 70516737;BA.debugLine="If mBase.Visible Then Start";
...
RDebugUtils.currentLine=70123521;
 //BA.debugLineNum = 70123521;BA.debugLine="Private mEventName As String 'ignore";
_meventname = "";
RDebugUtils.currentLine=70123522;
 //BA.debugLineNum = 70123522;BA.debugLine="Private mCallBack As Object 'ignore";
_mcallback = new Object();
RDebugUtils.currentLine=70123523;
 //BA.debugLineNum = 70123523;BA.debugLine="Private mBase As Panel";
_mbase = new anywheresoftware.b4a.objects.PanelWrapper();
RDebugUtils.currentLine=70123524;
 //BA.debugLineNum = 70123524;BA.debugLine="Private Const DefaultColorConstant As Int = -9848";
_defaultcolorconstant = (int) (-984833);
RDebugUtils.currentLine=70123525;
 //BA.debugLineNum = 70123525;BA.debugLine="Private WorkIndex As Int";
_workindex = 0;
RDebugUtils.currentLine=70123526;
 //BA.debugLineNum = 70123526;BA.debugLine="Private BDGravity As Int";
_bdgravity = 0;
RDebugUtils.currentLine=70123527;
 //BA.debugLineNum = 70123527;BA.debugLine="Private bitmaps As List";
_bitmaps = new anywheresoftware.b4a.objects.collections.List();
RDebugUtils.currentLine=70123528;
 //BA.debugLineNum = 70123528;BA.debugLine="Type BitmapAndDelay (bmp As Bitmap, Delay As Int)";
;
...
RDebugUtils.currentLine=70254592;
 //BA.debugLineNum = 70254592;BA.debugLine="Public Sub DesignerCreateView (Base As Panel, Lbl";
RDebugUtils.currentLine=70254593;
 //BA.debugLineNum = 70254593;BA.debugLine="mBase = Base";
__ref._mbase /*anywheresoftware.b4a.objects.PanelWrapper*/  = _base;
RDebugUtils.currentLine=70254594;
 //BA.debugLineNum = 70254594;BA.debugLine="mBase.Visible = False";
__ref._mbase /*anywheresoftware.b4a.objects.PanelWrapper*/ .setVisible(__c.False);
RDebugUtils.currentLine=70254595;
 //BA.debugLineNum = 70254595;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=70647808;
 //BA.debugLineNum = 70647808;BA.debugLine="Public Sub GetBase As Panel";
RDebugUtils.currentLine=70647809;
 //BA.debugLineNum = 70647809;BA.debugLine="Return mBase";
...
RDebugUtils.currentLine=70189056;
 //BA.debugLineNum = 70189056;BA.debugLine="Public Sub Initialize (Callback As Object, EventNa";
RDebugUtils.currentLine=70189057;
 //BA.debugLineNum = 70189057;BA.debugLine="mEventName = EventName";
__ref._meventname /*String*/  = _eventname;
RDebugUtils.currentLine=70189058;
 //BA.debugLineNum = 70189058;BA.debugLine="mCallBack = Callback";
...
RDebugUtils.currentLine=70582273;
 //BA.debugLineNum = 70582273;BA.debugLine="Dim FrameIndex As Int = 0";
_frameindex = (int) (0);
RDebugUtils.currentLine=70582274;
 //BA.debugLineNum = 70582274;BA.debugLine="Do While MyWorkIndex = WorkIndex";
if (true) break;
...
RDebugUtils.currentLine=70582275;
 //BA.debugLineNum = 70582275;BA.debugLine="FrameIndex = (FrameIndex + 1) Mod bitmaps.Size";
...
RDebugUtils.currentLine=70582276;
 //BA.debugLineNum = 70582276;BA.debugLine="Dim bdrawable As BitmapDrawable";
_bdrawable = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
RDebugUtils.currentLine=70582277;
 //BA.debugLineNum = 70582277;BA.debugLine="Dim bd As BitmapAndDelay = bitmaps.Get(FrameInde";
...
RDebugUtils.currentLine=70582278;
 //BA.debugLineNum = 70582278;BA.debugLine="bdrawable.Initialize(bd.bmp)";
...
RDebugUtils.currentLine=70582279;
 //BA.debugLineNum = 70582279;BA.debugLine="bdrawable.Gravity = BDGravity";
_bdrawable.setGravity(__ref._bdgravity /*int*/ );
RDebugUtils.currentLine=70582280;
 //BA.debugLineNum = 70582280;BA.debugLine="mBase.Background = bdrawable";
...
RDebugUtils.currentLine=70582281;
 //BA.debugLineNum = 70582281;BA.debugLine="Sleep(bd.Delay)";
