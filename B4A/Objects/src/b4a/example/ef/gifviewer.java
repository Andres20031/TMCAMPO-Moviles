...
RDebugUtils.currentLine=66846720;
 //BA.debugLineNum = 66846720;BA.debugLine="Public Sub Start";
RDebugUtils.currentLine=66846721;
 //BA.debugLineNum = 66846721;BA.debugLine="mBase.Visible = True";
__ref._mbase /*anywheresoftware.b4a.objects.PanelWrapper*/ .setVisible(__c.True);
RDebugUtils.currentLine=66846722;
 //BA.debugLineNum = 66846722;BA.debugLine="WorkIndex = WorkIndex + 1";
__ref._workindex /*int*/  = (int) (__ref._workindex /*int*/ +1);
RDebugUtils.currentLine=66846723;
 //BA.debugLineNum = 66846723;BA.debugLine="ShowImpl(WorkIndex)";
...
RDebugUtils.currentLine=66912256;
 //BA.debugLineNum = 66912256;BA.debugLine="Public Sub Stop";
RDebugUtils.currentLine=66912257;
 //BA.debugLineNum = 66912257;BA.debugLine="mBase.Visible = False";
__ref._mbase /*anywheresoftware.b4a.objects.PanelWrapper*/ .setVisible(__c.False);
RDebugUtils.currentLine=66912258;
 //BA.debugLineNum = 66912258;BA.debugLine="WorkIndex = WorkIndex + 1";
__ref._workindex /*int*/  = (int) (__ref._workindex /*int*/ +1);
...
RDebugUtils.currentLine=66781184;
 //BA.debugLineNum = 66781184;BA.debugLine="Public Sub SetGif (Dir As String, FileName As Stri";
RDebugUtils.currentLine=66781185;
 //BA.debugLineNum = 66781185;BA.debugLine="If Dir = File.DirAssets Then";
if ((_dir).equals(__c.File.getDirAssets())) { 
RDebugUtils.currentLine=66781186;
 //BA.debugLineNum = 66781186;BA.debugLine="File.Copy(File.DirAssets, FileName, File.DirInte";
__c.File.Copy(__c.File.getDirAssets(),_filename,__c.File.getDirInternal(),_filename);
RDebugUtils.currentLine=66781187;
 //BA.debugLineNum = 66781187;BA.debugLine="Dir = File.DirInternal";
_dir = __c.File.getDirInternal();
 };
RDebugUtils.currentLine=66781189;
 //BA.debugLineNum = 66781189;BA.debugLine="Dim path As String = File.Combine(Dir, FileName)";
_path = __c.File.Combine(_dir,_filename);
RDebugUtils.currentLine=66781190;
 //BA.debugLineNum = 66781190;BA.debugLine="If Main.GifsCache.IsInitialized = False Then Main";
...
RDebugUtils.currentLine=66781191;
 //BA.debugLineNum = 66781191;BA.debugLine="If Main.GifsCache.ContainsKey(path) Then";
...
RDebugUtils.currentLine=66781192;
 //BA.debugLineNum = 66781192;BA.debugLine="bitmaps = Main.GifsCache.Get(path)";
...
RDebugUtils.currentLine=66781194;
 //BA.debugLineNum = 66781194;BA.debugLine="Dim gd As GifDecoder";
_gd = new anywheresoftware.b4a.agraham.gifdecoder.GifDecoder();
RDebugUtils.currentLine=66781195;
 //BA.debugLineNum = 66781195;BA.debugLine="gd.Load(Dir, FileName)";
_gd.Load(_dir,_filename);
RDebugUtils.currentLine=66781196;
 //BA.debugLineNum = 66781196;BA.debugLine="bitmaps.Initialize";
__ref._bitmaps /*anywheresoftware.b4a.objects.collections.List*/ .Initialize();
RDebugUtils.currentLine=66781197;
 //BA.debugLineNum = 66781197;BA.debugLine="For i = 0 To gd.FrameCount - 1";
{
final int step13 = 1;
...
RDebugUtils.currentLine=66781198;
 //BA.debugLineNum = 66781198;BA.debugLine="Dim bd As BitmapAndDelay";
_bd = new b4a.example.ef.gifviewer._bitmapanddelay();
RDebugUtils.currentLine=66781199;
 //BA.debugLineNum = 66781199;BA.debugLine="bd.Initialize";
_bd.Initialize();
RDebugUtils.currentLine=66781200;
 //BA.debugLineNum = 66781200;BA.debugLine="bd.bmp = gd.Frame(i)";
...
RDebugUtils.currentLine=66781201;
 //BA.debugLineNum = 66781201;BA.debugLine="bd.Delay = gd.Delay(i)";
_bd.Delay /*int*/  = _gd.Delay(_i);
RDebugUtils.currentLine=66781202;
 //BA.debugLineNum = 66781202;BA.debugLine="bitmaps.Add(bd)";
__ref._bitmaps /*anywheresoftware.b4a.objects.collections.List*/ .Add((Object)(_bd));
 }
};
RDebugUtils.currentLine=66781204;
 //BA.debugLineNum = 66781204;BA.debugLine="Main.GifsCache.Put(path, bitmaps)";
...
RDebugUtils.currentLine=66781207;
 //BA.debugLineNum = 66781207;BA.debugLine="Dim FirstFrame As BitmapAndDelay = bitmaps.Get(0)";
...
RDebugUtils.currentLine=66781208;
 //BA.debugLineNum = 66781208;BA.debugLine="Dim FirstBmp As Bitmap = FirstFrame.bmp";
...
RDebugUtils.currentLine=66781209;
 //BA.debugLineNum = 66781209;BA.debugLine="If FirstBmp.Width < mBase.Width Or FirstBmp.Heigh";
...
RDebugUtils.currentLine=66781210;
 //BA.debugLineNum = 66781210;BA.debugLine="BDGravity = Gravity.CENTER";
__ref._bdgravity /*int*/  = __c.Gravity.CENTER;
 }else {
RDebugUtils.currentLine=66781212;
 //BA.debugLineNum = 66781212;BA.debugLine="BDGravity = Gravity.FILL";
__ref._bdgravity /*int*/  = __c.Gravity.FILL;
 };
RDebugUtils.currentLine=66781215;
 //BA.debugLineNum = 66781215;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=66977792;
 //BA.debugLineNum = 66977792;BA.debugLine="Public Sub CallFromResume";
RDebugUtils.currentLine=66977793;
 //BA.debugLineNum = 66977793;BA.debugLine="If mBase.Visible Then Start";
...
RDebugUtils.currentLine=66584577;
 //BA.debugLineNum = 66584577;BA.debugLine="Private mEventName As String 'ignore";
_meventname = "";
RDebugUtils.currentLine=66584578;
 //BA.debugLineNum = 66584578;BA.debugLine="Private mCallBack As Object 'ignore";
_mcallback = new Object();
RDebugUtils.currentLine=66584579;
 //BA.debugLineNum = 66584579;BA.debugLine="Private mBase As Panel";
_mbase = new anywheresoftware.b4a.objects.PanelWrapper();
RDebugUtils.currentLine=66584580;
 //BA.debugLineNum = 66584580;BA.debugLine="Private Const DefaultColorConstant As Int = -9848";
_defaultcolorconstant = (int) (-984833);
RDebugUtils.currentLine=66584581;
 //BA.debugLineNum = 66584581;BA.debugLine="Private WorkIndex As Int";
_workindex = 0;
RDebugUtils.currentLine=66584582;
 //BA.debugLineNum = 66584582;BA.debugLine="Private BDGravity As Int";
_bdgravity = 0;
RDebugUtils.currentLine=66584583;
 //BA.debugLineNum = 66584583;BA.debugLine="Private bitmaps As List";
_bitmaps = new anywheresoftware.b4a.objects.collections.List();
RDebugUtils.currentLine=66584584;
 //BA.debugLineNum = 66584584;BA.debugLine="Type BitmapAndDelay (bmp As Bitmap, Delay As Int)";
;
RDebugUtils.currentLine=66584585;
 //BA.debugLineNum = 66584585;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=66715648;
 //BA.debugLineNum = 66715648;BA.debugLine="Public Sub DesignerCreateView (Base As Panel, Lbl";
RDebugUtils.currentLine=66715649;
 //BA.debugLineNum = 66715649;BA.debugLine="mBase = Base";
__ref._mbase /*anywheresoftware.b4a.objects.PanelWrapper*/  = _base;
RDebugUtils.currentLine=66715650;
 //BA.debugLineNum = 66715650;BA.debugLine="mBase.Visible = False";
__ref._mbase /*anywheresoftware.b4a.objects.PanelWrapper*/ .setVisible(__c.False);
...
RDebugUtils.currentLine=67108864;
 //BA.debugLineNum = 67108864;BA.debugLine="Public Sub GetBase As Panel";
RDebugUtils.currentLine=67108865;
 //BA.debugLineNum = 67108865;BA.debugLine="Return mBase";
...
RDebugUtils.currentLine=66650112;
 //BA.debugLineNum = 66650112;BA.debugLine="Public Sub Initialize (Callback As Object, EventNa";
RDebugUtils.currentLine=66650113;
 //BA.debugLineNum = 66650113;BA.debugLine="mEventName = EventName";
__ref._meventname /*String*/  = _eventname;
RDebugUtils.currentLine=66650114;
 //BA.debugLineNum = 66650114;BA.debugLine="mCallBack = Callback";
...
RDebugUtils.currentLine=67043329;
 //BA.debugLineNum = 67043329;BA.debugLine="Dim FrameIndex As Int = 0";
_frameindex = (int) (0);
RDebugUtils.currentLine=67043330;
 //BA.debugLineNum = 67043330;BA.debugLine="Do While MyWorkIndex = WorkIndex";
if (true) break;
...
RDebugUtils.currentLine=67043331;
 //BA.debugLineNum = 67043331;BA.debugLine="FrameIndex = (FrameIndex + 1) Mod bitmaps.Size";
...
RDebugUtils.currentLine=67043332;
 //BA.debugLineNum = 67043332;BA.debugLine="Dim bdrawable As BitmapDrawable";
_bdrawable = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
RDebugUtils.currentLine=67043333;
 //BA.debugLineNum = 67043333;BA.debugLine="Dim bd As BitmapAndDelay = bitmaps.Get(FrameInde";
...
RDebugUtils.currentLine=67043334;
 //BA.debugLineNum = 67043334;BA.debugLine="bdrawable.Initialize(bd.bmp)";
...
RDebugUtils.currentLine=67043335;
 //BA.debugLineNum = 67043335;BA.debugLine="bdrawable.Gravity = BDGravity";
_bdrawable.setGravity(__ref._bdgravity /*int*/ );
RDebugUtils.currentLine=67043336;
 //BA.debugLineNum = 67043336;BA.debugLine="mBase.Background = bdrawable";
...
RDebugUtils.currentLine=67043337;
 //BA.debugLineNum = 67043337;BA.debugLine="Sleep(bd.Delay)";
...
RDebugUtils.currentLine=67043339;
 //BA.debugLineNum = 67043339;BA.debugLine="End Sub";
if (true) break;
