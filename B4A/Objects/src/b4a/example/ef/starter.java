...
anywheresoftware.b4a.keywords.Common.LogImpl("2983045","JA EXISTEM ITENS",0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("2983076","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("2917519",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("21048587","Erro 0005: "+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 };
