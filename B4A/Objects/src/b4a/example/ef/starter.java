...
anywheresoftware.b4a.keywords.Common.LogImpl("250659333","JA EXISTEM ITENS",0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("250659364","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("250593807",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("250724875","Erro 0005: "+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 };
