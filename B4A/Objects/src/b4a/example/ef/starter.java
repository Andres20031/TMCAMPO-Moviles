...
anywheresoftware.b4a.keywords.Common.LogImpl("11245189","JA EXISTEM ITENS",0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("11245220","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("11179663",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("11310731","Erro 0005: "+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 };
