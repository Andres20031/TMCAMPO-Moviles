...
RDebugUtils.currentLine=62324736;
 //BA.debugLineNum = 62324736;BA.debugLine="Public Sub Base_Resize (Width As Double, Height As";
RDebugUtils.currentLine=62324737;
 //BA.debugLineNum = 62324737;BA.debugLine="cvs.Resize(Width, Height)";
__ref._cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .Resize((float) (_width),(float) (_height));
RDebugUtils.currentLine=62324738;
 //BA.debugLineNum = 62324738;BA.debugLine="TouchPanel.SetLayoutAnimated(0, 0, 0, Width, Heig";
__ref._touchpanel /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .SetLayoutAnimated((int) (0),(int) (0),(int) (0),(int) (_width),(int) (_height));
RDebugUtils.currentLine=62324739;
 //BA.debugLineNum = 62324739;BA.debugLine="Draw";
...
RDebugUtils.currentLine=62390272;
 //BA.debugLineNum = 62390272;BA.debugLine="Private Sub Draw";
RDebugUtils.currentLine=62390273;
 //BA.debugLineNum = 62390273;BA.debugLine="cvs.ClearRect(cvs.TargetRect)";
__ref._cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .ClearRect(__ref._cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .getTargetRect());
RDebugUtils.currentLine=62390274;
 //BA.debugLineNum = 62390274;BA.debugLine="Dim bcolor As ARGBColor";
_bcolor = new b4a.example.bitmapcreator._argbcolor();
RDebugUtils.currentLine=62390275;
 //BA.debugLineNum = 62390275;BA.debugLine="bc.ColorToARGB(CrumbColor, bcolor)";
__ref._bc /*b4a.example.bitmapcreator*/ ._colortoargb(__ref._crumbcolor /*int*/ ,_bcolor);
RDebugUtils.currentLine=62390276;
 //BA.debugLineNum = 62390276;BA.debugLine="bcolor.r = Min(255, bcolor.r * 2)";
_bcolor.r = (int) (__c.Min(255,_bcolor.r*2));
RDebugUtils.currentLine=62390277;
 //BA.debugLineNum = 62390277;BA.debugLine="bcolor.g = Min(255, bcolor.g * 2)";
_bcolor.g = (int) (__c.Min(255,_bcolor.g*2));
RDebugUtils.currentLine=62390278;
 //BA.debugLineNum = 62390278;BA.debugLine="bcolor.b = Min(255, bcolor.b * 2)";
_bcolor.b = (int) (__c.Min(255,_bcolor.b*2));
RDebugUtils.currentLine=62390279;
 //BA.debugLineNum = 62390279;BA.debugLine="Dim strokeColor As Int = bc.ARGBToColor(bcolor)";
_strokecolor = __ref._bc /*b4a.example.bitmapcreator*/ ._argbtocolor(_bcolor);
RDebugUtils.currentLine=62390281;
 //BA.debugLineNum = 62390281;BA.debugLine="bc.ColorToARGB(CrumbColor, bcolor)";
__ref._bc /*b4a.example.bitmapcreator*/ ._colortoargb(__ref._crumbcolor /*int*/ ,_bcolor);
RDebugUtils.currentLine=62390282;
 //BA.debugLineNum = 62390282;BA.debugLine="bcolor.r = bcolor.r * 0.8";
_bcolor.r = (int) (_bcolor.r*0.8);
RDebugUtils.currentLine=62390283;
 //BA.debugLineNum = 62390283;BA.debugLine="bcolor.g = bcolor.g * 0.8";
_bcolor.g = (int) (_bcolor.g*0.8);
RDebugUtils.currentLine=62390284;
 //BA.debugLineNum = 62390284;BA.debugLine="bcolor.b = bcolor.b * 0.8";
_bcolor.b = (int) (_bcolor.b*0.8);
RDebugUtils.currentLine=62390285;
 //BA.debugLineNum = 62390285;BA.debugLine="Dim Clrs() As Int = Array As Int(CrumbColor, bc.A";
...
RDebugUtils.currentLine=62390287;
 //BA.debugLineNum = 62390287;BA.debugLine="RightPositions.Clear";
__ref._rightpositions /*anywheresoftware.b4a.objects.collections.List*/ .Clear();
RDebugUtils.currentLine=62390288;
 //BA.debugLineNum = 62390288;BA.debugLine="If mItems.Size = 0 Then Return";
if (__ref._mitems /*anywheresoftware.b4a.objects.collections.List*/ .getSize()==0) { 
if (true) return "";};
RDebugUtils.currentLine=62390289;
 //BA.debugLineNum = 62390289;BA.debugLine="Dim Left As Int = 0";
_left = (int) (0);
RDebugUtils.currentLine=62390290;
 //BA.debugLineNum = 62390290;BA.debugLine="For i = 0 To mItems.Size - 1";
{
final int step16 = 1;
...
RDebugUtils.currentLine=62390291;
 //BA.debugLineNum = 62390291;BA.debugLine="Dim sc As Int";
_sc = 0;
RDebugUtils.currentLine=62390292;
 //BA.debugLineNum = 62390292;BA.debugLine="If PressedItem = i Then sc = strokeColor Else sc";
if (__ref._presseditem /*int*/ ==_i) { 
_sc = _strokecolor;}
else {
_sc = (int) (0);};
RDebugUtils.currentLine=62390293;
 //BA.debugLineNum = 62390293;BA.debugLine="Dim width As Int = DrawItem(Left, mItems.Get(i),";
...
RDebugUtils.currentLine=62128129;
 //BA.debugLineNum = 62128129;BA.debugLine="Private mEventName As String 'ignore";
_meventname = "";
RDebugUtils.currentLine=62128130;
 //BA.debugLineNum = 62128130;BA.debugLine="Private mCallBack As Object 'ignore";
_mcallback = new Object();
RDebugUtils.currentLine=62128131;
 //BA.debugLineNum = 62128131;BA.debugLine="Public mBase As B4XView 'ignore";
_mbase = new anywheresoftware.b4a.objects.B4XViewWrapper();
RDebugUtils.currentLine=62128132;
 //BA.debugLineNum = 62128132;BA.debugLine="Private xui As XUI 'ignore";
_xui = new anywheresoftware.b4a.objects.B4XViewWrapper.XUI();
RDebugUtils.currentLine=62128133;
 //BA.debugLineNum = 62128133;BA.debugLine="Private cvs As B4XCanvas";
_cvs = new anywheresoftware.b4a.objects.B4XCanvas();
RDebugUtils.currentLine=62128134;
 //BA.debugLineNum = 62128134;BA.debugLine="Private mItems As List";
_mitems = new anywheresoftware.b4a.objects.collections.List();
RDebugUtils.currentLine=62128135;
 //BA.debugLineNum = 62128135;BA.debugLine="Private RightPositions As List";
_rightpositions = new anywheresoftware.b4a.objects.collections.List();
RDebugUtils.currentLine=62128136;
 //BA.debugLineNum = 62128136;BA.debugLine="Public TextColor As Int";
_textcolor = 0;
RDebugUtils.currentLine=62128137;
 //BA.debugLineNum = 62128137;BA.debugLine="Public fnt As B4XFont";
_fnt = new anywheresoftware.b4a.objects.B4XViewWrapper.B4XFont();
RDebugUtils.currentLine=62128138;
 //BA.debugLineNum = 62128138;BA.debugLine="Private offset As Int = 10dip";
_offset = __c.DipToCurrent((int) (10));
RDebugUtils.currentLine=62128139;
 //BA.debugLineNum = 62128139;BA.debugLine="Private bc As BitmapCreator";
_bc = new b4a.example.bitmapcreator();
RDebugUtils.currentLine=62128140;
 //BA.debugLineNum = 62128140;BA.debugLine="Public CrumbColor As Int";
_crumbcolor = 0;
RDebugUtils.currentLine=62128141;
 //BA.debugLineNum = 62128141;BA.debugLine="Private TouchPanel As B4XView";
_touchpanel = new anywheresoftware.b4a.objects.B4XViewWrapper();
RDebugUtils.currentLine=62128142;
 //BA.debugLineNum = 62128142;BA.debugLine="Private PressedItem As Int = -1";
_presseditem = (int) (-1);
RDebugUtils.currentLine=62128143;
 //BA.debugLineNum = 62128143;BA.debugLine="Public Tag As Object";
_tag = new Object();
RDebugUtils.currentLine=62128144;
 //BA.debugLineNum = 62128144;BA.debugLine="Public mHaptic As Boolean";
_mhaptic = false;
RDebugUtils.currentLine=62128145;
 //BA.debugLineNum = 62128145;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=62259200;
 //BA.debugLineNum = 62259200;BA.debugLine="Public Sub DesignerCreateView (Base As Object, Lbl";
RDebugUtils.currentLine=62259201;
 //BA.debugLineNum = 62259201;BA.debugLine="mBase = Base";
__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/  = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_base));
RDebugUtils.currentLine=62259202;
 //BA.debugLineNum = 62259202;BA.debugLine="Tag = mBase.Tag : mBase.Tag = Me";
__ref._tag /*Object*/  = __ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getTag();
RDebugUtils.currentLine=62259202;
 //BA.debugLineNum = 62259202;BA.debugLine="Tag = mBase.Tag : mBase.Tag = Me";
__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setTag(this);
RDebugUtils.currentLine=62259203;
 //BA.debugLineNum = 62259203;BA.debugLine="cvs.Initialize(mBase)";
__ref._cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .Initialize(__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ );
RDebugUtils.currentLine=62259204;
 //BA.debugLineNum = 62259204;BA.debugLine="Dim xlbl As B4XView = Lbl";
_xlbl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_xlbl = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_lbl.getObject()));
RDebugUtils.currentLine=62259205;
 //BA.debugLineNum = 62259205;BA.debugLine="fnt = xlbl.Font";
__ref._fnt /*anywheresoftware.b4a.objects.B4XViewWrapper.B4XFont*/  = _xlbl.getFont();
RDebugUtils.currentLine=62259206;
 //BA.debugLineNum = 62259206;BA.debugLine="TextColor = xlbl.TextColor";
__ref._textcolor /*int*/  = _xlbl.getTextColor();
RDebugUtils.currentLine=62259207;
 //BA.debugLineNum = 62259207;BA.debugLine="CrumbColor = xui.PaintOrColorToColor(Props.Get(\"C";
...
RDebugUtils.currentLine=62259208;
 //BA.debugLineNum = 62259208;BA.debugLine="mHaptic = Props.GetDefault(\"HapticFeedback\", Fals";
__ref._mhaptic /*boolean*/  = BA.ObjectToBoolean(_props.GetDefault((Object)("HapticFeedback"),(Object)(__c.False)));
RDebugUtils.currentLine=62259209;
 //BA.debugLineNum = 62259209;BA.debugLine="TouchPanel = xui.CreatePanel(\"Touch\")";
...
RDebugUtils.currentLine=62259210;
 //BA.debugLineNum = 62259210;BA.debugLine="mBase.AddView(TouchPanel, 0, 0, mBase.Width, mBas";
__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .AddView((android.view.View)(__ref._touchpanel /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getObject()),(int) (0),(int) (0),__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getWidth(),__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight());
RDebugUtils.currentLine=62259211;
 //BA.debugLineNum = 62259211;BA.debugLine="Dim items As String = Props.Get(\"Items\")";
_items = BA.ObjectToString(_props.Get((Object)("Items")));
RDebugUtils.currentLine=62259212;
 //BA.debugLineNum = 62259212;BA.debugLine="For Each s As String In Regex.Split(\"\\|\", items)";
{
...
RDebugUtils.currentLine=62259213;
 //BA.debugLineNum = 62259213;BA.debugLine="mItems.Add(s)";
__ref._mitems /*anywheresoftware.b4a.objects.collections.List*/ .Add((Object)(_s));
 }
};
RDebugUtils.currentLine=62259215;
 //BA.debugLineNum = 62259215;BA.debugLine="Draw";
__ref._draw /*String*/ (null);
RDebugUtils.currentLine=62259216;
 //BA.debugLineNum = 62259216;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=62455808;
 //BA.debugLineNum = 62455808;BA.debugLine="Private Sub DrawItem(Left As Int, Text As String,";
RDebugUtils.currentLine=62455809;
 //BA.debugLineNum = 62455809;BA.debugLine="Dim r As B4XRect = cvs.MeasureText(Text, fnt)";
...
RDebugUtils.currentLine=62455810;
 //BA.debugLineNum = 62455810;BA.debugLine="Dim ItemWidth As Int = r.Width + 30dip";
_itemwidth = (int) (_r.getWidth()+__c.DipToCurrent((int) (30)));
RDebugUtils.currentLine=62455811;
 //BA.debugLineNum = 62455811;BA.debugLine="Dim ItemHeight As Int = cvs.TargetRect.Height";
...
RDebugUtils.currentLine=62455812;
 //BA.debugLineNum = 62455812;BA.debugLine="Dim BaseLine As Int = cvs.TargetRect.CenterY - r.";
...
RDebugUtils.currentLine=62455813;
 //BA.debugLineNum = 62455813;BA.debugLine="Dim p As B4XPath";
_p = new anywheresoftware.b4a.objects.B4XCanvas.B4XPath();
RDebugUtils.currentLine=62455814;
 //BA.debugLineNum = 62455814;BA.debugLine="p.Initialize(Left, 0)";
_p.Initialize((float) (_left),(float) (0));
RDebugUtils.currentLine=62455815;
 //BA.debugLineNum = 62455815;BA.debugLine="p.LineTo(Left + ItemWidth, 0)";
_p.LineTo((float) (_left+_itemwidth),(float) (0));
RDebugUtils.currentLine=62455816;
 //BA.debugLineNum = 62455816;BA.debugLine="If Last = False Then";
if (_last==__c.False) { 
RDebugUtils.currentLine=62455817;
 //BA.debugLineNum = 62455817;BA.debugLine="p.LineTo(Left + ItemWidth + offset, ItemHeight /";
_p.LineTo((float) (_left+_itemwidth+__ref._offset /*int*/ ),(float) (_itemheight/(double)2));
 };
RDebugUtils.currentLine=62455819;
 //BA.debugLineNum = 62455819;BA.debugLine="p.LineTo(Left + ItemWidth, ItemHeight)";
_p.LineTo((float) (_left+_itemwidth),(float) (_itemheight));
RDebugUtils.currentLine=62455820;
 //BA.debugLineNum = 62455820;BA.debugLine="If First = False Then";
if (_first==__c.False) { 
RDebugUtils.currentLine=62455821;
 //BA.debugLineNum = 62455821;BA.debugLine="p.LineTo(Left - offset, ItemHeight)";
_p.LineTo((float) (_left-__ref._offset /*int*/ ),(float) (_itemheight));
RDebugUtils.currentLine=62455822;
 //BA.debugLineNum = 62455822;BA.debugLine="p.LineTo(Left, ItemHeight / 2)";
_p.LineTo((float) (_left),(float) (_itemheight/(double)2));
RDebugUtils.currentLine=62455823;
 //BA.debugLineNum = 62455823;BA.debugLine="p.LineTo(Left - offset, 0)";
_p.LineTo((float) (_left-__ref._offset /*int*/ ),(float) (0));
 }else {
RDebugUtils.currentLine=62455825;
 //BA.debugLineNum = 62455825;BA.debugLine="p.LineTo(Left, ItemHeight)";
_p.LineTo((float) (_left),(float) (_itemheight));
 };
RDebugUtils.currentLine=62455827;
 //BA.debugLineNum = 62455827;BA.debugLine="p.LineTo(Left, 0)";
_p.LineTo((float) (_left),(float) (0));
RDebugUtils.currentLine=62455828;
 //BA.debugLineNum = 62455828;BA.debugLine="cvs.DrawPath(p, clr, True, 0)";
__ref._cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .DrawPath(_p,_clr,__c.True,(float) (0));
RDebugUtils.currentLine=62455829;
 //BA.debugLineNum = 62455829;BA.debugLine="If strokeColor <> 0 Then";
if (_strokecolor!=0) { 
RDebugUtils.currentLine=62455830;
 //BA.debugLineNum = 62455830;BA.debugLine="cvs.DrawPath(p, strokeColor, False, 3dip)";
...
RDebugUtils.currentLine=62455833;
 //BA.debugLineNum = 62455833;BA.debugLine="cvs.DrawText(Text, Left + ItemWidth / 2, BaseLine";
...
RDebugUtils.currentLine=62455834;
 //BA.debugLineNum = 62455834;BA.debugLine="Return ItemWidth";
if (true) return _itemwidth;
RDebugUtils.currentLine=62455835;
 //BA.debugLineNum = 62455835;BA.debugLine="End Sub";
return 0;
}
...
RDebugUtils.currentLine=62586880;
 //BA.debugLineNum = 62586880;BA.debugLine="Private Sub FindItem (x As Int, y As Int) As Int";
RDebugUtils.currentLine=62586881;
 //BA.debugLineNum = 62586881;BA.debugLine="If RightPositions.Size = 0 Then Return -1";
if (__ref._rightpositions /*anywheresoftware.b4a.objects.collections.List*/ .getSize()==0) { 
if (true) return (int) (-1);};
RDebugUtils.currentLine=62586882;
 //BA.debugLineNum = 62586882;BA.debugLine="If y < 0 Or y > cvs.TargetRect.Height Then Return";
if (_y<0 || _y>__ref._cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .getTargetRect().getHeight()) { 
if (true) return (int) (-1);};
RDebugUtils.currentLine=62586883;
 //BA.debugLineNum = 62586883;BA.debugLine="Dim r As Int = RightPositions.Get(RightPositions.";
...
RDebugUtils.currentLine=62586884;
 //BA.debugLineNum = 62586884;BA.debugLine="If x > r Then Return -1";
if (_x>_r) { 
if (true) return (int) (-1);};
RDebugUtils.currentLine=62586885;
 //BA.debugLineNum = 62586885;BA.debugLine="For i = RightPositions.Size - 2 To 0 Step -1";
{
final int step5 = -1;
...
RDebugUtils.currentLine=62586886;
 //BA.debugLineNum = 62586886;BA.debugLine="Dim r As Int = RightPositions.Get(i)";
...
RDebugUtils.currentLine=62586887;
 //BA.debugLineNum = 62586887;BA.debugLine="If x > r Then Return i + 1";
if (_x>_r) { 
if (true) return (int) (_i+1);};
 }
};
RDebugUtils.currentLine=62586889;
 //BA.debugLineNum = 62586889;BA.debugLine="Return 0";
if (true) return (int) (0);
RDebugUtils.currentLine=62586890;
 //BA.debugLineNum = 62586890;BA.debugLine="End Sub";
return 0;
}
...
RDebugUtils.currentLine=62717952;
 //BA.debugLineNum = 62717952;BA.debugLine="Public Sub getItems As List";
RDebugUtils.currentLine=62717953;
 //BA.debugLineNum = 62717953;BA.debugLine="Return mItems";
...
RDebugUtils.currentLine=62193664;
 //BA.debugLineNum = 62193664;BA.debugLine="Public Sub Initialize (Callback As Object, EventNa";
RDebugUtils.currentLine=62193665;
 //BA.debugLineNum = 62193665;BA.debugLine="mEventName = EventName";
__ref._meventname /*String*/  = _eventname;
RDebugUtils.currentLine=62193666;
 //BA.debugLineNum = 62193666;BA.debugLine="mCallBack = Callback";
__ref._mcallback /*Object*/  = _callback;
RDebugUtils.currentLine=62193667;
 //BA.debugLineNum = 62193667;BA.debugLine="mItems.Initialize";
__ref._mitems /*anywheresoftware.b4a.objects.collections.List*/ .Initialize();
RDebugUtils.currentLine=62193668;
 //BA.debugLineNum = 62193668;BA.debugLine="RightPositions.Initialize";
__ref._rightpositions /*anywheresoftware.b4a.objects.collections.List*/ .Initialize();
RDebugUtils.currentLine=62193669;
 //BA.debugLineNum = 62193669;BA.debugLine="bc.Initialize(1, 1)";
__ref._bc /*b4a.example.bitmapcreator*/ ._initialize(ba,(int) (1),(int) (1));
RDebugUtils.currentLine=62193670;
 //BA.debugLineNum = 62193670;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=62652416;
 //BA.debugLineNum = 62652416;BA.debugLine="Public Sub setItems (i As List)";
RDebugUtils.currentLine=62652417;
 //BA.debugLineNum = 62652417;BA.debugLine="mItems = i";
__ref._mitems /*anywheresoftware.b4a.objects.collections.List*/  = _i;
RDebugUtils.currentLine=62652418;
 //BA.debugLineNum = 62652418;BA.debugLine="Draw";
__ref._draw /*String*/ (null);
...
RDebugUtils.currentLine=62521344;
 //BA.debugLineNum = 62521344;BA.debugLine="Private Sub Touch_Touch (Action As Int, X As Float";
RDebugUtils.currentLine=62521345;
 //BA.debugLineNum = 62521345;BA.debugLine="Select Action";
...
RDebugUtils.currentLine=62521347;
 //BA.debugLineNum = 62521347;BA.debugLine="Dim prev As Int = PressedItem";
_prev = __ref._presseditem /*int*/ ;
RDebugUtils.currentLine=62521348;
 //BA.debugLineNum = 62521348;BA.debugLine="PressedItem = FindItem(X, Y)";
__ref._presseditem /*int*/  = __ref._finditem /*int*/ (null,(int) (_x),(int) (_y));
RDebugUtils.currentLine=62521349;
 //BA.debugLineNum = 62521349;BA.debugLine="If prev <> PressedItem Then Draw";
if (_prev!=__ref._presseditem /*int*/ ) { 
__ref._draw /*String*/ (null);};
 break; }
case 2: {
RDebugUtils.currentLine=62521351;
 //BA.debugLineNum = 62521351;BA.debugLine="Dim index As Int = FindItem(X, Y)";
_index = __ref._finditem /*int*/ (null,(int) (_x),(int) (_y));
RDebugUtils.currentLine=62521352;
 //BA.debugLineNum = 62521352;BA.debugLine="If index = PressedItem And index > -1 Then";
if (_index==__ref._presseditem /*int*/  && _index>-1) { 
RDebugUtils.currentLine=62521353;
 //BA.debugLineNum = 62521353;BA.debugLine="Dim Items As List";
_items = new anywheresoftware.b4a.objects.collections.List();
RDebugUtils.currentLine=62521354;
 //BA.debugLineNum = 62521354;BA.debugLine="Items.Initialize";
_items.Initialize();
RDebugUtils.currentLine=62521355;
 //BA.debugLineNum = 62521355;BA.debugLine="For i = 0 To index";
{
final int step11 = 1;
...
RDebugUtils.currentLine=62521356;
 //BA.debugLineNum = 62521356;BA.debugLine="Items.Add(mItems.Get(i))";
_items.Add(__ref._mitems /*anywheresoftware.b4a.objects.collections.List*/ .Get(_i));
 }
};
RDebugUtils.currentLine=62521358;
 //BA.debugLineNum = 62521358;BA.debugLine="If mHaptic Then XUIViewsUtils.PerformHapticFee";
if (__ref._mhaptic /*boolean*/ ) { 
_xuiviewsutils._performhapticfeedback /*String*/ (ba,__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ );};
RDebugUtils.currentLine=62521359;
 //BA.debugLineNum = 62521359;BA.debugLine="CallSub2(mCallBack, mEventName & \"_CrumbClick\"";
...
RDebugUtils.currentLine=62521361;
 //BA.debugLineNum = 62521361;BA.debugLine="PressedItem = -1";
__ref._presseditem /*int*/  = (int) (-1);
RDebugUtils.currentLine=62521362;
 //BA.debugLineNum = 62521362;BA.debugLine="Draw";
__ref._draw /*String*/ (null);
 break; }
}
;
RDebugUtils.currentLine=62521364;
 //BA.debugLineNum = 62521364;BA.debugLine="End Sub";
return "";
}
}