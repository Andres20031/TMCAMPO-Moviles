...
public class b4xcache extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.example.ef.b4xcache");
            if (htSubs == null) {
...
public b4a.example.ef.b4xcache._b4xcacheitem  _createb4xcacheitem(Object _value,String _key) throws Exception{
...
_ci = (b4a.example.ef.b4xcache._b4xcacheitem)(_data._get /*Object*/ ((Object)(_key)));
...
_data._remove /*String*/ ((Object)(((b4a.example.ef.b4xcache._b4xcacheitem)(_values.Get(_i))).Key /*String*/ ));
 }
};
 };
