...
parent.__c.LogImpl("83145789","ERROR al obtener el nombre del cliente: "+_j2._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("83145805","ERROR al obtener el nombre de la hacienda: "+_j3._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("83145816","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
__c.LogImpl("83342345",BA.ObjectToString(__c.LastException(ba)),0);
 };
...
parent.__c.LogImpl("83276805",BA.NumberToString(_index),0);
...
parent.__c.LogImpl("83276819","Error: el índice está fuera de los límites de la lista.",0);
 if (true) break;
...
parent.__c.LogImpl("83276824",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
if (true) break;
