...
parent.__c.LogImpl("754460477","ERROR al obtener el nombre del cliente: "+_j2._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("754460493","ERROR al obtener el nombre de la hacienda: "+_j3._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("754460504","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
__c.LogImpl("754657033",BA.ObjectToString(__c.LastException(ba)),0);
 };
...
parent.__c.LogImpl("754591493",BA.NumberToString(_index),0);
...
parent.__c.LogImpl("754591507","Error: el índice está fuera de los límites de la lista.",0);
 if (true) break;
...
parent.__c.LogImpl("754591512",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
if (true) break;
