...
parent.__c.LogImpl("73145789","ERROR al obtener el nombre del cliente: "+_j2._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("73145805","ERROR al obtener el nombre de la hacienda: "+_j3._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("73145816","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
__c.LogImpl("73342345",BA.ObjectToString(__c.LastException(ba)),0);
 };
...
parent.__c.LogImpl("73276805",BA.NumberToString(_index),0);
...
parent.__c.LogImpl("73276819","Error: el índice está fuera de los límites de la lista.",0);
 if (true) break;
...
parent.__c.LogImpl("73276824",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
if (true) break;
