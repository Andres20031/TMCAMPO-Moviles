...
parent.__c.LogImpl("263832125","ERROR al obtener el nombre del cliente: "+_j2._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("263832141","ERROR al obtener el nombre de la hacienda: "+_j3._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("263832152","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
__c.LogImpl("264028681",BA.ObjectToString(__c.LastException(ba)),0);
 };
...
parent.__c.LogImpl("263963141",BA.NumberToString(_index),0);
...
parent.__c.LogImpl("263963155","Error: el índice está fuera de los límites de la lista.",0);
 if (true) break;
...
parent.__c.LogImpl("263963160",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
if (true) break;
