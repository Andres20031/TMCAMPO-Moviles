...
parent.__c.LogImpl("21572926","ERROR al obtener el nombre del cliente: "+_j2._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("21572942","ERROR al obtener el nombre de la hacienda: "+_j3._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("21572953","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
__c.LogImpl("21769481",BA.ObjectToString(__c.LastException(ba)),0);
 };
...
parent.__c.LogImpl("21703941",BA.NumberToString(_index),0);
...
parent.__c.LogImpl("21703955","Error: el índice está fuera de los límites de la lista.",0);
 if (true) break;
...
parent.__c.LogImpl("21703960",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
if (true) break;
