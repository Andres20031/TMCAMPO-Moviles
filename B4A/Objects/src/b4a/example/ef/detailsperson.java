...
parent.__c.LogImpl("262914621","ERROR al obtener el nombre del cliente: "+_j2._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("262914637","ERROR al obtener el nombre de la hacienda: "+_j3._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("262914648","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
__c.LogImpl("263111177",BA.ObjectToString(__c.LastException(ba)),0);
 };
...
parent.__c.LogImpl("263045637",BA.NumberToString(_index),0);
...
parent.__c.LogImpl("263045651","Error: el índice está fuera de los límites de la lista.",0);
 if (true) break;
...
parent.__c.LogImpl("263045656",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
if (true) break;
