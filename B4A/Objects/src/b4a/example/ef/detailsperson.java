...
parent.__c.LogImpl("73211325","ERROR al obtener el nombre del cliente: "+_j2._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("73211341","ERROR al obtener el nombre de la hacienda: "+_j3._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("73211352","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
__c.LogImpl("73407881",BA.ObjectToString(__c.LastException(ba)),0);
 };
...
parent.__c.LogImpl("73342341",BA.NumberToString(_index),0);
...
parent.__c.LogImpl("73342355","Error: el índice está fuera de los límites de la lista.",0);
 if (true) break;
...
parent.__c.LogImpl("73342360",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
if (true) break;
