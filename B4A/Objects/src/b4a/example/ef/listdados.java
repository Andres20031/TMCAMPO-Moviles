...
parent.__c.LogImpl("27274498",BA.ObjectToString(parent._button1agendar.getTag()),0);
...
parent.__c.LogImpl("27274511","DADOS:",0);
 //BA.debugLineNum = 251;BA.debugLine="Log(Label3Inicial.Text)";
parent.__c.LogImpl("27274513",parent._label3inicial.getText(),0);
 //BA.debugLineNum = 252;BA.debugLine="Log(Label4Final.Text)";
parent.__c.LogImpl("27274514",parent._label4final.getText(),0);
 //BA.debugLineNum = 253;BA.debugLine="Log(EditText1Area.Text)";
parent.__c.LogImpl("27274515",parent._edittext1area.getText(),0);
 //BA.debugLineNum = 254;BA.debugLine="Log(\"=======================\")";
parent.__c.LogImpl("27274516","=======================",0);
 if (true) break;
...
parent.__c.LogImpl("27208962",BA.ObjectToString(parent._button1check.getTag()),0);
...
parent.__c.LogImpl("27208974","DADOS:",0);
 //BA.debugLineNum = 226;BA.debugLine="Log(Label3Inicial.Text)";
parent.__c.LogImpl("27208976",parent._label3inicial.getText(),0);
 //BA.debugLineNum = 227;BA.debugLine="Log(Label4Final.Text)";
parent.__c.LogImpl("27208977",parent._label4final.getText(),0);
 //BA.debugLineNum = 229;BA.debugLine="Log(\"=======================\")";
parent.__c.LogImpl("27208979","=======================",0);
 if (true) break;
...
parent.__c.LogImpl("27143426",BA.ObjectToString(parent._button2del.getTag()),0);
...
parent.__c.LogImpl("27143439","DADOS:",0);
 //BA.debugLineNum = 187;BA.debugLine="Log(EditText1TextArea.Text)";
parent.__c.LogImpl("27143440",parent._edittext1textarea.getText(),0);
 //BA.debugLineNum = 188;BA.debugLine="Log(\"=======================\")";
parent.__c.LogImpl("27143441","=======================",0);
...
parent.__c.LogImpl("27798785",BA.ObjectToString(_value),0);
...
__c.LogImpl("26881288","=====Maquinas #"+BA.NumberToString(_i)+"=====",0);
 //BA.debugLineNum = 78;BA.debugLine="Log(Cursor.GetString(\"id\"))";
__c.LogImpl("26881289",_cursor.GetString("id"),0);
...
__c.LogImpl("26881296",BA.NumberToString(_i),0);
...
__c.LogImpl("26815750",_cursor.GetString("Consecutivo"),0);
