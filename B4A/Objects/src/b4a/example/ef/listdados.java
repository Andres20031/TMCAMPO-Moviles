...
parent.__c.LogImpl("671434242",BA.ObjectToString(parent._button1agendar.getTag()),0);
...
parent.__c.LogImpl("671434255","DADOS:",0);
 //BA.debugLineNum = 251;BA.debugLine="Log(Label3Inicial.Text)";
parent.__c.LogImpl("671434257",parent._label3inicial.getText(),0);
 //BA.debugLineNum = 252;BA.debugLine="Log(Label4Final.Text)";
parent.__c.LogImpl("671434258",parent._label4final.getText(),0);
 //BA.debugLineNum = 253;BA.debugLine="Log(EditText1Area.Text)";
parent.__c.LogImpl("671434259",parent._edittext1area.getText(),0);
 //BA.debugLineNum = 254;BA.debugLine="Log(\"=======================\")";
parent.__c.LogImpl("671434260","=======================",0);
 if (true) break;
...
parent.__c.LogImpl("671368706",BA.ObjectToString(parent._button1check.getTag()),0);
...
parent.__c.LogImpl("671368718","DADOS:",0);
 //BA.debugLineNum = 226;BA.debugLine="Log(Label3Inicial.Text)";
parent.__c.LogImpl("671368720",parent._label3inicial.getText(),0);
 //BA.debugLineNum = 227;BA.debugLine="Log(Label4Final.Text)";
parent.__c.LogImpl("671368721",parent._label4final.getText(),0);
 //BA.debugLineNum = 229;BA.debugLine="Log(\"=======================\")";
parent.__c.LogImpl("671368723","=======================",0);
 if (true) break;
...
parent.__c.LogImpl("671303170",BA.ObjectToString(parent._button2del.getTag()),0);
...
parent.__c.LogImpl("671303183","DADOS:",0);
 //BA.debugLineNum = 187;BA.debugLine="Log(EditText1TextArea.Text)";
parent.__c.LogImpl("671303184",parent._edittext1textarea.getText(),0);
 //BA.debugLineNum = 188;BA.debugLine="Log(\"=======================\")";
parent.__c.LogImpl("671303185","=======================",0);
...
parent.__c.LogImpl("671958529",BA.ObjectToString(_value),0);
...
__c.LogImpl("671041032","=====Maquinas #"+BA.NumberToString(_i)+"=====",0);
 //BA.debugLineNum = 78;BA.debugLine="Log(Cursor.GetString(\"id\"))";
__c.LogImpl("671041033",_cursor.GetString("id"),0);
...
__c.LogImpl("671041040",BA.NumberToString(_i),0);
...
__c.LogImpl("670975494",_cursor.GetString("Consecutivo"),0);
