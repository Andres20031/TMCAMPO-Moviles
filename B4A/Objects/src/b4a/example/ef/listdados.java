...
parent.__c.LogImpl("067371010",BA.ObjectToString(parent._button1agendar.getTag()),0);
...
parent.__c.LogImpl("067371023","DADOS:",0);
 //BA.debugLineNum = 251;BA.debugLine="Log(Label3Inicial.Text)";
parent.__c.LogImpl("067371025",parent._label3inicial.getText(),0);
 //BA.debugLineNum = 252;BA.debugLine="Log(Label4Final.Text)";
parent.__c.LogImpl("067371026",parent._label4final.getText(),0);
 //BA.debugLineNum = 253;BA.debugLine="Log(EditText1Area.Text)";
parent.__c.LogImpl("067371027",parent._edittext1area.getText(),0);
 //BA.debugLineNum = 254;BA.debugLine="Log(\"=======================\")";
parent.__c.LogImpl("067371028","=======================",0);
 if (true) break;
...
parent.__c.LogImpl("067305474",BA.ObjectToString(parent._button1check.getTag()),0);
...
parent.__c.LogImpl("067305486","DADOS:",0);
 //BA.debugLineNum = 226;BA.debugLine="Log(Label3Inicial.Text)";
parent.__c.LogImpl("067305488",parent._label3inicial.getText(),0);
 //BA.debugLineNum = 227;BA.debugLine="Log(Label4Final.Text)";
parent.__c.LogImpl("067305489",parent._label4final.getText(),0);
 //BA.debugLineNum = 229;BA.debugLine="Log(\"=======================\")";
parent.__c.LogImpl("067305491","=======================",0);
 if (true) break;
...
parent.__c.LogImpl("067239938",BA.ObjectToString(parent._button2del.getTag()),0);
...
parent.__c.LogImpl("067239951","DADOS:",0);
 //BA.debugLineNum = 187;BA.debugLine="Log(EditText1TextArea.Text)";
parent.__c.LogImpl("067239952",parent._edittext1textarea.getText(),0);
 //BA.debugLineNum = 188;BA.debugLine="Log(\"=======================\")";
parent.__c.LogImpl("067239953","=======================",0);
...
parent.__c.LogImpl("067895297",BA.ObjectToString(_value),0);
...
__c.LogImpl("066977800","=====Maquinas #"+BA.NumberToString(_i)+"=====",0);
 //BA.debugLineNum = 78;BA.debugLine="Log(Cursor.GetString(\"id\"))";
__c.LogImpl("066977801",_cursor.GetString("id"),0);
...
__c.LogImpl("066977808",BA.NumberToString(_i),0);
...
__c.LogImpl("066912262",_cursor.GetString("Consecutivo"),0);
