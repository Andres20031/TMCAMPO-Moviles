...
parent.__c.LogImpl("818415618",BA.ObjectToString(parent._button1agendar.getTag()),0);
...
parent.__c.LogImpl("818415631","DADOS:",0);
 //BA.debugLineNum = 251;BA.debugLine="Log(Label3Inicial.Text)";
parent.__c.LogImpl("818415633",parent._label3inicial.getText(),0);
 //BA.debugLineNum = 252;BA.debugLine="Log(Label4Final.Text)";
parent.__c.LogImpl("818415634",parent._label4final.getText(),0);
 //BA.debugLineNum = 253;BA.debugLine="Log(EditText1Area.Text)";
parent.__c.LogImpl("818415635",parent._edittext1area.getText(),0);
 //BA.debugLineNum = 254;BA.debugLine="Log(\"=======================\")";
parent.__c.LogImpl("818415636","=======================",0);
 if (true) break;
...
parent.__c.LogImpl("818350082",BA.ObjectToString(parent._button1check.getTag()),0);
...
parent.__c.LogImpl("818350094","DADOS:",0);
 //BA.debugLineNum = 226;BA.debugLine="Log(Label3Inicial.Text)";
parent.__c.LogImpl("818350096",parent._label3inicial.getText(),0);
 //BA.debugLineNum = 227;BA.debugLine="Log(Label4Final.Text)";
parent.__c.LogImpl("818350097",parent._label4final.getText(),0);
 //BA.debugLineNum = 229;BA.debugLine="Log(\"=======================\")";
parent.__c.LogImpl("818350099","=======================",0);
 if (true) break;
...
parent.__c.LogImpl("818284546",BA.ObjectToString(parent._button2del.getTag()),0);
...
parent.__c.LogImpl("818284559","DADOS:",0);
 //BA.debugLineNum = 187;BA.debugLine="Log(EditText1TextArea.Text)";
parent.__c.LogImpl("818284560",parent._edittext1textarea.getText(),0);
 //BA.debugLineNum = 188;BA.debugLine="Log(\"=======================\")";
parent.__c.LogImpl("818284561","=======================",0);
...
parent.__c.LogImpl("818939905",BA.ObjectToString(_value),0);
...
__c.LogImpl("818022408","=====Maquinas #"+BA.NumberToString(_i)+"=====",0);
 //BA.debugLineNum = 78;BA.debugLine="Log(Cursor.GetString(\"id\"))";
__c.LogImpl("818022409",_cursor.GetString("id"),0);
...
__c.LogImpl("818022416",BA.NumberToString(_i),0);
...
__c.LogImpl("817956870",_cursor.GetString("Consecutivo"),0);
