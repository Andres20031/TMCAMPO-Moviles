...
parent.__c.LogImpl("718415618",BA.ObjectToString(parent._button1agendar.getTag()),0);
...
parent.__c.LogImpl("718415631","DADOS:",0);
 //BA.debugLineNum = 251;BA.debugLine="Log(Label3Inicial.Text)";
parent.__c.LogImpl("718415633",parent._label3inicial.getText(),0);
 //BA.debugLineNum = 252;BA.debugLine="Log(Label4Final.Text)";
parent.__c.LogImpl("718415634",parent._label4final.getText(),0);
 //BA.debugLineNum = 253;BA.debugLine="Log(EditText1Area.Text)";
parent.__c.LogImpl("718415635",parent._edittext1area.getText(),0);
 //BA.debugLineNum = 254;BA.debugLine="Log(\"=======================\")";
parent.__c.LogImpl("718415636","=======================",0);
 if (true) break;
...
parent.__c.LogImpl("718350082",BA.ObjectToString(parent._button1check.getTag()),0);
...
parent.__c.LogImpl("718350094","DADOS:",0);
 //BA.debugLineNum = 226;BA.debugLine="Log(Label3Inicial.Text)";
parent.__c.LogImpl("718350096",parent._label3inicial.getText(),0);
 //BA.debugLineNum = 227;BA.debugLine="Log(Label4Final.Text)";
parent.__c.LogImpl("718350097",parent._label4final.getText(),0);
 //BA.debugLineNum = 229;BA.debugLine="Log(\"=======================\")";
parent.__c.LogImpl("718350099","=======================",0);
 if (true) break;
...
parent.__c.LogImpl("718284546",BA.ObjectToString(parent._button2del.getTag()),0);
...
parent.__c.LogImpl("718284559","DADOS:",0);
 //BA.debugLineNum = 187;BA.debugLine="Log(EditText1TextArea.Text)";
parent.__c.LogImpl("718284560",parent._edittext1textarea.getText(),0);
 //BA.debugLineNum = 188;BA.debugLine="Log(\"=======================\")";
parent.__c.LogImpl("718284561","=======================",0);
...
parent.__c.LogImpl("718939905",BA.ObjectToString(_value),0);
...
__c.LogImpl("718022408","=====Maquinas #"+BA.NumberToString(_i)+"=====",0);
 //BA.debugLineNum = 78;BA.debugLine="Log(Cursor.GetString(\"id\"))";
__c.LogImpl("718022409",_cursor.GetString("id"),0);
...
__c.LogImpl("718022416",BA.NumberToString(_i),0);
...
__c.LogImpl("717956870",_cursor.GetString("Consecutivo"),0);
