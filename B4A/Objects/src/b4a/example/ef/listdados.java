...
parent.__c.LogImpl("268550658",BA.ObjectToString(parent._button1agendar.getTag()),0);
...
parent.__c.LogImpl("268550671","DADOS:",0);
 //BA.debugLineNum = 251;BA.debugLine="Log(Label3Inicial.Text)";
parent.__c.LogImpl("268550673",parent._label3inicial.getText(),0);
 //BA.debugLineNum = 252;BA.debugLine="Log(Label4Final.Text)";
parent.__c.LogImpl("268550674",parent._label4final.getText(),0);
 //BA.debugLineNum = 253;BA.debugLine="Log(EditText1Area.Text)";
parent.__c.LogImpl("268550675",parent._edittext1area.getText(),0);
 //BA.debugLineNum = 254;BA.debugLine="Log(\"=======================\")";
parent.__c.LogImpl("268550676","=======================",0);
 if (true) break;
...
parent.__c.LogImpl("268485122",BA.ObjectToString(parent._button1check.getTag()),0);
...
parent.__c.LogImpl("268485134","DADOS:",0);
 //BA.debugLineNum = 226;BA.debugLine="Log(Label3Inicial.Text)";
parent.__c.LogImpl("268485136",parent._label3inicial.getText(),0);
 //BA.debugLineNum = 227;BA.debugLine="Log(Label4Final.Text)";
parent.__c.LogImpl("268485137",parent._label4final.getText(),0);
 //BA.debugLineNum = 229;BA.debugLine="Log(\"=======================\")";
parent.__c.LogImpl("268485139","=======================",0);
 if (true) break;
...
parent.__c.LogImpl("268419586",BA.ObjectToString(parent._button2del.getTag()),0);
...
parent.__c.LogImpl("268419599","DADOS:",0);
 //BA.debugLineNum = 187;BA.debugLine="Log(EditText1TextArea.Text)";
parent.__c.LogImpl("268419600",parent._edittext1textarea.getText(),0);
 //BA.debugLineNum = 188;BA.debugLine="Log(\"=======================\")";
parent.__c.LogImpl("268419601","=======================",0);
...
parent.__c.LogImpl("269074945",BA.ObjectToString(_value),0);
...
__c.LogImpl("268157448","=====Maquinas #"+BA.NumberToString(_i)+"=====",0);
 //BA.debugLineNum = 78;BA.debugLine="Log(Cursor.GetString(\"id\"))";
__c.LogImpl("268157449",_cursor.GetString("id"),0);
...
__c.LogImpl("268157456",BA.NumberToString(_i),0);
...
__c.LogImpl("268091910",_cursor.GetString("Consecutivo"),0);
