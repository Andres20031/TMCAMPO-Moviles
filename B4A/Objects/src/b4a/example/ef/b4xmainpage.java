...
public String  _b4xpage_appear() throws Exception{
 //BA.debugLineNum = 97;BA.debugLine="Sub B4XPage_Appear";
 //BA.debugLineNum = 99;BA.debugLine="End Sub";
return "";
}
public String  _b4xpage_created(anywheresoftware.b4a.objects.B4XViewWrapper _root1) throws Exception{
 //BA.debugLineNum = 49;BA.debugLine="Private Sub B4XPage_Created(Root1 As B4XView)";
 //BA.debugLineNum = 53;BA.debugLine="Root = Root1";
_root = _root1;
 //BA.debugLineNum = 55;BA.debugLine="Root.LoadLayout(\"login\")";
_root.LoadLayout("login",ba);
 //BA.debugLineNum = 58;BA.debugLine="utilClass.Initialize";
_utilclass._initialize /*String*/ (ba);
 //BA.debugLineNum = 61;BA.debugLine="utilClass.SetStatusBarColor(0xB4008000,0xB4008000";
_utilclass._setstatusbarcolor /*String*/ (((int)0xb4008000),((int)0xb4008000));
 //BA.debugLineNum = 64;BA.debugLine="EditText1Mail.Color = Colors.Transparent";
_edittext1mail.setColor(__c.Colors.Transparent);
 //BA.debugLineNum = 65;BA.debugLine="EditText2Pass.Color = Colors.Transparent";
_edittext2pass.setColor(__c.Colors.Transparent);
 //BA.debugLineNum = 68;BA.debugLine="menu_C.Initialize";
_menu_c._initialize /*Object*/ (ba);
 //BA.debugLineNum = 69;BA.debugLine="ListPerson_C.Initialize";
_listperson_c._initialize /*Object*/ (ba);
 //BA.debugLineNum = 70;BA.debugLine="DetailsPerson_C.Initialize";
_detailsperson_c._initialize /*Object*/ (ba);
 //BA.debugLineNum = 71;BA.debugLine="FormPerson_C.Initialize";
_formperson_c._initialize /*Object*/ (ba);
 //BA.debugLineNum = 72;BA.debugLine="Form_C.Initialize";
_form_c._initialize /*Object*/ (ba);
 //BA.debugLineNum = 73;BA.debugLine="listDados_C.Initialize";
_listdados_c._initialize /*Object*/ (ba);
 //BA.debugLineNum = 74;BA.debugLine="FormMaquinaria_C.Initialize";
_formmaquinaria_c._initialize /*Object*/ (ba);
 //BA.debugLineNum = 75;BA.debugLine="FormPrecipitacion_C.Initialize";
_formprecipitacion_c._initialize /*Object*/ (ba);
 //BA.debugLineNum = 78;BA.debugLine="B4XPages.AddPageAndCreate(\"menu\", menu_C)";
_b4xpages._addpageandcreate /*String*/ (ba,"menu",(Object)(_menu_c));
 //BA.debugLineNum = 80;BA.debugLine="B4XPages.AddPageAndCreate(\"ListPerson\", ListPerso";
_b4xpages._addpageandcreate /*String*/ (ba,"ListPerson",(Object)(_listperson_c));
 //BA.debugLineNum = 82;BA.debugLine="B4XPages.AddPageAndCreate(\"DetailsPerson\", Detail";
_b4xpages._addpageandcreate /*String*/ (ba,"DetailsPerson",(Object)(_detailsperson_c));
 //BA.debugLineNum = 84;BA.debugLine="B4XPages.AddPageAndCreate(\"FormPerson\", FormPerso";
_b4xpages._addpageandcreate /*String*/ (ba,"FormPerson",(Object)(_formperson_c));
 //BA.debugLineNum = 86;BA.debugLine="B4XPages.AddPage(\"Form\", Form_C)";
_b4xpages._addpage /*String*/ (ba,"Form",(Object)(_form_c));
 //BA.debugLineNum = 88;BA.debugLine="B4XPages.AddPageAndCreate(\"listDados\", listDados_";
_b4xpages._addpageandcreate /*String*/ (ba,"listDados",(Object)(_listdados_c));
 //BA.debugLineNum = 90;BA.debugLine="B4XPages.AddPageAndCreate(\"FormMaquinaria\", FormM";
_b4xpages._addpageandcreate /*String*/ (ba,"FormMaquinaria",(Object)(_formmaquinaria_c));
 //BA.debugLineNum = 92;BA.debugLine="B4XPages.AddPageAndCreate(\"FormPrecipitacion\", Fo";
...
String _usuario = "";
String _contraseña = "";
 //BA.debugLineNum = 101;BA.debugLine="Private Sub Button1LOGIN_Click";
 //BA.debugLineNum = 103;BA.debugLine="Dim usuario As String";
_usuario = "";
 //BA.debugLineNum = 104;BA.debugLine="Dim contraseña As String";
_contraseña = "";
 //BA.debugLineNum = 107;BA.debugLine="usuario = EditText1Mail.text";
_usuario = _edittext1mail.getText();
 //BA.debugLineNum = 108;BA.debugLine="contraseña = EditText2Pass.text";
_contraseña = _edittext2pass.getText();
 //BA.debugLineNum = 111;BA.debugLine="If usuario = \"\" Or contraseña = \"\" Then";
if ((_usuario).equals("") || (_contraseña).equals("")) { 
 //BA.debugLineNum = 112;BA.debugLine="MsgboxAsync(\"Usuario o contraseña invalido\", \"TM";
__c.MsgboxAsync(BA.ObjectToCharSequence("Usuario o contraseña invalido"),BA.ObjectToCharSequence("TM App"),ba);
 }else {
 //BA.debugLineNum = 115;BA.debugLine="GetRecordUser(Main.pDBNameSeguridad,usuario)";
_getrecorduser(_main._pdbnameseguridad /*String*/ ,_usuario);
 //BA.debugLineNum = 117;BA.debugLine="If Main.pNit = \"890307964\" Or Main.pNit = Null T";
if ((_main._pnit /*String*/ ).equals("890307964") || _main._pnit /*String*/ == null) { 
 //BA.debugLineNum = 118;BA.debugLine="Panel1Precipitacion2.Enabled = False";
_panel1precipitacion2.setEnabled(__c.False);
 //BA.debugLineNum = 119;BA.debugLine="pnlPrograma_de_labores.Enabled = False";
_pnlprograma_de_labores.setEnabled(__c.False);
 //BA.debugLineNum = 120;BA.debugLine="pnlPrecipitacion.Enabled = False";
_pnlprecipitacion.setEnabled(__c.False);
 //BA.debugLineNum = 121;BA.debugLine="pnlCosecha.Enabled = False";
_pnlcosecha.setEnabled(__c.False);
 //BA.debugLineNum = 122;BA.debugLine="pnlTaller.Enabled = False";
_pnltaller.setEnabled(__c.False);
 //BA.debugLineNum = 123;BA.debugLine="PnlMaquinaria.Enabled = True";
...
_formprecipitacion_c = new b4a.example.ef.formprecipitacion();
 //BA.debugLineNum = 25;BA.debugLine="Private const rdcLink As String = \"http://84.46.2";
_rdclink = "http://84.46.255.129:17178/rdc";
 //BA.debugLineNum = 26;BA.debugLine="Dim parametrosUsuario As String=\"\"";
_parametrosusuario = "";
 //BA.debugLineNum = 28;BA.debugLine="Dim sf As StringFunctions";
_sf = new ADR.stringdemo.stringfunctions();
 //BA.debugLineNum = 29;BA.debugLine="sf.Initialize";
_sf._vvv1(ba);
 //BA.debugLineNum = 31;BA.debugLine="Private Panel1Precipitacion2 As B4XView";
_panel1precipitacion2 = new anywheresoftware.b4a.objects.B4XViewWrapper();
 //BA.debugLineNum = 32;BA.debugLine="Private pnlPrograma_de_labores As B4XView";
_pnlprograma_de_labores = new anywheresoftware.b4a.objects.B4XViewWrapper();
 //BA.debugLineNum = 33;BA.debugLine="Private pnlPrecipitacion As B4XView";
_pnlprecipitacion = new anywheresoftware.b4a.objects.B4XViewWrapper();
 //BA.debugLineNum = 34;BA.debugLine="Private pnlCosecha As B4XView";
_pnlcosecha = new anywheresoftware.b4a.objects.B4XViewWrapper();
 //BA.debugLineNum = 35;BA.debugLine="Private pnlTaller As B4XView";
_pnltaller = new anywheresoftware.b4a.objects.B4XViewWrapper();
 //BA.debugLineNum = 36;BA.debugLine="Private pnlPersonal As B4XView";
_pnlpersonal = new anywheresoftware.b4a.objects.B4XViewWrapper();
 //BA.debugLineNum = 37;BA.debugLine="Private PnlMaquinaria As B4XView";
_pnlmaquinaria = new anywheresoftware.b4a.objects.B4XViewWrapper();
 //BA.debugLineNum = 38;BA.debugLine="Private utilClass As util";
_utilclass = new b4a.example.ef.util();
...
b4a.example.ef.main._dbcommand _cmd = null;
 //BA.debugLineNum = 201;BA.debugLine="Sub CreateCommand(Name As String, Parameters() As";
 //BA.debugLineNum = 202;BA.debugLine="Dim cmd As DBCommand";
_cmd = new b4a.example.ef.main._dbcommand();
 //BA.debugLineNum = 203;BA.debugLine="cmd.Initialize";
_cmd.Initialize();
 //BA.debugLineNum = 204;BA.debugLine="cmd.Name = Name";
_cmd.Name /*String*/  = _name;
 //BA.debugLineNum = 205;BA.debugLine="If Parameters <> Null Then cmd.Parameters = Param";
if (_parameters!= null) { 
_cmd.Parameters /*Object[]*/  = _parameters;};
 //BA.debugLineNum = 206;BA.debugLine="Return cmd";
if (true) return _cmd;
...
b4a.example.ef.dbrequestmanager _req = null;
 //BA.debugLineNum = 195;BA.debugLine="Sub CreateRequest (Db As String) As DBRequestManag";
 //BA.debugLineNum = 196;BA.debugLine="Dim Req As DBRequestManager";
_req = new b4a.example.ef.dbrequestmanager();
 //BA.debugLineNum = 197;BA.debugLine="Req.Initialize(Me, rdcLink & \"?DBName=\" &  Main.p";
_req._initialize /*String*/ (ba,this,_rdclink+"?DBName="+_main._pdbnameseguridad /*String*/ );
 //BA.debugLineNum = 198;BA.debugLine="Return Req";
if (true) return _req;
...
//C
this.state = 1;
 //BA.debugLineNum = 135;BA.debugLine="Dim req As DBRequestManager = CreateRequest(UseDb";
_req = parent._createrequest(_usedbuser);
 //BA.debugLineNum = 136;BA.debugLine="Dim cmd As DBCommand = CreateCommand(\"select_usua";
_cmd = parent._createcommand("select_usuarioApp",new Object[]{(Object)(_usuario)});
 //BA.debugLineNum = 138;BA.debugLine="Dim cadena As String";
_cadena = "";
 //BA.debugLineNum = 139;BA.debugLine="Dim separador As String";
_separador = "";
 //BA.debugLineNum = 140;BA.debugLine="Dim longitud As Int";
_longitud = 0;
 //BA.debugLineNum = 142;BA.debugLine="Dim parts() As String";
_parts = new String[(int) (0)];
java.util.Arrays.fill(_parts,"");
 //BA.debugLineNum = 144;BA.debugLine="Wait For (req.ExecuteQuery(cmd, 0, id)) JobDone(j";
...
//C
this.state = 4;
 //BA.debugLineNum = 146;BA.debugLine="Msgbox(\"¿Está seguro que desea iniciar sesión?\",";
parent.__c.Msgbox(BA.ObjectToCharSequence("¿Está seguro que desea iniciar sesión?"),BA.ObjectToCharSequence("Confirmación"),ba);
 //BA.debugLineNum = 148;BA.debugLine="req.HandleJobAsync(j, \"req\")";
_req._handlejobasync /*void*/ (_j,"req");
 //BA.debugLineNum = 149;BA.debugLine="Wait For (req) req_Result(res As DBResult)";
...
;
 //BA.debugLineNum = 152;BA.debugLine="If res.Rows.Size > 0 Then";
if (true) break;
...
//C
this.state = 9;
 //BA.debugLineNum = 154;BA.debugLine="Main.pUser = sf.Trim(usuario)";
parent._main._puser /*String*/  = parent._sf._vvvvv7(_usuario);
 //BA.debugLineNum = 156;BA.debugLine="B4XPages.ShowPage(\"menu\")";
...
//C
this.state = 9;
 //BA.debugLineNum = 159;BA.debugLine="MsgboxAsync(\"Usuario o contraseña inválidos\", \"";
parent.__c.MsgboxAsync(BA.ObjectToCharSequence("Usuario o contraseña inválidos"),BA.ObjectToCharSequence("TM App"),ba);
 if (true) break;
;
 //BA.debugLineNum = 161;BA.debugLine="For Each row() As Object In res.Rows";
...
//C
this.state = 12;
 //BA.debugLineNum = 162;BA.debugLine="cadena = \"\"";
_cadena = "";
 //BA.debugLineNum = 163;BA.debugLine="separador=\" - \"";
_separador = " - ";
 //BA.debugLineNum = 164;BA.debugLine="For Each record As Object In row";
if (true) break;
...
//C
this.state = 31;
 //BA.debugLineNum = 166;BA.debugLine="cadena=cadena & record & separador";
...
this.state = 16;
;
 //BA.debugLineNum = 168;BA.debugLine="parts = Regex.Split(\"-\", cadena)";
_parts = parent.__c.Regex.Split("-",_cadena);
 //BA.debugLineNum = 169;BA.debugLine="Main.pUser = sf.Trim(usuario)";
parent._main._puser /*String*/  = parent._sf._vvvvv7(_usuario);
 //BA.debugLineNum = 170;BA.debugLine="Main.puserActivo = sf.Trim(parts(0))";
parent._main._puseractivo /*String*/  = parent._sf._vvvvv7(_parts[(int) (0)]);
 //BA.debugLineNum = 171;BA.debugLine="Main.pDBName  = sf.Trim(parts(1))";
parent._main._pdbname /*String*/  = parent._sf._vvvvv7(_parts[(int) (1)]);
 //BA.debugLineNum = 172;BA.debugLine="Main.pNit = sf.Trim(parts(2))";
parent._main._pnit /*String*/  = parent._sf._vvvvv7(_parts[(int) (2)]);
 //BA.debugLineNum = 174;BA.debugLine="Main.pUserOpcionLabores = sf.Trim(parts(3))";
parent._main._puseropcionlabores /*String*/  = parent._sf._vvvvv7(_parts[(int) (3)]);
 //BA.debugLineNum = 175;BA.debugLine="Main.pUserOpcionAgenda = sf.Trim(parts(4))";
parent._main._puseropcionagenda /*String*/  = parent._sf._vvvvv7(_parts[(int) (4)]);
 //BA.debugLineNum = 176;BA.debugLine="Main.pUserOpcionMaquinaria = sf.Trim(parts(5))";
parent._main._puseropcionmaquinaria /*String*/  = parent._sf._vvvvv7(_parts[(int) (5)]);
 //BA.debugLineNum = 177;BA.debugLine="Main.pUserOpcionPluviometros = sf.Trim(parts(6)";
parent._main._puseropcionpluviometros /*String*/  = parent._sf._vvvvv7(_parts[(int) (6)]);
 //BA.debugLineNum = 178;BA.debugLine="Main.pUserOpcionMonotoreo = sf.Trim(parts(7))";
parent._main._puseropcionmonotoreo /*String*/  = parent._sf._vvvvv7(_parts[(int) (7)]);
 //BA.debugLineNum = 180;BA.debugLine="longitud = cadena.Length";
_longitud = _cadena.length();
 //BA.debugLineNum = 181;BA.debugLine="cadena=cadena.SubString2(0, longitud - 3)";
_cadena = _cadena.substring((int) (0),(int) (_longitud-3));
 //BA.debugLineNum = 182;BA.debugLine="If parametrosUsuario = cadena Then";
if (true) break;
...
//C
this.state = 21;
 //BA.debugLineNum = 183;BA.debugLine="Log(\"Usuario: \"&parametrosUsuario)";
parent.__c.LogImpl("2655410","Usuario: "+parent._parametrosusuario,0);
 if (true) break;

case 20:
//C
this.state = 21;
 //BA.debugLineNum = 185;BA.debugLine="cadena=\"\"";
_cadena = "";
 if (true) break;
...
//C
this.state = 25;
 //BA.debugLineNum = 190;BA.debugLine="Log(\"ERROR: \" & j.ErrorMessage)";
parent.__c.LogImpl("2655417","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 192;BA.debugLine="j.Release";
_j._release /*String*/ ();
...
innerInitialize(_ba);
 ...
 //BA.debugLineNum = 44;BA.debugLine="B4XPages.GetManager.LogEvents = True";
_b4xpages._getmanager /*b4a.example.ef.b4xpagesmanager*/ (ba)._logevents /*boolean*/  = __c.True;
 //BA.debugLineNum = 45;BA.debugLine="B4XPages.GetManager.TransitionAnimationDuration =";
