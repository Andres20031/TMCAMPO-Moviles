...
public String  _panel1precipitacion2_click() throws Exception{
 //BA.debugLineNum = 92;BA.debugLine="Private Sub Panel1Precipitacion2_Click";
 //BA.debugLineNum = 94;BA.debugLine="End Sub";
return "";
}
public String  _pnlcosecha_click() throws Exception{
 //BA.debugLineNum = 79;BA.debugLine="Private Sub pnlCosecha_Click";
...
public String  _pnlmaquinaria_click() throws Exception{
 ...
 //BA.debugLineNum = 64;BA.debugLine="B4XPages.ShowPage(\"Form\")";
_b4xpages._showpage /*String*/ (ba,"Form");
 //BA.debugLineNum = 65;BA.debugLine="End Sub";
return "";
}
public String  _pnlpersonal_click() throws Exception{
 //BA.debugLineNum = 67;BA.debugLine="Private Sub pnlPersonal_Click";
 //BA.debugLineNum = 69;BA.debugLine="B4XPages.ShowPage(\"ListPerson\")";
_b4xpages._showpage /*String*/ (ba,"ListPerson");
 //BA.debugLineNum = 71;BA.debugLine="End Sub";
return "";
}
public String  _pnlprecipitacion_click() throws Exception{
 //BA.debugLineNum = 83;BA.debugLine="Private Sub pnlPrecipitacion_Click";
 //BA.debugLineNum = 84;BA.debugLine="B4XPages.ShowPage(\"FormPrecipitacion\")";
_b4xpages._showpage /*String*/ (ba,"FormPrecipitacion");
 //BA.debugLineNum = 85;BA.debugLine="End Sub";
return "";
}
public String  _pnlprograma_de_labores_click() throws Exception{
 //BA.debugLineNum = 87;BA.debugLine="Private Sub pnlPrograma_de_labores_Click";
 //BA.debugLineNum = 88;BA.debugLine="B4XPages.ShowPage(\"listDados\")";
_b4xpages._showpage /*String*/ (ba,"listDados");
 //BA.debugLineNum = 90;BA.debugLine="End Sub";
return "";
}
public String  _pnltaller_click() throws Exception{
 //BA.debugLineNum = 75;BA.debugLine="Private Sub pnlTaller_Click";
 //BA.debugLineNum = 76;BA.debugLine="B4XPages.ShowPage(\"FormMaquinaria\")";
