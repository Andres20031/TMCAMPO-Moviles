...
parent.__c.LogImpl("258523657","Comando SQL: insert_laborRiego",0);
 //BA.debugLineNum = 1031;BA.debugLine="Log(\"Parámetro 1 - consecutivo: \" & consecutivo)";
parent.__c.LogImpl("258523658","Parámetro 1 - consecutivo: "+BA.NumberToString(parent._consecutivo),0);
 //BA.debugLineNum = 1032;BA.debugLine="Log(\"Parámetro 2 - tipoRiego: \" & tipoRiego)";
parent.__c.LogImpl("258523659","Parámetro 2 - tipoRiego: "+parent._tiporiego,0);
 //BA.debugLineNum = 1033;BA.debugLine="Log(\"Parámetro 3 - procedenciaRiego: \" & proceden";
parent.__c.LogImpl("258523660","Parámetro 3 - procedenciaRiego: "+parent._procedenciariego,0);
 //BA.debugLineNum = 1034;BA.debugLine="Log(\"Parámetro 4 - caudalRiego: \" & caudalRiego)";
parent.__c.LogImpl("258523661","Parámetro 4 - caudalRiego: "+parent._caudalriego,0);
 //BA.debugLineNum = 1035;BA.debugLine="Log(\"Parámetro 5 - cantidadRiego: \" & cantidadRie";
parent.__c.LogImpl("258523662","Parámetro 5 - cantidadRiego: "+parent._cantidadriego,0);
...
parent.__c.LogImpl("258523673","Error al ejecutar la consulta: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("258523697","nitEmpresaCBX: "+parent._nitempresacbx,0);
 //BA.debugLineNum = 1071;BA.debugLine="Log(\"haciendaCBX: \" & haciendaCBX)";
parent.__c.LogImpl("258523698","haciendaCBX: "+parent._haciendacbx,0);
 //BA.debugLineNum = 1072;BA.debugLine="Log(\"loteCBX: \" & loteCBX)";
parent.__c.LogImpl("258523699","loteCBX: "+parent._lotecbx,0);
 //BA.debugLineNum = 1073;BA.debugLine="Log(\"fechafmrto: \" & fechafmrto)";
parent.__c.LogImpl("258523700","fechafmrto: "+parent._fechafmrto,0);
 //BA.debugLineNum = 1074;BA.debugLine="Log(\"tipoLabor: \" & tipoLabor)";
parent.__c.LogImpl("258523701","tipoLabor: "+parent._tipolabor,0);
 //BA.debugLineNum = 1075;BA.debugLine="Log(\"fechaInicio: \" & fechaInicio)";
parent.__c.LogImpl("258523702","fechaInicio: "+parent._fechainicio,0);
 //BA.debugLineNum = 1076;BA.debugLine="Log(\"fechaFin: \" & fechaFin)";
parent.__c.LogImpl("258523703","fechaFin: "+parent._fechafin,0);
 //BA.debugLineNum = 1077;BA.debugLine="Log(\"elementoGasto: \" & elementoGasto)";
parent.__c.LogImpl("258523704","elementoGasto: "+parent._elementogasto,0);
 //BA.debugLineNum = 1078;BA.debugLine="Log(\"areaLabor: \" & areaLabor)";
parent.__c.LogImpl("258523705","areaLabor: "+BA.NumberToString(parent._arealabor),0);
 //BA.debugLineNum = 1079;BA.debugLine="Log(\"consecutivo: \" & consecutivo)";
parent.__c.LogImpl("258523706","consecutivo: "+BA.NumberToString(parent._consecutivo),0);
 //BA.debugLineNum = 1080;BA.debugLine="Log(\"areaLote: \" & areaLote)";
parent.__c.LogImpl("258523707","areaLote: "+BA.NumberToString(parent._arealote),0);
 //BA.debugLineNum = 1081;BA.debugLine="Log(\"fechaActual: \" & fechaActual)";
parent.__c.LogImpl("258523708","fechaActual: "+parent._fechaactual,0);
 //BA.debugLineNum = 1082;BA.debugLine="Log(\"horaSistema: \" & horaSistema)";
parent.__c.LogImpl("258523709","horaSistema: "+parent._horasistema,0);
 //BA.debugLineNum = 1083;BA.debugLine="Log(\"user: \" & user)";
parent.__c.LogImpl("258523710","user: "+parent._user,0);
 //BA.debugLineNum = 1084;BA.debugLine="Log(\"DeviceName: \" & DeviceName)";
parent.__c.LogImpl("258523711","DeviceName: "+parent._devicename,0);
...
parent.__c.LogImpl("258523723","Error al ejecutar la consulta labor: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("258523727","Error al agregar datos: "+parent.__c.LastException(ba).getMessage(),0);
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("258589231","Datos insertados correctamente en insert_laborInsumo",0);
...
parent.__c.LogImpl("258589237","Excepción capturada en insert_laborInsumo: "+BA.ObjectToString(parent.__c.LastException(ba)),0);
...
parent.__c.LogImpl("258589259","nitEmpresaCBX: "+parent._nitempresacbx,0);
 //BA.debugLineNum = 1181;BA.debugLine="Log(\"haciendaCBX: \" & haciendaCBX)";
parent.__c.LogImpl("258589260","haciendaCBX: "+parent._haciendacbx,0);
 //BA.debugLineNum = 1182;BA.debugLine="Log(\"loteCBX: \" & loteCBX)";
parent.__c.LogImpl("258589261","loteCBX: "+parent._lotecbx,0);
 //BA.debugLineNum = 1183;BA.debugLine="Log(\"fechafmrto: \" & fechafmrto)";
parent.__c.LogImpl("258589262","fechafmrto: "+parent._fechafmrto,0);
 //BA.debugLineNum = 1184;BA.debugLine="Log(\"tipoLabor: \" & tipoLabor)";
parent.__c.LogImpl("258589263","tipoLabor: "+parent._tipolabor,0);
 //BA.debugLineNum = 1185;BA.debugLine="Log(\"fechaInicio: \" & fechaInicio)";
parent.__c.LogImpl("258589264","fechaInicio: "+parent._fechainicio,0);
 //BA.debugLineNum = 1186;BA.debugLine="Log(\"fechaFin: \" & fechaFin)";
parent.__c.LogImpl("258589265","fechaFin: "+parent._fechafin,0);
 //BA.debugLineNum = 1187;BA.debugLine="Log(\"elementoGasto: \" & elementoGasto)";
parent.__c.LogImpl("258589266","elementoGasto: "+parent._elementogasto,0);
 //BA.debugLineNum = 1188;BA.debugLine="Log(\"areaLabor: \" & areaLabor)";
parent.__c.LogImpl("258589267","areaLabor: "+BA.NumberToString(parent._arealabor),0);
 //BA.debugLineNum = 1189;BA.debugLine="Log(\"consecutivo: \" & consecutivo)";
parent.__c.LogImpl("258589268","consecutivo: "+BA.NumberToString(parent._consecutivo),0);
 //BA.debugLineNum = 1190;BA.debugLine="Log(\"areaLote: \" & areaLote)";
parent.__c.LogImpl("258589269","areaLote: "+BA.NumberToString(parent._arealote),0);
 //BA.debugLineNum = 1191;BA.debugLine="Log(\"fechaActual: \" & fechaActual)";
parent.__c.LogImpl("258589270","fechaActual: "+parent._fechaactual,0);
 //BA.debugLineNum = 1192;BA.debugLine="Log(\"horaSistema: \" & horaSistema)";
parent.__c.LogImpl("258589271","horaSistema: "+parent._horasistema,0);
 //BA.debugLineNum = 1193;BA.debugLine="Log(\"user: \" & user)";
parent.__c.LogImpl("258589272","user: "+parent._user,0);
 //BA.debugLineNum = 1194;BA.debugLine="Log(\"DeviceName: \" & DeviceName)";
parent.__c.LogImpl("258589273","DeviceName: "+parent._devicename,0);
...
parent.__c.LogImpl("258589285","Error al ejecutar la consulta labor: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("258589289","Error al agregar datos: "+parent.__c.LastException(ba).getMessage(),0);
 if (true) break;
if (true) break;
