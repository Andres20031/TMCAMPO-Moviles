...
parent._sd_xcomboboxelemento._add /*String*/ (_descripcionelementogasto+" - "+_codigoelementogasto,(Object)(_codigoelementogasto));
 if (true) break;
if (true) break;
...
_dscrpcion_producto = BA.ObjectToString(_row[(int) (1)]);
 //BA.debugLineNum = 692;BA.debugLine="SD_xComboBoxInsumo.Add(Dscrpcion_Producto & \" -";
parent._sd_xcomboboxinsumo._add /*String*/ (_dscrpcion_producto+" - "+_cdgo_producto,(Object)(_dscrpcion_producto+" - "+_cdgo_producto));
 if (true) break;
if (true) break;
...
parent._sd_xcomboboxtiporiego._add /*String*/ (_dscrpcion_tipo_riego+" - "+_cdgo_tipo_riego,(Object)(_cdgo_tipo_riego));
 if (true) break;
if (true) break;
...
parent._sd_xcomboboxtipolabranza._add /*String*/ (_dscrpcion_tipo_labranza+" - "+_cdgo_tipo_labranza,(Object)(_cdgo_tipo_labranza));
 if (true) break;
if (true) break;
...
_codg_hacienda = BA.ObjectToString(_row[(int) (0)]);
 //BA.debugLineNum = 414;BA.debugLine="SD_xComboBoxLote.Add(\"Codigo: \"&Codg_Hacienda,";
...
_nombrehacienda = BA.ObjectToString(_row[(int) (1)]);
 //BA.debugLineNum = 377;BA.debugLine="SD_xComboBoxHacienda.Add(NombreHacienda & \" - \"";
