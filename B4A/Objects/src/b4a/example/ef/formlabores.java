...
__c.LogImpl("07208989","Fecha inicio: "+_fechainicio,0);
...
__c.LogImpl("07274525","Fecha fin: "+_fechafin,0);
...
parent.__c.LogImpl("06750296",BA.NumberToString(parent._consecutivo),0);
...
parent.__c.LogImpl("06750316",BA.NumberToString(parent._consecutivosiembra),0);
...
__c.LogImpl("09371661",BA.NumberToString(_ideliminartabla),0);
...
parent.__c.LogImpl("09699351",BA.NumberToString(parent._consecutivosiembra),0);
...
__c.LogImpl("07733252","Area Labor "+BA.NumberToString(_arealabor),0);
...
__c.LogImpl("07798788","Area lote "+BA.NumberToString(_arealote),0);
...
__c.LogImpl("08519684","bandereo "+BA.NumberToString(_bandereosiembra),0);
...
__c.LogImpl("08060931","cantidad"+_cantidadriego,0);
...
__c.LogImpl("07995395","caudal"+_caudalriego,0);
...
__c.LogImpl("08454147","Distancia de siembra "+BA.NumberToString(_distanciasiembra),0);
...
__c.LogImpl("08847363","numero de macollos "+BA.NumberToString(_numeromacollosiembra),0);
...
__c.LogImpl("08781828","numero de paquetes "+BA.NumberToString(_numeropaquetessiembra),0);
...
__c.LogImpl("07929860","procedencia"+_procedenciariego,0);
...
__c.LogImpl("08650755","procedencia "+_procedenciasiembra,0);
...
__c.LogImpl("08585220","tonelada Semilla "+BA.NumberToString(_toneladasemillasiembra),0);
...
__c.LogImpl("08388611","codigo "+_codigosiembra,0);
...
__c.LogImpl("07667725","Las dos primeras letras (o menos si no hay suficientes): "+_elementogasto,0);
...
parent.__c.LogImpl("07471139","Hacienda"+parent._haciendacbx,0);
...
__c.LogImpl("07602180","Elemento labor"+_elementolabor,0);
...
__c.LogImpl("07536643","Lotecbx"+_lotecbx,0);
...
parent.__c.LogImpl("07405602","Nit seleccionado"+parent._nitempresacbx,0);
...
__c.LogImpl("08716292","tipo labranza "+_tipolabranzasiembra,0);
...
__c.LogImpl("08126467","tipo riego"+_tiporiego,0);
...
__c.LogImpl("07864358","Tipo labor "+_tipolabor,0);
