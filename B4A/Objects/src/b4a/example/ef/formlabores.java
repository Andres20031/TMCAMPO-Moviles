...
__c.LogImpl("256098846","Fecha inicio: "+_fechainicio,0);
...
__c.LogImpl("256164382","Fecha fin: "+_fechafin,0);
...
parent.__c.LogImpl("255640098","Error en la consulta de NITs: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("255640129","Error en la consulta de Maquina: "+_j3._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("255640156","Error en la consulta de Maquina: "+_j4._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("255640188","Último Registro obtenido: "+BA.NumberToString(_ultimoregistro),0);
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("255640192","Error en la consulta select_maxIdLabor: "+_j5._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("255640197",BA.NumberToString(parent._consecutivo),0);
...
parent.__c.LogImpl("255640208","Último Registro Siembra  obtenido: "+BA.NumberToString(_ultimoregistrosiembra),0);
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("255640212","Error en la consulta select_maxIdLabor: "+_j5._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("255640217",BA.NumberToString(parent._consecutivosiembra),0);
...
__c.LogImpl("258261505","COLUM ID"+_columnid,0);
 //BA.debugLineNum = 850;BA.debugLine="Log(\"ROW ID\"&RowId)";
__c.LogImpl("258261506","ROW ID"+BA.NumberToString(_rowid),0);
...
__c.LogImpl("258261517",BA.NumberToString(_ideliminartabla),0);
...
parent.__c.LogImpl("258458145","Fila "+BA.NumberToString((_i+1))+":",0);
 //BA.debugLineNum = 920;BA.debugLine="Log(\" - ID: \" & ID)";
parent.__c.LogImpl("258458146"," - ID: "+_id,0);
 //BA.debugLineNum = 921;BA.debugLine="Log(\" - NOMBRE: \" & nombreInsu)";
parent.__c.LogImpl("258458147"," - NOMBRE: "+_nombreinsu,0);
 //BA.debugLineNum = 922;BA.debugLine="Log(\" - CANTIDAD: \" & cantidadInsu)";
parent.__c.LogImpl("258458148"," - CANTIDAD: "+BA.NumberToString(_cantidadinsu),0);
...
parent.__c.LogImpl("258458157","Comando SQL: insert_laborInsumo",0);
 //BA.debugLineNum = 932;BA.debugLine="Log(\"Parámetro 1 - consecutivo: \" & consecutiv";
parent.__c.LogImpl("258458158","Parámetro 1 - consecutivo: "+BA.NumberToString(parent._consecutivo),0);
 //BA.debugLineNum = 933;BA.debugLine="Log(\"Parámetro 2 - ID: \" & ID)";
parent.__c.LogImpl("258458159","Parámetro 2 - ID: "+_id,0);
 //BA.debugLineNum = 934;BA.debugLine="Log(\"Parámetro 3 - cantidadInsu: \" & cantidadI";
parent.__c.LogImpl("258458160","Parámetro 3 - cantidadInsu: "+BA.NumberToString(_cantidadinsu),0);
...
parent.__c.LogImpl("258458168","Inserción insumo exitosa para ID: "+_id,0);
...
parent.__c.LogImpl("258458172","Error en la inserción insumo para ID: "+_id+". Error: "+_j._errormessage /*String*/ ,0);
...
parent.__c.LogImpl("258458184","Error al procesar insumo la cantidad para ID: "+_id,0);
...
parent.__c.LogImpl("258458209","nitEmpresaCBX: "+parent._nitempresacbx,0);
 //BA.debugLineNum = 984;BA.debugLine="Log(\"haciendaCBX: \" & haciendaCBX)";
parent.__c.LogImpl("258458210","haciendaCBX: "+parent._haciendacbx,0);
 //BA.debugLineNum = 985;BA.debugLine="Log(\"loteCBX: \" & loteCBX)";
parent.__c.LogImpl("258458211","loteCBX: "+parent._lotecbx,0);
 //BA.debugLineNum = 986;BA.debugLine="Log(\"fechafmrto: \" & fechafmrto)";
parent.__c.LogImpl("258458212","fechafmrto: "+parent._fechafmrto,0);
 //BA.debugLineNum = 987;BA.debugLine="Log(\"tipoLabor: \" & tipoLabor)";
parent.__c.LogImpl("258458213","tipoLabor: "+parent._tipolabor,0);
 //BA.debugLineNum = 988;BA.debugLine="Log(\"fechaInicio: \" & fechaInicio)";
parent.__c.LogImpl("258458214","fechaInicio: "+parent._fechainicio,0);
 //BA.debugLineNum = 989;BA.debugLine="Log(\"fechaFin: \" & fechaFin)";
parent.__c.LogImpl("258458215","fechaFin: "+parent._fechafin,0);
 //BA.debugLineNum = 990;BA.debugLine="Log(\"elementoGasto: \" & elementoGasto)";
parent.__c.LogImpl("258458216","elementoGasto: "+parent._elementogasto,0);
 //BA.debugLineNum = 991;BA.debugLine="Log(\"areaLabor: \" & areaLabor)";
parent.__c.LogImpl("258458217","areaLabor: "+BA.NumberToString(parent._arealabor),0);
 //BA.debugLineNum = 992;BA.debugLine="Log(\"consecutivo: \" & consecutivo)";
parent.__c.LogImpl("258458218","consecutivo: "+BA.NumberToString(parent._consecutivo),0);
 //BA.debugLineNum = 993;BA.debugLine="Log(\"areaLote: \" & areaLote)";
parent.__c.LogImpl("258458219","areaLote: "+BA.NumberToString(parent._arealote),0);
 //BA.debugLineNum = 994;BA.debugLine="Log(\"fechaActual: \" & fechaActual)";
parent.__c.LogImpl("258458220","fechaActual: "+parent._fechaactual,0);
 //BA.debugLineNum = 995;BA.debugLine="Log(\"horaSistema: \" & horaSistema)";
parent.__c.LogImpl("258458221","horaSistema: "+parent._horasistema,0);
 //BA.debugLineNum = 996;BA.debugLine="Log(\"user: \" & user)";
parent.__c.LogImpl("258458222","user: "+parent._user,0);
 //BA.debugLineNum = 997;BA.debugLine="Log(\"DeviceName: \" & DeviceName)";
parent.__c.LogImpl("258458223","DeviceName: "+parent._devicename,0);
...
parent.__c.LogImpl("258458235","Error al ejecutar la consulta labor: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("258458239","Error al agregar datos: "+parent.__c.LastException(ba).getMessage(),0);
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("258523659","Comando SQL: insert_laborRiego",0);
 //BA.debugLineNum = 1033;BA.debugLine="Log(\"Parámetro 1 - consecutivo: \" & consecutivo)";
parent.__c.LogImpl("258523660","Parámetro 1 - consecutivo: "+BA.NumberToString(parent._consecutivo),0);
 //BA.debugLineNum = 1034;BA.debugLine="Log(\"Parámetro 2 - tipoRiego: \" & tipoRiego)";
parent.__c.LogImpl("258523661","Parámetro 2 - tipoRiego: "+parent._tiporiego,0);
 //BA.debugLineNum = 1035;BA.debugLine="Log(\"Parámetro 3 - procedenciaRiego: \" & proceden";
parent.__c.LogImpl("258523662","Parámetro 3 - procedenciaRiego: "+parent._procedenciariego,0);
 //BA.debugLineNum = 1036;BA.debugLine="Log(\"Parámetro 4 - caudalRiego: \" & caudalRiego)";
parent.__c.LogImpl("258523663","Parámetro 4 - caudalRiego: "+parent._caudalriego,0);
 //BA.debugLineNum = 1037;BA.debugLine="Log(\"Parámetro 5 - cantidadRiego: \" & cantidadRie";
parent.__c.LogImpl("258523664","Parámetro 5 - cantidadRiego: "+parent._cantidadriego,0);
...
parent.__c.LogImpl("258523674","Error al ejecutar la consulta: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("258523677","Error al agregar datos: "+parent.__c.LastException(ba).getMessage(),0);
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("258523698","nitEmpresaCBX: "+parent._nitempresacbx,0);
 //BA.debugLineNum = 1072;BA.debugLine="Log(\"haciendaCBX: \" & haciendaCBX)";
parent.__c.LogImpl("258523699","haciendaCBX: "+parent._haciendacbx,0);
 //BA.debugLineNum = 1073;BA.debugLine="Log(\"loteCBX: \" & loteCBX)";
parent.__c.LogImpl("258523700","loteCBX: "+parent._lotecbx,0);
 //BA.debugLineNum = 1074;BA.debugLine="Log(\"fechafmrto: \" & fechafmrto)";
parent.__c.LogImpl("258523701","fechafmrto: "+parent._fechafmrto,0);
 //BA.debugLineNum = 1075;BA.debugLine="Log(\"tipoLabor: \" & tipoLabor)";
parent.__c.LogImpl("258523702","tipoLabor: "+parent._tipolabor,0);
 //BA.debugLineNum = 1076;BA.debugLine="Log(\"fechaInicio: \" & fechaInicio)";
parent.__c.LogImpl("258523703","fechaInicio: "+parent._fechainicio,0);
 //BA.debugLineNum = 1077;BA.debugLine="Log(\"fechaFin: \" & fechaFin)";
parent.__c.LogImpl("258523704","fechaFin: "+parent._fechafin,0);
 //BA.debugLineNum = 1078;BA.debugLine="Log(\"elementoGasto: \" & elementoGasto)";
parent.__c.LogImpl("258523705","elementoGasto: "+parent._elementogasto,0);
 //BA.debugLineNum = 1079;BA.debugLine="Log(\"areaLabor: \" & areaLabor)";
parent.__c.LogImpl("258523706","areaLabor: "+BA.NumberToString(parent._arealabor),0);
 //BA.debugLineNum = 1080;BA.debugLine="Log(\"consecutivo: \" & consecutivo)";
parent.__c.LogImpl("258523707","consecutivo: "+BA.NumberToString(parent._consecutivo),0);
 //BA.debugLineNum = 1081;BA.debugLine="Log(\"areaLote: \" & areaLote)";
parent.__c.LogImpl("258523708","areaLote: "+BA.NumberToString(parent._arealote),0);
 //BA.debugLineNum = 1082;BA.debugLine="Log(\"fechaActual: \" & fechaActual)";
parent.__c.LogImpl("258523709","fechaActual: "+parent._fechaactual,0);
 //BA.debugLineNum = 1083;BA.debugLine="Log(\"horaSistema: \" & horaSistema)";
parent.__c.LogImpl("258523710","horaSistema: "+parent._horasistema,0);
 //BA.debugLineNum = 1084;BA.debugLine="Log(\"user: \" & user)";
parent.__c.LogImpl("258523711","user: "+parent._user,0);
 //BA.debugLineNum = 1085;BA.debugLine="Log(\"DeviceName: \" & DeviceName)";
parent.__c.LogImpl("258523712","DeviceName: "+parent._devicename,0);
...
parent.__c.LogImpl("258523724","Error al ejecutar la consulta labor: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("258523728","Error al agregar datos: "+parent.__c.LastException(ba).getMessage(),0);
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("258589198","Último Registro Siembra  obtenido: "+BA.NumberToString(_ultimoregistrosiembra),0);
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("258589202","Error en la consulta select_maxIdLabor: "+_j5._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("258589207",BA.NumberToString(parent._consecutivosiembra),0);
...
parent.__c.LogImpl("258589213","Comando SQL: insert_laborSiembra",0);
 //BA.debugLineNum = 1136;BA.debugLine="Log(\"Parámetro 1 - consecutivoSiembra: \" & consec";
parent.__c.LogImpl("258589214","Parámetro 1 - consecutivoSiembra: "+BA.NumberToString(parent._consecutivosiembra),0);
 //BA.debugLineNum = 1137;BA.debugLine="Log(\"Parámetro 2 - codigoSiembra: \" & codigoSiemb";
parent.__c.LogImpl("258589215","Parámetro 2 - codigoSiembra: "+parent._codigosiembra,0);
 //BA.debugLineNum = 1138;BA.debugLine="Log(\"Parámetro 3 - distanciaSiembra: \" & distanci";
parent.__c.LogImpl("258589216","Parámetro 3 - distanciaSiembra: "+BA.NumberToString(parent._distanciasiembra),0);
 //BA.debugLineNum = 1139;BA.debugLine="Log(\"Parámetro 4 - toneladaSemillaSiembra: \" & to";
parent.__c.LogImpl("258589217","Parámetro 4 - toneladaSemillaSiembra: "+BA.NumberToString(parent._toneladasemillasiembra),0);
 //BA.debugLineNum = 1140;BA.debugLine="Log(\"Parámetro 5 - numeroPaquetesSiembra: \" & num";
parent.__c.LogImpl("258589218","Parámetro 5 - numeroPaquetesSiembra: "+BA.NumberToString(parent._numeropaquetessiembra),0);
 //BA.debugLineNum = 1141;BA.debugLine="Log(\"Parámetro 6 - procedenciaSiembra: \" & proced";
parent.__c.LogImpl("258589219","Parámetro 6 - procedenciaSiembra: "+parent._procedenciasiembra,0);
 //BA.debugLineNum = 1142;BA.debugLine="Log(\"Parámetro 7 - tipoLabranzaSiembra: \" & tipoL";
parent.__c.LogImpl("258589220","Parámetro 7 - tipoLabranzaSiembra: "+parent._tipolabranzasiembra,0);
 //BA.debugLineNum = 1143;BA.debugLine="Log(\"Parámetro 8 - bandereoSiembra: \" & bandereoS";
parent.__c.LogImpl("258589221","Parámetro 8 - bandereoSiembra: "+BA.NumberToString(parent._bandereosiembra),0);
 //BA.debugLineNum = 1144;BA.debugLine="Log(\"Parámetro 9 - numeroMacolloSiembra: \" & nume";
parent.__c.LogImpl("258589222","Parámetro 9 - numeroMacolloSiembra: "+BA.NumberToString(parent._numeromacollosiembra),0);
...
parent.__c.LogImpl("258589231","Datos insertados correctamente en insert_laborSiembra",0);
 //BA.debugLineNum = 1154;BA.debugLine="ToastMessageShow(\"Datos guardados con éxito\", F";
parent.__c.ToastMessageShow(BA.ObjectToCharSequence("Datos guardados con éxito"),parent.__c.False);
 if (true) break;

case 18:
//C
this.state = 19;
 //BA.debugLineNum = 1157;BA.debugLine="Log(\"Error al agregar datos: \" & LastException)";
parent.__c.LogImpl("258589235","Error al agregar datos: "+BA.ObjectToString(parent.__c.LastException(ba)),0);
 //BA.debugLineNum = 1158;BA.debugLine="Log(\"Error al ejecutar la consulta: \" & j.Error";
parent.__c.LogImpl("258589236","Error al ejecutar la consulta: "+_j._errormessage /*String*/ ,0);
 //BA.debugLineNum = 1159;BA.debugLine="Log(\"Valores enviados: consecutivo=\" & consecut";
parent.__c.LogImpl("258589237","Valores enviados: consecutivo="+BA.NumberToString(parent._consecutivosiembra)+", codigoSiembra="+parent._codigosiembra+", distanciaSiembra="+BA.NumberToString(parent._distanciasiembra)+", toneladaSemillaSiembra="+BA.NumberToString(parent._toneladasemillasiembra)+", numeroPaquetesSiembra="+BA.NumberToString(parent._numeropaquetessiembra)+", procedenciaSiembra="+parent._procedenciasiembra+", tipoLabranzaSiembra="+parent._tipolabranzasiembra+", bandereoSiembra="+BA.NumberToString(parent._bandereosiembra)+", numeroMacolloSiembra="+BA.NumberToString(parent._numeromacollosiembra),0);
 //BA.debugLineNum = 1164;BA.debugLine="ToastMessageShow(\"Error al guardar los datos\",";
...
this.state = 22;
this.catchState = 0;
 //BA.debugLineNum = 1168;BA.debugLine="Log(\"Excepción capturada: \" & LastException)";
parent.__c.LogImpl("258589246","Excepción capturada: "+BA.ObjectToString(parent.__c.LastException(ba)),0);
 //BA.debugLineNum = 1169;BA.debugLine="ToastMessageShow(\"Se produjo un error inesperado";
...
this.catchState = 0;
;
 //BA.debugLineNum = 1173;BA.debugLine="Dim horaSistema As String = DateTime.Time(DateTim";
parent._horasistema = parent.__c.DateTime.Time(parent.__c.DateTime.getNow());
 //BA.debugLineNum = 1174;BA.debugLine="user = Main.pUser";
parent._user = parent._main._puser /*String*/ ;
 //BA.debugLineNum = 1175;BA.debugLine="DeviceName = GetDeviceName";
parent._devicename = parent._getdevicename();
 //BA.debugLineNum = 1176;BA.debugLine="Dim fecha As Long = DateTime.Now ' Obtiene el tie";
_fecha = parent.__c.DateTime.getNow();
 //BA.debugLineNum = 1177;BA.debugLine="DateTime.DateFormat = \"yyyy-MM-dd HH:mm:ss\" ' Con";
parent.__c.DateTime.setDateFormat("yyyy-MM-dd HH:mm:ss");
 //BA.debugLineNum = 1178;BA.debugLine="fechaActual = DateTime.Date(fecha) ' Almacena la";
parent._fechaactual = parent.__c.DateTime.Date(_fecha);
 //BA.debugLineNum = 1180;BA.debugLine="fechafmrto = DateTime.Date(fecha)";
parent._fechafmrto = parent.__c.DateTime.Date(_fecha);
 //BA.debugLineNum = 1182;BA.debugLine="Dim Req As DBRequestManager";
_req = new b4a.example.ef.dbrequestmanager();
 //BA.debugLineNum = 1183;BA.debugLine="Req.Initialize(Me, rdcLink & \"?DBName=\" & Main.pD";
_req._initialize /*String*/ (ba,parent,parent._rdclink+"?DBName="+parent._main._pdbname /*String*/ );
 //BA.debugLineNum = 1186;BA.debugLine="Dim cmd As DBCommand = CreateCommand(\"insert_labo";
_cmd = parent._createcommand("insert_labor",new Object[]{(Object)(parent._nitempresacbx),(Object)(parent._haciendacbx),(Object)(parent._lotecbx),(Object)("0000-"),(Object)("CA"),(Object)(parent._tipolabor),(Object)(parent._fechainicio),(Object)(parent._fechafin),(Object)(parent._elementogasto),(Object)(parent._arealabor),(Object)(parent._consecutivo),parent.__c.Null,(Object)(parent._arealote),parent.__c.Null,(Object)(parent._fechaactual),(Object)(parent._horasistema),(Object)(parent._user),(Object)(parent._devicename)});
 //BA.debugLineNum = 1190;BA.debugLine="Log(\"nitEmpresaCBX: \" & nitEmpresaCBX)";
parent.__c.LogImpl("258589268","nitEmpresaCBX: "+parent._nitempresacbx,0);
 //BA.debugLineNum = 1191;BA.debugLine="Log(\"haciendaCBX: \" & haciendaCBX)";
parent.__c.LogImpl("258589269","haciendaCBX: "+parent._haciendacbx,0);
 //BA.debugLineNum = 1192;BA.debugLine="Log(\"loteCBX: \" & loteCBX)";
parent.__c.LogImpl("258589270","loteCBX: "+parent._lotecbx,0);
 //BA.debugLineNum = 1193;BA.debugLine="Log(\"fechafmrto: \" & fechafmrto)";
parent.__c.LogImpl("258589271","fechafmrto: "+parent._fechafmrto,0);
 //BA.debugLineNum = 1194;BA.debugLine="Log(\"tipoLabor: \" & tipoLabor)";
parent.__c.LogImpl("258589272","tipoLabor: "+parent._tipolabor,0);
 //BA.debugLineNum = 1195;BA.debugLine="Log(\"fechaInicio: \" & fechaInicio)";
parent.__c.LogImpl("258589273","fechaInicio: "+parent._fechainicio,0);
 //BA.debugLineNum = 1196;BA.debugLine="Log(\"fechaFin: \" & fechaFin)";
parent.__c.LogImpl("258589274","fechaFin: "+parent._fechafin,0);
 //BA.debugLineNum = 1197;BA.debugLine="Log(\"elementoGasto: \" & elementoGasto)";
parent.__c.LogImpl("258589275","elementoGasto: "+parent._elementogasto,0);
 //BA.debugLineNum = 1198;BA.debugLine="Log(\"areaLabor: \" & areaLabor)";
parent.__c.LogImpl("258589276","areaLabor: "+BA.NumberToString(parent._arealabor),0);
 //BA.debugLineNum = 1199;BA.debugLine="Log(\"consecutivo: \" & consecutivo)";
parent.__c.LogImpl("258589277","consecutivo: "+BA.NumberToString(parent._consecutivo),0);
 //BA.debugLineNum = 1200;BA.debugLine="Log(\"areaLote: \" & areaLote)";
parent.__c.LogImpl("258589278","areaLote: "+BA.NumberToString(parent._arealote),0);
 //BA.debugLineNum = 1201;BA.debugLine="Log(\"fechaActual: \" & fechaActual)";
parent.__c.LogImpl("258589279","fechaActual: "+parent._fechaactual,0);
 //BA.debugLineNum = 1202;BA.debugLine="Log(\"horaSistema: \" & horaSistema)";
parent.__c.LogImpl("258589280","horaSistema: "+parent._horasistema,0);
 //BA.debugLineNum = 1203;BA.debugLine="Log(\"user: \" & user)";
parent.__c.LogImpl("258589281","user: "+parent._user,0);
 //BA.debugLineNum = 1204;BA.debugLine="Log(\"DeviceName: \" & DeviceName)";
parent.__c.LogImpl("258589282","DeviceName: "+parent._devicename,0);
 //BA.debugLineNum = 1206;BA.debugLine="Dim j As HttpJob = Req.ExecuteCommand(cmd, Null)";
_j = _req._executecommand /*b4a.example.ef.httpjob*/ (_cmd,parent.__c.Null);
 //BA.debugLineNum = 1207;BA.debugLine="Wait For(j) JobDone(j As HttpJob)";
parent.__c.WaitFor("jobdone", ba, this, (Object)(_j));
this.state = 40;
return;
case 40:
...
this.state = 26;
this.catchState = 33;
 //BA.debugLineNum = 1211;BA.debugLine="If j.Success Then";
if (true) break;
...
//C
this.state = 31;
 //BA.debugLineNum = 1213;BA.debugLine="MsgboxAsync(\"Se ha insertado correctamente la l";
parent.__c.MsgboxAsync(BA.ObjectToCharSequence("Se ha insertado correctamente la labor."),BA.ObjectToCharSequence("Éxito"),ba);
 if (true) break;
...
//C
this.state = 31;
 //BA.debugLineNum = 1216;BA.debugLine="Log(\"Error al ejecutar la consulta labor: \" & j";
parent.__c.LogImpl("258589294","Error al ejecutar la consulta labor: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
this.state = 34;
this.catchState = 0;
 //BA.debugLineNum = 1220;BA.debugLine="Log(\"Error al agregar datos: \" & LastException.M";
parent.__c.LogImpl("258589298","Error al agregar datos: "+parent.__c.LastException(ba).getMessage(),0);
 if (true) break;
if (true) break;
...
__c.LogImpl("256623108","Area Labor "+BA.NumberToString(_arealabor),0);
...
__c.LogImpl("256688644","Area lote "+BA.NumberToString(_arealote),0);
...
__c.LogImpl("257409540","bandereo "+BA.NumberToString(_bandereosiembra),0);
...
__c.LogImpl("256950787","cantidad"+_cantidadriego,0);
...
__c.LogImpl("256885251","caudal"+_caudalriego,0);
...
__c.LogImpl("257344003","Distancia de siembra "+BA.NumberToString(_distanciasiembra),0);
...
__c.LogImpl("257737219","numero de macollos "+BA.NumberToString(_numeromacollosiembra),0);
...
__c.LogImpl("257671684","numero de paquetes "+BA.NumberToString(_numeropaquetessiembra),0);
...
__c.LogImpl("256819716","procedencia"+_procedenciariego,0);
...
__c.LogImpl("257540611","procedencia "+_procedenciasiembra,0);
...
__c.LogImpl("257475076","tonelada Semilla "+BA.NumberToString(_toneladasemillasiembra),0);
...
parent.__c.LogImpl("257933845","Error en la consulta de NITs: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("257802773","Error en la consulta de NITs: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("257868313","Error en la consulta de NITs: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("257868332","Error en la consulta de Tipo_Labranza: "+_j4._errormessage /*String*/ ,0);
 if (true) break;
...
__c.LogImpl("257278467","codigo "+_codigosiembra,0);
...
__c.LogImpl("256557581","Las dos primeras letras (o menos si no hay suficientes): "+_elementogasto,0);
...
parent.__c.LogImpl("256360987","Error: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("256360994","Hacienda"+parent._haciendacbx,0);
...
__c.LogImpl("256492036","Elemento labor"+_elementolabor,0);
...
__c.LogImpl("256426499","Lotecbx"+_lotecbx,0);
...
parent.__c.LogImpl("256295452","Error: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("256295458","Nit seleccionado"+parent._nitempresacbx,0);
...
__c.LogImpl("257606148","tipo labranza "+_tipolabranzasiembra,0);
...
__c.LogImpl("257016323","tipo riego"+_tiporiego,0);
...
__c.LogImpl("256754208","Valor no reconocido: "+BA.ObjectToString(_value),0);
 break; }
}
;
 }else {
 //BA.debugLineNum = 583;BA.debugLine="Log(\"Error: Value no es un número válido.\")";
__c.LogImpl("256754211","Error: Value no es un número válido.",0);
 };
 //BA.debugLineNum = 586;BA.debugLine="Log(\"Tipo labor \" & tipoLabor)";
__c.LogImpl("256754214","Tipo labor "+_tipolabor,0);
...
//C
this.state = 1;
 //BA.debugLineNum = 1353;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateEleme";
...
;
 //BA.debugLineNum = 1355;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 1356;BA.debugLine="SwiftButtonElemento.xLBL.Text = SearchTemplateEl";
parent._swiftbuttonelemento._xlbl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setText(BA.ObjectToCharSequence(parent._searchtemplateelemento._selecteditem /*String*/ ));
 //BA.debugLineNum = 1357;BA.debugLine="Dim Partes() As String = Regex.Split(\":\", Search";
_partes = parent.__c.Regex.Split(":",parent._searchtemplateelemento._selecteditem /*String*/ );
 //BA.debugLineNum = 1358;BA.debugLine="elementoGasto = Partes(0) ' Asignar solo la prim";
parent._elementogasto = _partes[(int) (0)];
 //BA.debugLineNum = 1361;BA.debugLine="If elementoGasto.Length >= 2 Then";
if (true) break;
...
//C
this.state = 9;
 //BA.debugLineNum = 1362;BA.debugLine="elementoGasto = elementoGasto.SubString2(0, 2)";
...
//C
this.state = 9;
 //BA.debugLineNum = 1365;BA.debugLine="elementoGasto = elementoGasto";
...
this.state = -1;
;
 //BA.debugLineNum = 1368;BA.debugLine="Log(elementoGasto)";
parent.__c.LogImpl("258916880",parent._elementogasto,0);
...
//C
this.state = 1;
 //BA.debugLineNum = 1279;BA.debugLine="Dim ItemsLote As List";
_itemslote = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 1280;BA.debugLine="ItemsLote.Initialize";
_itemslote.Initialize();
 //BA.debugLineNum = 1282;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateHacie";
...
_result = (Integer) result[0];
;
 //BA.debugLineNum = 1283;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 1284;BA.debugLine="SwiftButtonHacienda.xLBL.Text = SearchTemplateHa";
parent._swiftbuttonhacienda._xlbl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setText(BA.ObjectToCharSequence(parent._searchtemplatehacienda._selecteditem /*String*/ ));
 //BA.debugLineNum = 1285;BA.debugLine="Dim HACIENDACOMPLETO As String = SearchTemplateH";
_haciendacompleto = parent._searchtemplatehacienda._selecteditem /*String*/ ;
 //BA.debugLineNum = 1286;BA.debugLine="Dim Partes() As String = Regex.Split(\":\", HACIEN";
_partes = parent.__c.Regex.Split(":",_haciendacompleto);
 //BA.debugLineNum = 1287;BA.debugLine="haciendaCBX = Partes(0)";
parent._haciendacbx = _partes[(int) (0)];
 //BA.debugLineNum = 1288;BA.debugLine="ItemsLote.Clear";
_itemslote.Clear();
 //BA.debugLineNum = 1289;BA.debugLine="ItemsLote.Add(\"Seleccionar:\")";
_itemslote.Add((Object)("Seleccionar:"));
 //BA.debugLineNum = 1290;BA.debugLine="SwiftButtonLote.xLBL.Text = \"\"";
parent._swiftbuttonlote._xlbl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 1292;BA.debugLine="Dim Req As DBRequestManager";
_req = new b4a.example.ef.dbrequestmanager();
 //BA.debugLineNum = 1293;BA.debugLine="Req.Initialize(Me, rdcLink & \"?DBName=\" & Main.p";
_req._initialize /*String*/ (ba,parent,parent._rdclink+"?DBName="+parent._main._pdbname /*String*/ );
 //BA.debugLineNum = 1294;BA.debugLine="Dim cmd As DBCommand = CreateCommand(\"select_lot";
_cmd = parent._createcommand("select_lotes",new Object[]{(Object)(parent._nitempresacbx),(Object)(parent._haciendacbx)});
 //BA.debugLineNum = 1297;BA.debugLine="Wait For (Req.ExecuteQuery(cmd, 0, Null)) JobDon";
parent.__c.WaitFor("jobdone", ba, this, (Object)(_req._executequery /*b4a.example.ef.httpjob*/ (_cmd,(int) (0),parent.__c.Null)));
this.state = 16;
return;
case 16:
...
_j = (b4a.example.ef.httpjob) result[0];
;
 //BA.debugLineNum = 1300;BA.debugLine="If j.Success Then";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 1302;BA.debugLine="Req.HandleJobAsync(j, \"req\")";
_req._handlejobasync /*void*/ (_j,"req");
 //BA.debugLineNum = 1303;BA.debugLine="Wait For (Req) req_Result(res As DBResult)";
parent.__c.WaitFor("req_result", ba, this, (Object)(_req));
this.state = 17;
return;
case 17:
...
_res = (b4a.example.ef.main._dbresult) result[0];
;
 //BA.debugLineNum = 1307;BA.debugLine="For Each row() As Object In res.Rows";
if (true) break;
...
//C
this.state = 19;
 //BA.debugLineNum = 1308;BA.debugLine="Dim Codg_Hacienda As String = row(0)";
_codg_hacienda = BA.ObjectToString(_row[(int) (0)]);
 //BA.debugLineNum = 1312;BA.debugLine="ItemsLote.Add(Codg_Hacienda)";
...
//C
this.state = 13;
 //BA.debugLineNum = 1317;BA.debugLine="Log(\"Error: \" & j.ErrorMessage)";
parent.__c.LogImpl("258720295","Error: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
this.state = 14;
;
 //BA.debugLineNum = 1319;BA.debugLine="SearchTemplateLote.SetItems(ItemsLote)";
parent._searchtemplatelote._setitems /*Object*/ (_itemslote);
 //BA.debugLineNum = 1320;BA.debugLine="SwiftButtonLote.Enabled = True";
parent._swiftbuttonlote._setenabled /*boolean*/ (parent.__c.True);
 //BA.debugLineNum = 1321;BA.debugLine="Log(haciendaCBX)";
parent.__c.LogImpl("258720299",parent._haciendacbx,0);
 //BA.debugLineNum = 1323;BA.debugLine="j.Release";
_j._release /*String*/ ();
 if (true) break;
...
//C
this.state = 1;
 //BA.debugLineNum = 1416;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateInsum";
...
_result = (Integer) result[0];
;
 //BA.debugLineNum = 1417;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 1418;BA.debugLine="SwiftButtonInsumo.xLBL.Text = SearchTemplateInsu";
parent._swiftbuttoninsumo._xlbl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setText(BA.ObjectToCharSequence(parent._searchtemplateinsumo._selecteditem /*String*/ ));
 //BA.debugLineNum = 1419;BA.debugLine="Dim INSUMOCOMPLETO As String = SearchTemplateIns";
_insumocompleto = parent._searchtemplateinsumo._selecteditem /*String*/ ;
 //BA.debugLineNum = 1420;BA.debugLine="Dim partes() As String = Regex.Split(\":\", INSUMO";
_partes = parent.__c.Regex.Split(":",_insumocompleto);
 //BA.debugLineNum = 1421;BA.debugLine="NAMEINSUMO = partes(1)";
parent._nameinsumo = _partes[(int) (1)];
 //BA.debugLineNum = 1422;BA.debugLine="IDINSUMO = partes(0)";
...
this.state = -1;
;
 //BA.debugLineNum = 1424;BA.debugLine="Log(IDINSUMO)";
parent.__c.LogImpl("259047945",parent._idinsumo,0);
...
//C
this.state = 1;
 //BA.debugLineNum = 1341;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateLabor";
...
_result = (Integer) result[0];
;
 //BA.debugLineNum = 1343;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 1344;BA.debugLine="SwiftButtonLabor.xLBL.Text = SearchTemplateLabor";
parent._swiftbuttonlabor._xlbl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setText(BA.ObjectToCharSequence(parent._searchtemplatelabor._selecteditem /*String*/ ));
 //BA.debugLineNum = 1345;BA.debugLine="Dim Partes() As String = Regex.Split(\":\", Search";
_partes = parent.__c.Regex.Split(":",parent._searchtemplatelabor._selecteditem /*String*/ );
 //BA.debugLineNum = 1346;BA.debugLine="elementoLabor = Partes(0) ' Asignar solo la prim";
...
this.state = -1;
;
 //BA.debugLineNum = 1348;BA.debugLine="Log(elementoLabor)";
parent.__c.LogImpl("258851336",parent._elementolabor,0);
...
//C
this.state = 1;
 //BA.debugLineNum = 1329;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateLote,";
...
_result = (Integer) result[0];
;
 //BA.debugLineNum = 1331;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 1332;BA.debugLine="SwiftButtonLote.xLBL.Text = SearchTemplateLote.S";
parent._swiftbuttonlote._xlbl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setText(BA.ObjectToCharSequence(parent._searchtemplatelote._selecteditem /*String*/ ));
 //BA.debugLineNum = 1333;BA.debugLine="Dim Partes() As String = Regex.Split(\":\", Search";
_partes = parent.__c.Regex.Split(":",parent._searchtemplatelote._selecteditem /*String*/ );
 //BA.debugLineNum = 1334;BA.debugLine="loteCBX = Partes(0) ' Asignar solo la primera pa";
...
this.state = -1;
;
 //BA.debugLineNum = 1337;BA.debugLine="Log(loteCBX)";
parent.__c.LogImpl("258785801",parent._lotecbx,0);
...
//C
this.state = 1;
 //BA.debugLineNum = 1228;BA.debugLine="Dim ItemsHacienda As List";
_itemshacienda = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 1229;BA.debugLine="ItemsHacienda.Initialize";
_itemshacienda.Initialize();
 //BA.debugLineNum = 1230;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateNit,";
...
_result = (Integer) result[0];
;
 //BA.debugLineNum = 1231;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 1232;BA.debugLine="SwiftButtonNit.xLBL.Text = SearchTemplateNit.Sel";
parent._swiftbuttonnit._xlbl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setText(BA.ObjectToCharSequence(parent._searchtemplatenit._selecteditem /*String*/ ));
 //BA.debugLineNum = 1233;BA.debugLine="Dim NITCOMPLETO As String = SearchTemplateNit.Se";
_nitcompleto = parent._searchtemplatenit._selecteditem /*String*/ ;
 //BA.debugLineNum = 1234;BA.debugLine="Dim Partes() As String = Regex.Split(\":\", NITCOM";
_partes = parent.__c.Regex.Split(":",_nitcompleto);
 //BA.debugLineNum = 1235;BA.debugLine="nitEmpresaCBX = Partes(0)";
parent._nitempresacbx = _partes[(int) (0)];
 //BA.debugLineNum = 1236;BA.debugLine="ItemsHacienda.Clear";
_itemshacienda.Clear();
 //BA.debugLineNum = 1237;BA.debugLine="ItemsHacienda.Add(\"Seleccionar:\")";
_itemshacienda.Add((Object)("Seleccionar:"));
 //BA.debugLineNum = 1238;BA.debugLine="SwiftButtonHacienda.xLBL.Text = \"\"";
parent._swiftbuttonhacienda._xlbl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 1240;BA.debugLine="Dim Req As DBRequestManager";
_req = new b4a.example.ef.dbrequestmanager();
 //BA.debugLineNum = 1241;BA.debugLine="Req.Initialize(Me, rdcLink & \"?DBName=\" & Main.p";
_req._initialize /*String*/ (ba,parent,parent._rdclink+"?DBName="+parent._main._pdbname /*String*/ );
 //BA.debugLineNum = 1242;BA.debugLine="Dim cmd As DBCommand = CreateCommand(\"select_hac";
_cmd = parent._createcommand("select_haciendas",new Object[]{(Object)(parent._nitempresacbx)});
 //BA.debugLineNum = 1245;BA.debugLine="Wait For (Req.ExecuteQuery(cmd, 0, Null)) JobDon";
parent.__c.WaitFor("jobdone", ba, this, (Object)(_req._executequery /*b4a.example.ef.httpjob*/ (_cmd,(int) (0),parent.__c.Null)));
this.state = 16;
return;
case 16:
...
//C
this.state = 7;
 //BA.debugLineNum = 1250;BA.debugLine="Req.HandleJobAsync(j, \"req\")";
_req._handlejobasync /*void*/ (_j,"req");
 //BA.debugLineNum = 1251;BA.debugLine="Wait For (Req) req_Result(res As DBResult)";
parent.__c.WaitFor("req_result", ba, this, (Object)(_req));
this.state = 17;
return;
case 17:
...
_res = (b4a.example.ef.main._dbresult) result[0];
;
 //BA.debugLineNum = 1255;BA.debugLine="For Each row() As Object In res.Rows";
if (true) break;
...
//C
this.state = 19;
 //BA.debugLineNum = 1256;BA.debugLine="Dim Codg_Hacienda As String = row(0)";
_codg_hacienda = BA.ObjectToString(_row[(int) (0)]);
 //BA.debugLineNum = 1257;BA.debugLine="Dim NombreHacienda As String = row(1)";
_nombrehacienda = BA.ObjectToString(_row[(int) (1)]);
 //BA.debugLineNum = 1262;BA.debugLine="ItemsHacienda.Add(Codg_Hacienda&\":\"&NombreHaci";
...
//C
this.state = 13;
 //BA.debugLineNum = 1267;BA.debugLine="Log(\"Error: \" & j.ErrorMessage)";
parent.__c.LogImpl("258654760","Error: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
this.state = 14;
;
 //BA.debugLineNum = 1269;BA.debugLine="SearchTemplateHacienda.SetItems(ItemsHacienda)";
parent._searchtemplatehacienda._setitems /*Object*/ (_itemshacienda);
 //BA.debugLineNum = 1270;BA.debugLine="SwiftButtonHacienda.Enabled = True";
parent._swiftbuttonhacienda._setenabled /*boolean*/ (parent.__c.True);
 //BA.debugLineNum = 1271;BA.debugLine="Log(nitEmpresaCBX)";
parent.__c.LogImpl("258654764",parent._nitempresacbx,0);
 //BA.debugLineNum = 1273;BA.debugLine="j.Release";
_j._release /*String*/ ();
 if (true) break;
...
//C
this.state = 1;
 //BA.debugLineNum = 1428;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateRiego";
...
_result = (Integer) result[0];
;
 //BA.debugLineNum = 1430;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 1431;BA.debugLine="SwiftButtonRiego.xLBL.Text = SearchTemplateRiego";
parent._swiftbuttonriego._xlbl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setText(BA.ObjectToCharSequence(parent._searchtemplateriego._selecteditem /*String*/ ));
 //BA.debugLineNum = 1432;BA.debugLine="Dim Partes() As String = Regex.Split(\":\", Search";
_partes = parent.__c.Regex.Split(":",parent._searchtemplateriego._selecteditem /*String*/ );
 //BA.debugLineNum = 1433;BA.debugLine="tipoRiego = Partes(0) ' Asignar solo la primera";
...
this.state = -1;
;
 //BA.debugLineNum = 1435;BA.debugLine="Log(tipoRiego)";
parent.__c.LogImpl("259113480",parent._tiporiego,0);
...
//C
this.state = 1;
 //BA.debugLineNum = 1440;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateTipoL";
...
_result = (Integer) result[0];
;
 //BA.debugLineNum = 1442;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 1443;BA.debugLine="SwiftButtonTipoLabranza.xLBL.Text = SearchTempla";
parent._swiftbuttontipolabranza._xlbl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setText(BA.ObjectToCharSequence(parent._searchtemplatetipolabranza._selecteditem /*String*/ ));
 //BA.debugLineNum = 1444;BA.debugLine="Dim Partes() As String = Regex.Split(\":\", Search";
_partes = parent.__c.Regex.Split(":",parent._searchtemplatetipolabranza._selecteditem /*String*/ );
 //BA.debugLineNum = 1447;BA.debugLine="tipoLabranzaSiembra = Partes(0)";
parent._tipolabranzasiembra = _partes[(int) (0)];
 //BA.debugLineNum = 1448;BA.debugLine="If tipoLabranzaSiembra.Length >= 2 Then";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 1449;BA.debugLine="tipoLabranzaSiembra = tipoLabranzaSiembra.SubSt";
...
this.state = -1;
;
 //BA.debugLineNum = 1453;BA.debugLine="Log(tipoLabranzaSiembra)";
parent.__c.LogImpl("259179022",parent._tipolabranzasiembra,0);
...
//C
this.state = 1;
 //BA.debugLineNum = 1373;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateTypeF";
...
_result = (Integer) result[0];
;
 //BA.debugLineNum = 1374;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 1375;BA.debugLine="SwiftButtonTypeForm.xLBL.Text = SearchTemplateTy";
parent._swiftbuttontypeform._xlbl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setText(BA.ObjectToCharSequence(parent._searchtemplatetypeform._selecteditem /*String*/ ));
 //BA.debugLineNum = 1376;BA.debugLine="Dim TYPEFORMCOMPLETO As String = SearchTemplateT";
_typeformcompleto = parent._searchtemplatetypeform._selecteditem /*String*/ ;
 //BA.debugLineNum = 1377;BA.debugLine="Dim Partes() As String = Regex.Split(\":\", TYPEFO";
_partes = parent.__c.Regex.Split(":",_typeformcompleto);
 //BA.debugLineNum = 1378;BA.debugLine="tipoLabor = Partes(0)";
parent._tipolabor = _partes[(int) (0)];
 //BA.debugLineNum = 1379;BA.debugLine="Log(tipoLabor)";
parent.__c.LogImpl("258982407",parent._tipolabor,0);
 //BA.debugLineNum = 1380;BA.debugLine="Dim tipoForm As String = Partes(0)";
_tipoform = _partes[(int) (0)];
 //BA.debugLineNum = 1382;BA.debugLine="Select Case tipoForm";
if (true) break;
...
//C
this.state = 13;
 //BA.debugLineNum = 1384;BA.debugLine="RemoveForm2IfExists";
parent._removeform2ifexists();
 //BA.debugLineNum = 1385;BA.debugLine="RemoveForm3IfExists";
parent._removeform3ifexists();
 //BA.debugLineNum = 1386;BA.debugLine="CustomListView1Geral.Add(CreateItemInsumo,\"form";
parent._customlistview1geral._add((anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(parent._createiteminsumo().getObject())),(Object)("form0"));
 //BA.debugLineNum = 1387;BA.debugLine="LlenarComboBoxInsumo";
parent._llenarcomboboxinsumo();
 //BA.debugLineNum = 1388;BA.debugLine="Dim INSUMOCOLUM As B4XTableColumn = B4XTable1.A";
...
//C
this.state = 13;
 //BA.debugLineNum = 1398;BA.debugLine="RemoveForm0IfExists";
parent._removeform0ifexists();
 //BA.debugLineNum = 1399;BA.debugLine="RemoveForm2IfExists ' Eliminar \"form2\" si exist";
parent._removeform2ifexists();
 //BA.debugLineNum = 1400;BA.debugLine="CustomListView1Geral.Add(CreateItemSiembra,\"for";
parent._customlistview1geral._add((anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(parent._createitemsiembra().getObject())),(Object)("form3"));
 //BA.debugLineNum = 1401;BA.debugLine="LlenarComboBoxSiembra";
...
//C
this.state = 13;
 //BA.debugLineNum = 1403;BA.debugLine="RemoveForm0IfExists";
parent._removeform0ifexists();
 //BA.debugLineNum = 1404;BA.debugLine="RemoveForm3IfExists";
parent._removeform3ifexists();
 //BA.debugLineNum = 1405;BA.debugLine="CustomListView1Geral.Add(CreateItemRiego, \"form";
parent._customlistview1geral._add((anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(parent._createitemriego().getObject())),(Object)("form2"));
 //BA.debugLineNum = 1406;BA.debugLine="LlenarComboBoxRiego";
...
//C
this.state = 13;
 //BA.debugLineNum = 1409;BA.debugLine="Log(\"Valor no reconocido: \" & tipoForm)";
parent.__c.LogImpl("258982437","Valor no reconocido: "+_tipoform,0);
 if (true) break;
...
//C
this.state = 1;
 //BA.debugLineNum = 1458;BA.debugLine="Wait For (Dialog.ShowTemplate(SearchTemplateVarie";
...
_result = (Integer) result[0];
;
 //BA.debugLineNum = 1460;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 1461;BA.debugLine="SwiftButtonVariedad.xLBL.Text = SearchTemplateVa";
parent._swiftbuttonvariedad._xlbl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setText(BA.ObjectToCharSequence(parent._searchtemplatevariedad._selecteditem /*String*/ ));
 //BA.debugLineNum = 1462;BA.debugLine="Dim Partes() As String = Regex.Split(\":\", Search";
_partes = parent.__c.Regex.Split(":",parent._searchtemplatevariedad._selecteditem /*String*/ );
 //BA.debugLineNum = 1463;BA.debugLine="codigoSiembra = Partes(0)";
...
this.state = -1;
;
 //BA.debugLineNum = 1465;BA.debugLine="Log(codigoSiembra)";
parent.__c.LogImpl("259244552",parent._codigosiembra,0);
