...
__c.LogImpl("666060303","Fecha seleccionada: "+_fechainicio,0);
...
__c.LogImpl("666256905","Fecha de fin"+_fechafin,0);
...
__c.LogImpl("666256910","Fecha seleccionada: "+_formatteddate,0);
...
parent.__c.LogImpl("665929275","Error en la consulta de NITs: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("665929297","Error en la consulta de destinos: "+_j2._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("665929336","Error en la consulta de conceptos: "+_j3._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("665929368","Error en la consulta de conceptos: "+_j4._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("668616204","ID: "+_id,0);
 if (true) break;
...
parent.__c.LogImpl("668616206","No se encontró el carácter # en la cadena.",0);
 if (true) break;
...
parent.__c.LogImpl("668616237","ID: "+_id,0);
 //BA.debugLineNum = 845;BA.debugLine="Log(\"FechaInicio: \" & FechaInicio)";
parent.__c.LogImpl("668616238","FechaInicio: "+parent._fechainicio,0);
 //BA.debugLineNum = 846;BA.debugLine="Log(\"LaborCBX: \" & LaborCBX)";
parent.__c.LogImpl("668616239","LaborCBX: "+parent._laborcbx,0);
 //BA.debugLineNum = 847;BA.debugLine="Log(\"Valor fijo: 0\")";
parent.__c.LogImpl("668616240","Valor fijo: 0",0);
 //BA.debugLineNum = 848;BA.debugLine="Log(\"ConceptoCBX: \" & ConceptoCBX)";
parent.__c.LogImpl("668616241","ConceptoCBX: "+parent._conceptocbx,0);
 //BA.debugLineNum = 849;BA.debugLine="Log(\"nitEmpresaCBX: \" & nitEmpresaCBX)";
parent.__c.LogImpl("668616242","nitEmpresaCBX: "+parent._nitempresacbx,0);
 //BA.debugLineNum = 850;BA.debugLine="Log(\"haciendaCBX: \" & haciendaCBX)";
parent.__c.LogImpl("668616243","haciendaCBX: "+parent._haciendacbx,0);
 //BA.debugLineNum = 851;BA.debugLine="Log(\"LoteCBX: \" & LoteCBX)";
parent.__c.LogImpl("668616244","LoteCBX: "+parent._lotecbx,0);
 //BA.debugLineNum = 852;BA.debugLine="Log(\"HorasText: \" & HorasText)";
parent.__c.LogImpl("668616245","HorasText: "+parent._horastext,0);
 //BA.debugLineNum = 853;BA.debugLine="Log(\"CantidadText: \" & CantidadText)";
parent.__c.LogImpl("668616246","CantidadText: "+parent._cantidadtext,0);
 //BA.debugLineNum = 854;BA.debugLine="Log(\"ObsvText: \" & ObsvText)";
parent.__c.LogImpl("668616247","ObsvText: "+parent._obsvtext,0);
 //BA.debugLineNum = 855;BA.debugLine="Log(\"TurnoCBX: \" & TurnoCBX)";
parent.__c.LogImpl("668616248","TurnoCBX: "+parent._turnocbx,0);
 //BA.debugLineNum = 856;BA.debugLine="Log(\"PorcentageText: \" & PorcentageText)";
parent.__c.LogImpl("668616249","PorcentageText: "+parent._porcentagetext,0);
 //BA.debugLineNum = 857;BA.debugLine="Log(\"Error en el job: \" & j.ErrorMessage)";
parent.__c.LogImpl("668616250","Error en el job: "+_j._errormessage /*String*/ ,0);
...
parent.__c.LogImpl("668616265","ID: "+_id,0);
 //BA.debugLineNum = 873;BA.debugLine="Log(\"FechaInicio: \" & FechaInicio)";
parent.__c.LogImpl("668616266","FechaInicio: "+parent._fechainicio,0);
 //BA.debugLineNum = 874;BA.debugLine="Log(\"LaborCBX: \" & LaborCBX)";
parent.__c.LogImpl("668616267","LaborCBX: "+parent._laborcbx,0);
 //BA.debugLineNum = 875;BA.debugLine="Log(\"Valor fijo: 0\")";
parent.__c.LogImpl("668616268","Valor fijo: 0",0);
 //BA.debugLineNum = 876;BA.debugLine="Log(\"ConceptoCBX: \" & ConceptoCBX)";
parent.__c.LogImpl("668616269","ConceptoCBX: "+parent._conceptocbx,0);
 //BA.debugLineNum = 877;BA.debugLine="Log(\"nitEmpresaCBX: \" & nitEmpresaCBX)";
parent.__c.LogImpl("668616270","nitEmpresaCBX: "+parent._nitempresacbx,0);
 //BA.debugLineNum = 878;BA.debugLine="Log(\"haciendaCBX: \" & haciendaCBX)";
parent.__c.LogImpl("668616271","haciendaCBX: "+parent._haciendacbx,0);
 //BA.debugLineNum = 879;BA.debugLine="Log(\"LoteCBX: \" & LoteCBX)";
parent.__c.LogImpl("668616272","LoteCBX: "+parent._lotecbx,0);
 //BA.debugLineNum = 880;BA.debugLine="Log(\"HorasText: \" & HorasText)";
parent.__c.LogImpl("668616273","HorasText: "+parent._horastext,0);
 //BA.debugLineNum = 881;BA.debugLine="Log(\"CantidadText: \" & CantidadText)";
parent.__c.LogImpl("668616274","CantidadText: "+parent._cantidadtext,0);
 //BA.debugLineNum = 882;BA.debugLine="Log(\"ObsvText: \" & ObsvText)";
parent.__c.LogImpl("668616275","ObsvText: "+parent._obsvtext,0);
 //BA.debugLineNum = 883;BA.debugLine="Log(\"TurnoCBX: \" & TurnoCBX)";
parent.__c.LogImpl("668616276","TurnoCBX: "+parent._turnocbx,0);
 //BA.debugLineNum = 884;BA.debugLine="Log(\"PorcentageText: \" & PorcentageText)";
parent.__c.LogImpl("668616277","PorcentageText: "+parent._porcentagetext,0);
 //BA.debugLineNum = 885;BA.debugLine="Log(\"Error en el job: \" & j.ErrorMessage)";
parent.__c.LogImpl("668616278","Error en el job: "+_j._errormessage /*String*/ ,0);
...
parent.__c.LogImpl("668616285","Error al ejecutar la consulta: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
_porcentagetext = _new;
 //BA.debugLineNum = 784;BA.debugLine="Log(PorcentageText)";
__c.LogImpl("668419586",_porcentagetext,0);
...
__c.LogImpl("668354052",_horastext,0);
...
__c.LogImpl("668485123",_cantidadtext,0);
...
__c.LogImpl("668550659",_obsvtext,0);
...
parent.__c.LogImpl("667239946","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("667174428","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("667567644","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("667502104","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
__c.LogImpl("668288523","Valor seleccionado: "+_conceptocbx,0);
 //BA.debugLineNum = 763;BA.debugLine="Log(\"Dato dstjo_Cncpto: \" & dstjo_Cncpto)";
__c.LogImpl("668288524","Dato dstjo_Cncpto: "+_dstjo_cncpto,0);
...
parent.__c.LogImpl("668091910",parent._haciendacbx,0);
...
parent.__c.LogImpl("668091938","Error: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
__c.LogImpl("668222984",_laborcbx,0);
...
__c.LogImpl("668157449",_lotecbx,0);
...
parent.__c.LogImpl("668026378","Valor seleccionado: "+parent._nitempresacbx,0);
 //BA.debugLineNum = 649;BA.debugLine="Log(\"Posicion: \"&Position&\" VALUE: \"&Value)";
parent.__c.LogImpl("668026380","Posicion: "+BA.NumberToString(_position)+" VALUE: "+BA.ObjectToString(_value),0);
...
parent.__c.LogImpl("668026408","Error: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("668026411",parent._nitempresacbx,0);
...
__c.LogImpl("667436550",BA.NumberToString(_position)+" - "+BA.ObjectToString(_value),0);
...
parent.__c.LogImpl("668878376","Error: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
_lotecompleto = parent._searchtemplatelote._selecteditem /*String*/ ;
...
parent.__c.LogImpl("668812844","Error: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("668812848",parent._nitempresacbx,0);
