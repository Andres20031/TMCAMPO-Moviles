...
RDebugUtils.currentLine=45219840;
 //BA.debugLineNum = 45219840;BA.debugLine="Sub Class_Globals";
RDebugUtils.currentLine=45219841;
 //BA.debugLineNum = 45219841;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=45285376;
 //BA.debugLineNum = 45285376;BA.debugLine="Public Sub Initialize";
RDebugUtils.currentLine=45285377;
 //BA.debugLineNum = 45285377;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=45481984;
 //BA.debugLineNum = 45481984;BA.debugLine="Private Sub Partition(Data As List, StartIndex As";
RDebugUtils.currentLine=45481985;
 //BA.debugLineNum = 45481985;BA.debugLine="Dim PivotValue As Object = Data.Get(StartIndex +";
_pivotvalue = _data.Get((int) (_startindex+_pivotindex));
RDebugUtils.currentLine=45481986;
 //BA.debugLineNum = 45481986;BA.debugLine="Swap(Data, StartIndex, PivotIndex, Length - 1)";
__ref._swap /*String*/ (null,_data,_startindex,_pivotindex,(int) (_length-1));
RDebugUtils.currentLine=45481987;
 //BA.debugLineNum = 45481987;BA.debugLine="Dim L As Int = 0";
_l = (int) (0);
RDebugUtils.currentLine=45481988;
 //BA.debugLineNum = 45481988;BA.debugLine="For i = 0 To Length - 2";
{
final int step4 = 1;
...
RDebugUtils.currentLine=45481989;
 //BA.debugLineNum = 45481989;BA.debugLine="If CallSub3(Comparator, \"Compare\", Data.Get(Star";
...
RDebugUtils.currentLine=45481990;
 //BA.debugLineNum = 45481990;BA.debugLine="L = L + 1";
_l = (int) (_l+1);
RDebugUtils.currentLine=45481991;
 //BA.debugLineNum = 45481991;BA.debugLine="Swap(Data, StartIndex, L - 1, i)";
__ref._swap /*String*/ (null,_data,_startindex,(int) (_l-1),_i);
 };
 }
};
RDebugUtils.currentLine=45481994;
 //BA.debugLineNum = 45481994;BA.debugLine="Swap(Data, StartIndex, Length - 1, L)";
__ref._swap /*String*/ (null,_data,_startindex,(int) (_length-1),_l);
RDebugUtils.currentLine=45481995;
 //BA.debugLineNum = 45481995;BA.debugLine="Return L";
if (true) return _l;
...
RDebugUtils.currentLine=45547520;
 //BA.debugLineNum = 45547520;BA.debugLine="Private Sub Swap (Data As List, StartIndex As Int,";
RDebugUtils.currentLine=45547521;
 //BA.debugLineNum = 45547521;BA.debugLine="Dim o As Object = Data.Get(StartIndex + i1)";
_o = _data.Get((int) (_startindex+_i1));
RDebugUtils.currentLine=45547522;
 //BA.debugLineNum = 45547522;BA.debugLine="Data.Set(StartIndex + i1, Data.Get(StartIndex + i";
_data.Set((int) (_startindex+_i1),_data.Get((int) (_startindex+_i2)));
RDebugUtils.currentLine=45547523;
 //BA.debugLineNum = 45547523;BA.debugLine="Data.Set(StartIndex + i2, o)";
...
RDebugUtils.currentLine=45416448;
 //BA.debugLineNum = 45416448;BA.debugLine="Private Sub QuickSort (Data As List, StartIndex As";
RDebugUtils.currentLine=45416449;
 //BA.debugLineNum = 45416449;BA.debugLine="If Length > 1 Then";
if (_length>1) { 
RDebugUtils.currentLine=45416450;
 //BA.debugLineNum = 45416450;BA.debugLine="Dim PivotIndex As Int = Rnd(0, Length)";
_pivotindex = __c.Rnd((int) (0),_length);
RDebugUtils.currentLine=45416451;
 //BA.debugLineNum = 45416451;BA.debugLine="Dim r As Int = Partition(Data, StartIndex, Lengt";
_r = __ref._partition /*int*/ (null,_data,_startindex,_length,_pivotindex,_comparator);
RDebugUtils.currentLine=45416452;
 //BA.debugLineNum = 45416452;BA.debugLine="QuickSort(Data, StartIndex, r, Comparator)";
__ref._quicksort /*String*/ (null,_data,_startindex,_r,_comparator);
RDebugUtils.currentLine=45416453;
 //BA.debugLineNum = 45416453;BA.debugLine="QuickSort(Data, StartIndex + r + 1, Length - r -";
...
RDebugUtils.currentLine=45350912;
 //BA.debugLineNum = 45350912;BA.debugLine="Public Sub Sort (Data As List, Comparator As Objec";
RDebugUtils.currentLine=45350914;
 //BA.debugLineNum = 45350914;BA.debugLine="QuickSort(Data, 0, Data.Size, Comparator)";
