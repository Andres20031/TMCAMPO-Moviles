...
RDebugUtils.currentLine=45678593;
 //BA.debugLineNum = 45678593;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=45744128;
 //BA.debugLineNum = 45744128;BA.debugLine="Public Sub Initialize";
...
RDebugUtils.currentLine=45940736;
 //BA.debugLineNum = 45940736;BA.debugLine="Private Sub Partition(Data As List, StartIndex As";
RDebugUtils.currentLine=45940737;
 //BA.debugLineNum = 45940737;BA.debugLine="Dim PivotValue As Object = Data.Get(StartIndex +";
_pivotvalue = _data.Get((int) (_startindex+_pivotindex));
RDebugUtils.currentLine=45940738;
 //BA.debugLineNum = 45940738;BA.debugLine="Swap(Data, StartIndex, PivotIndex, Length - 1)";
__ref._swap /*String*/ (null,_data,_startindex,_pivotindex,(int) (_length-1));
RDebugUtils.currentLine=45940739;
 //BA.debugLineNum = 45940739;BA.debugLine="Dim L As Int = 0";
_l = (int) (0);
RDebugUtils.currentLine=45940740;
 //BA.debugLineNum = 45940740;BA.debugLine="For i = 0 To Length - 2";
{
final int step4 = 1;
...
RDebugUtils.currentLine=45940741;
 //BA.debugLineNum = 45940741;BA.debugLine="If CallSub3(Comparator, \"Compare\", Data.Get(Star";
...
RDebugUtils.currentLine=45940742;
 //BA.debugLineNum = 45940742;BA.debugLine="L = L + 1";
_l = (int) (_l+1);
RDebugUtils.currentLine=45940743;
 //BA.debugLineNum = 45940743;BA.debugLine="Swap(Data, StartIndex, L - 1, i)";
__ref._swap /*String*/ (null,_data,_startindex,(int) (_l-1),_i);
 };
 }
};
RDebugUtils.currentLine=45940746;
 //BA.debugLineNum = 45940746;BA.debugLine="Swap(Data, StartIndex, Length - 1, L)";
__ref._swap /*String*/ (null,_data,_startindex,(int) (_length-1),_l);
RDebugUtils.currentLine=45940747;
 //BA.debugLineNum = 45940747;BA.debugLine="Return L";
if (true) return _l;
RDebugUtils.currentLine=45940748;
 //BA.debugLineNum = 45940748;BA.debugLine="End Sub";
return 0;
}
...
RDebugUtils.currentLine=46006272;
 //BA.debugLineNum = 46006272;BA.debugLine="Private Sub Swap (Data As List, StartIndex As Int,";
RDebugUtils.currentLine=46006273;
 //BA.debugLineNum = 46006273;BA.debugLine="Dim o As Object = Data.Get(StartIndex + i1)";
_o = _data.Get((int) (_startindex+_i1));
RDebugUtils.currentLine=46006274;
 //BA.debugLineNum = 46006274;BA.debugLine="Data.Set(StartIndex + i1, Data.Get(StartIndex + i";
_data.Set((int) (_startindex+_i1),_data.Get((int) (_startindex+_i2)));
RDebugUtils.currentLine=46006275;
 //BA.debugLineNum = 46006275;BA.debugLine="Data.Set(StartIndex + i2, o)";
_data.Set((int) (_startindex+_i2),_o);
RDebugUtils.currentLine=46006276;
 //BA.debugLineNum = 46006276;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=45875200;
 //BA.debugLineNum = 45875200;BA.debugLine="Private Sub QuickSort (Data As List, StartIndex As";
RDebugUtils.currentLine=45875201;
 //BA.debugLineNum = 45875201;BA.debugLine="If Length > 1 Then";
if (_length>1) { 
RDebugUtils.currentLine=45875202;
 //BA.debugLineNum = 45875202;BA.debugLine="Dim PivotIndex As Int = Rnd(0, Length)";
_pivotindex = __c.Rnd((int) (0),_length);
RDebugUtils.currentLine=45875203;
 //BA.debugLineNum = 45875203;BA.debugLine="Dim r As Int = Partition(Data, StartIndex, Lengt";
_r = __ref._partition /*int*/ (null,_data,_startindex,_length,_pivotindex,_comparator);
RDebugUtils.currentLine=45875204;
 //BA.debugLineNum = 45875204;BA.debugLine="QuickSort(Data, StartIndex, r, Comparator)";
__ref._quicksort /*String*/ (null,_data,_startindex,_r,_comparator);
RDebugUtils.currentLine=45875205;
 //BA.debugLineNum = 45875205;BA.debugLine="QuickSort(Data, StartIndex + r + 1, Length - r -";
...
RDebugUtils.currentLine=45809664;
 //BA.debugLineNum = 45809664;BA.debugLine="Public Sub Sort (Data As List, Comparator As Objec";
RDebugUtils.currentLine=45809666;
 //BA.debugLineNum = 45809666;BA.debugLine="QuickSort(Data, 0, Data.Size, Comparator)";
