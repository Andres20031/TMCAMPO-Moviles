...
parent.__c.LogImpl("263635485","NIT: "+parent._nitupdate,0);
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("263635488","NIT: "+parent._nit,0);
 if (true) break;
...
parent.__c.LogImpl("263635502",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
if (true) break;
...
__c.LogImpl("266060296",BA.ObjectToString(__c.LastException(ba)),0);
 };
...
__c.LogImpl("266191369",BA.ObjectToString(__c.LastException(ba)),0);
 };
...
parent.__c.LogImpl("263897610",_cursor.GetString("name"),0);
...
parent.__c.LogImpl("263897627",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("265667100","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("265273882","cadena: "+_cadena,0);
 //BA.debugLineNum = 705;BA.debugLine="Log(\"hacienda: \"&haciendaUpdate)";
parent.__c.LogImpl("265273883","hacienda: "+parent._haciendaupdate,0);
...
parent.__c.LogImpl("265273898","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("265601565","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("265404951","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("265536027","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("265208350","NIT: "+parent._nitupdate,0);
...
parent.__c.LogImpl("265208362","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("264552968","=====ITEM #"+BA.NumberToString(_i)+"=====",0);
 //BA.debugLineNum = 430;BA.debugLine="Log(Cursor.GetString(\"idmaquina\"))";
parent.__c.LogImpl("264552969",_cursor.GetString("idmaquina"),0);
 //BA.debugLineNum = 431;BA.debugLine="Log(Cursor.GetString(\"name\")&\"--\"&Cursor.GetStri";
parent.__c.LogImpl("264552970",_cursor.GetString("name")+"--"+_cursor.GetString("qnt"),0);
...
parent.__c.LogImpl("264552974",_sb.ToString(),0);
...
parent.__c.LogImpl("264552980","=====Maquinas #"+BA.NumberToString(_i)+"=====",0);
 //BA.debugLineNum = 442;BA.debugLine="Log(Cursor.GetString(\"id\"))'&\"--\"&Cursor.GetStr";
parent.__c.LogImpl("264552981",_cursor.GetString("id"),0);
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("264552988",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("264749575","Inserted successfully!",0);
 if (true) break;
...
__c.LogImpl("266125826",BA.ObjectToString(_label1removeinsumo.getTag()),0);
...
__c.LogImpl("263701005",_cursor.GetString("id"),0);
 //BA.debugLineNum = 157;BA.debugLine="Log(Cursor.GetString(\"name\"))";
__c.LogImpl("263701006",_cursor.GetString("name"),0);
 //BA.debugLineNum = 158;BA.debugLine="Log(Cursor.GetString(\"qnt\"))";
__c.LogImpl("263701007",_cursor.GetString("qnt"),0);
...
__c.LogImpl("263766534","REMOVE: "+BA.NumberToString(_iw),__c.Colors.Red);
...
__c.LogImpl("263766538",BA.ObjectToString(__c.LastException(ba)),0);
 };
 };
 }
};
...
__c.LogImpl("265339395",BA.ObjectToString(_value),0);
...
__c.LogImpl("265339404",_hacienda,0);
...
parent.__c.LogImpl("266256909",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
if (true) break;
...
__c.LogImpl("266322434",BA.ObjectToString(_spinner1nameinsumo.getTag()),0);
 //BA.debugLineNum = 1004;BA.debugLine="Log(Spinner1NameInsumo.SelectedItem)";
__c.LogImpl("266322435",_spinner1nameinsumo.getSelectedItem(),0);
...
__c.LogImpl("265732609",BA.ObjectToString(_value),0);
