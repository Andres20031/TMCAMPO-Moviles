...
parent.__c.LogImpl("88912925","NIT: "+parent._nitupdate,0);
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("88912928","NIT: "+parent._nit,0);
 if (true) break;
...
parent.__c.LogImpl("88912942",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
if (true) break;
...
__c.LogImpl("811337736",BA.ObjectToString(__c.LastException(ba)),0);
 };
...
__c.LogImpl("811468809",BA.ObjectToString(__c.LastException(ba)),0);
 };
...
parent.__c.LogImpl("89175050",_cursor.GetString("name"),0);
...
parent.__c.LogImpl("89175067",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("810944540","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("810551322","cadena: "+_cadena,0);
 //BA.debugLineNum = 705;BA.debugLine="Log(\"hacienda: \"&haciendaUpdate)";
parent.__c.LogImpl("810551323","hacienda: "+parent._haciendaupdate,0);
...
parent.__c.LogImpl("810551338","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("810879005","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("810682391","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("810813467","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("810485790","NIT: "+parent._nitupdate,0);
...
parent.__c.LogImpl("810485802","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("89830408","=====ITEM #"+BA.NumberToString(_i)+"=====",0);
 //BA.debugLineNum = 430;BA.debugLine="Log(Cursor.GetString(\"idmaquina\"))";
parent.__c.LogImpl("89830409",_cursor.GetString("idmaquina"),0);
 //BA.debugLineNum = 431;BA.debugLine="Log(Cursor.GetString(\"name\")&\"--\"&Cursor.GetStri";
parent.__c.LogImpl("89830410",_cursor.GetString("name")+"--"+_cursor.GetString("qnt"),0);
...
parent.__c.LogImpl("89830414",_sb.ToString(),0);
...
parent.__c.LogImpl("89830420","=====Maquinas #"+BA.NumberToString(_i)+"=====",0);
 //BA.debugLineNum = 442;BA.debugLine="Log(Cursor.GetString(\"id\"))'&\"--\"&Cursor.GetStr";
parent.__c.LogImpl("89830421",_cursor.GetString("id"),0);
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("89830428",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("810027015","Inserted successfully!",0);
 if (true) break;
...
__c.LogImpl("811403266",BA.ObjectToString(_label1removeinsumo.getTag()),0);
...
__c.LogImpl("88978445",_cursor.GetString("id"),0);
 //BA.debugLineNum = 157;BA.debugLine="Log(Cursor.GetString(\"name\"))";
__c.LogImpl("88978446",_cursor.GetString("name"),0);
 //BA.debugLineNum = 158;BA.debugLine="Log(Cursor.GetString(\"qnt\"))";
__c.LogImpl("88978447",_cursor.GetString("qnt"),0);
...
__c.LogImpl("89043974","REMOVE: "+BA.NumberToString(_iw),__c.Colors.Red);
...
__c.LogImpl("89043978",BA.ObjectToString(__c.LastException(ba)),0);
 };
 };
 }
};
...
__c.LogImpl("810616835",BA.ObjectToString(_value),0);
...
__c.LogImpl("810616844",_hacienda,0);
...
parent.__c.LogImpl("811534349",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
if (true) break;
...
__c.LogImpl("811599874",BA.ObjectToString(_spinner1nameinsumo.getTag()),0);
 //BA.debugLineNum = 1004;BA.debugLine="Log(Spinner1NameInsumo.SelectedItem)";
__c.LogImpl("811599875",_spinner1nameinsumo.getSelectedItem(),0);
...
__c.LogImpl("811010049",BA.ObjectToString(_value),0);
