...
parent.__c.LogImpl("78912925","NIT: "+parent._nitupdate,0);
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("78912928","NIT: "+parent._nit,0);
 if (true) break;
...
parent.__c.LogImpl("78912942",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
if (true) break;
...
__c.LogImpl("711337736",BA.ObjectToString(__c.LastException(ba)),0);
 };
...
__c.LogImpl("711468809",BA.ObjectToString(__c.LastException(ba)),0);
 };
...
parent.__c.LogImpl("79175050",_cursor.GetString("name"),0);
...
parent.__c.LogImpl("79175067",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("710944540","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("710551322","cadena: "+_cadena,0);
 //BA.debugLineNum = 705;BA.debugLine="Log(\"hacienda: \"&haciendaUpdate)";
parent.__c.LogImpl("710551323","hacienda: "+parent._haciendaupdate,0);
...
parent.__c.LogImpl("710551338","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("710879005","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("710682391","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("710813467","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("710485790","NIT: "+parent._nitupdate,0);
...
parent.__c.LogImpl("710485802","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("79830408","=====ITEM #"+BA.NumberToString(_i)+"=====",0);
 //BA.debugLineNum = 430;BA.debugLine="Log(Cursor.GetString(\"idmaquina\"))";
parent.__c.LogImpl("79830409",_cursor.GetString("idmaquina"),0);
 //BA.debugLineNum = 431;BA.debugLine="Log(Cursor.GetString(\"name\")&\"--\"&Cursor.GetStri";
parent.__c.LogImpl("79830410",_cursor.GetString("name")+"--"+_cursor.GetString("qnt"),0);
...
parent.__c.LogImpl("79830414",_sb.ToString(),0);
...
parent.__c.LogImpl("79830420","=====Maquinas #"+BA.NumberToString(_i)+"=====",0);
 //BA.debugLineNum = 442;BA.debugLine="Log(Cursor.GetString(\"id\"))'&\"--\"&Cursor.GetStr";
parent.__c.LogImpl("79830421",_cursor.GetString("id"),0);
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("79830428",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("710027015","Inserted successfully!",0);
 if (true) break;
...
__c.LogImpl("711403266",BA.ObjectToString(_label1removeinsumo.getTag()),0);
...
__c.LogImpl("78978445",_cursor.GetString("id"),0);
 //BA.debugLineNum = 157;BA.debugLine="Log(Cursor.GetString(\"name\"))";
__c.LogImpl("78978446",_cursor.GetString("name"),0);
 //BA.debugLineNum = 158;BA.debugLine="Log(Cursor.GetString(\"qnt\"))";
__c.LogImpl("78978447",_cursor.GetString("qnt"),0);
...
__c.LogImpl("79043974","REMOVE: "+BA.NumberToString(_iw),__c.Colors.Red);
...
__c.LogImpl("79043978",BA.ObjectToString(__c.LastException(ba)),0);
 };
 };
 }
};
...
__c.LogImpl("710616835",BA.ObjectToString(_value),0);
...
__c.LogImpl("710616844",_hacienda,0);
...
parent.__c.LogImpl("711534349",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
if (true) break;
...
__c.LogImpl("711599874",BA.ObjectToString(_spinner1nameinsumo.getTag()),0);
 //BA.debugLineNum = 1004;BA.debugLine="Log(Spinner1NameInsumo.SelectedItem)";
__c.LogImpl("711599875",_spinner1nameinsumo.getSelectedItem(),0);
...
__c.LogImpl("711010049",BA.ObjectToString(_value),0);
