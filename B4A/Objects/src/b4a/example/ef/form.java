...
parent.__c.LogImpl("22293789","NIT: "+parent._nitupdate,0);
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("22293792","NIT: "+parent._nit,0);
 if (true) break;
...
parent.__c.LogImpl("22293806",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
if (true) break;
...
__c.LogImpl("24718600",BA.ObjectToString(__c.LastException(ba)),0);
 };
...
__c.LogImpl("24849673",BA.ObjectToString(__c.LastException(ba)),0);
 };
...
parent.__c.LogImpl("22555914",_cursor.GetString("name"),0);
...
parent.__c.LogImpl("22555931",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("24325404","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("23932186","cadena: "+_cadena,0);
 //BA.debugLineNum = 705;BA.debugLine="Log(\"hacienda: \"&haciendaUpdate)";
parent.__c.LogImpl("23932187","hacienda: "+parent._haciendaupdate,0);
...
parent.__c.LogImpl("23932202","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("24259869","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("24063255","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("24194331","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("23866654","NIT: "+parent._nitupdate,0);
...
parent.__c.LogImpl("23866666","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("23211272","=====ITEM #"+BA.NumberToString(_i)+"=====",0);
 //BA.debugLineNum = 430;BA.debugLine="Log(Cursor.GetString(\"idmaquina\"))";
parent.__c.LogImpl("23211273",_cursor.GetString("idmaquina"),0);
 //BA.debugLineNum = 431;BA.debugLine="Log(Cursor.GetString(\"name\")&\"--\"&Cursor.GetStri";
parent.__c.LogImpl("23211274",_cursor.GetString("name")+"--"+_cursor.GetString("qnt"),0);
...
parent.__c.LogImpl("23211278",_sb.ToString(),0);
...
parent.__c.LogImpl("23211284","=====Maquinas #"+BA.NumberToString(_i)+"=====",0);
 //BA.debugLineNum = 442;BA.debugLine="Log(Cursor.GetString(\"id\"))'&\"--\"&Cursor.GetStr";
parent.__c.LogImpl("23211285",_cursor.GetString("id"),0);
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("23211292",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("23407879","Inserted successfully!",0);
 if (true) break;
...
__c.LogImpl("24784130",BA.ObjectToString(_label1removeinsumo.getTag()),0);
...
__c.LogImpl("22359309",_cursor.GetString("id"),0);
 //BA.debugLineNum = 157;BA.debugLine="Log(Cursor.GetString(\"name\"))";
__c.LogImpl("22359310",_cursor.GetString("name"),0);
 //BA.debugLineNum = 158;BA.debugLine="Log(Cursor.GetString(\"qnt\"))";
__c.LogImpl("22359311",_cursor.GetString("qnt"),0);
...
__c.LogImpl("22424838","REMOVE: "+BA.NumberToString(_iw),__c.Colors.Red);
...
__c.LogImpl("22424842",BA.ObjectToString(__c.LastException(ba)),0);
 };
 };
 }
};
...
__c.LogImpl("23997699",BA.ObjectToString(_value),0);
...
__c.LogImpl("23997708",_hacienda,0);
...
parent.__c.LogImpl("24915213",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
if (true) break;
...
__c.LogImpl("24980738",BA.ObjectToString(_spinner1nameinsumo.getTag()),0);
 //BA.debugLineNum = 1004;BA.debugLine="Log(Spinner1NameInsumo.SelectedItem)";
__c.LogImpl("24980739",_spinner1nameinsumo.getSelectedItem(),0);
...
__c.LogImpl("24390913",BA.ObjectToString(_value),0);
