...
parent.__c.LogImpl("264552989","NIT: "+parent._nitupdate,0);
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("264552992","NIT: "+parent._nit,0);
 if (true) break;
...
parent.__c.LogImpl("264553006",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
if (true) break;
...
__c.LogImpl("266977800",BA.ObjectToString(__c.LastException(ba)),0);
 };
...
__c.LogImpl("267108873",BA.ObjectToString(__c.LastException(ba)),0);
 };
...
parent.__c.LogImpl("264815114",_cursor.GetString("name"),0);
...
parent.__c.LogImpl("264815131",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("266584604","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("266191386","cadena: "+_cadena,0);
 //BA.debugLineNum = 705;BA.debugLine="Log(\"hacienda: \"&haciendaUpdate)";
parent.__c.LogImpl("266191387","hacienda: "+parent._haciendaupdate,0);
...
parent.__c.LogImpl("266191402","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("266519069","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("266322455","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("266453531","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("266125854","NIT: "+parent._nitupdate,0);
...
parent.__c.LogImpl("266125866","ERROR: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("265470472","=====ITEM #"+BA.NumberToString(_i)+"=====",0);
 //BA.debugLineNum = 430;BA.debugLine="Log(Cursor.GetString(\"idmaquina\"))";
parent.__c.LogImpl("265470473",_cursor.GetString("idmaquina"),0);
 //BA.debugLineNum = 431;BA.debugLine="Log(Cursor.GetString(\"name\")&\"--\"&Cursor.GetStri";
parent.__c.LogImpl("265470474",_cursor.GetString("name")+"--"+_cursor.GetString("qnt"),0);
...
parent.__c.LogImpl("265470478",_sb.ToString(),0);
...
parent.__c.LogImpl("265470484","=====Maquinas #"+BA.NumberToString(_i)+"=====",0);
 //BA.debugLineNum = 442;BA.debugLine="Log(Cursor.GetString(\"id\"))'&\"--\"&Cursor.GetStr";
parent.__c.LogImpl("265470485",_cursor.GetString("id"),0);
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("265470492",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("265667079","Inserted successfully!",0);
 if (true) break;
...
__c.LogImpl("267043330",BA.ObjectToString(_label1removeinsumo.getTag()),0);
...
__c.LogImpl("264618509",_cursor.GetString("id"),0);
 //BA.debugLineNum = 157;BA.debugLine="Log(Cursor.GetString(\"name\"))";
__c.LogImpl("264618510",_cursor.GetString("name"),0);
 //BA.debugLineNum = 158;BA.debugLine="Log(Cursor.GetString(\"qnt\"))";
__c.LogImpl("264618511",_cursor.GetString("qnt"),0);
...
__c.LogImpl("264684038","REMOVE: "+BA.NumberToString(_iw),__c.Colors.Red);
...
__c.LogImpl("264684042",BA.ObjectToString(__c.LastException(ba)),0);
 };
 };
 }
};
...
__c.LogImpl("266256899",BA.ObjectToString(_value),0);
...
__c.LogImpl("266256908",_hacienda,0);
...
parent.__c.LogImpl("267174413",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
if (true) break;
...
__c.LogImpl("267239938",BA.ObjectToString(_spinner1nameinsumo.getTag()),0);
 //BA.debugLineNum = 1004;BA.debugLine="Log(Spinner1NameInsumo.SelectedItem)";
__c.LogImpl("267239939",_spinner1nameinsumo.getSelectedItem(),0);
...
__c.LogImpl("266650113",BA.ObjectToString(_value),0);
