...
__c.LogImpl("772876034","Wrong number of values ="+BA.NumberToString(_values.length)+" col="+BA.NumberToString(_mnumberofcolumns),0);
...
__c.LogImpl("772941572","Wrong number of values ="+BA.NumberToString(_values.length)+" col="+BA.NumberToString(_mnumberofcolumns),0);
...
parent.__c.LogImpl("773924609","You may get this warning:",0);
 //BA.debugLineNum = 1707;BA.debugLine="Log(\"Unexpected event (missing RaiseSynchronousEv";
parent.__c.LogImpl("773924610","Unexpected event (missing RaiseSynchronousEvents): sv_scrollchanged",0);
 //BA.debugLineNum = 1708;BA.debugLine="Log(\"Ignore it, it is NOT harmful !\")";
parent.__c.LogImpl("773924611","Ignore it, it is NOT harmful !",0);
...
__c.LogImpl("781330179","Table.ScaleTable must be called before filling the Table",0);
...
__c.LogImpl("780805917","SetHeaderTypeFaces: Invalid number of columns",0);
...
__c.LogImpl("784017185","SortTable2, cColumnDataType("+BA.NumberToString(_col)+"): "+_ccolumndatatype[_col],0);
...
__c.LogImpl("784017231","SortTable2, cColumnDataType("+BA.NumberToString(_col)+"): "+_ccolumndatatype[_col],0);
