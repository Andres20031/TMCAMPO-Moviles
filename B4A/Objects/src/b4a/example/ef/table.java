...
__c.LogImpl("673793538","Wrong number of values ="+BA.NumberToString(_values.length)+" col="+BA.NumberToString(_mnumberofcolumns),0);
...
__c.LogImpl("673859076","Wrong number of values ="+BA.NumberToString(_values.length)+" col="+BA.NumberToString(_mnumberofcolumns),0);
...
parent.__c.LogImpl("674842113","You may get this warning:",0);
 //BA.debugLineNum = 1707;BA.debugLine="Log(\"Unexpected event (missing RaiseSynchronousEv";
parent.__c.LogImpl("674842114","Unexpected event (missing RaiseSynchronousEvents): sv_scrollchanged",0);
 //BA.debugLineNum = 1708;BA.debugLine="Log(\"Ignore it, it is NOT harmful !\")";
parent.__c.LogImpl("674842115","Ignore it, it is NOT harmful !",0);
...
__c.LogImpl("682247683","Table.ScaleTable must be called before filling the Table",0);
...
__c.LogImpl("681723421","SetHeaderTypeFaces: Invalid number of columns",0);
...
__c.LogImpl("684934689","SortTable2, cColumnDataType("+BA.NumberToString(_col)+"): "+_ccolumndatatype[_col],0);
...
__c.LogImpl("684934735","SortTable2, cColumnDataType("+BA.NumberToString(_col)+"): "+_ccolumndatatype[_col],0);
