...
__c.LogImpl("069206018","Wrong number of values ="+BA.NumberToString(_values.length)+" col="+BA.NumberToString(_mnumberofcolumns),0);
...
__c.LogImpl("069271556","Wrong number of values ="+BA.NumberToString(_values.length)+" col="+BA.NumberToString(_mnumberofcolumns),0);
...
parent.__c.LogImpl("070254593","You may get this warning:",0);
 //BA.debugLineNum = 1707;BA.debugLine="Log(\"Unexpected event (missing RaiseSynchronousEv";
parent.__c.LogImpl("070254594","Unexpected event (missing RaiseSynchronousEvents): sv_scrollchanged",0);
 //BA.debugLineNum = 1708;BA.debugLine="Log(\"Ignore it, it is NOT harmful !\")";
parent.__c.LogImpl("070254595","Ignore it, it is NOT harmful !",0);
...
__c.LogImpl("077660163","Table.ScaleTable must be called before filling the Table",0);
...
__c.LogImpl("077135901","SetHeaderTypeFaces: Invalid number of columns",0);
...
__c.LogImpl("080347169","SortTable2, cColumnDataType("+BA.NumberToString(_col)+"): "+_ccolumndatatype[_col],0);
...
__c.LogImpl("080347215","SortTable2, cColumnDataType("+BA.NumberToString(_col)+"): "+_ccolumndatatype[_col],0);
