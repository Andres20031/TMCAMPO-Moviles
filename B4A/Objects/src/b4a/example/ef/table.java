...
__c.LogImpl("270975490","Wrong number of values ="+BA.NumberToString(_values.length)+" col="+BA.NumberToString(_mnumberofcolumns),0);
...
__c.LogImpl("271041028","Wrong number of values ="+BA.NumberToString(_values.length)+" col="+BA.NumberToString(_mnumberofcolumns),0);
...
parent.__c.LogImpl("272024065","You may get this warning:",0);
 //BA.debugLineNum = 1707;BA.debugLine="Log(\"Unexpected event (missing RaiseSynchronousEv";
parent.__c.LogImpl("272024066","Unexpected event (missing RaiseSynchronousEvents): sv_scrollchanged",0);
 //BA.debugLineNum = 1708;BA.debugLine="Log(\"Ignore it, it is NOT harmful !\")";
parent.__c.LogImpl("272024067","Ignore it, it is NOT harmful !",0);
...
__c.LogImpl("279429635","Table.ScaleTable must be called before filling the Table",0);
...
__c.LogImpl("278905373","SetHeaderTypeFaces: Invalid number of columns",0);
...
__c.LogImpl("282116641","SortTable2, cColumnDataType("+BA.NumberToString(_col)+"): "+_ccolumndatatype[_col],0);
...
__c.LogImpl("282116687","SortTable2, cColumnDataType("+BA.NumberToString(_col)+"): "+_ccolumndatatype[_col],0);
