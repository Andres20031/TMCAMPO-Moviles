...
parent._sd_xcomboboxmaquina._add /*String*/ (_descripcionmaquina+" - "+_codigomaquina,(Object)(_codigomaquina));
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("29175063","Error en la consulta de Maquina: "+_j2._errormessage /*String*/ ,0);
 if (true) break;
...
parent._sd_xcomboboxlabor._add /*String*/ (_descripcionlabormaquina+" - "+_codigolabormaquina,(Object)(_codigolabormaquina));
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("29175080","Error en la consulta de Maquina: "+_j3._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("29175097","Error en la consulta de NITs: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent._sd_xcomboboximplemento._add /*String*/ (_descripcionimple+" - "+_codigoimple,(Object)(_codigoimple));
 //BA.debugLineNum = 148;BA.debugLine="SD_xComboBoxImplemento2.Add(descripcionImple &";
parent._sd_xcomboboximplemento2._add /*String*/ (_descripcionimple+" - "+_codigoimple,(Object)(_codigoimple));
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("29175114","Error en la consulta de Maquina: "+_j4._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("29175133","Error en la consulta de Maquina: "+_j5._errormessage /*String*/ ,0);
 if (true) break;
...
parent._sd_xcomboboxobservaciones._add /*String*/ (_desobser+"-"+_codigoobser,(Object)(_codigoobser));
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("29175150","Error en la consulta de Maquina: "+_j6._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("210092561","Ascdo_Maq_Mvto_Maq: "+parent._ascdo_maq_mvto_maq,0);
 //BA.debugLineNum = 382;BA.debugLine="Log(\"maquina: \" & maquina)";
parent.__c.LogImpl("210092562","maquina: "+parent._maquina,0);
 //BA.debugLineNum = 383;BA.debugLine="Log(\"fecha: \" & fecha)";
parent.__c.LogImpl("210092563","fecha: "+parent._fecha,0);
 //BA.debugLineNum = 384;BA.debugLine="Log(\"labor: \" & labor)";
parent.__c.LogImpl("210092564","labor: "+parent._labor,0);
 //BA.debugLineNum = 385;BA.debugLine="Log(\"nitEmpresaCBX: \" & nitEmpresaCBX)";
parent.__c.LogImpl("210092565","nitEmpresaCBX: "+parent._nitempresacbx,0);
 //BA.debugLineNum = 386;BA.debugLine="Log(\"haciendaCBX: \" & haciendaCBX)";
parent.__c.LogImpl("210092566","haciendaCBX: "+parent._haciendacbx,0);
 //BA.debugLineNum = 387;BA.debugLine="Log(\"Lote: \" & Lote)";
parent.__c.LogImpl("210092567","Lote: "+parent._lote,0);
 //BA.debugLineNum = 388;BA.debugLine="Log(\"implemento: \" & implemento)";
parent.__c.LogImpl("210092568","implemento: "+parent._implemento,0);
 //BA.debugLineNum = 389;BA.debugLine="Log(\"horainicio: \" & horainicio)";
parent.__c.LogImpl("210092569","horainicio: "+parent._horainicio,0);
 //BA.debugLineNum = 390;BA.debugLine="Log(\"horafin: \" & horafin)";
parent.__c.LogImpl("210092570","horafin: "+parent._horafin,0);
 //BA.debugLineNum = 391;BA.debugLine="Log(\"combustible: \" & combustible)";
parent.__c.LogImpl("210092571","combustible: "+parent._combustible,0);
 //BA.debugLineNum = 392;BA.debugLine="Log(\"observaciones: \" & observaciones)";
parent.__c.LogImpl("210092572","observaciones: "+parent._observaciones,0);
 //BA.debugLineNum = 393;BA.debugLine="Log(\"operario: \" & operario)";
parent.__c.LogImpl("210092573","operario: "+parent._operario,0);
 //BA.debugLineNum = 394;BA.debugLine="Log(\"implemento2: \" & implemento2)";
parent.__c.LogImpl("210092574","implemento2: "+parent._implemento2,0);
 //BA.debugLineNum = 395;BA.debugLine="Log(\"area: \" & area)";
parent.__c.LogImpl("210092575","area: "+parent._area,0);
 //BA.debugLineNum = 396;BA.debugLine="Log(\"fechaHoy: \" & fechaHoy)";
parent.__c.LogImpl("210092576","fechaHoy: "+parent._fechahoy,0);
 //BA.debugLineNum = 397;BA.debugLine="Log(\"horaActual: \" & horaActual)";
parent.__c.LogImpl("210092577","horaActual: "+parent._horaactual,0);
 //BA.debugLineNum = 398;BA.debugLine="Log(\"user: \" & user)";
parent.__c.LogImpl("210092578","user: "+parent._user,0);
 //BA.debugLineNum = 399;BA.debugLine="Log(\"DeviceName: \" & DeviceName)";
parent.__c.LogImpl("210092579","DeviceName: "+parent._devicename,0);
...
parent.__c.LogImpl("210092597","Error al ejecutar la consulta: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("210092600","Error al agregar datos: "+parent.__c.LastException(ba).getMessage(),0);
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("29306140","Error: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("29240604","Error: "+_j._errormessage /*String*/ ,0);
 if (true) break;
