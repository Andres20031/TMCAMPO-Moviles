...
parent.__c.LogImpl("664028702","Error en la consulta de Maquina: "+_j2._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("664028729","Error en la consulta de Maquina: "+_j3._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("664028754","Error en la consulta de NITs: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("664028781","Error en la consulta de Maquina: "+_j4._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("664028809","Error en la consulta de Maquina: "+_j5._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("664028833","Error en la consulta de Maquina: "+_j6._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("664946193","Ascdo_Maq_Mvto_Maq: "+parent._ascdo_maq_mvto_maq,0);
 //BA.debugLineNum = 467;BA.debugLine="Log(\"maquina: \" & maquina)";
parent.__c.LogImpl("664946194","maquina: "+parent._maquina,0);
 //BA.debugLineNum = 468;BA.debugLine="Log(\"fecha: \" & fecha)";
parent.__c.LogImpl("664946195","fecha: "+parent._fecha,0);
 //BA.debugLineNum = 469;BA.debugLine="Log(\"labor: \" & labor)";
parent.__c.LogImpl("664946196","labor: "+parent._labor,0);
 //BA.debugLineNum = 470;BA.debugLine="Log(\"nitEmpresaCBX: \" & nitEmpresaCBX)";
parent.__c.LogImpl("664946197","nitEmpresaCBX: "+parent._nitempresacbx,0);
 //BA.debugLineNum = 471;BA.debugLine="Log(\"haciendaCBX: \" & haciendaCBX)";
parent.__c.LogImpl("664946198","haciendaCBX: "+parent._haciendacbx,0);
 //BA.debugLineNum = 472;BA.debugLine="Log(\"Lote: \" & Lote)";
parent.__c.LogImpl("664946199","Lote: "+parent._lote,0);
 //BA.debugLineNum = 473;BA.debugLine="Log(\"implemento: \" & implemento)";
parent.__c.LogImpl("664946200","implemento: "+parent._implemento,0);
 //BA.debugLineNum = 474;BA.debugLine="Log(\"horainicio: \" & horainicio)";
parent.__c.LogImpl("664946201","horainicio: "+parent._horainicio,0);
 //BA.debugLineNum = 475;BA.debugLine="Log(\"horafin: \" & horafin)";
parent.__c.LogImpl("664946202","horafin: "+parent._horafin,0);
 //BA.debugLineNum = 476;BA.debugLine="Log(\"combustible: \" & combustible)";
parent.__c.LogImpl("664946203","combustible: "+parent._combustible,0);
 //BA.debugLineNum = 477;BA.debugLine="Log(\"observaciones: \" & observaciones)";
parent.__c.LogImpl("664946204","observaciones: "+parent._observaciones,0);
 //BA.debugLineNum = 478;BA.debugLine="Log(\"operario: \" & operario)";
parent.__c.LogImpl("664946205","operario: "+parent._operario,0);
 //BA.debugLineNum = 479;BA.debugLine="Log(\"implemento2: \" & implemento2)";
parent.__c.LogImpl("664946206","implemento2: "+parent._implemento2,0);
 //BA.debugLineNum = 480;BA.debugLine="Log(\"area: \" & area)";
parent.__c.LogImpl("664946207","area: "+parent._area,0);
 //BA.debugLineNum = 481;BA.debugLine="Log(\"fechaHoy: \" & fechaHoy)";
parent.__c.LogImpl("664946208","fechaHoy: "+parent._fechahoy,0);
 //BA.debugLineNum = 482;BA.debugLine="Log(\"horaActual: \" & horaActual)";
parent.__c.LogImpl("664946209","horaActual: "+parent._horaactual,0);
 //BA.debugLineNum = 483;BA.debugLine="Log(\"user: \" & user)";
parent.__c.LogImpl("664946210","user: "+parent._user,0);
 //BA.debugLineNum = 484;BA.debugLine="Log(\"DeviceName: \" & DeviceName)";
parent.__c.LogImpl("664946211","DeviceName: "+parent._devicename,0);
...
parent.__c.LogImpl("664946229","Error al ejecutar la consulta: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("664946232","Error al agregar datos: "+parent.__c.LastException(ba).getMessage(),0);
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("664159772","Error: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("664094236","Error: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("665273895","Error: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("665273900",parent._haciendacbx,0);
...
parent.__c.LogImpl("665404940","Implemento seleccionado: "+parent._implemento,0);
 if (true) break;
...
parent.__c.LogImpl("665404942","El texto no contiene ':' por lo que no se pudo dividir.",0);
...
parent.__c.LogImpl("665470475","Implemento2 seleccionado: "+parent._implemento2,0);
 if (true) break;
...
parent.__c.LogImpl("665470477","El texto no contiene ':' por lo que no se pudo dividir.",0);
...
parent.__c.LogImpl("665142796","Texto completo: "+parent._searchtemplatelabor._selecteditem /*String*/ ,0);
 //BA.debugLineNum = 546;BA.debugLine="Log(\"Labor seleccionada: \" & labor)";
parent.__c.LogImpl("665142797","Labor seleccionada: "+parent._labor,0);
 if (true) break;
...
parent.__c.LogImpl("665142799","El texto no contiene ':' por lo que no se pudo dividir.",0);
...
parent.__c.LogImpl("665142803",parent._labor,0);
...
parent.__c.LogImpl("665339401",parent._lote,0);
...
parent.__c.LogImpl("665077259","Máquina seleccionada: "+parent._maquina,0);
 if (true) break;
...
parent.__c.LogImpl("665077261","El texto no contiene ':' por lo que no se pudo dividir.",0);
...
parent.__c.LogImpl("665208360","Error: "+_j._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("665208364",parent._nitempresacbx,0);
...
parent.__c.LogImpl("665601548","Primera parte (observacionCBX): "+parent._observaciones,0);
 if (true) break;
...
parent.__c.LogImpl("665601550","Operación cancelada por el usuario.",0);
 if (true) break;
...
parent.__c.LogImpl("665536012","Operario seleccionado: "+parent._operario,0);
 if (true) break;
...
parent.__c.LogImpl("665536014","El texto no contiene ':' por lo que no se pudo dividir.",0);
