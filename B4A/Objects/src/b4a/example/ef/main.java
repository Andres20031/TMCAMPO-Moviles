...
public class main extends androidx.fragment.app.FragmentActivity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new anywheresoftware.b4a.ShellBA(this.getApplicationContext(), null, null, "b4a.example.ef", "b4a.example.ef.main");
...
public static String _consecutivolaboresglobal = "";
...
RDebugUtils.currentLine=49807360;
 //BA.debugLineNum = 49807360;BA.debugLine="Sub Activity_ActionBarHomeClick";
RDebugUtils.currentLine=49807361;
 //BA.debugLineNum = 49807361;BA.debugLine="ActionBarHomeClicked = True";
_actionbarhomeclicked = anywheresoftware.b4a.keywords.Common.True;
RDebugUtils.currentLine=49807362;
 //BA.debugLineNum = 49807362;BA.debugLine="B4XPages.Delegate.Activity_ActionBarHomeClick";
mostCurrent._b4xpages._delegate /*b4a.example.ef.b4xpagesdelegator*/ ._activity_actionbarhomeclick /*String*/ (null);
RDebugUtils.currentLine=49807363;
 //BA.debugLineNum = 49807363;BA.debugLine="ActionBarHomeClicked = False";
_actionbarhomeclicked = anywheresoftware.b4a.keywords.Common.False;
RDebugUtils.currentLine=49807364;
 //BA.debugLineNum = 49807364;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=49872896;
 //BA.debugLineNum = 49872896;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
RDebugUtils.currentLine=49872897;
 //BA.debugLineNum = 49872897;BA.debugLine="Return B4XPages.Delegate.Activity_KeyPress(KeyCod";
if (true) return mostCurrent._b4xpages._delegate /*b4a.example.ef.b4xpagesdelegator*/ ._activity_keypress /*boolean*/ (null,_keycode);
...
mostCurrent._b4xpages._delegate /*b4a.example.ef.b4xpagesdelegator*/ ._activity_pause /*String*/ (null);
...
RDebugUtils.currentLine=49938432;
 //BA.debugLineNum = 49938432;BA.debugLine="Sub Activity_PermissionResult (Permission As Strin";
RDebugUtils.currentLine=49938433;
 //BA.debugLineNum = 49938433;BA.debugLine="B4XPages.Delegate.Activity_PermissionResult(Permi";
mostCurrent._b4xpages._delegate /*b4a.example.ef.b4xpagesdelegator*/ ._activity_permissionresult /*String*/ (null,_permission,_result);
...
mostCurrent._b4xpages._delegate /*b4a.example.ef.b4xpagesdelegator*/ ._activity_resume /*String*/ (null);
...
RDebugUtils.currentLine=50003968;
 //BA.debugLineNum = 50003968;BA.debugLine="Sub Create_Menu (Menu As Object)";
RDebugUtils.currentLine=50003969;
 //BA.debugLineNum = 50003969;BA.debugLine="B4XPages.Delegate.Create_Menu(Menu)";
mostCurrent._b4xpages._delegate /*b4a.example.ef.b4xpagesdelegator*/ ._create_menu /*String*/ (null,_menu);
