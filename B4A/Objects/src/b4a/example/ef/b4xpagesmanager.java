...
__c.LogImpl("924903683",("Page with this id already exists: "+__c.SmartStringFormatter("",(Object)(_idtolower))+"!"),0);
...
__c.LogImpl("924772629","#SupportedOrientations attribute must be set to landscape or portrait.",_xui.Color_Red);
 };
 };
 }
};
...
__c.LogImpl("925165828","Only top page can be closed",0);
...
__c.LogImpl("925165831","First page cannot be closed",0);
...
__c.LogImpl("925821187","Error: page id not found: "+_id,0);
 //BA.debugLineNum = 402;BA.debugLine="Log(\"Ids: \" & IdToB4XPage.Keys) 'ignore";
__c.LogImpl("925821188","Ids: "+BA.ObjectToString(_idtob4xpage._getkeys /*anywheresoftware.b4a.objects.collections.List*/ ()),0);
 };
...
__c.LogImpl("924707099","Call B4XPages.GetManager.LogEvents = True to enable logging B4XPages events.",0);
 };
...
__c.LogImpl("926411022","Too many parameters",0);
 break; }
}
;
...
__c.LogImpl("926476558","Too many parameters",0);
 break; }
}
;
