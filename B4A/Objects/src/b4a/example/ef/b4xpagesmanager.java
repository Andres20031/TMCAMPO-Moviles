...
__c.LogImpl("918284547",("Page with this id already exists: "+__c.SmartStringFormatter("",(Object)(_idtolower))+"!"),0);
...
__c.LogImpl("918153493","#SupportedOrientations attribute must be set to landscape or portrait.",_xui.Color_Red);
 };
 };
 }
};
...
__c.LogImpl("918546692","Only top page can be closed",0);
...
__c.LogImpl("918546695","First page cannot be closed",0);
...
__c.LogImpl("919202051","Error: page id not found: "+_id,0);
 //BA.debugLineNum = 402;BA.debugLine="Log(\"Ids: \" & IdToB4XPage.Keys) 'ignore";
__c.LogImpl("919202052","Ids: "+BA.ObjectToString(_idtob4xpage._getkeys /*anywheresoftware.b4a.objects.collections.List*/ ()),0);
 };
...
__c.LogImpl("918087963","Call B4XPages.GetManager.LogEvents = True to enable logging B4XPages events.",0);
 };
...
__c.LogImpl("919791886","Too many parameters",0);
 break; }
}
;
...
__c.LogImpl("919857422","Too many parameters",0);
 break; }
}
;
