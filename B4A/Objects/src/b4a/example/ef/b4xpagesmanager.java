...
__c.LogImpl("919660803",("Page with this id already exists: "+__c.SmartStringFormatter("",(Object)(_idtolower))+"!"),0);
...
__c.LogImpl("919529749","#SupportedOrientations attribute must be set to landscape or portrait.",_xui.Color_Red);
 };
 };
 }
};
...
__c.LogImpl("919922948","Only top page can be closed",0);
...
__c.LogImpl("919922951","First page cannot be closed",0);
...
__c.LogImpl("920578307","Error: page id not found: "+_id,0);
 //BA.debugLineNum = 402;BA.debugLine="Log(\"Ids: \" & IdToB4XPage.Keys) 'ignore";
__c.LogImpl("920578308","Ids: "+BA.ObjectToString(_idtob4xpage._getkeys /*anywheresoftware.b4a.objects.collections.List*/ ()),0);
 };
...
__c.LogImpl("919464219","Call B4XPages.GetManager.LogEvents = True to enable logging B4XPages events.",0);
 };
...
__c.LogImpl("921168142","Too many parameters",0);
 break; }
}
;
...
__c.LogImpl("921233678","Too many parameters",0);
 break; }
}
;
