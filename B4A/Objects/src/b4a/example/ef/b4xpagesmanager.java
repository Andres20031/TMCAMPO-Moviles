...
__c.LogImpl("919070979",("Page with this id already exists: "+__c.SmartStringFormatter("",(Object)(_idtolower))+"!"),0);
...
__c.LogImpl("918939925","#SupportedOrientations attribute must be set to landscape or portrait.",_xui.Color_Red);
 };
 };
 }
};
...
__c.LogImpl("919333124","Only top page can be closed",0);
...
__c.LogImpl("919333127","First page cannot be closed",0);
...
__c.LogImpl("919988483","Error: page id not found: "+_id,0);
 //BA.debugLineNum = 402;BA.debugLine="Log(\"Ids: \" & IdToB4XPage.Keys) 'ignore";
__c.LogImpl("919988484","Ids: "+BA.ObjectToString(_idtob4xpage._getkeys /*anywheresoftware.b4a.objects.collections.List*/ ()),0);
 };
...
__c.LogImpl("918874395","Call B4XPages.GetManager.LogEvents = True to enable logging B4XPages events.",0);
 };
...
__c.LogImpl("920578318","Too many parameters",0);
 break; }
}
;
...
__c.LogImpl("920643854","Too many parameters",0);
 break; }
}
;
