...
__c.LogImpl("922478851",("Page with this id already exists: "+__c.SmartStringFormatter("",(Object)(_idtolower))+"!"),0);
...
__c.LogImpl("922347797","#SupportedOrientations attribute must be set to landscape or portrait.",_xui.Color_Red);
 };
 };
 }
};
...
__c.LogImpl("922740996","Only top page can be closed",0);
...
__c.LogImpl("922740999","First page cannot be closed",0);
...
__c.LogImpl("923396355","Error: page id not found: "+_id,0);
 //BA.debugLineNum = 402;BA.debugLine="Log(\"Ids: \" & IdToB4XPage.Keys) 'ignore";
__c.LogImpl("923396356","Ids: "+BA.ObjectToString(_idtob4xpage._getkeys /*anywheresoftware.b4a.objects.collections.List*/ ()),0);
 };
...
__c.LogImpl("922282267","Call B4XPages.GetManager.LogEvents = True to enable logging B4XPages events.",0);
 };
...
__c.LogImpl("923986190","Too many parameters",0);
 break; }
}
;
...
__c.LogImpl("924051726","Too many parameters",0);
 break; }
}
;
