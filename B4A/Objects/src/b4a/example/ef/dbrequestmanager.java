...
parent.__c.LogImpl("756885253","Error building command: "+BA.ObjectToString(parent.__c.LastException(parent.getActivityBA())),0);
...
parent.__c.LogImpl("757081862","Error reading response: "+BA.ObjectToString(parent.__c.LastException(parent.getActivityBA())),0);
...
__c.LogImpl("757344001","Tag: "+BA.ObjectToString(_table.Tag /*Object*/ )+", Columns: "+BA.NumberToString(_table.Columns /*anywheresoftware.b4a.objects.collections.Map*/ .getSize())+", Rows: "+BA.NumberToString(_table.Rows /*anywheresoftware.b4a.objects.collections.List*/ .getSize()),0);
...
__c.LogImpl("757344007",_sb.ToString(),0);
...
__c.LogImpl("757344014",_sb.ToString(),0);
 }
};
