...
_root = _root1;
 //BA.debugLineNum = 15;BA.debugLine="Root.LoadLayout(\"FormLaboresCampoCancelar\")";
...
public String  _label1_click() throws Exception{
 //BA.debugLineNum = 20;BA.debugLine="Private Sub Label1_Click";
 //BA.debugLineNum = 21;BA.debugLine="B4XPages.ClosePage(Me)";
